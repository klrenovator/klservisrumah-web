      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 sm:px-6 lg:grid-cols-12 lg:px-8">
        ...
        <aside className="lg:col-span-4">
          <div className="sticky top-28 rounded-3xl bg-[#0284C7] p-6 text-white shadow-xl">
            ...
            <a href={getWhatsAppLink({ service: localizedProblem.title, lang })} target="_blank" rel="noopener noreferrer" className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#25D366] px-5 py-3 text-sm font-extrabold text-white">
