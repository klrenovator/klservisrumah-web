  ...
  const points = [
    {
      ...
      desc: "Managed directly under Multicore Dynamics Resources (SSM: 202503227236). Fully insured operations across all property boundaries."
    },
    {
    ...
    {
      icon: <Clock className="w-6 h-6 text-[#0781B2]" />,
    ...
    {
      icon: <Heart className="w-6 h-6 text-[#0781B2]" />,
    ...
    {
      icon: <Headphones className="w-6 h-6 text-[#0781B2]" />,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {points.map((point, idx) => (
            <div
              key={idx}
              className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-100/50 shadow-[0_4px_20px_rgba(2,31,68,0.01)] hover:shadow-[0_15px_40px_rgba(2,31,68,0.03)] hover:border-[#0781B2]/20 transition-all duration-300"
            >
              <div className="p-3 bg-[#D2DEE7]/25 rounded-2xl w-fit mb-6">
                {point.icon}
              </div>
              <h3 className="text-lg font-bold text-[#021F44] tracking-tight mb-2.5">
                {point.title}
              </h3>
