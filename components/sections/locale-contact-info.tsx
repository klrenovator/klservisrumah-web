    ...
    <>
      <div className="flex flex-col gap-5">
        <div className="flex gap-4 items-start p-4 bg-white rounded-2xl border border-slate-100 shadow-3xs">
          <MapPin className="w-5 h-5 text-[#0369A1] shrink-0 mt-0.5" />
        ...
        <div className="flex gap-4 items-start p-4 bg-white rounded-2xl border border-slate-100 shadow-3xs">
          <Phone className="w-5 h-5 text-[#0369A1] shrink-0 mt-0.5" />
          <div className="flex flex-col gap-0.5">
            <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">{t("contact.labels.phone")}</span>
            <a href={`tel:${siteConfig.phone}`} className="text-xs sm:text-sm text-[#0369A1] font-extrabold">{siteConfig.phoneDisplay}</a>
          </div>
        </div>

        <div className="flex gap-4 items-start p-4 bg-white rounded-2xl border border-slate-100 shadow-3xs">
          <Mail className="w-5 h-5 text-[#0369A1] shrink-0 mt-0.5" />
          <div className="flex flex-col gap-0.5">
        ...
        <div className="flex gap-4 items-start p-4 bg-white rounded-2xl border border-slate-100 shadow-3xs">
          <Clock className="w-5 h-5 text-[#0369A1] shrink-0 mt-0.5" />
          <div className="flex flex-col gap-0.5">
      ...
      <div className="bg-[#F8FAFC] rounded-3xl p-5 border border-slate-100/60 flex gap-3">
        <ShieldAlert className="w-5 h-5 text-[#0369A1] shrink-0 mt-0.5" />
