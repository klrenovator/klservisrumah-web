...
export function StickyBookButton({ service, location }: { service?: string; location?: string }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-4 z-40 hidden rounded-full bg-[#15803D] px-5 py-3 text-sm font-extrabold text-white shadow-xl transition hover:-translate-y-0.5 md:inline-flex md:items-center md:gap-2"
    >
