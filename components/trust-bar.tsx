...
const items: Record<"en" | "ms" | "zh", { icon: React.ReactNode; label: string }[]> = {
  en: [
    ...
    { icon: <BadgeCheck className="h-4 w-4 text-[#0369A1]" />, label: "30-day to 10-year warranties" },
    { icon: <WalletCards className="h-4 w-4 text-[#0369A1]" />, label: "Honest upfront pricing" },
    { icon: <Clock3 className="h-4 w-4 text-[#0369A1]" />, label: "Same-day dispatch slots" },
    { icon: <Users className="h-4 w-4 text-[#0369A1]" />, label: "Background-verified crew" }
  ],
  ms: [
    ...
    { icon: <BadgeCheck className="h-4 w-4 text-[#0369A1]" />, label: "Jaminan 30 hari hingga 10 tahun" },
    { icon: <WalletCards className="h-4 w-4 text-[#0369A1]" />, label: "Harga adil, tiada kejutan" },
    { icon: <Clock3 className="h-4 w-4 text-[#0369A1]" />, label: "Slot penghantaran hari sama" },
    { icon: <Users className="h-4 w-4 text-[#0369A1]" />, label: "Krew yang disahkan latar belakang" }
  ],
  zh: [
    ...
    { icon: <BadgeCheck className="h-4 w-4 text-[#0369A1]" />, label: "30 天至 10 年保修" },
    { icon: <WalletCards className="h-4 w-4 text-[#0369A1]" />, label: "价格公道透明" },
    { icon: <Clock3 className="h-4 w-4 text-[#0369A1]" />, label: "当日派遣时段" },
    { icon: <Users className="h-4 w-4 text-[#0369A1]" />, label: "经过背景核查的团队" }
  ]
};
