    ...
    <section className="bg-white py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          ...
          <h1 className="mt-2 text-3xl font-extrabold text-[#075985]">Recent Home Service Work Types</h1>
          ...
          {projectItems.map((project) => (
            <article key={project.slug} className="overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-xs">
              ...
              <div className="p-5">
                ...
                <h2 className="mt-2 text-base font-extrabold text-[#075985]">{project.title}</h2>
