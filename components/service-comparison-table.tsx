    ...
    <section className="bg-white py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8 flex flex-col gap-3 text-center">
          ...
          <h2 className="text-3xl font-extrabold text-[#075985]">Choose the right service before booking</h2>
              ...
              {Object.values(servicesData).map((service) => (
                <tr key={service.slug} className="align-top">
                  ...
                  <td className="px-5 py-4">
                    <Link href={`/services/${service.slug}/cost`} className="rounded-xl bg-[#0284C7] px-4 py-2 text-xs font-extrabold text-white transition hover:bg-[#0369A1]">
                      View pricing
                    </Link>
                  </td>
                </tr>
