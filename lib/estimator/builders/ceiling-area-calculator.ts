...
export function buildCeilingAreaCalculatorSpec(t: Translator): EstimatorSpec {
  ...
  return {
    ...
    compute: (answers) => {
      ...
      return {
        ...
        addOns: [],
        related: [
          { label: t("related.service.label"), href: "/services/ceiling", desc: t("related.service.desc") },
