...
export function buildLightingInstallationCalculatorSpec(t: Translator): EstimatorSpec {
  const unit: string = "point";
  const rate = 120;
  return {
    ...
    compute: (answers) => {
      ...
      return {
        ...
        serviceHref: "/services/lighting",
        breakdown,
        addOns: [],
        related: [
          { label: t("related.service.label"), href: "/services/lighting", desc: t("related.service.desc") },
