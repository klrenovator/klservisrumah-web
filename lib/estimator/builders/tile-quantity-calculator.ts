...
export function buildTileQuantityCalculatorSpec(t: Translator): EstimatorSpec {
  return {
    ...
    steps: [
      ...
      },
      {
        ...
        fields: [
          ...
          ], visible: (a)=> "tile-quantity-calculator".includes("tile") },
          { id: "socketsPerWall", kind: "slider", label: t("fields.socketsPerWall.label"), min: 1, max: 6, step: 1, defaultValue: 2, format: (v:number)=>`${v} per wall`, visible: (a)=> "tile-quantity-calculator".includes("socket") },
          { id: "coats", kind: "slider", label: t("fields.coats.label"), min: 1, max: 3, step: 1, defaultValue: 2, format: (v:number)=>`${v} coats`, visible: (a)=> "tile-quantity-calculator".includes("paint") },
    ...
    compute: (answers) => {
      ...
      return {
        ...
        serviceHref: "/services/tiling",
        breakdown,
        addOns: [],
        related: [{ label: t("related.service.label"), href: "/services/tiling", desc: t("related.service.desc") }],
