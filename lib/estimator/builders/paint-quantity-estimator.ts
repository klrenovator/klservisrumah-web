...
export function buildPaintQuantityEstimatorSpec(t: Translator): EstimatorSpec {
  return {
    ...
    steps: [
      ...
      },
      {
        ...
        fields: [
          ...
          ], visible: (a)=> "paint-quantity-estimator".includes("tile") },
          { id: "socketsPerWall", kind: "slider", label: t("fields.socketsPerWall.label"), min: 1, max: 6, step: 1, defaultValue: 2, format: (v:number)=>`${v} per wall`, visible: (a)=> "paint-quantity-estimator".includes("socket") },
          { id: "coats", kind: "slider", label: t("fields.coats.label"), min: 1, max: 3, step: 1, defaultValue: 2, format: (v:number)=>`${v} coats`, visible: (a)=> "paint-quantity-estimator".includes("paint") },
    ...
    compute: (answers) => {
      ...
      return {
        ...
        breakdown,
        addOns: [],
        related: [{ label: t("related.service.label"), href: "/services/painting", desc: t("related.service.desc") }],
