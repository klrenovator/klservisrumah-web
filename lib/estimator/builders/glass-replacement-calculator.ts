...
export function buildGlassReplacementCalculatorSpec(t: Translator): EstimatorSpec {
  ...
  return {
    ...
    compute: (answers) => {
      ...
      return {
        ...
        serviceHref: "/services/glass-aluminium",
        breakdown,
        addOns: [],
        related: [
          { label: t("related.service.label"), href: "/services/glass-aluminium", desc: t("related.service.desc") },
