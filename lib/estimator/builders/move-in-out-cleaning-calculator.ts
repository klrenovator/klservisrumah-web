...
export function buildMoveInOutCleaningCalculatorSpec(t: Translator): EstimatorSpec {
  ...
  return {
    ...
    compute: (answers) => {
      ...
      return {
        ...
        addOns: [],
        related: [
          { label: t("related.service.label"), href: "/services/deep-cleaning", desc: t("related.service.desc") },
