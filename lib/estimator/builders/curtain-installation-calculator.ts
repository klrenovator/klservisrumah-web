...
export function buildCurtainInstallationCalculatorSpec(t: Translator): EstimatorSpec {
  ...
  return {
    ...
    compute: (answers) => {
      ...
      return {
        ...
        addOns: [],
        related: [
          { label: t("related.service.label"), href: "/services/handyman", desc: t("related.service.desc") },
