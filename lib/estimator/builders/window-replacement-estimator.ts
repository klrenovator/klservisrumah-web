...
export function buildWindowReplacementEstimatorSpec(t: Translator): EstimatorSpec {
  ...
  return {
    ...
    compute: (answers) => {
      ...
      return {
        ...
        serviceHref: "/services/window-repair",
        breakdown,
        addOns: [],
        related: [
          { label: t("related.service.label"), href: "/services/window-repair", desc: t("related.service.desc") },
