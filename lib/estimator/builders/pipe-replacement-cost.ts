...
export function buildPipeReplacementCostSpec(t: Translator): EstimatorSpec {
  ...
  return {
    ...
    compute: (answers) => {
      ...
      return {
        ...
        addOns: [],
        related: [
          { label: t("related.service.label"), href: "/services/plumbing", desc: t("related.service.desc") },
