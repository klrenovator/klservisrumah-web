...
export function buildCeilingFanInstallationEstimatorSpec(t: Translator): EstimatorSpec {
  ...
  return {
    ...
    compute: (answers) => {
      ...
      return {
        ...
        serviceHref: "/services/ceiling-fan",
        breakdown,
        addOns: [],
        related: [
          { label: t("related.service.label"), href: "/services/ceiling-fan", desc: t("related.service.desc") },
