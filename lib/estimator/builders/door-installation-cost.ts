...
export function buildDoorInstallationCostSpec(t: Translator): EstimatorSpec {
  ...
  return {
    ...
    compute: (answers) => {
      ...
      return {
        ...
        serviceHref: "/services/door",
        breakdown,
        addOns: [],
        related: [
          { label: t("related.service.label"), href: "/services/door", desc: t("related.service.desc") },
