...
export function buildCeilingReplacementCostSpec(t: Translator): EstimatorSpec {
  ...
  return {
    ...
    compute: (answers) => {
      ...
      return {
        ...
        serviceHref: "/services/plaster-ceiling",
        breakdown,
        addOns: [],
        related: [
          { label: t("related.service.label"), href: "/services/plaster-ceiling", desc: t("related.service.desc") },
