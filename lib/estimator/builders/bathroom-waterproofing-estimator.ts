...
export function buildBathroomWaterproofingEstimatorSpec(t: Translator): EstimatorSpec {
  const unit: string = "job";
  const rate = 1000;
  return {
    ...
    compute: (answers) => {
      ...
      return {
        ...
        serviceHref: "/services/waterproofing",
        breakdown,
        addOns: [],
        related: [
          { label: t("related.service.label"), href: "/services/waterproofing", desc: t("related.service.desc") },
