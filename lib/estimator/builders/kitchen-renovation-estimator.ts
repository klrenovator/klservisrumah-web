...
export function buildKitchenRenovationEstimatorSpec(t: Translator): EstimatorSpec {
  const unit: string = "linearft";
  const rate = 180;
  return {
    ...
    compute: (answers) => {
      ...
      return {
        ...
        serviceHref: "/services/kitchen-cabinet",
        breakdown,
        addOns: [],
        related: [
          { label: t("related.service.label"), href: "/services/kitchen-cabinet", desc: t("related.service.desc") },
