...
const BLOG: Record<string, string[]> = {
  ...
  "awning-installation": ["how-to-choose-right-awning-malaysia", "polycarbonate-vs-metal-vs-acp-awning-malaysia", "car-porch-awning-guide-malaysia", "how-awning-pricing-works-malaysia", "awning-maintenance-leaks-rust-water-pooling", "retractable-vs-fixed-awning-malaysia", "how-to-fix-a-leaking-roof-in-kl", "roof-repair-waterproofing-kl", "roof-leak-diagnosis-repair-kl"],
...
export const topicalAuthorityMap: Record<string, TopicalSilo> = {
  ...
  "awning-installation": {
    ...
    specialties: [
      ...
      { specialtySlug: "balcony-patio-and-window-awning", relatedProblems: ["balcony-leak-condo", "ceiling-leak-after-rain"], relatedBlogs: ["retractable-vs-fixed-awning-malaysia", "how-to-choose-right-awning-malaysia", "how-to-fix-a-leaking-roof-in-kl"] },
