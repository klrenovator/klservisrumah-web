...
const BLOG: Record<string, string[]> = {
  ...
  "awning-installation": ["polycarbonate-vs-metal-vs-acp-awning-malaysia", "car-porch-awning-guide-malaysia", "how-awning-pricing-works-malaysia", "how-to-fix-a-leaking-roof-in-kl", "roof-repair-waterproofing-kl", "roof-leak-diagnosis-repair-kl"],
...
export const topicalAuthorityMap: Record<string, TopicalSilo> = {
  ...
  "awning-installation": {
    ...
    specialties: [
      ...
      { specialtySlug: "awning-replacement-and-repair", relatedProblems: ["clogged-gutter-leaking", "roof-leak-rainy-season", "rusting-window-grille"], relatedBlogs: ["how-awning-pricing-works-malaysia", "how-to-fix-a-leaking-roof-in-kl", "roof-leak-diagnosis-repair-kl"] },
    ],
  },
  welding: {
    serviceSlug: "welding",
