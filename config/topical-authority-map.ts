...
const BLOG: Record<string, string[]> = {
  ...
  "awning-installation": ["polycarbonate-vs-metal-vs-acp-awning-malaysia", "how-to-fix-a-leaking-roof-in-kl", "roof-repair-waterproofing-kl", "roof-leak-diagnosis-repair-kl"],
...
export const topicalAuthorityMap: Record<string, TopicalSilo> = {
  ...
  "awning-installation": {
    ...
    specialties: [
      { specialtySlug: "car-porch-awning-installation", relatedProblems: ["roof-leak-rainy-season", "clogged-gutter-leaking"], relatedBlogs: ["polycarbonate-vs-metal-vs-acp-awning-malaysia", "how-to-fix-a-leaking-roof-in-kl"] },
      { specialtySlug: "polycarbonate-awning", relatedProblems: ["ceiling-leak-after-rain", "roof-leak-rainy-season"], relatedBlogs: ["polycarbonate-vs-metal-vs-acp-awning-malaysia", "roof-leak-diagnosis-repair-kl"] },
