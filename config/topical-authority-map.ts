...
const BLOG: Record<string, string[]> = {
  ...
  "awning-installation": ["how-to-choose-right-awning-malaysia", "polycarbonate-vs-metal-vs-acp-awning-malaysia", "car-porch-awning-guide-malaysia", "how-awning-pricing-works-malaysia", "how-to-fix-a-leaking-roof-in-kl", "roof-repair-waterproofing-kl", "roof-leak-diagnosis-repair-kl"],
