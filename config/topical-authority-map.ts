...
const BLOG: Record<string, string[]> = {
  ...
  "awning-installation": ["how-to-fix-a-leaking-roof-in-kl", "roof-repair-waterproofing-kl", "roof-leak-diagnosis-repair-kl"],
...
export const topicalAuthorityMap: Record<string, TopicalSilo> = {
  ...
  "awning-installation": {
    ...
    specialties: [
      { specialtySlug: "car-porch-awning-installation", relatedProblems: ["roof-leak-rainy-season", "clogged-gutter-leaking"], relatedBlogs: ["how-to-fix-a-leaking-roof-in-kl"] },
      { specialtySlug: "polycarbonate-awning", relatedProblems: ["ceiling-leak-after-rain", "roof-leak-rainy-season"], relatedBlogs: ["roof-leak-diagnosis-repair-kl"] },
      { specialtySlug: "metal-deck-awning", relatedProblems: ["clogged-gutter-leaking", "rusting-window-grille"], relatedBlogs: ["roof-repair-waterproofing-kl"] },
      { specialtySlug: "aluminium-composite-acp-awning", relatedProblems: ["ceiling-leak-after-rain"], relatedBlogs: [] },
      { specialtySlug: "glass-awning", relatedProblems: ["ceiling-leak-after-rain"], relatedBlogs: [] },
      { specialtySlug: "canvas-and-fabric-awning", relatedProblems: ["roof-leak-rainy-season"], relatedBlogs: [] },
      { specialtySlug: "balcony-patio-and-window-awning", relatedProblems: ["balcony-leak-condo", "ceiling-leak-after-rain"], relatedBlogs: ["how-to-fix-a-leaking-roof-in-kl"] },
      { specialtySlug: "awning-replacement-and-repair", relatedProblems: ["clogged-gutter-leaking", "roof-leak-rainy-season", "rusting-window-grille"], relatedBlogs: ["how-to-fix-a-leaking-roof-in-kl", "roof-leak-diagnosis-repair-kl"] },
    ],
  },
  welding: {
    serviceSlug: "welding",
