...
const PROB: Record<string, string[]> = {
  ...
  "post-renovation-cleaning": ["construction-dust-returning", "cement-splatter-tile-clean", "stubborn-grout-stains-after-deep-clean", "sliding-window-stuck"],
  ...
  "kitchen-renovation": ["kitchen-cabinet-door-misaligned", "cabinet-door-sagging", "clogged-drain"],
  "bathroom-renovation": ["leaking-bathroom", "bathroom-leak-upper-floor", "toilet-not-flushing", "loose-hollow-tiles", "cracked-tile-grout"],
};
...
const BLOG: Record<string, string[]> = {
  ...
  cleaning: [],
  "deep-cleaning": [],
  "post-renovation-cleaning": ["post-renovation-cleaning-kl", "condo-post-renovation-clean-kl", "terrace-house-post-renovation-clean-kl", "new-tiles-grout-haze-removal-kl"],
...
export const topicalAuthorityMap: Record<string, TopicalSilo> = {
  ...
  "house-renovation": {
    ...
    specialties: [
      ...
      { specialtySlug: "partial-house-renovation", relatedProblems: ["old-condo-full-refurbishment"], relatedBlogs: ["cost-of-full-house-renovation-kl"] },
      { specialtySlug: "terrace-house-renovation", relatedProblems: ["old-condo-full-refurbishment"], relatedBlogs: ["cost-of-full-house-renovation-kl"] },
      { specialtySlug: "semi-d-renovation", relatedProblems: ["old-condo-full-refurbishment"], relatedBlogs: ["cost-of-full-house-renovation-kl"] },
      { specialtySlug: "bungalow-renovation", relatedProblems: ["old-condo-full-refurbishment"], relatedBlogs: ["cost-of-full-house-renovation-kl"] },
      ...
      { specialtySlug: "house-extension", relatedProblems: ["old-condo-full-refurbishment"], relatedBlogs: ["cost-of-full-house-renovation-kl"] },
      ...
      { specialtySlug: "office-renovation-and-fit-out", relatedProblems: ["old-condo-full-refurbishment"], relatedBlogs: ["how-to-hire-honest-contractor-malaysia", "cost-of-full-house-renovation-kl"] },
      { specialtySlug: "retail-shop-renovation", relatedProblems: ["old-condo-full-refurbishment"], relatedBlogs: ["how-to-hire-honest-contractor-malaysia"] },
      { specialtySlug: "restaurant-and-f-and-b-renovation", relatedProblems: ["old-condo-full-refurbishment"], relatedBlogs: ["how-to-hire-honest-contractor-malaysia"] },
      { specialtySlug: "office-partition-and-workspace-build", relatedProblems: ["old-condo-full-refurbishment"], relatedBlogs: ["how-to-hire-honest-contractor-malaysia"] },
      { specialtySlug: "renovation-contractor-services", relatedProblems: ["old-condo-full-refurbishment"], relatedBlogs: ["how-to-hire-honest-contractor-malaysia"] },
    ],
  },
  electrical: {
  ...
  tiling: {
    ...
    specialties: [
      ...
      { specialtySlug: "floor-tile-replacement-and-tile-hacking", relatedProblems: ["loose-hollow-tiles", "cracked-tile-grout"], relatedBlogs: [] },
      { specialtySlug: "porcelain-tiles-installation", relatedProblems: ["loose-hollow-tiles"], relatedBlogs: [] },
      ...
      { specialtySlug: "bathroom-tiling-and-waterproofing", relatedProblems: ["leaking-bathroom", "loose-hollow-tiles"], relatedBlogs: [] },
      ...
      { specialtySlug: "floor-leveling-and-self-leveling", relatedProblems: ["loose-hollow-tiles"], relatedBlogs: [] },
    ],
  },
  "plaster-ceiling": {
    ...
    specialties: [
      ...
      { specialtySlug: "gypsum-partition-and-office-partition", relatedProblems: ["cracked-ceiling-joints"], relatedBlogs: ["gypsum-vs-plaster-ceiling-malaysia"] },
      { specialtySlug: "room-partition", relatedProblems: ["cracked-ceiling-joints"], relatedBlogs: ["gypsum-vs-plaster-ceiling-malaysia"] },
      ...
      { specialtySlug: "wall-crack-repair-and-repainting", relatedProblems: ["cracked-ceiling-joints"], relatedBlogs: ["gypsum-vs-plaster-ceiling-malaysia"] },
  ...
  flooring: {
    ...
    specialties: [
      ...
      { specialtySlug: "vinyl-flooring-installation", relatedProblems: ["vinyl-flooring-lifting-edges"], relatedBlogs: ["spc-vs-vinyl-vs-laminate-flooring-malaysia"] },
      { specialtySlug: "floor-tile-installation", relatedProblems: ["loose-hollow-tiles"], relatedBlogs: ["spc-vs-vinyl-vs-laminate-flooring-malaysia"] },
      { specialtySlug: "floor-tile-replacement-and-subfloor-hacking", relatedProblems: ["loose-hollow-tiles"], relatedBlogs: ["spc-vs-vinyl-vs-laminate-flooring-malaysia"] },
      { specialtySlug: "porcelain-and-ceramic-tiles", relatedProblems: ["loose-hollow-tiles"], relatedBlogs: ["spc-vs-vinyl-vs-laminate-flooring-malaysia"] },
      ...
      { specialtySlug: "floor-leveling-and-screeding", relatedProblems: ["vinyl-flooring-lifting-edges"], relatedBlogs: ["spc-vs-vinyl-vs-laminate-flooring-malaysia"] },
      { specialtySlug: "hollow-tile-and-uneven-floor-repair", relatedProblems: ["loose-hollow-tiles"], relatedBlogs: ["spc-vs-vinyl-vs-laminate-flooring-malaysia"] },
  ...
  "post-renovation-cleaning": {
    ...
    specialties: [
      { specialtySlug: "condo-post-renovation-clean-1-000-sqft", relatedProblems: ["construction-dust-returning", "cement-splatter-tile-clean"], relatedBlogs: ["condo-post-renovation-clean-kl"] },
      { specialtySlug: "terrace-house-post-renovation-clean-2-000-sqft", relatedProblems: ["construction-dust-returning", "cement-splatter-tile-clean"], relatedBlogs: ["terrace-house-post-renovation-clean-kl"] },
      { specialtySlug: "new-tiles-grout-haze-removal", relatedProblems: ["cement-splatter-tile-clean", "stubborn-grout-stains-after-deep-clean"], relatedBlogs: ["new-tiles-grout-haze-removal-kl"] },
      { specialtySlug: "construction-debris-removal", relatedProblems: ["construction-dust-returning", "cement-splatter-tile-clean"], relatedBlogs: ["post-renovation-cleaning-kl"] },
      { specialtySlug: "construction-rough-cleaning-and-site-clearance", relatedProblems: ["construction-dust-returning", "cement-splatter-tile-clean"], relatedBlogs: ["post-renovation-cleaning-kl"] },
      { specialtySlug: "fine-dust-extraction-and-air-purifying", relatedProblems: ["construction-dust-returning"], relatedBlogs: ["post-renovation-cleaning-kl"] },
      { specialtySlug: "paint-splatter-and-silicone-smear-removal", relatedProblems: ["cement-splatter-tile-clean", "stubborn-grout-stains-after-deep-clean"], relatedBlogs: ["post-renovation-cleaning-kl"] },
      { specialtySlug: "window-glass-and-aluminium-track-detailing", relatedProblems: ["sliding-window-stuck", "cement-splatter-tile-clean"], relatedBlogs: ["post-renovation-cleaning-kl"] },
      { specialtySlug: "floor-machine-scrubbing-and-buffing", relatedProblems: ["cement-splatter-tile-clean", "stubborn-grout-stains-after-deep-clean"], relatedBlogs: ["new-tiles-grout-haze-removal-kl"] },
      { specialtySlug: "move-in-and-handover-final-cleaning", relatedProblems: ["construction-dust-returning", "move-out-condo-deep-clean"], relatedBlogs: ["condo-post-renovation-clean-kl", "terrace-house-post-renovation-clean-kl"] },
    ],
  },
  cctv: {
    serviceSlug: "cctv",
  ...
  "kitchen-renovation": {
    ...
    specialties: [
      { specialtySlug: "full-kitchen-renovation", relatedProblems: ["kitchen-cabinet-door-misaligned"], relatedBlogs: ["kitchen-cabinet-material-guide-malaysia"] },
      { specialtySlug: "kitchen-cabinet-installation", relatedProblems: ["kitchen-cabinet-door-misaligned", "cabinet-door-sagging"], relatedBlogs: ["kitchen-cabinet-material-guide-malaysia"] },
      ...
      { specialtySlug: "wet-kitchen-renovation", relatedProblems: ["clogged-drain"], relatedBlogs: [] },
      { specialtySlug: "dry-kitchen-renovation", relatedProblems: ["kitchen-cabinet-door-misaligned"], relatedBlogs: [] },
      { specialtySlug: "kitchen-extension", relatedProblems: ["old-condo-full-refurbishment"], relatedBlogs: ["cost-of-full-house-renovation-kl"] },
      { specialtySlug: "kitchen-plumbing-and-electrical", relatedProblems: ["clogged-drain", "rccb-tripping-kl"], relatedBlogs: ["safe-electrical-wiring-upgrade-old-house"] },
    ],
  },
  "bathroom-renovation": {
    ...
    specialties: [
      { specialtySlug: "full-bathroom-renovation", relatedProblems: ["leaking-bathroom", "bathroom-leak-upper-floor"], relatedBlogs: ["how-to-fix-leaking-ceiling-without-tile-hacking"] },
      { specialtySlug: "toilet-renovation", relatedProblems: ["toilet-not-flushing", "blocked-drain-toilet"], relatedBlogs: [] },
      { specialtySlug: "bathroom-makeover", relatedProblems: ["mold-in-bathroom-after-cleaning", "stubborn-bathroom-limescale"], relatedBlogs: [] },
      { specialtySlug: "shower-area-renovation", relatedProblems: ["shower-screen-leaking", "leaking-bathroom"], relatedBlogs: [] },
      { specialtySlug: "bathroom-tiling", relatedProblems: ["loose-hollow-tiles", "cracked-tile-grout"], relatedBlogs: [] },
      ...
      { specialtySlug: "bathroom-plumbing", relatedProblems: ["leaking-bathroom", "low-water-pressure"], relatedBlogs: ["hidden-water-leak-detection-kl"] },
      { specialtySlug: "sanitary-installation", relatedProblems: ["toilet-not-flushing"], relatedBlogs: [] },
      { specialtySlug: "bathroom-floor-replacement", relatedProblems: ["loose-hollow-tiles", "leaking-bathroom"], relatedBlogs: [] },
