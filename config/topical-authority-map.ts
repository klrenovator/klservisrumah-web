...
const PROB: Record<string, string[]> = {
  ...
  plumbing: ["burst-pipe-emergency", "leaking-bathroom", "low-water-pressure-kl", "low-water-pressure", "blocked-drain-toilet", "clogged-drain", "toilet-not-flushing", "water-heater-not-working"],
  ceiling: ["ceiling-mold-stains", "sagging-plaster-ceiling", "sagging-ceiling", "cracked-ceiling-joints", "condensation-ceiling-mold", "ceiling-cornice-crack"],
  ...
  handyman: ["loose-door-hinge", "door-hinge-sagging", "tv-fell-off-wall", "stuck-window-lock", "ikea-furniture-assembly-help", "curtain-track-falling"],
  "house-renovation": ["old-condo-full-refurbishment"],
  electrical: ["rccb-tripping-kl", "power-tripping-frequently", "flickering-lights-kl"],
  "water-heater": ["water-heater-not-heating", "water-heater-cold"],
  "ceiling-fan": ["ceiling-fan-wobbling"],
  lighting: ["flickering-downlights", "downlight-flickering"],
  tiling: ["hollow-tiles-floor", "loose-hollow-tiles", "cracked-tile-grout"],
  "plaster-ceiling": ["plaster-ceiling-cracking-joints", "plaster-ceiling-hairline-crack"],
  ...
  "window-repair": ["sliding-window-stuck", "stuck-sliding-window"],
  locksmith: ["smart-lock-not-working", "locked-out-of-house"],
  "glass-aluminium": ["shower-screen-leaking", "shower-screen-water-leak"],
...
export const topicalAuthorityMap: Record<string, TopicalSilo> = {
  ...
  plumbing: {
    ...
    specialties: [
      { specialtySlug: "water-leakage-diagnosis-and-repair", relatedProblems: ["burst-pipe-emergency", "leaking-bathroom", "water-heater-not-working"], relatedBlogs: ["hidden-water-leak-detection-kl"] },
      ...
      { specialtySlug: "water-heater-and-pump-installation", relatedProblems: ["low-water-pressure-kl", "water-heater-not-working"], relatedBlogs: [] },
    ],
  },
  ceiling: {
    serviceSlug: "ceiling",
    ...
    specialties: [
      { specialtySlug: "water-damaged-ceiling-repair", relatedProblems: ["ceiling-mold-stains", "ceiling-leak-after-rain", "condensation-ceiling-mold", "sagging-ceiling"], relatedBlogs: ["how-to-fix-leaking-ceiling-without-tile-hacking"] },
  ...
  handyman: {
    ...
    specialties: [
      ...
      { specialtySlug: "door-hinge-and-lockset-repair", relatedProblems: ["loose-door-hinge", "door-hinge-sagging", "stuck-window-lock"], relatedBlogs: [] },
  ...
  electrical: {
    ...
    specialties: [
      { specialtySlug: "new-power-point-and-switch-installation", relatedProblems: ["power-tripping-frequently", "flickering-lights-kl"], relatedBlogs: ["safe-electrical-wiring-upgrade-old-house"] },
      ...
      { specialtySlug: "lighting-point-and-downlight-installation", relatedProblems: ["flickering-lights-kl", "flickering-downlights"], relatedBlogs: ["safe-electrical-wiring-upgrade-old-house"] },
      { specialtySlug: "aircond-water-heater-and-oven-point", relatedProblems: ["power-tripping-frequently", "flickering-lights-kl"], relatedBlogs: [] },
    ],
  },
  "water-heater": {
    ...
    specialties: [
      { specialtySlug: "instant-water-heater-installation", relatedProblems: ["water-heater-not-heating", "water-heater-cold"], relatedBlogs: [] },
      { specialtySlug: "storage-tank-heater-installation", relatedProblems: ["water-heater-not-heating", "water-heater-cold"], relatedBlogs: [] },
      { specialtySlug: "water-heater-repair-and-descaling", relatedProblems: ["water-heater-not-heating", "water-heater-cold"], relatedBlogs: [] },
  ...
  lighting: {
    ...
    specialties: [
      { specialtySlug: "led-downlight-installation", relatedProblems: ["flickering-downlights", "downlight-flickering"], relatedBlogs: [] },
      { specialtySlug: "pendant-and-chandelier-install", relatedProblems: ["flickering-downlights"], relatedBlogs: [] },
      { specialtySlug: "cove-and-strip-led-installation", relatedProblems: ["flickering-downlights"], relatedBlogs: [] },
      { specialtySlug: "smart-lighting-and-dimmer-retrofit", relatedProblems: ["downlight-flickering", "flickering-lights-kl"], relatedBlogs: [] },
    ],
  },
  tiling: {
    serviceSlug: "tiling",
    ...
    specialties: [
      { specialtySlug: "floor-tiling-installation", relatedProblems: ["hollow-tiles-floor", "loose-hollow-tiles", "cracked-tile-grout"], relatedBlogs: [] },
      { specialtySlug: "wall-tiling-installation", relatedProblems: ["hollow-tiles-floor", "loose-hollow-tiles"], relatedBlogs: [] },
      { specialtySlug: "large-format-slab-tiling", relatedProblems: ["hollow-tiles-floor", "loose-hollow-tiles"], relatedBlogs: [] },
      { specialtySlug: "tile-repair-and-re-grouting", relatedProblems: ["cracked-tile-grout", "hollow-tiles-floor", "loose-hollow-tiles"], relatedBlogs: [] },
    ],
  },
  "plaster-ceiling": {
    ...
    specialties: [
      { specialtySlug: "flat-plaster-ceiling", relatedProblems: ["plaster-ceiling-cracking-joints", "plaster-ceiling-hairline-crack"], relatedBlogs: ["gypsum-vs-plaster-ceiling-malaysia"] },
      { specialtySlug: "tiered-and-l-box-ceiling", relatedProblems: ["plaster-ceiling-cracking-joints"], relatedBlogs: ["gypsum-vs-plaster-ceiling-malaysia"] },
      { specialtySlug: "cove-and-curved-ceiling", relatedProblems: ["plaster-ceiling-cracking-joints"], relatedBlogs: ["gypsum-vs-plaster-ceiling-malaysia"] },
      { specialtySlug: "ceiling-repair-and-re-skim", relatedProblems: ["plaster-ceiling-hairline-crack", "plaster-ceiling-cracking-joints"], relatedBlogs: ["gypsum-vs-plaster-ceiling-malaysia"] },
    ],
  },
  "skim-coat": {
  ...
  "window-repair": {
    ...
    specialties: [
      { specialtySlug: "glass-replacement", relatedProblems: ["sliding-window-stuck", "stuck-sliding-window"], relatedBlogs: [] },
      ...
      { specialtySlug: "sliding-window-roller-replacement", relatedProblems: ["sliding-window-stuck", "stuck-sliding-window"], relatedBlogs: [] },
    ],
  },
  locksmith: {
  ...
  "glass-aluminium": {
    ...
    specialties: [
      { specialtySlug: "frameless-shower-screen", relatedProblems: ["shower-screen-leaking", "shower-screen-water-leak"], relatedBlogs: [] },
      { specialtySlug: "aluminium-sliding-window", relatedProblems: ["sliding-window-stuck", "stuck-sliding-window"], relatedBlogs: [] },
