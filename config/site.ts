...
export const siteConfig = {
  ...
  knowsAbout: [
    ...
    "Waterproofing & Leak Repair Services",
    "Handyman Services",
    ...
    "Professional Tiling & Tile Repair",
    "Plaster Ceiling Design & Build",
    "Wall & Ceiling Skim Coat",
    "Vinyl, SPC & Laminate Flooring",
    ...
    "Locksmith & Smart Lock Services",
    "Glass & Aluminium Fabrication",
    "CCTV & Security Camera Installation",
    "Auto Gate & Motorised Gate",
    "Welding & Metal Fabrication",
    "Aircon Service, Repair & Installation",
    "Kitchen Renovation",
    "Bathroom Renovation",
