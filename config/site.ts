...
export const siteConfig = {
  ...
  tagline: "Premium Painting, Plumbing, Ceiling & Handyman Services in KL & Selangor",
  description:
    "KL Servis Rumah provides expert home maintenance including house painting, plaster ceiling repair, gypsum partition setup, plumbing leak repairs, waterproofing, door and lock repairs, TV mounting, and handyman services across Kuala Lumpur & Selangor. Same-day service available. Highly professional, SSM-registered, 100% transparent pricing confirmed before work begins.",
  metaDescription:
