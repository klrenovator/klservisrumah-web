...
export const contentI18nMsFull: Record<string, Partial<{ title: string; intro: string; category: string }>> = {
  ...
  "best-house-painters-kl-2026": { title: "Tukang Cat Rumah Terbaik KL 2026", intro: "Senarai tukang cat rumah terbaik di KL.", category: "Pertimbangan Teratas" },
  "best-plumbers-kl": { title: "Tukang Paip Terbaik di KL", intro: "Senarai tukang paip terbaik di KL.", category: "Pertimbangan Teratas" },
  "best-ceiling-contractors-kl": { title: "Kontraktor Siling Terbaik di KL", intro: "Senarai kontraktor siling terbaik di KL.", category: "Pertimbangan Teratas" },
  "best-waterproofing-contractors-kl": { title: "Kontraktor Kalis Air Terbaik di KL", intro: "Senarai kontraktor kalis air terbaik di KL.", category: "Pertimbangan Teratas" },
  "best-handyman-kl": { title: "Tukang Serba Terbaik di KL", intro: "Senarai tukang serba terbaik di KL.", category: "Pertimbangan Teratas" },
  "best-paint-brands-malaysia-2026": { title: "Jenama Cat Terbaik Malaysia 2026", intro: "Senarai jenama cat terbaik di Malaysia.", category: "Pertimbangan Teratas" },
  "best-waterproofing-methods-malaysia": { title: "Kaedah Kalis Air Terbaik Malaysia", intro: "Senarai kaedah kalis air terbaik di Malaysia.", category: "Pertimbangan Teratas" },
...
export const contentI18nZhFull: Record<string, Partial<{ title: string; intro: string; category: string }>> = {
  ...
  // ─── Top Considerations (10) ───
  "best-house-painters-kl-2026": { title: "2026吉隆坡最佳油漆工", intro: "吉隆坡最佳油漆工名单。", category: "重要考量" },
  "best-plumbers-kl": { title: "吉隆坡最佳水管工", intro: "吉隆坡最佳水管工名单。", category: "重要考量" },
  "best-ceiling-contractors-kl": { title: "吉隆坡最佳天花板承包商", intro: "吉隆坡最佳天花板承包商名单。", category: "重要考量" },
  "best-waterproofing-contractors-kl": { title: "吉隆坡最佳防水承包商", intro: "吉隆坡最佳防水承包商名单。", category: "重要考量" },
  "best-handyman-kl": { title: "吉隆坡最佳杂工", intro: "吉隆坡最佳杂工名单。", category: "重要考量" },
  "best-paint-brands-malaysia-2026": { title: "2026马来西亚最佳油漆品牌", intro: "马来西亚最佳油漆品牌名单。", category: "重要考量" },
  "best-waterproofing-methods-malaysia": { title: "马来西亚最佳防水方法", intro: "马来西亚最佳防水方法名单。", category: "重要考量" },
