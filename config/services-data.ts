...
export const servicesData: Record<string, ServiceDetail> = {
  ...
  "awning-installation": {
    ...
    tagline:
      "Custom awnings and awning roofing for car porches, entrances, windows, balconies and yards across the Klang Valley (KL & Selangor) — polycarbonate, metal deck, aluminium composite (ACP), glass and fabric systems, plus retractable awnings and outdoor roller blinds, fabricated and installed to suit your site. Starting from RM 380 with per-sq-ft rates for every material, project-quoted with a 12-month workmanship warranty.",
    description:
      "KL Servis Rumah designs, fabricates and installs residential and light-commercial awnings across the Klang Valley (Kuala Lumpur and Selangor). Our awning work covers new fixed awnings and awning roofing for car porches, front and back entrances, doors, windows, balconies, patios, drying yards, walkways and shopfronts, plus replacement of old, leaking or damaged awnings. We work with the common Malaysian awning systems — polycarbonate sheet roofing, metal deck roofing, aluminium composite panel (ACP), tempered glass, and canvas/fabric options — including manual and motorised retractable systems and outdoor roller blinds — framed in mild steel or aluminium with anti-rust primer and a powder-coat or weather-resistant finish. Each project starts from your application and site conditions: width, projection, exposure to rain and sun, fixing points, drainage and the look you want. We discuss material and design options, prepare a project-specific quotation with the scope clearly itemised, then fabricate and install with attention to fixing, slope and water flow. Drainage, sealing at joints and fasteners, and the right material for the exposure are all part of the design conversation, because awnings in Malaysia's tropical weather need to handle heavy rain, strong sun and humidity over many years. Fabrication and installation carry a 12-month workmanship warranty, with any material or fabric warranty following the manufacturer's or supplier's terms — all stated clearly in your quotation. Published starting prices apply to every scope — see the price table below; each is confirmed as a fixed, itemised quotation after measurements or a free site visit. Site visits and quotations are free. Contact KL Servis Rumah on WhatsApp with your location, photos and rough dimensions for a project-specific quotation.",
    startPrice: "RM 380",
    icon: "awning-canopy",
    highlights: [
      "Custom awnings for car porch, entrance, door, window, balcony, patio, yard, walkway and shopfront applications",
      "Polycarbonate, metal deck, ACP, tempered glass and canvas/fabric options, plus retractable awnings and outdoor roller blinds",
      ...
      "Free site consultation, itemised project quotation and a 12-month workmanship warranty",
      "Published starting prices from RM 380, with per-sq-ft rates for every material"
    ],
    subServices: [
      { name: "Car Porch Awning Installation", price: "From RM 1,800", desc: "New car porch / carport awning to shade and protect vehicles from sun and rain, sized to your porch with suitable slope and drainage." },
      { name: "Polycarbonate Awning", price: "From RM 25 / sq ft", desc: "Polycarbonate sheet awning roofing in clear or tinted profiles — translucent, lightweight cover for porch, yard, walkway or balcony that lets natural light through." },
      { name: "Metal Deck Awning", price: "From RM 18 / sq ft", desc: "Metal deck / metal-sheet awning roofing for strong rain and sun protection over utility areas, drying yards and porches, with anti-rust frame treatment." },
      { name: "Aluminium Composite (ACP) Awning", price: "From RM 30 / sq ft", desc: "Aluminium composite panel awning — opaque, clean-lined and low-maintenance cover that reduces glare and rain noise for porches and yards." },
      { name: "Glass Awning", price: "From RM 60 / sq ft", desc: "Tempered glass awning for entrances, windows and feature areas where a premium, light-filled look is wanted, framed and fixed to suit the opening." },
      { name: "Canvas & Fabric Awning", price: "From RM 20 / sq ft", desc: "Fixed canvas/fabric awnings and retractable systems — manual or motorised — for balconies, patios, terraces and shopfronts where shade and appearance are the priority." },
      { name: "Balcony, Patio & Window Awning", price: "From RM 380", desc: "Awnings sized for balconies, patios, terraces, windows and doors — shade and rain protection without closing up the space." },
      { name: "Awning Replacement & Repair", price: "From RM 280", desc: "Replacing old, leaking, rusted or sagging awnings — inspection of the existing frame, roofing, joints and drainage, with repair or full replacement options." },
      { name: "Outdoor Roller Blinds", price: "From RM 15 / sq ft", desc: "Outdoor and zip roller blinds for balconies, patios, windows and shopfronts — manual or motorised shade, privacy and rain screening that rolls away when not needed." }
    ],
    process: [
      ...
      { step: "02", title: "Site Assessment", desc: "Where photos and dimensions are not enough, we arrange a free site visit to check span, fixing points, existing structure, access and drainage." },
    ...
    faqs: [
      { q: "How much does awning installation cost in Kuala Lumpur and Selangor?", a: "KL Servis Rumah publishes minimum starting prices for every awning scope: small balcony, patio, window and door awnings from RM 380, material rates from RM 18–60 per sq ft depending on the material, car porch awnings from RM 1,800, repairs from RM 280 and outdoor roller blinds from RM 15 per sq ft — see the full price table on this page. The exact figure is confirmed in a fixed, itemised quotation after photos or a site visit, because span, projection, frame and finish, access, drainage and any removal work change the total. Every published rate sits inside the KL/Selangor market ranges for its material." },
      ...
      { q: "What information is needed for an awning quotation?", a: "The most useful information is: your location/area, where the awning will go (porch, balcony, window, yard, shopfront), approximate width and projection, photos of the site and fixing points, the material or look you prefer, whether an old awning needs removal, and any management rules that apply. With photos and dimensions many quotations can be prepared remotely; we arrange a free site visit when the project needs it." },
      { q: "Does awning installation require a site visit?", a: "Not always. For straightforward replacements or standard applications, clear photos with dimensions may be enough to quote. When the span is large, the fixing points or existing structure are unclear, access is difficult, drainage needs planning, or the design is custom, we arrange a site visit — and site visits and quotations are free across our Klang Valley coverage." },
      { q: "Do you also install outdoor roller blinds?", a: "Yes. Outdoor and zip roller blinds are a popular companion to awnings for balconies, patios, windows and shopfronts — adjustable shade, privacy and rain screening that rolls away when not needed. Manual and motorised options are available, and we confirm the suitable system, fabric and fixing for your opening in the quotation. If you live in a managed property, confirm the management (JMB/MC) rules before installing." },
      ...
      { q: "What awning options are available in KL and Selangor?", a: "Across Kuala Lumpur and Selangor the common installations are polycarbonate awnings (clear or tinted), metal deck awnings, aluminium composite panel (ACP) awnings, tempered glass awnings, and canvas/fabric awnings — applied to car porches, entrances, windows, balconies, patios, drying yards, walkways and shopfronts, plus replacements of existing awnings. Manual retractable awnings start from about RM 1,800 and motorised systems from about RM 3,500 (quoted by model and size), while outdoor roller blinds start from RM 15 per sq ft; tell us your application and we will confirm which options suit it." }
    ],
    priceTableNote:
      "Every awning price below is a minimum starting price for a straightforward, ground-level project, quoted with its unit (per job or per sq ft). The exact figure is confirmed in a free, itemised project quotation after photos or a site visit, because size, material, frame, finish, access, drainage and any removal work change the total. Indicative KL/Selangor market rate ranges are summarised in our awning pricing guide.",
    heroImage: "/hero-awning.svg",
    metaTitle: "Awning Installation KL & Selangor | Car Porch & Polycarbonate Awnings",
    metaDesc:
      "Awning installation in KL & Selangor from RM 380: car porch, polycarbonate, metal deck, ACP, glass and fabric awnings, plus replacement from RM 280 and outdoor roller blinds from RM 15 / sq ft. Fixed quote on WhatsApp.",
    aioSummary:
      "KL Servis Rumah installs custom awnings and awning roofing across the Klang Valley (Kuala Lumpur & Selangor) for car porches, entrances, windows, balconies, patios, yards, walkways and shopfronts, using polycarbonate, metal deck, aluminium composite (ACP), tempered glass or fabric on steel/aluminium frames with anti-rust finishing, plus manual and motorised retractable awnings and outdoor roller blinds. Services include new fixed awnings and replacement of old/leaking/rusted awnings, with site-aware design for slope, drainage, fixing and sealing. Published starting prices: small awnings from RM 380, car porch awnings from RM 1,800, material rates from RM 18–60 per sq ft and outdoor roller blinds from RM 15 per sq ft — each confirmed as an itemised fixed quotation with free site consultation and a 12-month workmanship warranty.",
    ...
    guide: {
      en: {
        ...
        types: [
          ...
          { title: "Retractable awnings", desc: "Manual or motorised fold-away awnings that give shade on demand and retract when not needed. Best for balconies, patios and shopfronts rather than permanent car-porch cover; we confirm the suitable model and controls for your site in the quotation." },
          { title: "Outdoor & zip roller blinds", desc: "Vertical fabric blinds that screen sun, rain and view for balconies, patios, windows and shopfronts. Manual crank or motorised operation, with zip-guided systems holding the fabric taut in breezy conditions — a shade and privacy companion to awnings rather than a permanent roof." }
        ],
        ...
        applications: [
          ...
          { title: "Shopfront & commercial premises", desc: "Shades entrances, signage and walkways for shops, offices and light-commercial premises, subject to management rules." }
        ],
        ...
        quoteIntro:
          "Every awning is built to a specific site, so the published prices above are minimum starting prices for straightforward, ground-level projects. Your project-specific quotation depends on:",
        quoteFactors: [
          ...
          "Colour, custom design and any management specifications"
        ],
        quoteCta:
          "Send your area, photos and rough dimensions on WhatsApp and we will advise whether a remote quote or a free site visit suits your project, then provide an itemised quotation with the 12-month workmanship warranty clearly stated."
      },
      ms: {
        ...
        types: [
          ...
          { title: "Awning boleh-tarik (retractable)", desc: "Awning lipat manual atau bermotor yang memberi teduhan apabila diperlukan dan ditarik balik apabila tidak digunakan. Paling sesuai untuk balkoni, patio dan kedai berbanding penutup car porch kekal; kami sahkan model dan kawalan yang sesuai untuk tapak anda dalam sebut harga." },
          { title: "Bidai luar & zip roller blind", desc: "Bidai fabrik menegak yang menapis matahari, hujan dan pemandangan untuk balkoni, patio, tingkap dan kedai. Operasi engkol manual atau bermotor, dengan sistem zip memegang fabrik kekal ketat ketika berangin — pelengkap teduhan dan privasi kepada awning, bukan bumbung kekal." }
        ],
        ...
        applications: [
          ...
          { title: "Kedai & premis komersial", desc: "Meneduhkan pintu masuk, papan tanda dan laluan untuk kedai, pejabat dan premis komersial ringan, tertakluk pada peraturan pengurusan." }
        ],
        ...
        quoteIntro:
          "Setiap awning dibina untuk tapak khusus, jadi harga yang diterbitkan di atas ialah harga mula minimum untuk projek mudah di aras tanah. Sebut harga khusus projek anda bergantung pada:",
        quoteFactors: [
        ...
        quoteCta:
          "Hantar kawasan, gambar dan anggaran ukuran anda di WhatsApp; kami akan menasihati sama ada sebut harga dari jauh atau lawatan tapak percuma sesuai untuk projek anda, kemudian menyediakan sebut harga terperinci dengan waranti mutu kerja 12 bulan dinyatakan dengan jelas."
      },
      zh: {
        ...
        types: [
          ...
          { title: "伸缩式雨棚", desc: "手动或电动折叠雨棚，需要遮阳时打开、不用时收回。最适合阳台、露台和店面，而非车棚的永久遮蔽；我们会在报价中确认适合您现场的型号与控制方式。" },
          { title: "户外与拉链卷帘", desc: "垂直布帘，为阳台、露台、窗户和店面遮挡阳光、雨水与视线。手动摇柄或电动操作，拉链导轨系统在有风时保持布面绷紧——是雨棚的遮阳与隐私搭配，而非永久屋顶。" }
        ],
        ...
        applications: [
          ...
          { title: "店面与商业场所", desc: "为商店、办公室和轻型商业场所的入口、招牌和走道遮阳，须遵守物业管理规定。" }
        ],
        ...
        quoteIntro:
          "每个雨棚都按具体现场制作，因此上方公布的价格是简单地面工程的最低起步价。您的项目专项报价取决于：",
        quoteFactors: [
          "宽度、伸出长度和总覆盖面积",
        ...
        quoteCta:
          "请通过 WhatsApp 发送您的地区、照片和大致尺寸；我们会建议您的项目适合远程报价还是免费上门评估，随后提供明细报价并清楚载明 12 个月工艺保修。"
      }
    },
    i18n: {
      ms: {
        ...
        description:
          "KL Servis Rumah mereka bentuk, memfabrikasi dan memasang awning kediaman serta komersial ringan di seluruh Lembah Klang (Kuala Lumpur dan Selangor). Kerja awning kami meliputi pemasangan awning tetap baharu dan bumbung awning untuk car porch, pintu masuk depan dan belakang, pintu, tingkap, balkoni, patio, ruang jemuran, laluan pejalan kaki dan kedai, serta penggantian awning lama yang bocor atau rosak. Kami bekerja dengan sistem awning yang biasa digunakan di Malaysia — bumbung kepingan polikarbonat, bumbung metal deck, panel komposit aluminium (ACP), kaca tempered dan pilihan kanvas/fabrik — termasuk sistem boleh-tarik manual/bermotor dan bidai luar (roller blind) — dengan rangka keluli lembut atau aluminium yang diberi primer anti-karat serta kemasan powder-coat atau tahan cuaca. Setiap projek bermula daripada kegunaan dan keadaan tapak anda: lebar, unjuran, pendedahan kepada hujan dan matahari, titik pengancing, saliran dan rupa yang anda mahukan. Kami membincangkan pilihan bahan dan reka bentuk, menyediakan sebut harga khusus projek dengan skop yang diperincikan, kemudian memfabrikasi dan memasang dengan teliti dari segi pengancing, kecerunan dan aliran air. Saliran, pengedap pada sambungan dan pengikat, serta bahan yang sesuai dengan pendedahan cuaca adalah sebahagian daripada perbincangan reka bentuk, kerana awning dalam cuaca tropika Malaysia perlu menampung hujan lebat, matahari terik dan kelembapan selama bertahun-tahun. Fabrikasi dan pemasangan disertakan waranti mutu kerja 12 bulan, manakala waranti bahan atau fabrik mengikut terma pengeluar/pembekal — semuanya dinyatakan dengan jelas dalam sebut harga anda. Harga mula diterbitkan bagi setiap skop — lihat jadual harga di bawah; setiap satu disahkan sebagai sebut harga tetap terperinci selepas ukuran atau lawatan tapak percuma. Lawatan tapak dan sebut harga adalah percuma. Hubungi KL Servis Rumah di WhatsApp dengan lokasi, gambar dan anggaran ukuran anda untuk sebut harga khusus projek.",
        highlights: [
          "Awning tersuai untuk car porch, pintu masuk, pintu, tingkap, balkoni, patio, halaman, laluan pejalan kaki dan kedai",
          "Pilihan polikarbonat, metal deck, ACP, kaca tempered dan kanvas/fabrik, serta awning boleh-tarik dan bidai luar (roller blind)",
          ...
          "Perundingan tapak percuma, sebut harga projek diperincikan dan waranti mutu kerja 12 bulan",
          "Harga mula diterbitkan dari RM 380, dengan kadar sekaki persegi bagi setiap bahan"
        ],
        subServices: [
          { name: "Pemasangan Awning Car Porch", price: "Dari RM 1,800", desc: "Awning car porch/port kereta baharu untuk melindungi kenderaan daripada matahari dan hujan, bersaiz mengikut porch anda dengan kecerunan dan saliran yang sesuai." },
          { name: "Awning Polikarbonat", price: "Dari RM 25 / kaki persegi", desc: "Bumbung awning kepingan polikarbonat dalam profil jernih atau tinted — penutup lut cahaya dan ringan untuk porch, halaman, laluan atau balkoni." },
          { name: "Awning Metal Deck", price: "Dari RM 18 / kaki persegi", desc: "Bumbung awning metal deck/kepingan logam untuk perlindungan hujan dan matahari yang kuat di kawasan utiliti, ruang jemuran dan porch, dengan rangka dirawat anti-karat." },
          { name: "Awning Panel Komposit Aluminium (ACP)", price: "Dari RM 30 / kaki persegi", desc: "Awning panel komposit aluminium — penutup legap, kemas dan kurang penyelenggaraan yang mengurangkan silau dan bunyi hujan untuk porch dan halaman." },
          { name: "Awning Kaca", price: "Dari RM 60 / kaki persegi", desc: "Awning kaca tempered untuk pintu masuk, tingkap dan kawasan ciri yang mahukan penampilan premium dan terang, dengan rangka dan pengancing yang sesuai." },
          { name: "Awning Kanvas & Fabrik", price: "Dari RM 20 / kaki persegi", desc: "Awning kanvas/fabrik tetap dan sistem boleh-tarik — manual atau bermotor — untuk balkoni, patio, teres dan kedai di mana teduhan dan rupa menjadi keutamaan." },
          { name: "Awning Balkoni, Patio & Tingkap", price: "Dari RM 380", desc: "Awning bersaiz untuk balkoni, patio, teres, tingkap dan pintu — teduhan dan perlindungan hujan tanpa menutup ruang." },
          { name: "Penggantian & Pembaikan Awning", price: "Dari RM 280", desc: "Menggantikan awning lama, bocor, berkarat atau melendut — pemeriksaan rangka, bumbung, sambungan dan saliran sedia ada, dengan pilihan pembaikan atau penggantian penuh." },
          { name: "Bidai Luar (Roller Blind)", price: "Dari RM 15 / kaki persegi", desc: "Bidai luar dan zip roller blind untuk balkoni, patio, tingkap dan kedai — teduhan, privasi dan lindungan hujan secara manual atau bermotor, boleh digulung apabila tidak digunakan." }
        ],
        process: [
          ...
          { step: "02", title: "Penilaian Tapak", desc: "Jika gambar dan ukuran tidak mencukupi, kami aturkan lawatan tapak percuma untuk menyemak rentang, titik pengancing, struktur sedia ada, akses dan saliran." },
        ...
        faqs: [
          { q: "Berapa kos pemasangan awning di Kuala Lumpur dan Selangor?", a: "KL Servis Rumah menerbitkan harga mula minimum untuk setiap skop awning: awning balkoni, patio, tingkap dan pintu yang kecil dari RM 380, kadar bahan dari RM 18–60 sekaki persegi mengikut bahan, awning car porch dari RM 1,800, pembaikan dari RM 280 dan bidai luar dari RM 15 sekaki persegi — lihat jadual harga penuh di halaman ini. Angka tepat disahkan dalam sebut harga tetap yang diperincikan selepas gambar atau lawatan tapak, kerana rentang, unjuran, rangka dan kemasan, akses, saliran serta pembongkaran awning lama mengubah jumlahnya. Setiap harga mula berada dalam julat pasaran KL/Selangor bagi bahan berkenaan." },
          ...
          { q: "Maklumat apa yang diperlukan untuk sebut harga awning?", a: "Maklumat paling berguna: lokasi/kawasan anda, di mana awning akan dipasang (porch, balkoni, tingkap, halaman, kedai), anggaran lebar dan unjuran, gambar tapak dan titik pengancing, bahan atau rupa yang anda suka, sama ada awning lama perlu ditanggalkan, dan sebarang peraturan pengurusan. Dengan gambar dan ukuran, banyak sebut harga boleh disediakan dari jauh; kami aturkan lawatan tapak percuma apabila projek memerlukannya." },
          { q: "Adakah pemasangan awning memerlukan lawatan tapak?", a: "Tidak semestinya. Untuk penggantian mudah atau kegunaan standard, gambar yang jelas dengan ukuran mungkin mencukupi untuk sebut harga. Apabila rentang besar, titik pengancing tidak jelas, akses sukar, saliran perlu dirancang atau reka bentuk tersuai, kami aturkan lawatan tapak — dan lawatan tapak serta sebut harga adalah percuma dalam liputan Lembah Klang kami." },
          { q: "Adakah anda juga memasang bidai luar (roller blind)?", a: "Ya. Bidai luar dan zip roller blind adalah pelengkap popular kepada awning untuk balkoni, patio, tingkap dan kedai — teduhan boleh dilaras, privasi dan lindungan hujan yang boleh digulung apabila tidak digunakan. Pilihan manual dan bermotor tersedia; kami sahkan sistem, fabrik dan pengancing yang sesuai untuk bukaan anda dalam sebut harga. Jika anda tinggal di hartanah berkaitan pengurusan, sahkan peraturan pengurusan (JMB/MC) sebelum pemasangan." },
          ...
          { q: "Apakah pilihan awning yang tersedia di KL dan Selangor?", a: "Di seluruh Kuala Lumpur dan Selangor, pemasangan yang biasa ialah awning polikarbonat (jernih atau tinted), awning metal deck, awning panel komposit aluminium (ACP), awning kaca tempered dan awning kanvas/fabrik — untuk car porch, pintu masuk, tingkap, balkoni, patio, ruang jemuran, laluan pejalan kaki dan kedai, serta penggantian awning sedia ada. Awning boleh-tarik manual bermula sekitar RM 1,800 dan sistem bermotor sekitar RM 3,500 (disebut mengikut model dan saiz), manakala bidai luar bermula dari RM 15 sekaki persegi; beritahu kami kegunaan anda dan kami akan sahkan pilihan yang sesuai." }
        ],
        metaTitle: "Pemasangan Awning KL & Selangor | Awning Car Porch & Polikarbonat",
        metaDesc:
          "Pemasangan awning di KL & Selangor dari RM 380: car porch, polikarbonat, metal deck, ACP, kaca dan fabrik, serta penggantian dari RM 280 dan bidai luar dari RM 15 / kaki persegi. Sebut harga tetap di WhatsApp.",
        aioSummary:
          "KL Servis Rumah memasang awning tersuai dan bumbung awning di seluruh Lembah Klang (Kuala Lumpur & Selangor) untuk car porch, pintu masuk, tingkap, balkoni, patio, halaman, laluan pejalan kaki dan kedai, menggunakan polikarbonat, metal deck, panel komosit aluminium (ACP), kaca tempered atau fabrik pada rangka keluli/aluminium dengan kemasan anti-karat. Perkhidmatan termasuk awning tetap baharu dan penggantian awning lama/bocor/berkarat, dengan reka bentuk mengambil kira tapak untuk kecerunan, saliran, pengancing dan pengedap, serta awning boleh-tarik manual/bermotor dan bidai luar (roller blind). Harga mula diterbitkan: awning kecil dari RM 380, awning car porch dari RM 1,800, kadar bahan dari RM 18–60 sekaki persegi dan bidai luar dari RM 15 sekaki persegi — setiap kerja disahkan sebagai sebut harga tetap terperinci dengan perundingan tapak percuma dan waranti mutu kerja 12 bulan.",
        warranty: "Waranti mutu kerja 12 bulan untuk fabrikasi & pemasangan, seperti yang dinyatakan dalam sebut harga anda"
      },
      zh: {
        title: "雨棚安装服务",
        tagline:
          "为巴生谷（吉隆坡与雪兰莪）的车棚、入口、窗户、阳台及庭院定制雨棚与雨棚屋顶——聚碳酸酯、金属瓦、铝塑板（ACP）、玻璃与布艺系统，另有伸缩雨棚与户外卷帘，按现场尺寸制作安装。小型工程从 RM 380 起，每种材料均公布每平方尺起步价，按项目报价，含12个月工艺保修。",
        description:
          "KL Servis Rumah 在巴生谷（吉隆坡与雪兰莪）设计、制作并安装住宅与轻型商业雨棚。我们的雨棚工程涵盖车棚、前后入口、大门、窗户、阳台、露台、晒衣区、走道和店面的全新固定雨棚及雨棚屋顶，并可更换老旧、漏水或损坏的雨棚。我们采用马来西亚常见的雨棚系统——聚碳酸酯板、金属瓦（metal deck）、铝塑复合板（ACP）、钢化玻璃以及帆布/布艺选项——包括手动/电动伸缩系统与户外卷帘——骨架为低碳钢或铝材，施以防锈底漆并配粉末喷涂或耐候面漆。每个项目都从您的用途和现场条件出发：宽度、伸出长度、风雨暴露程度、固定点、排水和您想要的外观。我们先与您讨论材料和设计方案，提供列明施工范围的项目专项报价，再进行制作与安装，并在固定、坡度和水流方向上加以把关。排水、接缝与紧固件的密封、以及材料与暴露环境的匹配，都是设计沟通的一部分，因为在马来西亚的热带气候下，雨棚需要长期承受大雨、烈日和高湿。制作与安装提供 12 个月工艺保修，材料或布艺保修按厂商/供应商条款——全部在报价单中明确列出。每项工程均有公布的起步价——完整价格表见下方；每项均在测量或免费上门评估后以固定明细报价确认。上门评估与报价免费。欢迎通过 WhatsApp 发送您的位置、照片和大致尺寸，向 KL Servis Rumah 获取项目专项报价。",
        highlights: [
          "适用于车棚、入口、大门、窗户、阳台、露台、庭院、走道及店面的定制雨棚",
          "聚碳酸酯、金属瓦、铝塑板（ACP）、钢化玻璃及帆布/布艺选项，另有伸缩雨棚与户外卷帘",
          "低碳钢或铝材骨架，配防锈底漆及粉末喷涂或耐候饰面",
          "按现场设计：制作前规划跨度、伸出、固定点、坡度、排水与密封",
          "更换老旧、漏水、生锈或下垂的雨棚，并可按约定拆除原有结构",
          "免费上门咨询、项目明细报价与 12 个月工艺保修",
          "公布起步价从 RM 380 起，每种材料均以每平方尺计价"
        ],
        subServices: [
          { name: "车棚雨棚安装", price: "从 RM 1,800 起", desc: "全新车棚（car porch）雨棚，为车辆遮阳挡雨，按您的车棚尺寸制作，配合适坡度与排水。" },
          { name: "聚碳酸酯雨棚", price: "从 RM 25 / 平方英尺 起", desc: "透明或着色聚碳酸酯板雨棚屋顶——透光、轻质，适用于车棚、庭院、走道或阳台。" },
          { name: "金属瓦雨棚", price: "从 RM 18 / 平方英尺 起", desc: "金属瓦/金属板雨棚屋顶，为工作区、晒衣区和车棚提供强力挡雨防晒，钢架经防锈处理。" },
          { name: "铝塑板（ACP）雨棚", price: "从 RM 30 / 平方英尺 起", desc: "铝塑复合板雨棚——不透明、线条简洁、维护少，可减少眩光与雨声，适用于车棚与庭院。" },
          { name: "玻璃雨棚", price: "从 RM 60 / 平方英尺 起", desc: "用于入口、窗户和特色区域的钢化玻璃雨棚，外观高档、采光好，骨架与固定方式按跨度匹配。" },
          { name: "帆布与布艺雨棚", price: "从 RM 20 / 平方英尺 起", desc: "适用于阳台、露台、天台和店面的固定帆布及伸缩式系统——手动或电动——以遮阳与美观为优先。" },
          { name: "阳台、露台与窗户雨棚", price: "从 RM 380 起", desc: "为阳台、露台、天台、窗户和门量身定制的雨棚——遮阳挡雨又不封闭空间。" },
          { name: "雨棚更换与维修", price: "从 RM 280 起", desc: "更换老旧、漏水、生锈或下垂的雨棚——检查原有骨架、面板、接缝与排水，提供维修或整体更换方案。" },
          { name: "户外卷帘", price: "从 RM 15 / 平方英尺 起", desc: "适用于阳台、露台、窗户和店面的户外与拉链卷帘——手动或电动遮阳、隐私与挡雨，不用时可收起。" }
        ],
        process: [
          { step: "01", title: "咨询与用途", desc: "您告诉我们雨棚的位置——车棚、入口、窗户、阳台、庭院或店面——并通过 WhatsApp 发送照片和大致尺寸。" },
          { step: "02", title: "现场评估", desc: "当照片和尺寸不足时，我们安排免费上门评估，检查跨度、固定点、现有结构、施工通道和排水。" },
        ...
        faqs: [
          { q: "在吉隆坡和雪兰莪安装雨棚要多少钱？", a: "KL Servis Rumah 为每项雨棚工程公布最低起步价：小型阳台、露台、窗户和门雨棚从 RM 380 起，材料价按材料每平方尺从 RM 18–60 起，车棚雨棚从 RM 1,800 起，维修从 RM 280 起，户外卷帘每平方尺从 RM 15 起——完整价格表见本页。准确价格在照片或上门评估后以固定明细报价确认，因为跨度、伸出长度、骨架与饰面、施工通道、排水以及是否拆除旧雨棚都会改变总价。每项公布起步价均处于该材料的巴生谷市面价格区间内。" },
          ...
          { q: "雨棚报价需要哪些信息？", a: "最有用的信息包括：您所在地区、雨棚位置（车棚、阳台、窗户、庭院、店面）、大致宽度和伸出长度、现场及固定点照片、偏好的材料或外观、是否需要拆除旧雨棚，以及任何物业管理规定。有了照片和尺寸，许多报价可以远程完成；项目需要时我们再安排免费上门评估。" },
          { q: "安装雨棚一定要上门查看吗？", a: "不一定。对于简单的更换或标准用途，清晰的照片加尺寸可能就足够报价。当跨度较大、固定点不明确、施工通道困难、需要规划排水或定制设计时，我们会安排上门评估——在巴生谷服务范围内，上门评估与报价均为免费。" },
          { q: "你们也安装户外卷帘吗？", a: "安装。户外卷帘和拉链卷帘是雨棚的热门搭配，适用于阳台、露台、窗户和店面——可调遮阳、隐私与挡雨，不用时可收起。提供手动和电动选项；我们会在报价中确认适合您洞口的系统、布料与固定方式。若您住在有管理的物业，安装前请先确认管理处（JMB/MC）的规定。" },
          ...
          { q: "在吉隆坡和雪兰莪有哪些雨棚选择？", a: "在吉隆坡与雪兰莪，常见安装包括聚碳酸酯雨棚（透明或着色）、金属瓦雨棚、铝塑板（ACP）雨棚、钢化玻璃雨棚和帆布/布艺雨棚——用于车棚、入口、窗户、阳台、露台、晒衣区、走道和店面，以及现有雨棚更换。手动伸缩雨棚约从 RM 1,800 起、电动系统约从 RM 3,500 起（按型号与尺寸报价），户外卷帘每平方尺从 RM 15 起；告诉我们您的用途，我们会确认适合的选项。" }
        ],
        metaTitle: "吉隆坡与雪兰莪雨棚安装 | 车棚与聚碳酸酯雨棚",
        metaDesc:
          "吉隆坡与雪兰莪雨棚安装从 RM 380 起：车棚、聚碳酸酯、金属瓦、ACP、玻璃与布艺雨棚，更换从 RM 280 起，户外卷帘每平方尺从 RM 15 起。WhatsApp 获取固定报价。",
        aioSummary:
          "KL Servis Rumah 在巴生谷（吉隆坡与雪兰莪）安装定制雨棚及雨棚屋顶，适用于车棚、入口、窗户、阳台、露台、庭院、走道和店面，采用聚碳酸酯、金属瓦、铝塑板（ACP）、钢化玻璃或布艺，配钢/铝骨架与防锈饰面，并提供手动/电动伸缩雨棚与户外卷帘。服务包括全新固定雨棚和老旧/漏水/生锈雨棚更换，设计按现场考虑坡度、排水、固定与密封。公布起步价：小型雨棚从 RM 380 起，车棚雨棚从 RM 1,800 起，材料价每平方尺从 RM 18–60 起，户外卷帘每平方尺从 RM 15 起——每项工程均以固定明细报价确认，附免费上门咨询与 12 个月工艺保修。",
