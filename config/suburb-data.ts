...
const rawSuburbs = [
  ...
  ["Setapak", "kuala-lumpur", "Kuala Lumpur", 3.1883, 101.7121, ["Danau Kota", "Wangsa Walk", "TAR UMT", "PV128"], "High-density student accommodations, PV-series high-rise condominiums along Jalan Genting Klang, and mature Danau Kota terrace houses with high tenant turnover requiring quick gypsum patch repairs, rental tenancy repainting, and partition divider builds."],
  ...
  ["Kepong", "kuala-lumpur", "Kuala Lumpur", 3.2140, 101.6370, ["Kepong Baru", "Metro Prima", "FRIM", "Desa ParkCity border"], "Older terrace neighbourhoods and commercial shop rows around Kepong Baru and Metro Prima, where aging pipework, damp interior walls and full repaints are the most common call-outs."],
  ...
  ["Selayang", "kuala-lumpur", "Selangor", 3.2465, 101.6537, ["Selayang Mall", "Hospital Selayang", "Selayang Baru", "FRIM border"], "Landed houses and walk-up apartments near Selayang Mall and Hospital Selayang, with recurring ceiling leaks, plumbing faults and lock repairs keeping local crews busy."],
  ...
  ["Sentul", "kuala-lumpur", "Kuala Lumpur", 3.1801, 101.6956, ["Sentul Depot", "Sentul West", "KLPAC", "Sentul Timur"], "Historic railway hub transitioning into modern luxury condominiums around Sentul West and Sentul East, alongside mature pre-war shophouses and older low-cost flats needing specialized plaster ceiling restoration, acoustic partitions, and moisture-proof skim coating."],
