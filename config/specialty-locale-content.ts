...
export const specialtyLocaleContent: Record<string, SpecialtyLocaleContent> = {
  ...
  "waterproofing/toilet-waterproofing": {
    ms: {
      name: "Kalis Air Tandas",
      tagline: "Kalis air lantai dan dinding tandas/WC dengan pembetulan cerun, pengukuhan sudut dan ujian kolam 48 jam.",
      description:
        "Tandas dan WC adalah kawasan basah yang paling kerap dilupakan tetapi juga paling kerap bocor ke tingkat bawah. Sebelum memasang semula jubin, kami menyediakan substrat sehingga konkrit mentah, membetulkan cerun ke arah floor trap, mengukuhkan sudut dan penembusan paip dengan bahan fleksibel, dan menyapu tiga lapisan membran kalis air. Setiap kerja menerima kesinambungan ujian kolam 24–48 jam untuk mengesahkan tiada pemindahan lembapan ke siling di bawah. Sistem ini direka untuk menahan pembersihan harian, agen pencuci berasid ringan dan pergerakan struktur kecil, sekali gus mengelakkan warna siling bernoda, jubin berongga dan pertumbuhan kulat pada masa hadapan.",
      highlights: [
        "Persediaan substrat sehingga konkrit mentah untuk lekatan membran yang optimum",
        "Pembetulan cerun ke arah floor trap supaya air tidak bertakung",
        "Pengukuhan sudut dan penembusan paip dengan bahan fleksibel",
        "Tiga lapisan membran kalis air dengan ujian kolam 24–48 jam",
        "Sesuai untuk tandas utama, tetamu dan tandas komersial",
      ],
      process: [
        { step: "01", title: "Penilaian & Persiapan", desc: "Kami menilai keadaan lantai, cerun dan penembusan paip sedia ada, kemudian menanggalkan jubin lama jika perlu." },
        { step: "02", title: "Pembetulan Cerun", desc: "Substrat diampelas dan cerun dibetulkan ke arah floor trap supaya air mengalir keluar dan tidak bertakung." },
        { step: "03", title: "Fillet & Pengukuhan", desc: "Sudut dan penembusan paip dibulatkan (fillet) dan dirawat dengan jalur fleksibel untuk mengelakkan titik lemah." },
        { step: "04", title: "Membran Kalis Air", desc: "Tiga lapisan membran disapu dengan teliti, setiap lapisan dibiarkan kering sebelum yang seterusnya." },
        { step: "05", title: "Ujian Kolam & Serahan", desc: "Air ditakung 24–48 jam, siling bawah diperiksa, dan kawasan diserahkan sedia untuk jubin baharu." },
      ],
      faqs: [
        { q: "Berapa lama kalis air tandas mengambil masa?", a: "Kalis air tandas standard (tanpa penanggalan dan pemasangan jubin) biasanya mengambil 2–3 hari, termasuk ujian kolam 24–48 jam. Kerja penuh dengan jubin baharu mengambil 4–7 hari." },
        { q: "Adakah jubin perlu ditanggalkan untuk kalis air tandas?", a: "Untuk hasil kekal, ya. Jubin lama perlu ditanggalkan supaya membran boleh diaplikasi terus pada substrat konkrit. Produk atas jubin hanya penyelesaian sementara 6–12 bulan." },
        { q: "Mengapa tandas saya bocor ke siling bawah?", a: "Punca biasa termasuk cerun floor trap yang salah, membran gagal pada sudut dan penembusan paip, atau grout retak. Kami membetulkan kesemuanya semasa kerja kalis air penuh." },
        { q: "Adakah kalis air tandas datang dengan jaminan?", a: "Ya, kerja kalis air lengkap membawa jaminan bertulis sehingga 5 tahun terhadap kebocoran berulang, tertakluk pada skop kerja yang diluluskan." },
      ],
      metaTitle: "Kalis Air Tandas KL & Selangor | Harga Dari RM900",
      metaDesc: "Kalis air tandas/WC profesional di KL & Selangor. Pembetulan cerun, membran 3 lapis, ujian kolam 48 jam. Jaminan sehingga 5 tahun. Sebut harga percuma.",
    },
    zh: {
      name: "马桶防水",
      tagline: "马桶/WC 地面与墙面防水，含坡度修正、阴阳角加强与 48 小时蓄水测试。",
      description:
        "马桶与 WC 是最易被忽略却最常漏水到楼下的湿区。在重新铺砖前，我们将基层处理至裸露混凝土、修正指向地漏的坡度、用柔性材料加强阴阳角与管道穿透处，并涂刷三层防水层。每项工程都进行 24–48 小时蓄水测试，确认下方天花板无任何水分渗透。该系统可抵御日常清洁、轻度酸性清洁剂与轻微结构位移，从而避免日后天花板水渍、空鼓砖与霉菌滋生。",
      highlights: [
        "基层处理至裸露混凝土，确保防水层最佳附着",
        "修正指向地漏的坡度，防止积水",
        "阴阳角与管道穿透处用柔性材料加强",
        "三层防水层配合 24–48 小时蓄水测试",
        "适用于主卫、客卫与商业洗手间",
      ],
      process: [
        { step: "01", title: "评估与准备", desc: "我们评估现有地面、坡度与管道穿透状况，必要时拆除旧瓷砖。" },
        { step: "02", title: "坡度修正", desc: "打磨基层并修正指向地漏的坡度，使水能顺畅排出而不积水。" },
        { step: "03", title: "圆角与加强", desc: "将阴阳角与管道穿透处做成圆角并贴柔性加强带，避免出现薄弱点。" },
        { step: "04", title: "防水层", desc: "仔细涂刷三层防水层，每层完全干燥后再涂下一层。" },
        { step: "05", title: "蓄水测试与交付", desc: "蓄水 24–48 小时，检查下方天花板，然后交付铺新砖。" },
      ],
      faqs: [
        { q: "马桶防水需要多长时间？", a: "标准马桶防水（不含砸砖与铺砖）通常需 2–3 天，包括 24–48 小时蓄水测试。含新砖的完整工程需 4–7 天。" },
        { q: "马桶防水必须砸掉瓷砖吗？", a: "要做到永久效果，是的。旧砖需拆除以便防水层直接涂在混凝土基层上。表面涂层只是 6–12 个月的临时方案。" },
        { q: "为什么马桶会漏到楼下天花板？", a: "常见原因包括地漏坡度不对、阴阳角与管道穿透处防水失效，或美缝开裂。我们在完整防水中会一并处理。" },
        { q: "马桶防水有保修吗？", a: "有。完整防水工程享有最长 5 年的书面防漏水保修，以已批准的施工范围为准。" },
      ],
      metaTitle: "吉隆坡与雪兰莪马桶防水 | 从 RM900 起",
      metaDesc: "吉隆坡与雪兰莪专业马桶/WC 防水。坡度修正、3 层防水膜、48 小时蓄水测试。长达 5 年保修。免费报价。",
    },
  },
  "waterproofing/balcony-waterproofing": {
    ms: {
      name: "Kalis Air Balkoni",
      tagline: "Sistem membran tahan UV untuk balkoni terbuka, kotak penanam dan teres bumbung dengan semakan saliran.",
      description:
        "Balkoni terdedah kepada hujan lebat, matahari UV dan pengembangan struktur sepanjang tahun di Malaysia. Kami menyediakan sistem kalis air berbilang lapisan untuk balkoni terbuka, kotak penanam dan teres bumbung. Setiap kerja bermula dengan pembersihan substrat, pengisian retak, rawatan sudut dan semakan saliran serta penempatan floor trap. Kami menyapu membran akrilik elastomerik bertetulang gentian atau membran bituminus torch-on, diikuti topcoat tahan UV untuk perlindungan jangka panjang. Ujian kolam air dijalankan sebelum lapisan penutup seperti jubin atau penutup kayu dipasang, supaya balkoni gembira kekal kering dan tidak merosakkan ruang di bawahnya.",
      highlights: [
        "Membran akrilik elastomerik atau bituminus torch-on pilihan",
        "Semakan saliran dan penempatan floor trap sebelum aplikasi",
        "Topcoat tahan UV untuk melindungi membran daripada matahari",
        "Ujian kolam 24–48 jam sebelum lapisan penutup dipasang",
        "Sesuai untuk balkoni terbuka, kotak penanam dan teres bumbung",
      ],
      process: [
        { step: "01", title: "Semakan Saliran", desc: "Kami memeriksa floor trap dan cerun saliran, memastikan air boleh mengalir keluar sebelum kerja membran bermula." },
        { step: "02", title: "Persediaan Substrat", desc: "Permukaan dibersihkan, retakan dan lubang diisi dengan sealant fleksibel, dan sudut difillet untuk kekuatan maksimum." },
        { step: "03", title: "Primer", desc: "Primer pelekat berat disapu untuk memastikan membran melekat kukuh pada substrat." },
        { step: "04", title: "Membran & Topcoat", desc: "Tiga lapisan membran disapu atau dipanaskan dengan teliti, kemudian topcoat tahan UV disapu." },
        { step: "05", title: "Ujian Kolam", desc: "Air ditakung 24–48 jam dan kawasan di bawah diperiksa untuk mengesahkan tiada kebocoran sebelum lapisan penutup." },
      ],
      faqs: [
        { q: "Bolehkah kalis air dilakukan di atas jubin balkoni sedia ada?", a: "Produk sealant permukaan boleh disapu di atas jubin, tetapi ia hanya tahan 6–12 bulan. Untuk penyelesaian kekal, jubin perlu ditanggalkan supaya membran boleh diaplikasi terus pada substrat." },
        { q: "Apakah jenis membran terbaik untuk balkoni?", a: "Membran akrilik elastomerik bertetulang gentian dengan topcoat tahan UV adalah pilihan paling seimbang untuk balkoni kediaman. Untuk teres bumbung besar atau kawasan komersial, membran bituminus torch-on lebih tahan lasak." },
        { q: "Bagaimana anda mengelakkan air bertakung di balkoni?", a: "Kami membetulkan cerun ke arah floor trap dan memastikan saliran tidak tersumbat. Air bertakung adalah punca utama kegagalan balkoni, jadi ia ditangani sebelum membran." },
        { q: "Berapa lama kalis air balkoni bertahan?", a: "Membran profesional dengan topcoat tahan UV biasanya bertahan 5–10 tahun dalam iklim Malaysia. Penyelenggaraan berkala memanjangkan jangka hayatnya." },
      ],
      metaTitle: "Kalis Air Balkoni KL & Selangor | Harga Dari RM1,200",
      metaDesc: "Kalis air balkoni terbuka, kotak penanam & teres bumbung di KL & Selangor. Membran tahan UV, semakan saliran, ujian kolam 48 jam. Sebut harga percuma.",
    },
    zh: {
      name: "阳台防水",
      tagline: "为开放阳台、花池与屋顶露台提供抗紫外线防水系统，含排水检查。",
      description:
        "阳台在马来西亚全年暴露于暴雨、紫外线与结构膨胀。我们为开放阳台、花池与屋顶露台提供多层防水系统。每项工程都从基层清洁、裂缝填补、阴阳角处理以及排水与地漏检查开始。我们涂刷纤维增强的弹性丙烯酸防水层或热熔沥青防水层，并覆以抗紫外线保护面层以提供长期保护。在铺贴瓷砖或木饰面前进行蓄水测试，确保阳台保持干爽，不损坏下方空间。",
      highlights: [
        "弹性丙烯酸或热熔沥青防水层可选",
        "施工前检查排水与地漏位置",
        "抗紫外线保护面层，抵御日晒",
      ...
      process: [
        { step: "01", title: "排水检查", desc: "我们检查地漏与排水坡度，确保水能顺畅排出，然后才开始防水层施工。" },
        { step: "02", title: "基层准备", desc: "清洁表面，用柔性密封剂填补裂缝与孔洞，并将阴阳角做成圆角以增强强度。" },
        { step: "03", title: "底漆", desc: "涂刷重型粘结底漆，确保防水层牢固附着于基层。" },
        { step: "04", title: "防水层与面层", desc: "仔细涂刷或热熔三层防水层，然后涂刷抗紫外线保护面层。" },
        { step: "05", title: "蓄水测试", desc: "蓄水 24–48 小时并检查下方区域，确认无漏水后再铺设饰面层。" },
      ],
      faqs: [
        { q: "可以在现有阳台瓷砖上做防水吗？", a: "可在表面涂刷密封剂，但仅维持 6–12 个月。要永久解决，需拆砖让防水层直接涂在基层上。" },
        { q: "阳台用哪种防水层最好？", a: "纤维增强弹性丙烯酸防水层配抗紫外线面层是住宅阳台最均衡的选择。大型屋顶露台或商业区域用热熔沥青防水层更耐久。" },
        { q: "如何避免阳台积水？", a: "我们修正指向地漏的坡度并确保排水口不堵塞。积水是阳台失效的主因，因此会在施工前处理。" },
        { q: "阳台防水能用多久？", a: "配抗紫外线面层的优质防水层在马来西亚气候下通常可用 5–10 年。定期维护可延长使用寿命。" },
      ],
      metaTitle: "吉隆坡与雪兰莪阳台防水 | 从 RM1,200 起",
      metaDesc: "吉隆坡与雪兰莪开放阳台、花池与屋顶露台防水。抗紫外线防水层、排水检查、48 小时蓄水测试。免费报价。",
    },
  },
  "waterproofing/concrete-slab-and-car-porch-waterproofing": {
    ms: {
      name: "Kalis Air Slab Konkrit & Porch Kereta",
      tagline: "Perlindungan kalis air untuk porch kereta, laluan dan slab konkrit terdedah dengan pengedapan retak dan topcoat.",
      description:
        "Porch kereta, laluan dan slab konkrit terdedah kepada hujan, pancaran matahari dan kenderaan setiap hari. Lama-kelamaan retakan halus dan sendi pengembangan membenarkan air meresap, menyebabkan karat tetulang, kesan garam dan kerosakan struktur. Kami menyediakan sistem kalis air menyeluruh yang menutup retakan dengan sealant fleksibel, merawat sendi pengembangan, menyapu membran simenan atau akrilik, dan menutup dengan topcoat tahan UV dan tahan lelasan. Kerja ini sesuai untuk porch kereta, laluan masuk, tanjakan, teres belakang dan mana-mana slab konkrit yang terdedah, memberikan perlindungan jangka panjang terhadap cuaca tropika.",
      highlights: [
        "Pengedapan retakan dan sendi pengembangan dengan sealant fleksibel",
        "Membran simenan atau akrilik untuk lekatan kuat pada konkrit",
        "Topcoat tahan UV dan tahan lelasan untuk laluan kenderaan",
        "Menghalang karat tetulang, kesan garam dan kerosakan struktur",
        "Sesuai untuk porch kereta, laluan, tanjakan dan teres belakang",
      ],
      process: [
        { step: "01", title: "Pemeriksaan Slab", desc: "Kami memeriksa keadaan slab, mengenal pasti retakan, sendi pengembangan dan genangan air sebelum rawatan." },
        { step: "02", title: "Penyediaan & Pengedapan", desc: "Permukaan dibersihkan, retakan disapu dan sendi pengembangan disegel dengan sealant fleksibel." },
        { step: "03", title: "Primer", desc: "Primer konkrit berat disapu untuk memastikan membran melekat pada permukaan berliang." },
        { step: "04", title: "Membran", desc: "Membran simenan atau akrilik disapu dalam dua hingga tiga lapisan untuk penutupan penuh." },
        { step: "05", title: "Topcoat & Ujian", desc: "Topcoat tahan UV dan tahan lelasan disapu, diikuti ujian penyembur air untuk mengesahkan pengedap." },
      ],
      faqs: [
        { q: "Bolehkah porch kereta digunakan sejurus selepas kalis air?", a: "Kebanyakan sistem kalis air simenan memerlukan 24–48 jam untuk kering sebelum laluan biasa. Topcoat tahan lelasan tambahan biasanya sedia dalam 24 jam lagi. Kami menasihatkan tempoh pengeringan penuh sebelum kenderaan." },
        { q: "Adakah kalis air slab menghalang karat tetulang?", a: "Ya, dengan menutup retakan dan mencegah air meresap ke konkrit, ia mengurangkan risiko karat tetulang dan kanser konkrit dengan ketara." },
        { q: "Bagaimana anda merawat retakan pada porch kereta?", a: "Kami bersihkan retakan, sapu sealant fleksibel untuk membolehkan pergerakan, kemudian sapu sistem membran di atasnya supaya retakan tidak kembali membocorkan air." },
        { q: "Berapa lama sistem ini bertahan?", a: "Sistem membran simenan dengan topcoat tahan UV biasanya bertahan 5–10 tahun pada slab terdedah, tertakluk kepada penyelenggaraan dan keadaan saliran." },
      ],
      metaTitle: "Kalis Air Porch Kereta & Slab Konkrit KL | Atas Sebut Harga",
      metaDesc: "Kalis air porch kereta, laluan & slab konkrit di KL & Selangor. Pengedapan retak, membran, topcoat tahan UV. Cegah karat tetulang. Sebut harga percuma.",
    },
    zh: {
      name: "混凝土板与车棚防水",
      tagline: "为车棚、车道与暴露混凝土板提供防水保护，含裂缝密封与保护面层。",
      description:
        "车棚、车道与暴露的混凝土板每天承受雨水、日晒与车辆荷载。久而久之，细微裂缝与伸缩缝会允许水渗入，造成钢筋锈蚀、盐析与结构损坏。我们提供全面的防水系统：用柔性密封剂封闭裂缝、处理伸缩缝、涂刷水泥基或丙烯酸防水层，并覆以抗紫外线、耐磨的保护面层。本工程适用于车棚、车道、坡道、后院露台及任何暴露的混凝土板，为热带气候提供长期保护。",
      highlights: [
        "用柔性密封剂封闭裂缝与伸缩缝",
        "水泥基或丙烯酸防水层，牢固附着混凝土",
        "抗紫外线、耐磨保护面层，可承受车辆荷载",
      ...
      process: [
        { step: "01", title: "板面检查", desc: "我们检查板面状况，识别裂缝、伸缩缝与积水区域后再进行处理。" },
        { step: "02", title: "准备与密封", desc: "清洁表面，打磨裂缝，并用柔性密封剂封堵伸缩缝。" },
        { step: "03", title: "底漆", desc: "涂刷重型混凝土底漆，确保防水层附着于多孔表面。" },
        { step: "04", title: "防水层", desc: "涂刷两至三层水泥基或丙烯酸防水层，实现完全覆盖。" },
        { step: "05", title: "面层与测试", desc: "涂刷抗紫外线、耐磨面层，并用喷水测试验证密封。" },
      ],
      faqs: [
        { q: "防水后能马上用车棚吗？", a: "多数水泥基防水系统需 24–48 小时干燥后方可正常通行。耐磨面层通常再需 24 小时。我们会建议车辆可通行前的完整干燥时间。" },
        { q: "板面防水能防止钢筋锈蚀吗？", a: "能。通过封闭裂缝阻止水渗入混凝土，可显著降低钢筋锈蚀与混凝土癌变的风险。" },
        { q: "车棚裂缝如何处理？", a: "我们清洁裂缝、涂抹柔性密封剂以允许轻微位移，再在其上涂防水系统，避免裂缝再次渗水。" },
        { q: "这套系统能用多久？", a: "水泥基防水系统配抗紫外线面层在暴露板上通常可用 5–10 年，视维护与排水状况而定。" },
      ],
      metaTitle: "吉隆坡车棚与混凝土板防水 | 依报价",
      metaDesc: "吉隆坡与雪兰莪车棚、车道与混凝土板防水。裂缝密封、防水层、抗紫外线面层。防止钢筋锈蚀。免费报价。",
    },
  },
  "waterproofing/water-leakage-repair": {
    ms: {
      name: "Pembaikan Kebocoran Air",
      tagline: "Diagnosis kebocoran dengan kamera pengimejan terma dan pembaikan berfokus untuk dinding, lantai, paip dan slab.",
      description:
        "Kebocoran air aktif muncul sebagai siling bernoda, bau hapak, penggunaan air meningkat atau pertumbuhan kulat. Pelanggan sering tidak pasti sama ada punca dari paip, membran kalis air atau saliran. Kami menggunakan kamera pengimejan terma dan meter lembapan untuk memetakan laluan air tanpa kerja merosakkan. Bergantung pada punca, kami menyuntik grouting PU, membaiki sambungan paip, mengedap sendi jubin atau menyapu membran kalis air kecil. Pendekatan berfokus ini menyelesaikan punca dengan kerosakan minimum, dan kami menerangkan sepenuhnya pilihan sebelum kerja bermula supaya anda tahu pilihan yang paling kos berkesan.",
      highlights: [
        "Pengesanan kamera terma & meter lembapan tanpa merosakkan",
        "Pembaikan berfokus pada punca, bukan hanya gejala permukaan",
        "Pilihan PU grouting, pembaikan paip atau membran kecil",
        "Penerangan jelas pilihan pembaikan dan kos sebelum kerja",
        "Sesuai untuk siling, dinding, bilik air dan balkoni",
      ],
      process: [
        { step: "01", title: "Diagnosis Terma", desc: "Kami menggunakan kamera terma dan meter lembapan untuk mengesan laluan air dan mengenal pasti titik tertinggi kelembapan." },
        { step: "02", title: "Siasatan Laluan", desc: "Kami mengesahkan sama ada kebocoran dari paip, membran atau saliran berdasarkan corak dan sejarah kerja." },
        { step: "03", title: "Sebut Harga Berfokus", desc: "Anda menerima pilihan pembaikan yang jelas dengan kos dan jangka hayat setiap satu, dipersetujui sebelum kerja." },
        { step: "04", title: "Pembaikan Punca", desc: "Kami menyuntik PU, membaiki sendi paip, mengedap jubin atau menyapu membran sesuai punca." },
        { step: "05", title: "Pengujian & Kemasan", desc: "Kami menjalankan ujian air atau pemeriksaan lembapan semula untuk mengesahkan kebocoran berhenti dan memulihkan permukaan." },
      ],
      faqs: [
        { q: "Bagaimana anda mencari punca kebocoran tanpa memecahkan dinding?", a: "Kami menggunakan kamera pengimejan terma dan meter lembapan untuk mengesan suhu dan kelembapan yang berbeza, memetakan laluan air dengan tepat dan hanya membuka kawasan yang perlu." },
        { q: "Berapa kos untuk membetulkan kebocoran?", a: "Kos bergantung pada punca dan kawasan. Suntikan PU bermula dari RM 300/titik, membran kecil mengikut keluasan, dan pembaikan paip mengikut penyambungan. Kami memberi sebut harga tetap selepas diagnosis." },
        { q: "Adakah kebocoran air perlu dibaiki segera?", a: "Ya. Kebocoran yang dibiarkan boleh menyebabkan karat tetulang, siling melendut, pertumbuhan kulat dan kos pembaikan lebih tinggi. Kami mengesyorkan diagnosis dalam 24–48 jam bagi kes aktif." },
        { q: "Apakah jaminan untuk pembaikan kebocoran?", a: "Suntikan PU dan kerja membran lengkap membawa jaminan bertulis sehingga 5 tahun; pembaikan sambungan paip biasanya dilindungi jaminan kerja 30 hari." },
      ],
      metaTitle: "Pembaikan Kebocoran Air KL & Selangor | Dari RM350",
      metaDesc: "Pembaikan kebocoran air di KL & Selangor. Pengimejan terma, suntikan PU, pembaikan paip & membran. Tanpa pecah dinding. Sebut harga percuma.",
    },
    zh: {
      name: "漏水修复",
      tagline: "用热成像相机与湿度计进行漏水诊断，并针对墙面、地面、管道与混凝土板进行修复。",
      description:
        "活跃漏水表现为天花板水渍、霉味、用水量增加或霉菌滋生。客户常常不确定问题来自管道、防水层还是排水。我们使用热成像相机与湿度计在不破坏的前提下绘制水流路径。根据成因，我们可进行 PU 注浆、修复管道接头、密封砖缝或涂刷局部防水层。这种聚焦的方法以最小破坏解决根源，并在开工前充分解释方案，让您了解最具成本效益的选择。",
      highlights: [
        "非破坏性热成像与湿度计检测",
        "针对根源修复，而非只处理表面症状",
        "可选 PU 注浆、管道修复或局部防水层",
      ...
      process: [
        { step: "01", title: "热成像诊断", desc: "用热成像相机与湿度计追踪水流路径，识别最高含水点。" },
        { step: "02", title: "路径排查", desc: "根据渗水模式与施工历史，确认漏水来自管道、防水层还是排水。" },
        { step: "03", title: "聚焦报价", desc: "您获得清晰的修复选项，包括各自费用与寿命，确认后再开工。" },
        { step: "04", title: "根源修复", desc: "按成因进行 PU 注浆、管道接头修复、砖缝密封或局部防水层涂刷。" },
        { step: "05", title: "测试与收尾", desc: "我们进行注水或复测湿度以确认漏水停止，并恢复受影响表面。" },
      ],
      faqs: [
        { q: "如何在不砸墙的情况下找到漏水点？", a: "我们用热成像相机与湿度计检测温湿度差异，精确绘制水流路径，并只打开必要区域。" },
        { q: "修复漏水要多少钱？", a: "费用取决于成因与范围。PU 注浆每点从 RM 300 起，局部防水层按面积计，管道修复按接头计。我们诊断后提供固定报价。" },
        { q: "漏水需要马上修吗？", a: "是的。放任不管会导致钢筋锈蚀、天花板下垂、霉菌滋生并带来更高维修成本。活跃漏水建议在 24–48 小时内诊断。" },
        { q: "漏水修复有保修吗？", a: "PU 注浆与完整防水层工程享有最长 5 年书面保修；管道接头修复通常为 30 天工艺保修。" },
      ],
      metaTitle: "吉隆坡与雪兰莪漏水修复 | 从 RM350 起",
      metaDesc: "吉隆坡与雪兰莪漏水修复。热成像诊断、PU 注浆、管道与防水层修复。无需砸墙。免费报价。",
    },
  },
  "waterproofing/ceiling-water-damage-repair": {
    ms: {
      name: "Pembaikan Siling Rosak Air",
      tagline: "Memulihkan siling bernoda atau lembut akibat kebocoran dengan rawatan punca, penggantian papan dan kemasan semula.",
      description:
        "Siling bernoda, menggelembung atau lembut adalah tanda air meresap dari bumbung, bilik air atas atau paip tersembunyi. Kami menangani kedua-dua punca dan kesan: mengesan dan membetulkan sumber kebocoran terlebih dahulu, sama ada membran kalis air, paip atau saliran, kemudian menggantikan papan plaster yang rosak. Papan baharu dipasang pada rangka yang diperiksa, sendi diketuk dan disapu dengan skim coat, dan permukaan diserahkan sedia untuk dicat. Kerja ini menghalang masalah berulang dan memulihkan siling ke keadaan kemas dan selamat.",
      highlights: [
        "Rawatan punca kebocoran sebelum pembaikan siling",
        "Papan plaster tahan lembapan untuk bilik air dan balkoni",
        "Penggantian papan, pengetapan sendi dan skim coat",
        "Pemeriksaan rangka dan pengukuhan jika perlu",
        "Diserahkan sedia untuk dicat atau kemasan akhir",
      ],
      process: [
        { step: "01", title: "Diagnosis Punca", desc: "Kami mengesan punca kebocoran (bumbung, bilik air atas atau paip) sebelum sebarang kerja siling dimulakan." },
        { step: "02", title: "Pembaikan Punca", desc: "Kami membetulkan kebocoran dengan grouting PU, membran atau pembaikan paip supaya masalah tidak berulang." },
        { step: "03", title: "Penanggalan Papan", desc: "Papan plaster yang bernoda, lembut atau berkulat ditanggalkan dengan selamat dan disingkirkan." },
        { step: "04", title: "Rangka & Papan Baru", desc: "Rangka diperiksa dan diperkukuh jika perlu, kemudian papan plaster baharu dipasang." },
        { step: "05", title: "Pengetapan & Skim", desc: "Sendi diketuk dengan mesh, disapu skim coat dan diampelas rata untuk kemasan sedia cat." },
      ],
      faqs: [
        { q: "Mengapa siling saya bernoda walaupun tiada hujan?", a: "Noda tanpa hujan biasanya dari kebocoran paip, bilik air di atas atau pengudaraan AC. Kami mengesan punca dengan pengimejan terma sebelum membaiki siling." },
        { q: "Adakah papan plaster perlu diganti atau boleh dibaiki?", a: "Jika papan lembut, menggelembung atau berkulat, ia perlu diganti. Noda kecil tanpa kerosakan struktur boleh dirawat dengan primer penyekat dan dicat semula." },
        { q: "Berapa lama kerja pembaikan siling mengambil masa?", a: "Siling kepada satu bilik biasanya mengambil 1–2 hari bergantung pada keluasan dan penyediaan. Sekiranya pembaikan punca kebocoran diperlukan, tambah masa bergantung pada kerumitan." },
        { q: "Adakah anda membaiki punca kebocoran atau hanya siling?", a: "Kami sentiasa menangani punca dahulu. Membaiki siling tanpa membetulkan kebocoran hanya menangguhkan masalah dan membazir kos." },
      ],
      metaTitle: "Pembaikan Siling Rosak Air KL & Selangor | Dari RM420",
      metaDesc: "Pembaikan siling rosak air di KL & Selangor. Rawatan punca bocor, penggantian papan plaster & kemasan sedia cat. Sebut harga percuma.",
    },
    zh: {
      name: "天花板水损修复",
      tagline: "通过处理漏水源头、更换石膏板与重新饰面，修复水渍或软化的天花板。",
      description:
        "天花板水渍、起泡或软化是屋顶、楼上浴室或隐藏管道渗水的征兆。我们同时处理成因与后果：先通过热成像与湿度检测定位并修复漏水源头——无论是防水层、管道还是排水——然后更换受损石膏板。新板材安装在经过检查的龙骨上，接缝贴带并批灰找平，最后交付可直接上漆。这样既能防止问题复发，又能让天花板恢复整洁、安全的状态。",
      highlights: [
        "修复天花板前先处理漏水源头",
        "浴室与阳台采用防潮石膏板",
        "更换板材、接缝贴带与批灰找平",
      ...
      process: [
        { step: "01", title: "源头诊断", desc: "在开始任何天花作业前，先定位漏水来源（屋顶、楼上浴室或管道）。" },
        { step: "02", title: "源头修复", desc: "通过 PU 注浆、防水层或管道修复解决漏水，避免问题复发。" },
        { step: "03", title: "拆除旧板", desc: "安全拆除并清运水渍、软化或发霉的石膏板。" },
        { step: "04", title: "龙骨与新板", desc: "检查并必要时加固龙骨，然后安装新的石膏板。" },
        { step: "05", title: "贴带与批灰", desc: "接缝贴网格带、批刮腻子并打磨平整，提供可直接上漆的饰面。" },
      ],
      faqs: [
        { q: "为什么没下雨天花板也有水渍？", a: "无雨天的水渍通常来自管道漏水、楼上浴室或空调冷凝。我们先用热成像定位源头再修复天花板。" },
        { q: "石膏板需要更换还是可以修补？", a: "如果板材软化、起泡或发霉，就必须更换。没有结构损坏的小水渍可用防污封闭底漆处理后重新粉刷。" },
        { q: "天花板修复需要多久？", a: "单间天花板通常需 1–2 天，视面积与准备情况而定。如需先修复漏水源头，则按复杂程度增加时间。" },
        { q: "你们既修漏水源头也修天花板吗？", a: "我们总是先处理源头。只修天花板而不解决漏水只是推迟问题，并浪费费用。" },
      ],
      metaTitle: "吉隆坡与雪兰莪天花板水损修复 | 从 RM420 起",
      metaDesc: "吉隆坡与雪兰莪天花板水损修复。先处理漏水源头，再更换石膏板并完成上漆前饰面。免费报价。",
    },
  },
  "waterproofing/waterproofing-repair-and-re-coating": {
    ms: {
      name: "Pembaikan & Sapu Semula Kalis Air",
      tagline: "Memulihkan sistem kalis air yang gagal atau lama dengan pembersihan, primer, sapu semula membran dan ujian kolam.",
      description:
        "Membran kalis air yang lama akhirnya gagal—retak, menggelembung atau kehilangan lekatan—dan membenarkan air meresap semula. Daripada menggantikan keseluruhan sistem, kami menilai keadaan membran sedia ada dan memulihkannya dengan pembersihan menyeluruh, pengisian retak, primer pelekat dan sapuan semula membran baharu di atas sistem yang masih kukuh. Selepas sapu semula, kami menjalankan ujian kolam air untuk mengesahkan pengedap. Pendekatan ini jauh lebih berpatutan daripada penggantian penuh dan boleh memanjangkan jangka hayat kalis air anda dengan ketara.",
      highlights: [
        "Penilaian keadaan membran sedia ada sebelum kerja",
        "Pembersihan mendalam dan pengisian retak termasuk",
        "Sapu semula membran baharu di atas sistem yang kukuh",
        "Ujian kolam air untuk mengesahkan pengedap",
        "Lebih berpatutan daripada penggantian penuh",
      ],
      process: [
        { step: "01", title: "Penilaian Keadaan", desc: "Kami memeriksa membran sedia ada untuk menentukan sama ada ia boleh dipulihkan atau perlu penanggalan." },
        { step: "02", title: "Pembersihan & Penyediaan", desc: "Kotoran, salutan longgar dan retakan dibersihkan dan diisi dengan sealant fleksibel." },
        { step: "03", title: "Primer", desc: "Primer pelekat berat disapu untuk memastikan sapu semula melekat pada membran lama." },
        { step: "04", title: "Sapu Semula Membran", desc: "Lapisan membran baharu disapu sama ada akrilik atau simenan, mengikut jenis sistem sedia ada." },
        { step: "05", title: "Ujian Kolam & Kemasan", desc: "Ujian kolam 24–48 jam dijalankan untuk mengesahkan tiada kebocoran sebelum kemasan." },
      ],
      faqs: [
        { q: "Bagaimana saya tahu jika membran perlu diganti atau boleh disapu semula?", a: "Jika membran masih melekat kukuh, tidak menggelembung dan tidak berkulat, sapu semula adalah pilihan kos efektif. Jika ia gagal sepenuhnya, terkelupas atau berlubang, penggantian diperlukan. Kami menilai di tapak dan mengesyorkan pilihan." },
        { q: "Berapa lama sapu semula kalis air bertahan?", a: "Sapu semula dengan membran berkualiti dan topcoat tahan UV biasanya bertahan 3–7 tahun, bergantung pada keadaan membran asal dan pendedahan cuaca." },
        { q: "Adakah sapu semula lebih murah daripada penggantian?", a: "Ya, biasanya jauh lebih murah kerana tidak memerlukan penanggalan, pelupusan dan penyediaan substrat penuh. Ia sesuai apabila sistem sedia ada masih kukuh." },
        { q: "Adakah anda menjalankan ujian kolam selepas sapu semula?", a: "Ya, kami menjalankan ujian kolam 24–48 jam selepas sapu semula untuk mengesahkan pengedap sebelum lapisan penutup atau kemasan dipasang." },
      ],
      metaTitle: "Pembaikan & Sapu Semula Kalis Air KL | Dari RM500",
      metaDesc: "Pembaikan & sapu semula membran kalis air di KL & Selangor. Penilaian, pembersihan, primer & ujian kolam. Jimat berbanding penggantian. Sebut harga percuma.",
    },
    zh: {
      name: "防水层维修与重涂",
      tagline: "通过清洁、底漆、重涂防水层与蓄水测试，恢复失效或老化的防水系统。",
      description:
        "老化的防水层最终会失效——开裂、起泡或失去附着力——从而让水再次渗入。与其整系统拆掉重做，我们评估现有防水层状况，并通过彻底清洁、裂缝填补、粘结底漆以及在仍牢固的旧层上重涂新防水层来修复。重涂后进行蓄水测试确认密封。这比完全更换便宜得多，并能显著延长您防水层的使用寿命。",
      highlights: [
        "施工前先评估现有防水层状况",
        "包含深层清洁与裂缝填补",
        "在仍牢固的旧层上重涂新防水层",
      ...
      process: [
        { step: "01", title: "状况评估", desc: "我们检查现有防水层，判断可修复还是需要拆除。" },
        { step: "02", title: "清洁与准备", desc: "清理污垢、松脱涂层并填补裂缝，用柔性密封剂处理。" },
        { step: "03", title: "底漆", desc: "涂刷重型粘结底漆，确保新涂层附着在旧防水层上。" },
        { step: "04", title: "重涂防水层", desc: "按现有系统类型涂刷一层新的丙烯酸或水泥基防水层。" },
        { step: "05", title: "蓄水测试与收尾", desc: "进行 24–48 小时蓄水测试，确认无漏水后再铺饰面。" },
      ],
      faqs: [
        { q: "怎么知道防水层该重涂还是该换？", a: "如果旧层仍牢固附着、不起泡、不发霉，重涂是低成本选择。如果已完全失效、剥落或穿孔，则需更换。我们现场评估并给出建议。" },
        { q: "重涂防水层能撑多久？", a: "用优质防水层加抗紫外线面层重涂通常可用 3–7 年，视旧层状况与气候暴露而定。" },
        { q: "重涂比更换便宜吗？", a: "通常便宜得多，因为无需拆除、清运与全面基层处理。它最适合旧层仍牢固的情况。" },
        { q: "重涂后会做蓄水测试吗？", a: "会。我们会在重涂后进行 24–48 小时蓄水测试，确认密封后铺饰面层。" },
      ],
      metaTitle: "吉隆坡防水层维修与重涂 | 从 RM500 起",
      metaDesc: "吉隆坡与雪兰莪防水层维修与重涂。状况评估、清洁、底漆与蓄水测试。比更换更省钱。免费报价。",
    },
  },
  /* ── PLUMBING ─────────────────────────────────────────────────────────── */
  ...
  "carpentry/walk-in-wardrobe-and-closet-system": {
    ms: {
      name: "Walk-in Wardrobe & Sistem Closet",
      tagline: "Sistem walk-in wardrobe lantai-ke-siling dengan zon gantungan, laci, unit pulau dan pencahayaan dalaman untuk ruang persalinan yang kemas dan premium.",
      description:
        "Walk-in wardrobe ialah ruang persalinan khas yang memaksimumkan kapasiti storan sambil memaparkan koleksi pakaian anda dengan kemas. Kami mereka dan membina sistem lantai-ke-siling sepenuhnya: zon gantungan panjang dan pendek, rak para, laci dalam, rak kasut dan laci aksesori—disusun mengikut tabiat berpakaian anda. Untuk bilik yang lebih luas, kami tambah unit pulau dengan laci untuk barang kemas dan aksesori, serta pilihan pencahayaan dalaman LED (sensor atau suis sentuh) supaya setiap sudut kelihatan jelas. Semua binaan menggunakan rangka papan lapis 18mm dengan para 25mm, engsel tutup lembut Häfele/Blum dan rel laci sambungan penuh. Reka bentuk disediakan dalam render 3D dengan ukuran laser di tapak sebelum pembuatan di bengkel KL kami.",
      highlights: [
        "Reka bentuk ruang penuh: zon gantungan, para, laci, rak kasut dan aksesori",
        "Unit pulau pilihan dengan laci barang kemas dan aksesori",
        "Pencahayaan dalaman LED dengan sensor atau suis sentuh",
        "Rangka papan lapis 18mm, para 25mm, perkakasan Häfele/Blum",
        "Render 3D dan ukuran laser sebelum pembuatan bermula",
      ],
      process: [
        { step: "01", title: "Kajian Ruang & Storan", desc: "Kami mengukur bilik, menilai aliran laluan dan mencatat koleksi pakaian, kasut dan aksesori anda untuk menentukan keperluan zon." },
        { step: "02", title: "Reka Bentuk 3D", desc: "Susun atur sistem, unit pulau dan pencahayaan direka dalam 3D dengan sebut harga terperinci untuk kelulusan anda." },
        { step: "03", title: "Pembuatan Bengkel", desc: "Semua panel, laci dan rak dipotong CNC dan dipra-pasang di bengkel kami dalam 2–3 minggu." },
        { step: "04", title: "Pemasangan & Pencahayaan", desc: "Unit dipasang dalam 1–2 hari, diratakan dan diselaras, diikuti pendawaian lampu LED oleh juruelektrik kami." },
        { step: "05", title: "Penjajaran & Serahan", desc: "Setiap laci dan pintu diuji, lampu disemak, dan kad jaminan struktur 5 tahun diserahkan." },
      ],
      faqs: [
        { q: "Berapakah saiz minimum untuk walk-in wardrobe?", a: "Ruang seluas 1.8m × 1.8m sudah boleh memuatkan sistem berbentuk U atau L dengan zon gantungan di kedua-dua sisi. Untuk ruang lebih kecil, kami cadangkan sistem bentuk L atau garisan tunggal supaya laluan tetap selesa." },
        { q: "Adakah lampu LED termasuk dalam sebut harga?", a: "Pencahayaan dalaman LED ditawarkan sebagai pilihan tambahan dalam sebut harga—sensor gerakan, suis sentuh atau dimmer—dan dipasang oleh juruelektrik kami supaya pendawaian selamat dan kemas." },
        { q: "Berapa lama masa untuk membina walk-in wardrobe?", a: "Biasanya 5 hingga 7 minggu dari kelulusan reka bentuk: 1–2 minggu reka bentuk, 3 minggu pembuatan, 1–2 hari pemasangan dan pendawaian lampu." },
        { q: "Bolehkah ia dibina di kondominium?", a: "Ya. Kami biasa membina sistem walk-in di kondominium dan apartmen servis—mematuhi waktu kerja pengurusan, menggunakan perlindungan lif dan menguruskan penyingkiran serpihan." },
      ],
      metaTitle: "Walk-in Wardrobe Custom KL & Selangor | Atas Sebut Harga",
      metaDesc: "Sistem walk-in wardrobe lantai-ke-siling di KL & Selangor. Zon gantungan, laci, unit pulau, lampu LED, rangka papan lapis 18mm, reka bentuk 3D. Jaminan struktur 5 tahun. Sebut harga percuma di WhatsApp.",
    },
    zh: {
      name: "步入式衣帽间与衣橱系统",
      tagline: "顶天立地步入式衣帽间系统，含挂衣区、抽屉、岛台与内嵌灯光，打造整洁高级的专属衣帽间。",
      description:
        "步入式衣帽间是专门的更衣空间，在最大化收纳容量的同时让衣物陈列整齐有序。我们设计并打造全套顶天立地系统：长衣与短衣挂区、层板、深抽屉、鞋架与配饰抽——完全按照您的穿搭习惯排布。空间充裕的房间还可增加带珠宝与配饰抽屉的岛台，并选配 LED 内嵌照明（感应或触摸开关），让每个角落一目了然。所有柜体采用 18mm 胶合板配 25mm 加厚层板，Häfele/Blum 缓冲铰链与全拉出抽屉滑轨。设计阶段提供现场激光测量与 3D 渲染，确认后再由我们吉隆坡自有工厂投产。",
      highlights: [
        "全空间设计：挂衣区、层板、抽屉、鞋架与配饰收纳",
        "可选岛台，配珠宝与配饰抽屉",
        "LED 内嵌照明，感应或触摸开关",
        "18mm 胶合板柜体、25mm 层板、Häfele/Blum 五金",
        "投产前提供 3D 渲染与激光测量",
      ],
      process: [
        { step: "01", title: "空间与收纳分析", desc: "测量房间、评估动线，并记录衣物、鞋履与配饰数量，确定分区需求。" },
        { step: "02", title: "3D 设计", desc: "以 3D 呈现系统布局、岛台与照明方案，并附逐项报价供您确认。" },
        { step: "03", title: "工厂生产", desc: "所有面板、抽屉与层板在工厂 CNC 加工并预组装，工期 2–3 周。" },
        { step: "04", title: "安装与灯光", desc: "1–2 天安装到位、调平对齐，随后由我们的电工完成 LED 灯光布线。" },
        { step: "05", title: "调校与交付", desc: "逐一测试抽屉与柜门、检查灯光，并移交 5 年结构保修卡。" },
      ],
      faqs: [
        { q: "步入式衣帽间最小需要多大空间？", a: "约 1.8米 × 1.8米即可容纳 U 形或 L 形系统，两侧都设挂衣区。空间更小建议 L 形或单排布局，保证行走动线舒适。" },
        { q: "报价包含 LED 灯吗？", a: "LED 内嵌照明作为可选项目列入报价——感应、触摸开关或调光——由我们的电工安装，确保布线安全整洁。" },
        { q: "定制步入式衣帽间需要多久？", a: "从设计确认起通常 5 到 7 周：1–2 周设计，3 周生产，1–2 天安装与灯光布线。" },
        { q: "公寓里可以安装吗？", a: "可以。我们经常在吉隆坡各公寓与服务式住宅安装衣帽间系统——遵守管理处工时、使用电梯保护并负责废料清运。" },
      ],
      metaTitle: "吉隆坡与雪兰莪定制步入式衣帽间 | 按报价",
      metaDesc: "吉隆坡与雪兰莪顶天立地步入式衣帽间系统。挂衣区、抽屉、岛台、LED 灯、18mm 胶合板柜体、3D 设计。5 年结构保修。WhatsApp免费报价。",
    },
  },
  "carpentry/vanity-cabinet-and-dressing-table": {
    ms: {
      name: "Kabinet Vanity & Meja Solek",
      tagline: "Kabinet vanity kustom dengan bahagian atas sinki, laci, cermin dan pencahayaan untuk bilik mandi, atau meja solek bilik tidur dengan storan.",
      description:
        "Kabinet vanity yang direka khas menggabungkan fungsi bilik mandi dengan gaya peribadi—sama ada kabinet gantung moden dengan sinki atas, kabinet lantai berganda untuk bilik mandi keluarga, atau meja solek bilik tidur dengan cermin menyala. Kami membina menggunakan papan lapis 18mm yang tahan kelembapan untuk kawasan basah, dengan kemasan laminate, akrilik atau cat semburan yang mudah dibersihkan. Ruang dalaman disusun mengikut keperluan: laci untuk alat solek, rak untuk tuala, ruang paip tersembunyi dan lubang kabel untuk meja solek. Semua laci dan pintu menggunakan rel serta engsel tutup lembut Häfele/Blum. Untuk bilik mandi, kami berkoordinasi dengan pasukan paip supaya sambungan sinki dan kedudukan paip dipasang dengan betul.",
      highlights: [
        "Reka bentuk kustom untuk bilik mandi atau bilik tidur",
        "Papan lapis 18mm tahan kelembapan untuk kawasan basah",
        "Dalaman disusun: laci solek, rak tuala, ruang paip dan lubang kabel",
        "Rel laci dan engsel tutup lembut Häfele/Blum",
        "Koordinasi pemasangan paip dan sinki dengan pasukan paip kami",
      ],
      process: [
        { step: "01", title: "Ukuran & Keperluan", desc: "Kami mengukur ruang, mencatat saiz sinki atau cermin sedia ada dan keperluan storan alat solek atau tuala anda." },
        { step: "02", title: "Reka Bentuk 3D", desc: "Susun atur kabinet, kedudukan paip dan pilihan kemasan direka dalam 3D dengan sebut harga terperinci." },
        { step: "03", title: "Pembuatan Bengkel", desc: "Kabinet dibina di bengkel kami dengan papan lapis 18mm, dipotong CNC dan dipra-pasang dalam 2–3 minggu." },
        { step: "04", title: "Pemasangan & Paip", desc: "Unit dipasang, diratakan dan diikat ke dinding; sambungan sinki dan paip disiapkan oleh jurutera paip kami." },
        { step: "05", title: "Kemasan & Serahan", desc: "Cermin dan lampu dipasang, laci diuji, dan kad jaminan struktur 5 tahun diserahkan." },
      ],
      faqs: [
        { q: "Bolehkah saya menggunakan sinki atau cermin sedia ada?", a: "Ya. Kami mereka kabinet mengikut ukuran sinki atas, sinki bawah atau cermin yang anda sudah ada, atau kami boleh cadangkan pilihan yang bersesuaian dengan reka bentuk." },
        { q: "Adakah kabinet vanity sesuai untuk bilik mandi kecil?", a: "Ya. Kabinet gantung yang kami bina mengekalkan ruang lantai, dan reka bentuk nipis boleh memuatkan sinki kecil serta storan dalam ruang serendah 60cm lebar." },
        { q: "Bagaimana dengan kelembapan di bilik mandi?", a: "Kami menggunakan papan lapis 18mm dengan kemasan laminate, akrilik atau cat semburan yang menutup tepi dan permukaan—tahan kelembapan tinggi dan mudah disapu bersih." },
        { q: "Adakah pemasangan paip termasuk?", a: "Pemasangan paip sinki boleh ditambah ke dalam sebut harga—pasukan paip kami menyiapkan sambungan air, sifon dan pengedap supaya semuanya berfungsi dengan sempurna." },
      ],
      metaTitle: "Kabinet Vanity Custom KL & Selangor | Atas Sebut Harga",
      metaDesc: "Kabinet vanity bilik mandi dan meja solek bilik tidur kustom di KL & Selangor. Papan lapis 18mm tahan lembapan, laci tutup lembut, reka bentuk 3D, pemasangan paip pilihan. Sebut harga percuma di WhatsApp.",
    },
    zh: {
      name: "浴室柜与梳妆台",
      tagline: "定制浴室柜，配台盆、抽屉、镜子与灯光；或带收纳的卧室梳妆台。",
      description:
        "定制浴室柜将卫生间的功能与个人风格融为一体——无论是配台上盆的现代悬挂柜、适合家庭双人使用的落地双盆柜，还是带灯镜的卧室梳妆台。湿区柜体采用防潮 18mm 胶合板，搭配易清洁的防火板、亚克力或喷漆饰面。内部按需规划：化妆品抽屉、毛巾层架、隐藏管道空间，梳妆台则预留走线孔。所有抽屉与门板采用 Häfele/Blum 缓冲滑轨与铰链。卫生间项目我们会与水管团队协调，确保台盆接管与管道定位一次到位。",
      highlights: [
        "卫生间或卧室均可定制",
        "湿区采用防潮 18mm 胶合板柜体",
        "内部按需规划：化妆品抽屉、毛巾架、管道空间与走线孔",
        "Häfele/Blum 缓冲抽屉滑轨与铰链",
        "与我们的水管团队协调台盆接管与安装",
      ],
      process: [
        { step: "01", title: "测量与需求确认", desc: "测量空间，记录现有台盆或镜子尺寸，以及化妆品、毛巾等收纳需求。" },
        { step: "02", title: "3D 设计", desc: "以 3D 呈现柜体布局、管道位置与饰面选择，并附逐项报价。" },
        { step: "03", title: "工厂生产", desc: "柜体在我们工厂以 18mm 胶合板 CNC 加工并预组装，工期 2–3 周。" },
        { step: "04", title: "安装与接管", desc: "安装柜体、调平并固定上墙；台盆进水与排水由我们的水管工完成。" },
        { step: "05", title: "收尾与交付", desc: "安装镜子与灯具、测试抽屉，并移交 5 年结构保修卡。" },
      ],
      faqs: [
        { q: "可以用我现有的台盆或镜子吗？", a: "可以。我们会按您现有台上盆、台下盆或镜子的尺寸设计柜体，也可以根据设计为您推荐合适款式。" },
        { q: "小卫生间适合做浴室柜吗？", a: "适合。我们制作的悬挂柜保留地面空间，60 厘米宽的窄柜也能容纳小型台盆与充足收纳。" },
        { q: "卫生间潮湿环境怎么办？", a: "柜体采用 18mm 胶合板，防火板、亚克力或喷漆饰面封边包覆，防潮耐湿、易于擦拭。" },
        { q: "水管连接包含在内吗？", a: "可以加入报价——我们的水管团队负责进水、排水与密封，确保台盆即装即用。" },
      ],
      metaTitle: "吉隆坡与雪兰莪定制浴室柜 | 按报价",
      metaDesc: "吉隆坡与雪兰莪定制浴室柜与卧室梳妆台。防潮 18mm 胶合板、缓冲抽屉、3D 设计、可选水管安装。WhatsApp免费报价。",
    },
  },
  "carpentry/storage-cabinet-and-display-shelving": {
    ms: {
      name: "Kabinet Storan & Rak Pameran",
      tagline: "Kabinet storan lantai-ke-siling, rak pameran dan dinding storan feature untuk ruang tamu, laluan dan pejabat rumah — bina mengikut ukuran, kemas dan bebas kekacauan.",
      description:
        "Kabinet storan kustom menyelesaikan masalah ruang tanpa mengorbankan gaya—sama ada kabinet lantai-ke-siling di ruang tamu untuk menyimpan barangan hiasan dan elektronik, rak pameran terbuka untuk koleksi buku atau cenderamata, atau dinding storan feature yang menggabungkan kabinet tertutup dengan rak terbuka di ruang keluarga. Setiap binaan menggunakan rangka papan lapis 18mm dengan para 25mm yang mampu menanggung beban, kemasan laminate, akrilik atau cat semburan, dan engsel serta rel laci tutup lembut Häfele/Blum. Kami mengambil kira beban khusus—contohnya rak buku dengan para tebal, atau kabinet media dengan lubang kabel dan pengudaraan untuk peralatan elektronik. Reka bentuk 3D dengan ukuran laser disediakan sebelum pembuatan.",
      highlights: [
        "Kabinet lantai-ke-siling, rak pameran atau gabungan dinding storan",
        "Para 25mm tebal mampu menanggung beban buku dan barangan berat",
        "Lubang kabel dan pengudaraan untuk kabinet media elektronik",
        "Kemasan laminate, akrilik atau cat semburan dengan engsel tutup lembut",
        "Reka bentuk 3D dengan ukuran laser sebelum pembuatan",
      ],
      process: [
        { step: "01", title: "Penilaian Storan", desc: "Kami menilai ruang, barang yang perlu disimpan dan cara anda menggunakannya—buku, media, koleksi atau perkakas harian." },
        { step: "02", title: "Reka Bentuk 3D", desc: "Gabungan kabinet tertutup dan rak terbuka direka dalam 3D dengan pertimbangan beban dan sebut harga terperinci." },
        { step: "03", title: "Pembuatan Bengkel", desc: "Panel dipotong CNC dan dipra-pasang di bengkel kami dalam 2–3 minggu dengan para 25mm untuk kawasan beban." },
        { step: "04", title: "Pemasangan", desc: "Unit dipasang dalam 1–2 hari, diratakan dan diikat ke dinding; bahagian atas dirapatkan ke siling tanpa celah." },
        { step: "05", title: "Serahan", desc: "Setiap para dan pintu diuji beban ringan, dan kad jaminan struktur 5 tahun diserahkan." },
      ],
      faqs: [
        { q: "Bolehkah kabinet dibuat sehingga ke siling?", a: "Ya. Kabinet lantai-ke-siling memaksimumkan storan dan mengelakkan pengumpulan habuk di atas unit. Untuk siling tidak rata, kami tambah panel penutup atas yang dipotong mengikut sudut." },
        { q: "Berapa beban yang boleh ditanggung oleh para?", a: "Para 25mm dengan jarak penyokong 600mm mampu menanggung beban buku dan barangan berat dengan selamat. Untuk beban sangat berat, kami kurangkan jarak atau tambah penyokong tengah." },
        { q: "Bolehkah rak pameran dipasang tanpa kabinet tertutup?", a: "Ya. Rak pameran terbuka dengan para tebal dan pengikat dinding tersedia untuk koleksi buku, cenderamata atau barangan hiasan—dengan kemasan yang sama seperti kabinet." },
        { q: "Adakah sesuai untuk pejabat rumah?", a: "Ya. Kami mereka kabinet storan dan rak pameran untuk pejabat rumah—filing, perkakasan, buku rujukan dan barangan pameran—dengan susun atur yang kemas dan profesional." },
      ],
      metaTitle: "Kabinet Storan & Rak Pameran Custom KL & Selangor | Atas Sebut Harga",
      metaDesc: "Kabinet storan lantai-ke-siling dan rak pameran kustom di KL & Selangor. Para 25mm tahan beban, kemasan premium, reka bentuk 3D. Jaminan struktur 5 tahun. Sebut harga percuma di WhatsApp.",
    },
    zh: {
      name: "储物柜与展示架",
      tagline: "顶天立地储物柜、展示层架与客厅收纳背景墙——按尺寸定制，整洁有序。",
      description:
        "定制储物柜在不牺牲风格的前提下解决空间问题——无论是客厅顶天立地柜收纳摆件与电子设备、开放式展示架陈列书籍与收藏，还是结合封闭柜与开放格的客厅收纳背景墙。所有柜体采用 18mm 胶合板、25mm 加厚承重层板，防火板、亚克力或喷漆饰面，配 Häfele/Blum 缓冲铰链与抽屉滑轨。我们会专门考虑承重要求——例如书柜使用加厚层板，影音柜预留走线孔与散热缝隙。投产前提供现场激光测量与 3D 设计。",
      highlights: [
        "顶天立地柜、展示架或组合式收纳背景墙",
        "25mm 加厚层板，可承受书籍与重物",
        "影音柜预留走线孔与散热设计",
      ...
      process: [
        { step: "01", title: "收纳评估", desc: "评估空间、需要收纳的物品及其使用方式——书籍、影音、收藏或日用品。" },
        { step: "02", title: "3D 设计", desc: "以 3D 设计封闭柜与开放架的组合，考虑承重因素并附逐项报价。" },
        { step: "03", title: "工厂生产", desc: "面板在工厂 CNC 加工并预组装，工期 2–3 周，承重区使用 25mm 层板。" },
        { step: "04", title: "现场安装", desc: "1–2 天安装到位、调平并固定上墙，顶部与天花板严密贴合。" },
        { step: "05", title: "交付", desc: "逐一测试层板与柜门，移交 5 年结构保修卡。" },
      ],
      faqs: [
        { q: "柜子可以做到顶吗？", a: "可以。顶天立地柜最大化收纳且避免顶部积灰。天花板不平整时，我们会加装按角度裁切的顶封板。" },
        { q: "层板能承重多少？", a: "25mm 层板在 600mm 支撑间距下可安全承载书籍与重物。超重物品我们会缩短间距或增加中撑。" },
        { q: "可以只做开放式展示架吗？", a: "可以。开放式展示架配加厚层板与墙体固定件，适合书籍、收藏与摆件，饰面与柜体一致。" },
        { q: "适合家庭办公室吗？", a: "适合。我们为家庭办公室设计文件、设备、参考书与展示品一体的储物柜与展示架，布局整洁专业。" },
      ],
      metaTitle: "吉隆坡与雪兰莪定制储物柜与展示架 | 按报价",
      metaDesc: "吉隆坡与雪兰莪顶天立地储物柜与展示架。25mm 承重层板、优质饰面、3D 设计。5 年结构保修。WhatsApp免费报价。",
    },
  },
  "carpentry/feature-wall-and-wall-panelling": {
    ms: {
      name: "Dinding Feature & Panel Dinding",
      tagline: "Panel dinding fluted, slat dan laminate dengan rak serta pencahayaan bersepadu untuk ruang tamu, bilik tidur dan dinding TV.",
      description:
        "Dinding feature dengan panel kayu atau laminate ialah cara paling berkesan untuk menambah tekstur dan kemewahan pada ruang tanpa pengubahsuaian besar. Kami mereka dan memasang panel fluted (alur menegak), slat (jalur kayu berselang) dan laminate tekanan tinggi untuk ruang tamu, bilik tidur, ruang makan dan dinding TV. Panel boleh digabungkan dengan rak terapung, kabinet tersembunyi dan pencahayaan LED tersembunyi untuk kesan dinding tunggal yang bersepadu. Semua pemasangan menggunakan tapak kayu yang diratakan, panel yang dipotong tepat di tapak, dan kemasan yang sepadan dengan konsep reka bentuk anda. Untuk ruang komersial seperti restoran dan butik, kami menyediakan panel yang tahan calar dan mudah dibersihkan.",
      highlights: [
        "Panel fluted, slat dan laminate tekanan tinggi",
        "Gabungan rak terapung, kabinet tersembunyi dan lampu LED",
        "Tapak kayu diratakan untuk permukaan yang licin sempurna",
        "Sesuai untuk kediaman dan ruang komersial",
        "Pilihan kemasan sepadan dengan konsep reka bentuk anda",
      ],
      process: [
        { step: "01", title: "Ukuran & Konsep", desc: "Kami mengukur dinding, menilai sumber cahaya dan mencadangkan susun atur panel serta kombinasi rak dan lampu." },
        { step: "02", title: "Reka Bentuk 3D", desc: "Corak panel, kedudukan rak dan pencahayaan direka dalam 3D supaya anda melihat hasil akhir sebelum kerja bermula." },
        { step: "03", title: "Penyediaan Tapak", desc: "Dinding diperiksa, tapak kayu dipasang dan diratakan; panel dipotong tepat di tapak mengikut ukuran sebenar." },
        { step: "04", title: "Pemasangan Panel", desc: "Panel dipasang dengan gam serta skru tersembunyi, sudut dan tepi dirapatkan dengan kemasan kemas." },
        { step: "05", title: "Lampu & Serahan", desc: "Lampu LED tersembunyi dipasang, permukaan dibersihkan, dan kawasan kerja diserahkan kemas." },
      ],
      faqs: [
        { q: "Berapa kos untuk dinding feature panel? ", a: "Kos bergantung pada jenis panel (fluted, slat atau laminate), keluasan dinding dan sama ada rak serta lampu disertakan. Kami berikan sebut harga terperinci selepas ukuran di tapak." },
        { q: "Bolehkah panel dipasang di dinding yang tidak rata?", a: "Ya. Kami memasang tapak kayu yang diratakan terlebih dahulu, jadi panel kelihatan licin walaupun dinding asal tidak rata. Ini juga menyediakan ruang untuk pendawaian lampu tersembunyi." },
        { q: "Adakah panel sesuai untuk ruang komersial?", a: "Ya. Panel laminate tekanan tinggi tahan calar dan mudah dibersihkan—sesuai untuk restoran, butik, pejabat dan ruang pameran yang memerlukan penampilan premium." },
        { q: "Berapa lama pemasangan mengambil masa?", a: "Dinding biasa seluas 3m × 3m mengambil 2 hingga 3 hari termasuk penyediaan tapak, pemasangan panel dan lampu. Projek dengan rak dan kabinet tersembunyi mengambil masa lebih lama." },
      ],
      metaTitle: "Dinding Feature & Panel Dinding KL & Selangor | Atas Sebut Harga",
      metaDesc: "Panel dinding fluted, slat dan laminate untuk ruang tamu, bilik tidur dan dinding TV di KL & Selangor. Rak dan lampu LED bersepadu, reka bentuk 3D. Sebut harga percuma di WhatsApp.",
    },
    zh: {
      name: "背景墙与护墙板",
      tagline: "格栅、竖条与防火板墙面护墙板，集成层架与灯光，适用于客厅、卧室与电视墙。",
      description:
        "木饰面或防火板背景墙是无需大动干戈即可为空间增添质感与格调的最有效方式。我们设计并安装格栅板（竖向凹槽）、竖条板（间隔木条）与高压防火板，适用于客厅、卧室、餐厅与电视墙。护墙板可与悬浮层架、隐藏柜体及 LED 暗藏灯带组合，形成一体化的整面墙效果。所有安装使用先找平的木龙骨基层与现场精密切割的板材，饰面与您的整体设计风格呼应。商业空间（餐厅、精品店）则提供耐刮、易清洁的防火板方案。",
      highlights: [
        "格栅板、竖条板与高压防火板",
        "可组合悬浮层架、隐藏柜体与 LED 灯带",
        "木龙骨基层找平，表面平整无瑕",
        "适用于住宅与商业空间",
        "饰面选择与整体设计风格呼应",
      ],
      process: [
        { step: "01", title: "测量与方案", desc: "测量墙面、评估采光，并建议板材布局以及层架与灯光的组合方式。" },
        { step: "02", title: "3D 设计", desc: "以 3D 呈现板材纹理、层架位置与灯光效果，让您施工前看到最终效果。" },
        { step: "03", title: "基层准备", desc: "检查墙面、安装并调平木龙骨；板材按实际尺寸现场精密切割。" },
        { step: "04", title: "安装板材", desc: "板材以胶粘与隐藏螺丝固定，边角收口整洁。" },
        { step: "05", title: "灯光与交付", desc: "安装暗藏 LED 灯带、清洁表面，作业区整洁交付。" },
      ],
      faqs: [
        { q: "背景墙护墙板要多少钱？", a: "费用取决于板材类型（格栅、竖条或防火板）、墙面面积以及是否包含层架与灯光。现场测量后提供逐项报价。" },
        { q: "墙面不平整可以安装吗？", a: "可以。我们先安装找平的木龙骨基层，即使原墙不平整，面板看起来依然笔直，同时也为暗藏灯线留出空间。" },
        { q: "适合商业空间吗？", a: "适合。高压防火板耐刮易清洁——非常适合餐厅、精品店、办公室与展厅的质感升级。" },
        { q: "安装需要多长时间？", a: "一面 3米×3米 的墙面通常需要 2 到 3 天，含基层准备、板材安装与灯光。带层架与隐藏柜的项目用时更长。" },
      ],
      metaTitle: "吉隆坡与雪兰莪背景墙与护墙板 | 按报价",
      metaDesc: "吉隆坡与雪兰莪格栅、竖条与防火板背景墙护墙板。集成层架与 LED 灯带、3D 设计。WhatsApp免费报价。",
    },
  },
  "carpentry/dining-bench-and-banquette-seating": {
    ms: {
      name: "Bangku Makan & Tempat Duduk Banquette",
      tagline: "Bangku makan kustom, tempat duduk banquette dan bangku tingkap dengan storan terbina untuk ruang makan dan dapur — kemasan upholsteri atau kayu.",
      description:
        "Tempat duduk banquette memaksimumkan kapasiti ruang makan sambil mencipta sudut yang selesa dan menarik—sesuai untuk ruang makan kecil, dapur terbuka dan kafe. Kami mereka dan membina bangku makan tetap di sepanjang dinding dengan storan terbina di bawah tempat duduk (laci atau kabinet buka-atas), bangku tingkap dengan ruang simpanan, dan unit banquette berbentuk L atau U untuk sudut ruang. Rangka menggunakan papan lapis 18mm, tempat duduk diberi lapisan foam berkualiti dan upholsteri pilihan anda (fabrik tahan kotor atau kulit sintetik), atau kemasan kayu penuh dengan kusyen boleh tanggal. Setiap projek direka dalam 3D dengan ukuran di tapak, dan boleh diselaraskan dengan meja makan sedia ada.",
      highlights: [
        "Storan terbina di bawah tempat duduk—laci atau kabinet buka-atas",
        "Rangka papan lapis 18mm dengan upholsteri atau kemasan kayu",
        "Reka bentuk bentuk L, U atau garis lurus untuk sebarang ruang",
        "Kusyen fabrik tahan kotor atau kulit sintetik pilihan",
        "Diselaraskan dengan meja makan sedia ada anda",
      ],
      process: [
        { step: "01", title: "Ukuran & Keperluan", desc: "Kami mengukur ruang makan, menilai susunan meja dan kerusi, serta keperluan storan dan gaya upholsteri anda." },
        { step: "02", title: "Reka Bentuk 3D", desc: "Bentuk banquette, kedudukan storan dan pilihan fabrik direka dalam 3D dengan sebut harga terperinci." },
        { step: "03", title: "Pembuatan Bengkel", desc: "Rangka dan storan dibina di bengkel kami dalam 2–3 minggu; upholsteri dijahit mengikut ukuran tepat." },
        { step: "04", title: "Pemasangan", desc: "Unit dipasang di tapak dalam 1–2 hari, diratakan dan diikat ke dinding atau lantai." },
        { step: "05", title: "Serahan", desc: "Kusyen, laci dan pintu storan diuji; kad jaminan struktur 5 tahun diserahkan." },
      ],
      faqs: [
        { q: "Berapa ramai yang boleh duduk di bangku banquette? ", a: "Bangku sepanjang 1.8m memuatkan 3 hingga 4 orang dewasa; bentuk L atau U memuatkan lebih ramai di sudut ruang. Kami cadangkan susunan mengikut saiz meja dan ruang laluan anda." },
        { q: "Bolehkah banquette menggantikan kerusi makan sepenuhnya?", a: "Ya. Banquette tetap di satu sisi atau sudut digabung dengan kerusi di sisi lain adalah susunan paling popular—memaksimumkan kapasiti tanpa menyempitkan laluan." },
        { q: "Apakah pilihan upholsteri yang tersedia?", a: "Fabrik tahan kotor, kulit sintetik dan kemasan kayu penuh dengan kusyen boleh tanggal. Kami boleh padankan warna dengan konsep ruang makan anda." },
        { q: "Adakah sesuai untuk kafe atau restoran kecil?", a: "Ya. Banquette popular untuk kafe dan restoran kecil kerana memaksimumkan tempat duduk dalam ruang sempit. Untuk komersial, kami gunakan fabrik gred komersial yang tahan lasak." },
      ],
      metaTitle: "Bangku Makan & Banquette Custom KL & Selangor | Atas Sebut Harga",
      metaDesc: "Bangku makan dan tempat duduk banquette kustom di KL & Selangor. Storan terbina, upholsteri pilihan, rangka papan lapis 18mm, reka bentuk 3D. Jaminan struktur 5 tahun. Sebut harga percuma di WhatsApp.",
    },
    zh: {
      name: "餐椅长凳与卡座",
      tagline: "定制餐椅长凳、卡座与窗边座位，底部带收纳，适用于餐厅与厨房，可选软包或木饰面。",
      description:
        "卡座能在有限空间内最大化用餐容量，同时营造舒适别致的角落——非常适合小餐厅、开放式厨房与咖啡馆。我们设计并打造沿墙固定的餐椅长凳，座下带内置收纳（抽屉或上翻柜）；窗边座位带储物空间；以及适合墙角的 L 形或 U 形卡座。框架采用 18mm 胶合板，座面配优质海绵与您选择的软包面料（耐污布艺或仿皮），也可做全木饰面配可拆洗坐垫。每个项目均现场测量并提供 3D 设计，可与您现有餐桌完美搭配。",
      highlights: [
        "座下内置收纳——抽屉或上翻柜",
        "18mm 胶合板框架，软包或木饰面可选",
        "L 形、U 形或一字形，适配任何空间",
      ...
      process: [
        { step: "01", title: "测量与需求", desc: "测量餐厅空间、评估餐桌与椅子布局，以及收纳需求与软包风格。" },
        { step: "02", title: "3D 设计", desc: "以 3D 呈现卡座造型、收纳位置与面料选择，并附逐项报价。" },
        { step: "03", title: "工厂生产", desc: "框架与收纳在工厂 2–3 周完成制作，软包按精确尺寸缝制。" },
        { step: "04", title: "现场安装", desc: "1–2 天安装到位，调平并固定于墙面或地面。" },
        { step: "05", title: "交付", desc: "坐垫、抽屉与收纳门逐一测试，移交 5 年结构保修卡。" },
      ],
      faqs: [
        { q: "卡座能坐多少人？", a: "1.8 米长的卡座可坐 3 到 4 位成人；L 形或 U 形适合墙角，可容纳更多人。我们会根据桌子和动线尺寸建议布局。" },
        { q: "卡座能完全替代餐椅吗？", a: "可以。一侧或角落做固定卡座、另一侧配餐椅是最常见的组合——既增加容量又不挤占通道。" },
        { q: "有哪些软包选择？", a: "耐污布艺、仿皮以及全木饰面配可拆洗坐垫。颜色可与餐厅整体风格匹配。" },
        { q: "适合小咖啡馆或餐厅吗？", a: "适合。卡座是咖啡馆与小型餐厅的常见方案，窄小空间也能容纳更多座位。商业项目我们会选用耐磨商用面料。" },
      ],
      metaTitle: "吉隆坡与雪兰莪定制餐椅长凳与卡座 | 按报价",
      metaDesc: "吉隆坡与雪兰莪定制餐椅长凳与卡座。座下收纳、可选软包、18mm 胶合板框架、3D 设计。5 年结构保修。WhatsApp免费报价。",
    },
  },
  "carpentry/wardrobe-and-cabinet-repair": {
    ms: {
      name: "Pembaikan Almari & Kabinet",
      tagline: "Penjajaran semula pintu, penggantian engsel dan rel, pembaikan para melendut dan refacing kabinet untuk memulihkan binaan tanam sedia ada.",
      description:
        "Almari dan kabinet tanam yang lama sering mengalami masalah biasa: pintu tidak sejajar atau sukar ditutup, engsel longgar, rel laci tersekat, para melendut atau kemasan mengelupas. Pasukan kami membaiki semua isu ini tanpa menggantikan keseluruhan unit—menjimatkan kos dengan ketara. Kami menjajarkan semula pintu dengan melaraskan engsel atau menggantikan engsel lama dengan engsel tutup lembut baharu, menggantikan rel laci yang rosak, menambah penyokong pada para yang melendut, dan menggantikan panel pintu atau kemasan laminate yang rosak melalui refacing. Untuk kabinet dapur, kami juga boleh menukar pintu dan perkakasan sahaja untuk penampilan baharu tanpa membina semula kabinet. Semua kerja disiapkan dengan habuk minimum dan kawasan dibersihkan selepas siap.",
      highlights: [
        "Pembaikan tanpa menggantikan keseluruhan unit—jimat kos",
        "Penjajaran semula pintu dan penggantian engsel tutup lembut",
        "Penggantian rel laci yang rosak atau tersekat",
        "Pengukuhan para melendut dan refacing kemasan rosak",
        "Penukaran pintu dan perkakasan untuk kabinet dapur",
      ],
      process: [
        { step: "01", title: "Diagnosis", desc: "Kami memeriksa setiap pintu, laci, engsel dan para untuk mengenal pasti punca masalah dan skop pembaikan." },
        { step: "02", title: "Sebut Harga Tetap", desc: "Anda menerima sebut harga tetap untuk bahagian yang perlu dibaiki atau diganti sebelum kerja bermula." },
        { step: "03", title: "Pembaikan & Penggantian", desc: "Engsel, rel dan para diganti atau dikuatkan; pintu dijajarkan semula dan diuji kelicinan." },
        { step: "04", title: "Refacing & Kemasan", desc: "Panel atau kemasan yang rosak diganti dan dipadankan dengan warna sedia ada atau konsep baharu." },
        { step: "05", title: "Ujian & Serahan", desc: "Semua pintu dan laci diuji berulang kali; kawasan kerja dibersihkan dan diserahkan." },
      ],
      faqs: [
        { q: "Adakah pembaikan lebih murah daripada menggantikan almari?", a: "Ya, biasanya jauh lebih murah. Kebanyakan isu—pintu tidak sejajar, engsel longgar, laci tersekat—boleh diselesaikan dengan pembaikan atau penggantian perkakasan, tanpa kos pembinaan semula." },
        { q: "Bolehkah anda menukar rupa almari lama tanpa membina semula?", a: "Ya. Refacing menukar pintu, kemasan dan perkakasan sahaja—almari mendapat penampilan baharu pada sebahagian kecil kos pembinaan semula, dalam masa beberapa hari." },
        { q: "Berapa lama pembaikan almari mengambil masa?", a: "Pembaikan biasa seperti penjajaran pintu atau penggantian engsel siap dalam beberapa jam. Refacing penuh atau penggantian pintu mengambil 3 hingga 7 hari bergantung pada skop." },
        { q: "Adakah anda membaiki kabinet dapur juga?", a: "Ya. Kami membaiki dan menggantikan pintu kabinet dapur, perkakasan, para dan rak—termasuk menukar gaya kabinet dapur sedia ada dengan pintu baharu sahaja." },
      ],
      metaTitle: "Pembaikan Almari & Kabinet KL & Selangor | Atas Sebut Harga",
      metaDesc: "Pembaikan almari pakaian dan kabinet tanam di KL & Selangor. Penjajaran pintu, engsel dan rel baharu, para dikuatkan, refacing kabinet. Jaminan kerja. Sebut harga percuma di WhatsApp.",
    },
    zh: {
      name: "衣柜与柜体维修",
      tagline: "柜门调校、铰链与滑轨更换、层板下弯修复与柜体翻新，恢复现有入墙家具。",
      description:
        "使用多年的入墙衣柜与柜体常出现常见问题：柜门不齐或难以关闭、铰链松动、抽屉滑轨卡滞、层板下弯或饰面脱皮。我们无需更换整个柜体即可修复所有这些问题——大幅节省费用。我们会通过调节或更换缓冲铰链重新调校柜门，更换损坏的滑轨，为下弯层板加装支撑，并通过翻新更换损坏的门板或防火板饰面。厨房橱柜则只需更换门板与五金即可焕然一新，无需重做柜体。所有维修以最小粉尘作业，完工后清理现场。",
      highlights: [
        "无需更换整个柜体即可修复——节省费用",
        "柜门调校与缓冲铰链更换",
        "更换损坏或卡滞的抽屉滑轨",
      ...
      process: [
        { step: "01", title: "诊断", desc: "逐一检查柜门、抽屉、铰链与层板，确定问题根源与维修范围。" },
        { step: "02", title: "固定报价", desc: "开工前提供需维修或更换部分的固定报价。" },
        { step: "03", title: "维修与更换", desc: "更换或加固铰链、滑轨与层板，重新调校柜门并测试顺滑度。" },
        { step: "04", title: "翻新与饰面", desc: "更换受损门板或饰面，颜色与原柜匹配或按新方案搭配。" },
        { step: "05", title: "测试与交付", desc: "反复测试所有柜门与抽屉，清理作业区后交付。" },
      ],
      faqs: [
        { q: "维修比换新衣柜便宜吗？", a: "是的，通常便宜得多。柜门不齐、铰链松动、抽屉卡滞等多数问题通过维修或更换五金即可解决，无需重做柜体。" },
        { q: "不重做柜体也能改变旧衣柜的外观吗？", a: "可以。翻新只更换门板、饰面与五金——几天内让衣柜焕然一新，费用仅为重做的一小部分。" },
        { q: "衣柜维修需要多长时间？", a: "柜门调校或铰链更换等常规维修几小时完成。全面翻新或换门板需要 3 到 7 天，视范围而定。" },
        { q: "厨房橱柜也维修吗？", a: "修。我们维修和更换厨房橱柜门板、五金、层板与拉篮，也可以只换门板为旧橱柜改头换面。" },
      ],
      metaTitle: "吉隆坡与雪兰莪衣柜与柜体维修 | 按报价",
      metaDesc: "吉隆坡与雪兰莪入墙衣柜与柜体维修。柜门调校、更换铰链与滑轨、层板加固、柜体翻新。工艺保修。WhatsApp免费报价。",
    },
  },
  ...
  "window-repair/window-installation": {
    ms: {
      ...
      tagline: "Pemasangan tingkap aluminium atau UPVC baharu pada bukaan sedia ada atau bukaan baharu, lengkap dengan pengedapan kalis air dan ujian operasi.",
      description:
        "Pemasangan tingkap yang betul bermula jauh sebelum tingkap tiba di tapak. KL Servis Rumah mengukur bukaan dengan tepat, menyemak sama ada ia segi empat dan aras, dan mencadangkan sistem tingkap yang sesuai — gelangsar aluminium untuk ruang tamu dan bilik tidur, casement untuk pengudaraan maksimum, top-hung untuk bilik air, atau UPVC untuk pengedapan bunyi yang lebih baik. Bingkai disauh dengan pengikat yang betul mengikut bahan dinding (bata, konkrit atau blok ringan), diletakkan aras dan plumb, kemudian jurang antara bingkai dan dinding ditutup dengan mortar atau busa serta dikedap dengan silikon gred luaran di kedua-dua belah. Cerun tolakan air dan lubang saliran diperiksa supaya air hujan mengalir keluar dan bukan masuk. Setiap tingkap diuji buka-tutup, kunci dan diperiksa kebocoran sebelum serahan.",
      highlights: [
        "Pilihan sistem gelangsar, casement, top-hung atau UPVC mengikut bilik",
        "Bingkai disauh mengikut bahan dinding — bata, konkrit atau blok ringan",
        "Dipasang aras dan plumb supaya daun tingkap bergerak lancar",
        "Pengedapan silikon gred luaran di dalam dan luar bingkai",
        "Lubang saliran dan cerun tolakan air diperiksa sebelum serahan",
      ],
      process: [
        { step: "01", title: "Ukuran & Semakan Bukaan", desc: "Bukaan diukur di beberapa titik dan diperiksa sama ada segi empat, aras dan cukup kukuh untuk pengikat." },
        { step: "02", title: "Pilihan Sistem Tingkap", desc: "Jenis bukaan, profil bingkai, ketebalan kaca dan warna kemasan dipilih mengikut bilik serta pendedahan cuaca." },
        { step: "03", title: "Fabrikasi & Penghantaran", desc: "Tingkap difabrikasi mengikut ukuran tapak, dan tarikh pemasangan disahkan selepas penghantaran." },
        { step: "04", title: "Pemasangan Bingkai", desc: "Bingkai diletakkan aras dan plumb, disauh dengan pengikat sesuai, dan jurang sekeliling ditutup." },
        { step: "05", title: "Kedap & Ujian", desc: "Silikon gred luaran disapu di dalam dan luar, daun diuji buka-tutup serta dikunci, dan ujian air dijalankan." },
      ],
      faqs: [
        { q: "Aluminium atau UPVC — mana lebih sesuai?", a: "Aluminium ringan, tahan cuaca Malaysia dan sesuai untuk kebanyakan rumah teres serta kondominium. UPVC memberi pengedapan bunyi dan haba yang lebih baik, sesuai untuk rumah berhampiran jalan sibuk. Kami mencadangkan pilihan selepas melihat lokasi dan pendedahan tingkap anda." },
        { q: "Perlukah dinding diubah untuk memasang tingkap baharu?", a: "Jika menggunakan bukaan sedia ada, biasanya tidak — kecuali bukaan tidak segi empat atau kaki bukaan rosak. Untuk bukaan baharu, kerja potong dinding dan lintel perlu dinilai kerana ia melibatkan struktur, dan kami akan menyatakannya dengan jelas dalam sebut harga." },
        { q: "Berapa lama masa pemasangan?", a: "Selepas tingkap difabrikasi, pemasangan satu hingga dua tingkap lazimnya siap dalam sehari. Tempoh fabrikasi bergantung pada saiz tempahan dan sistem yang dipilih, dan tarikh disahkan semasa sebut harga." },
        { q: "Berapakah kos pemasangan tingkap?", a: "Kerja ini disebut harga selepas ukuran kerana harga bergantung pada saiz, bilangan panel, sistem bingkai, ketebalan kaca, tingkat unit dan keperluan kerja tampalan dinding." },
      ],
      metaTitle: "Pemasangan Tingkap KL & Selangor | Atas Sebut Harga",
      metaDesc: "Pasang tingkap aluminium atau UPVC di KL & Selangor. Gelangsar, casement dan top-hung, kedap silikon luaran, ujian air. Sebut harga selepas ukuran tapak.",
    },
    zh: {
      name: "窗户安装",
      tagline: "在现有或新开洞口安装铝合金或 UPVC 窗，含防水密封与开关测试。",
      description:
        "窗户装得好不好，在窗到场之前就已经决定了。KL Servis Rumah 会精确测量洞口、检查是否方正水平，并推荐合适的窗型——客厅卧室常用铝合金推拉窗，需要最大通风量时用平开窗，浴室适合上悬窗，临街住宅则可选隔音更好的 UPVC 窗。窗框按墙体材质（砖墙、混凝土或轻质砌块）选用相应固定件，校准水平垂直后固定，框墙缝隙用砂浆或发泡填充，再在内外两侧打上户外级硅胶密封。我们同时检查排水孔与泄水坡度，确保雨水向外排出而不是倒灌进来。每扇窗在交付前都会做开关、上锁与渗漏检查。",
      highlights: [
        "按房间用途选配推拉、平开、上悬或 UPVC 窗系统",
        "根据砖墙、混凝土或轻质砌块选用对应固定件",
        "水平垂直校准安装，窗扇推拉顺畅不卡滞",
        "窗框内外双面打户外级硅胶密封",
        "交付前检查排水孔与泄水坡度",
      ],
      process: [
        { step: "01", title: "量尺检查", desc: "多点测量洞口，检查是否方正水平，以及墙体能否可靠受力固定。" },
        { step: "02", title: "窗型选择", desc: "按房间与朝向确定开启方式、框料型材、玻璃厚度与饰面颜色。" },
        { step: "03", title: "加工送货", desc: "按现场实测尺寸加工窗户，到货后确认安装日期。" },
        { step: "04", title: "安装窗框", desc: "窗框校平校直后用合适固定件锚固，四周缝隙填补密实。" },
        { step: "05", title: "密封测试", desc: "内外打户外级硅胶，测试开关与上锁，并做淋水检查。" },
      ],
      faqs: [
        { q: "铝合金还是 UPVC 更合适？", a: "铝合金轻便、耐受马来西亚气候，适合大多数排屋与公寓。UPVC 的隔音隔热更好，靠近繁忙路段的住宅更适用。我们会先看窗户的位置与外露程度再给建议。" },
        { q: "装新窗需要改动墙体吗？", a: "如果沿用现有洞口，通常不需要，除非洞口不方正或洞口边缘已经损坏。若是新开洞口，则涉及切墙与过梁等结构问题，需要专门评估，我们会在报价中明确说明。" },
        { q: "安装需要多久？", a: "窗户加工完成后，一到两扇窗通常一天内可以装好。加工周期取决于订单数量与所选系统，具体日期会在报价时确认。" },
        { q: "装窗要多少钱？", a: "这项服务在量尺后报价，取决于尺寸、扇数、型材系统、玻璃厚度、楼层高度以及墙面修补工作量。" },
      ],
      metaTitle: "吉隆坡与雪兰莪窗户安装 | 依报价",
      metaDesc: "吉隆坡与雪兰莪铝合金与 UPVC 窗安装。推拉、平开、上悬窗，户外级硅胶密封与淋水测试，量尺后报价。",
    },
  },
  "window-repair/window-replacement": {
    ms: {
      name: "Penggantian Tingkap",
      tagline: "Tanggalkan tingkap lama yang bocor, berkarat atau tersekat dan pasang set tingkap baharu pada bukaan yang sama dengan kemasan penuh.",
      description:
        "Tingkap besi lama yang berkarat, tingkap aluminium yang bingkainya sudah pudar dan bocor, atau tingkap yang daunnya tidak lagi boleh dibuka biasanya lebih berbaloi diganti berbanding dibaiki berulang kali. KL Servis Rumah menanggalkan set tingkap lama dengan kerosakan dinding paling minimum, membersihkan bukaan, membaiki kaki bukaan yang retak atau reput, kemudian memasang set tingkap baharu yang difabrikasi mengikut ukuran sebenar. Kami menguruskan pelupusan bingkai lama dan serpihan kaca dengan selamat. Selepas pemasangan, jurang antara bingkai dan dinding ditutup, dikedap dengan silikon gred luaran, dan permukaan plaster di sekeliling ditampal supaya sedia untuk dicat. Ujian air dijalankan untuk memastikan tiada kebocoran sebelum kerja diserahkan.",
      highlights: [
        "Tingkap lama ditanggalkan dengan kerosakan dinding paling minimum",
        "Kaki bukaan yang retak atau reput dibaiki sebelum pemasangan",
        "Set tingkap baharu difabrikasi mengikut ukuran bukaan sebenar",
        "Pelupusan bingkai lama dan serpihan kaca diuruskan dengan selamat",
        "Tampalan plaster sekeliling disiapkan dan sedia untuk dicat",
      ],
      process: [
        { step: "01", title: "Pemeriksaan & Ukuran", desc: "Kami menyemak keadaan tingkap lama, punca bocor atau karat, dan mengukur bukaan untuk fabrikasi." },
        { step: "02", title: "Sebut Harga & Pilihan", desc: "Sistem tingkap, jenis kaca dan kemasan dicadangkan, berserta skop tampalan dinding dalam sebut harga." },
        { step: "03", title: "Penanggalan", desc: "Tingkap lama ditanggalkan dengan berhati-hati, kaca lama dibungkus dan bukaan dibersihkan sepenuhnya." },
        { step: "04", title: "Pemasangan Baharu", desc: "Bingkai baharu dipasang aras dan plumb, disauh dan jurang sekeliling ditutup dengan mortar atau busa." },
        { step: "05", title: "Kedap, Tampal & Uji", desc: "Silikon luaran disapu, plaster ditampal, tingkap diuji operasi dan ujian air dijalankan sebelum serahan." },
      ],
      faqs: [
        { q: "Bila tingkap patut diganti dan bukan dibaiki?", a: "Apabila bingkai sudah berkarat teruk atau berlubang, apabila air masuk walaupun selepas kerja pengedapan berulang, apabila alur trek sudah haus sehingga daun tidak boleh dijajarkan, atau apabila alat ganti untuk sistem lama itu sudah tidak dikeluarkan lagi." },
        { q: "Adakah dinding akan rosak semasa menukar tingkap?", a: "Sedikit plaster di sekeliling bukaan biasanya terjejas semasa penanggalan. Kami mengehadkan kerosakan tersebut dan menampal semula plaster sebagai sebahagian daripada kerja, meninggalkan permukaan yang sedia untuk dicat." },
        { q: "Bolehkah saiz tingkap dikekalkan?", a: "Ya, kaedah biasa ialah memfabrikasi set baharu mengikut bukaan sedia ada supaya tiada kerja struktur diperlukan. Jika anda mahu bukaan lebih besar, ia melibatkan kerja potong dinding dan lintel yang perlu dinilai berasingan." },
        { q: "Berapakah kos menukar tingkap?", a: "Kos disebut harga selepas ukuran kerana ia bergantung pada saiz dan bilangan tingkap, sistem bingkai, jenis kaca, tingkat unit, kesukaran penanggalan serta skop tampalan dinding." },
      ],
      metaTitle: "Penggantian Tingkap KL & Selangor | Atas Sebut Harga",
      metaDesc: "Ganti tingkap besi berkarat atau aluminium bocor di KL & Selangor. Penanggalan selamat, set baharu ikut ukuran, tampalan plaster dan ujian air.",
    },
    zh: {
      name: "窗户更换",
      tagline: "拆除渗水、锈蚀或卡死的旧窗，在原洞口安装全新窗户并完成周边收口。",
      description:
        "锈穿的老式铁窗、框料老化渗水的铝窗，或是已经推不动的窗扇，往往换新比反复维修更划算。KL Servis Rumah 会以最小的墙面损伤拆下旧窗，清理洞口，修补开裂或酥松的洞口边缘，再按实测尺寸安装全新窗户。旧窗框与碎玻璃由我们安全清运。安装完成后，框墙缝隙填补密实、内外打户外级硅胶密封，周边批荡一并修补至可直接上漆的状态，并进行淋水测试确认无渗漏后交付。",
      highlights: [
        "以最小墙面损伤拆除旧窗",
        "安装前先修补开裂或酥松的洞口边缘",
        "新窗按实测洞口尺寸加工制作",
      ...
      process: [
        { step: "01", title: "检查量尺", desc: "查看旧窗状况与渗水、锈蚀原因，并测量洞口尺寸用于加工。" },
        { step: "02", title: "报价选型", desc: "推荐窗系统、玻璃类型与饰面，并在报价中列明墙面修补范围。" },
        { step: "03", title: "拆除旧窗", desc: "小心拆除旧窗，包裹旧玻璃并彻底清理洞口。" },
        { step: "04", title: "安装新窗", desc: "新框校平校直后锚固，四周缝隙以砂浆或发泡填补密实。" },
        { step: "05", title: "密封收尾", desc: "打户外硅胶、修补批荡，测试开关并做淋水检查后交付。" },
      ],
      faqs: [
        { q: "什么时候该换窗而不是修窗？", a: "当框料已经严重锈蚀甚至穿孔、反复打胶后仍然渗水、轨道磨损到窗扇无法校正，或者旧系统的配件早已停产买不到时，换新窗更值得。" },
        { q: "换窗会把墙弄坏吗？", a: "拆除时洞口周边通常会有少量批荡受损。我们会尽量控制破损范围，并把批荡修补列入施工内容，交付时留下可直接上漆的表面。" },
        { q: "可以保持原来的窗户尺寸吗？", a: "可以，常规做法就是按现有洞口加工新窗，这样不涉及结构改动。如果想扩大洞口，就要切墙并处理过梁，属于结构工程，需要另行评估。" },
        { q: "换窗要多少钱？", a: "费用在量尺后报价，取决于窗户尺寸与数量、型材系统、玻璃类型、楼层高度、拆除难度以及墙面修补范围。" },
      ],
      metaTitle: "吉隆坡与雪兰莪窗户更换 | 依报价",
      metaDesc: "吉隆坡与雪兰莪旧铁窗、渗水铝窗更换。安全拆除、按尺寸定制新窗、批荡修补与淋水测试，量尺后报价。",
    },
  },
  "window-repair/window-grille-installation": {
    ms: {
      name: "Pemasangan Grill Tingkap",
      tagline: "Grill tingkap besi tempa atau aluminium yang difabrikasi mengikut ukuran, dipasang dengan pengikat kukuh dan kemasan kalis karat.",
      description:
        "Grill tingkap memberi lapisan keselamatan tambahan tanpa menghalang pengudaraan, dan di kebanyakan rumah teres serta unit tingkat bawah ia menjadi keperluan asas. KL Servis Rumah memfabrikasi grill mengikut ukuran bukaan sebenar dalam pilihan besi hollow, besi tempa dengan corak, atau aluminium untuk kawasan yang lebih terdedah kepada hujan. Setiap grill dipasang dengan pengikat yang mencengkam struktur bata atau konkrit — bukan hanya plaster — supaya ia benar-benar berfungsi sebagai penghalang. Untuk bilik tidur, kami boleh memasang panel grill boleh buka dengan mangga sebagai laluan keluar kecemasan. Kemasan merangkumi lapisan primer kalis karat dan cat akhir, dengan pilihan warna mengikut kemasan rumah anda. Sambungan kimpalan dicanai licin supaya tiada tepi tajam.",
      highlights: [
        "Difabrikasi mengikut ukuran bukaan sebenar, termasuk bukaan bukan standard",
        "Pilihan besi hollow, besi tempa berukir atau aluminium kalis karat",
        "Pengikat mencengkam struktur bata atau konkrit, bukan sekadar plaster",
        "Panel boleh buka dengan mangga untuk laluan keluar kecemasan bilik tidur",
        "Primer kalis karat, cat akhir dan kimpalan dicanai licin tanpa tepi tajam",
      ],
      process: [
        { step: "01", title: "Ukuran & Reka Bentuk", desc: "Bukaan diukur dan corak grill, jarak bar serta warna kemasan dipilih bersama anda." },
        { step: "02", title: "Fabrikasi", desc: "Grill dipotong, dikimpal dan dicanai di bengkel mengikut ukuran tapak sebelum disapu primer." },
        { step: "03", title: "Persediaan Tapak", desc: "Kedudukan pengikat ditanda dan kekuatan dinding disemak supaya angkur mencengkam struktur." },
        { step: "04", title: "Pemasangan", desc: "Grill dipasang aras, disauh dengan angkur yang sesuai dan panel boleh buka diuji operasinya." },
        { step: "05", title: "Kemasan Akhir", desc: "Sentuhan cat pada titik pemasangan, pemeriksaan tepi tajam dan pembersihan kawasan kerja." },
      ],
      faqs: [
        { q: "Grill besi atau aluminium yang lebih baik?", a: "Besi lebih kukuh dan lebih sesuai sebagai penghalang keselamatan, tetapi memerlukan penyelenggaraan cat berkala. Aluminium tidak berkarat dan sesuai untuk kawasan yang sangat terdedah kepada hujan, walaupun ia kurang kukuh berbanding besi pada saiz yang sama." },
        { q: "Bolehkah grill dibuka semasa kecemasan?", a: "Ya. Untuk bilik tidur kami mengesyorkan sekurang-kurangnya satu panel boleh buka dengan mangga di dalam, supaya penghuni boleh keluar semasa kebakaran. Susun atur ini dibincangkan semasa lawatan ukuran." },
        { q: "Adakah grill boleh dipasang di kondominium?", a: "Kebanyakan pengurusan kondominium membenarkan grill dalaman tetapi mempunyai garis panduan reka bentuk dan warna. Sila sahkan dengan pihak pengurusan terlebih dahulu; kami memfabrikasi mengikut spesifikasi yang diluluskan." },
        { q: "Berapakah harga grill tingkap?", a: "Grill disebut harga selepas ukuran kerana harga bergantung pada keluasan, jenis bahan, ketebalan profil, kerumitan corak, bilangan panel boleh buka dan kemasan cat yang dipilih." },
      ],
      metaTitle: "Pemasangan Grill Tingkap KL & Selangor | Sebut Harga",
      metaDesc: "Grill tingkap besi dan aluminium ikut ukuran di KL & Selangor. Angkur ke struktur, panel keluar kecemasan, primer kalis karat dan cat akhir.",
    },
    zh: {
      name: "窗户防盗格栅安装",
      tagline: "按尺寸定制的铁艺或铝合金窗格栅，牢固锚固安装并做防锈涂装收尾。",
      description:
        "窗格栅能在不影响通风的前提下增加一层安全防护，对排屋和低楼层单位来说几乎是标配。KL Servis Rumah 按实际洞口尺寸定制格栅，可选方通铁材、带花式的铁艺，或更耐雨淋的铝合金材质。每套格栅都用能咬合砖墙或混凝土结构的固定件锚固——而不是只钉在批荡层上——这样才真正起到防护作用。卧室位置可加装带内锁的可开启逃生扇，作为紧急疏散通道。表面处理包含防锈底漆与面漆，颜色可配合住宅整体风格；所有焊点打磨平顺，不留尖锐毛边。",
      highlights: [
        "按实际洞口定制，非标准尺寸同样可做",
        "可选方通铁材、花式铁艺或防锈铝合金",
        "固定件锚入砖墙或混凝土结构，而非仅固定在批荡层",
        "卧室可加装带内锁的可开启逃生扇",
        "防锈底漆加面漆，焊点打磨平顺无尖角",
      ],
      process: [
        { step: "01", title: "量尺设计", desc: "测量洞口，并与您确定格栅花式、栏杆间距与涂装颜色。" },
        { step: "02", title: "工厂加工", desc: "按现场尺寸下料、焊接、打磨，并在出厂前完成底漆处理。" },
        { step: "03", title: "现场准备", desc: "标定固定点位置，检查墙体强度，确保膨胀件能锚入结构层。" },
        { step: "04", title: "安装固定", desc: "格栅校平后用合适锚固件固定，并测试可开启扇的启闭。" },
        { step: "05", title: "涂装收尾", desc: "补涂固定点漆面，检查有无尖锐边角，并清理施工区域。" },
      ],
      faqs: [
        { q: "铁艺格栅和铝合金哪个更好？", a: "铁材强度更高，作为安全防护更可靠，但需要定期补漆维护。铝合金不会生锈，适合特别容易淋雨的位置，只是同等尺寸下强度不如铁材。" },
        { q: "紧急情况下格栅能打开吗？", a: "可以。卧室我们建议至少设置一扇带内侧挂锁的可开启扇，火灾时住户能够从窗口撤离。具体布置会在量尺时一起商定。" },
        { q: "公寓可以安装窗格栅吗？", a: "多数公寓管理处允许安装内侧格栅，但对样式和颜色有规定。请先与管理处确认，我们会按获批的规格加工制作。" },
        { q: "窗格栅多少钱？", a: "格栅在量尺后报价，价格取决于面积、材质、型材壁厚、花式复杂度、可开启扇数量以及所选涂装方式。" },
      ],
      metaTitle: "吉隆坡窗户防盗格栅安装 | 依报价",
      metaDesc: "吉隆坡与雪兰莪定制铁艺与铝合金窗格栅。锚入结构固定、逃生开启扇、防锈底漆与面漆，量尺后报价。",
    },
  },
  "window-repair/window-frame-repair-and-realignment": {
    ms: {
      name: "Pembaikan & Penjajaran Semula Bingkai Tingkap",
      tagline: "Betulkan bingkai tingkap yang senget, longgar atau tercabut daripada dinding supaya daun tingkap kembali rapat dan mudah dibuka.",
      description:
        "Bingkai tingkap yang bergerak atau senget menyebabkan daun tingkap menggesel, tidak mengunci rapat dan membenarkan air serta angin masuk. Punca biasa termasuk angkur bingkai yang longgar, mortar sekeliling yang retak, kaki bingkai yang berkarat, atau pergerakan bangunan yang menyebabkan bukaan tidak lagi segi empat. KL Servis Rumah memeriksa kelurusan bingkai dengan aras dan pengukur jurang, mengenal pasti punca sebenar, dan kemudian membaiki: angkur baharu dipasang ke dalam struktur, jurang di antara bingkai dan dinding dipacak semula dengan mortar atau busa struktur, kaki bingkai yang berkarat dibaiki atau digantikan bahagiannya, dan bingkai ditegakkan semula dengan shim yang betul. Selepas penjajaran, engsel, penahan dan kunci dilaras semula, dan pengedapan luaran diperbaharui supaya tingkap kembali kalis air.",
      highlights: [
        "Kelurusan diperiksa dengan aras dan pengukur jurang sebelum kerja bermula",
        "Angkur baharu dipasang ke dalam struktur bata atau konkrit",
        "Jurang bingkai ke dinding dipacak semula dan dikedap semula",
        "Shim digunakan untuk menegakkan bingkai tanpa memaksa daun tingkap",
        "Engsel, penahan dan kunci dilaras semula selepas penjajaran",
      ],
      process: [
        { step: "01", title: "Diagnosis Kelurusan", desc: "Kami mengukur jurang di setiap sudut dan menyemak aras serta plumb untuk mengenal pasti arah kesenget." },
        { step: "02", title: "Cari Punca", desc: "Angkur longgar, mortar retak, karat pada kaki bingkai atau pergerakan bukaan dikenal pasti sebelum pembaikan." },
        { step: "03", title: "Pengukuhan Semula", desc: "Angkur baharu dipasang, shim diletakkan dan bingkai ditegakkan semula ke kedudukan yang betul." },
        { step: "04", title: "Tampalan & Pengedapan", desc: "Jurang dipacak dengan mortar atau busa struktur, kemudian dikedap semula dengan silikon gred luaran." },
        { step: "05", title: "Pelarasan Daun", desc: "Engsel, roller, penahan dan kunci dilaras sehingga daun menutup rapat dan mudah dikendalikan." },
      ],
      faqs: [
        { q: "Kenapa tingkap saya susah ditutup sejak kebelakangan ini?", a: "Selalunya kerana bingkai sudah tidak segi empat — angkur longgar, mortar sekeliling retak atau kaki bingkai berkarat dan mendap. Apabila bingkai bergerak walaupun beberapa milimeter, daun tingkap tidak lagi sepadan dengan kedudukan penahan dan kuncinya." },
        { q: "Boleh bingkai dibaiki tanpa ditukar?", a: "Dalam banyak kes ya. Jika profil bingkai masih kukuh dan hanya pengikat atau mortar yang gagal, penjajaran semula dan pengukuhan sudah memadai. Jika bingkai sudah berkarat teruk atau berlubang, penggantian penuh lebih berbaloi." },
        { q: "Adakah kerja ini menyelesaikan masalah bocor?", a: "Ia menyelesaikan kebocoran yang berpunca daripada jurang bingkai dan pengedapan yang gagal. Jika air masuk melalui retakan dinding atau bahagian atas bukaan, kerja pengedapan tambahan atau kerja kalis air mungkin diperlukan dan akan dinyatakan selepas pemeriksaan." },
        { q: "Berapakah kos pembaikan bingkai tingkap?", a: "Kos disebut harga selepas pemeriksaan kerana ia bergantung pada tahap kesenget, bilangan tingkap, keperluan angkur dan tampalan, tingkat unit serta sama ada pengedapan luaran perlu diperbaharui sepenuhnya." },
      ],
      metaTitle: "Pembaikan Bingkai Tingkap Senget KL | Atas Sebut Harga",
      metaDesc: "Jajarkan semula bingkai tingkap senget dan longgar di KL & Selangor. Angkur baharu, tampalan mortar, pengedapan semula dan pelarasan daun tingkap.",
    },
    zh: {
      name: "窗框维修与校正",
      tagline: "校正歪斜、松动或与墙体脱开的窗框，让窗扇重新关严、推拉顺畅。",
      description:
        "窗框一旦松动或走形，窗扇就会刮框、关不严，风和雨水也会从缝隙灌入。常见原因包括固定膨胀件松脱、周边砂浆开裂、框脚锈蚀，或建筑轻微沉降导致洞口不再方正。KL Servis Rumah 会用水平尺与缝隙量具检查窗框的垂直与水平度，找出真正原因后再施工：重新植入锚固件到结构层、用砂浆或结构发泡重新填塞框墙缝隙、修复或局部更换锈蚀的框脚，并用垫片把窗框重新扶正。校正完成后，再复调铰链、限位与锁点，并重做外侧密封，让窗户恢复防水性能。",
      highlights: [
        "施工前先用水平尺与缝隙量具检测框体走形方向",
        "重新植入锚固件，咬合砖墙或混凝土结构",
        "框墙缝隙重新填塞并重做密封",
        "使用垫片扶正窗框，不靠强行掰动窗扇",
        "校正后复调铰链、限位与锁点",
      ...
      process: [
        { step: "01", title: "走形诊断", desc: "测量四角缝隙并检查水平与垂直度，判断窗框歪斜的方向和程度。" },
        { step: "02", title: "查找原因", desc: "确认是锚固松脱、砂浆开裂、框脚锈蚀还是洞口位移，再决定做法。" },
        { step: "03", title: "重新加固", desc: "植入新锚固件、垫入垫片，把窗框扶正到正确位置。" },
        { step: "04", title: "填补密封", desc: "以砂浆或结构发泡填实缝隙，再用户外级硅胶重新密封。" },
        { step: "05", title: "窗扇调校", desc: "调整铰链、滑轮、限位与锁点，直到窗扇关严且操作顺畅。" },
      ],
      faqs: [
        { q: "为什么窗户最近越来越难关上？", a: "多半是窗框已经不方正了——固定件松动、周边砂浆开裂，或框脚锈蚀下沉。窗框哪怕只位移几毫米，窗扇也会和限位、锁点对不上位。" },
        { q: "窗框能只修不换吗？", a: "很多情况下可以。只要框体型材本身还结实，问题出在固定件或砂浆失效，重新校正加固就够了。但如果框料已经严重锈蚀甚至穿孔，整体更换更划算。" },
        { q: "做完这项维修能解决渗水吗？", a: "由框缝和密封失效引起的渗水可以解决。如果水是从墙体裂缝或洞口上方进来的，可能还需要额外的密封或防水处理，我们会在检查后说明。" },
        { q: "窗框维修多少钱？", a: "费用在检查后报价，取决于走形程度、窗户数量、锚固与填补工作量、楼层高度，以及外侧密封是否需要整体重做。" },
      ],
      metaTitle: "吉隆坡窗框歪斜维修校正 | 依报价",
      metaDesc: "吉隆坡与雪兰莪窗框松动歪斜校正。重新锚固、砂浆填补、外侧重做密封与窗扇调校，检查后报价。",
    },
  },
  "window-repair/louvre-and-top-hung-window-repair": {
    ms: {
      name: "Pembaikan Tingkap Louvre & Top-Hung",
      tagline: "Baiki bilah louvre yang longgar, klip pemegang patah, mekanisme engkol tersekat dan engsel top-hung yang berkarat.",
      description:
        "Tingkap louvre dan top-hung banyak digunakan di bilik air, dapur dan tangga kerana ia memberi pengudaraan tanpa memerlukan ruang bukaan besar. Masalah yang paling kerap ialah klip pemegang bilah kaca yang rapuh dan patah, bilah louvre yang longgar atau tidak lagi menutup rapat, mekanisme engkol yang tersekat kerana kotoran dan karat, serta engsel gunting top-hung yang berkarat sehingga daun tergantung senget. KL Servis Rumah membuka mekanisme, membersihkan trek dan pin, menggantikan klip louvre, bilah kaca yang pecah, engkol dan engsel gunting dengan komponen yang setara, kemudian melincirkan dan melaraskan semula supaya semua bilah bergerak serentak dan menutup rapat. Jika bahagian bingkai berkarat, kami merawat karat dan menyapu lapisan pelindung sebelum pemasangan semula.",
      highlights: [
        "Klip pemegang bilah louvre yang patah atau rapuh diganti",
        "Bilah kaca louvre yang pecah atau hilang dibekalkan mengikut saiz",
        "Mekanisme engkol dibuka, dibersihkan, dilincirkan atau digantikan",
        "Engsel gunting top-hung berkarat diganti supaya daun tidak senget",
        "Bahagian bingkai berkarat dirawat sebelum pemasangan semula",
      ],
      process: [
        { step: "01", title: "Pemeriksaan", desc: "Kami mengendalikan setiap bilah dan engkol untuk mengenal pasti komponen yang patah, haus atau berkarat." },
        { step: "02", title: "Padanan Alat Ganti", desc: "Klip, bilah kaca, engkol atau engsel gunting dipadankan mengikut sistem dan saiz sedia ada." },
        { step: "03", title: "Pembukaan & Pembersihan", desc: "Mekanisme dibuka, kotoran dan karat dibersihkan, dan pin serta trek diperiksa keadaannya." },
        { step: "04", title: "Penggantian Komponen", desc: "Komponen rosak diganti, bahagian berkarat dirawat dan mekanisme dipasang semula dengan pengikat yang betul." },
        { step: "05", title: "Pelarasan & Ujian", desc: "Bilah dilaras supaya bergerak serentak dan menutup rapat, kemudian diuji buka-tutup beberapa kali." },
      ],
      faqs: [
        { q: "Bilah louvre saya pecah — boleh diganti satu sahaja?", a: "Boleh. Bilah kaca louvre dipotong mengikut lebar dan ketebalan sistem sedia ada, jadi bilah yang pecah boleh diganti satu per satu tanpa menukar keseluruhan tingkap, selagi klip pemegangnya masih elok atau boleh diganti." },
        { q: "Kenapa engkol tingkap saya tersekat?", a: "Punca biasa ialah gris kering bercampur habuk, karat pada gear, atau lengan pembuka yang bengkok. Kami membuka mekanisme, membersihkan dan melincirkannya semula; jika gear sudah haus atau tergelincir, engkol diganti dengan unit setara." },
        { q: "Adakah tingkap louvre boleh menjadi kedap sepenuhnya?", a: "Tingkap louvre direka untuk pengudaraan, jadi ia tidak sekedap tingkap casement walaupun selepas dibaiki. Selepas klip dan pelarasan dibetulkan, bilah menutup jauh lebih rapat dan tempias hujan berkurangan dengan ketara." },
        { q: "Berapakah kos pembaikan tingkap louvre?", a: "Kos disebut harga selepas pemeriksaan kerana ia bergantung pada bilangan bilah dan klip yang perlu diganti, sama ada engkol atau engsel gunting perlu ditukar, dan tahap karat pada bingkai." },
      ],
      metaTitle: "Pembaikan Tingkap Louvre & Top-Hung KL | Sebut Harga",
      metaDesc: "Baiki tingkap louvre dan top-hung di KL & Selangor. Klip bilah, kaca louvre, engkol tersekat dan engsel gunting berkarat diganti serta dilaras.",
    },
    zh: {
      name: "百叶窗与上悬窗维修",
      tagline: "维修松脱的百叶片、断裂的夹片、卡死的摇杆机构与锈蚀的上悬窗剪式铰链。",
      description:
        "百叶窗与上悬窗常用于浴室、厨房和楼梯间，不占开启空间又能保证通风。最常见的故障是玻璃片夹扣老化断裂、百叶片松动关不严、摇杆机构因积垢生锈而卡死，以及上悬窗剪式铰链锈蚀导致窗扇下垂歪斜。KL Servis Rumah 会拆开机构、清理轨道与转轴，更换百叶夹片、破损玻璃片、摇杆与剪式铰链等同规格配件，再润滑并重新调校，让所有叶片同步开合、关闭严实。若框体已有锈蚀，会先做除锈处理并涂刷保护涂层，然后再复装。",
      highlights: [
        "更换断裂或老化的百叶片夹扣",
        "按尺寸补配破损或缺失的百叶玻璃片",
        "摇杆机构拆解清洁、润滑或整体更换",
      ...
      process: [
        { step: "01", title: "现场检查", desc: "逐片操作叶片与摇杆，找出断裂、磨损或锈蚀的具体部件。" },
        { step: "02", title: "配件匹配", desc: "按现有系统与尺寸匹配夹片、玻璃片、摇杆或剪式铰链。" },
        { step: "03", title: "拆解清洁", desc: "拆开机构，清除积垢与锈迹，检查转轴与滑道状况。" },
        { step: "04", title: "更换部件", desc: "更换损坏件，处理锈蚀部位，用合适紧固件重新组装机构。" },
        { step: "05", title: "调校测试", desc: "调整叶片使其同步开合、关闭严实，并反复测试启闭动作。" },
      ],
      faqs: [
        { q: "百叶片碎了可以只换一片吗？", a: "可以。百叶玻璃片按现有系统的宽度与厚度裁切，只要夹扣完好或可以更换，就能单片补配，不必整扇窗更换。" },
        { q: "窗户摇杆为什么会卡住？", a: "常见原因是润滑脂干结混入灰尘、齿轮锈蚀，或开启臂变形。我们会拆开机构清洁并重新润滑；如果齿轮已经磨损打滑，就更换同规格摇杆。" },
        { q: "百叶窗修好后能完全密封吗？", a: "百叶窗本身是为通风设计的，即使修好也达不到平开窗的密封程度。但更换夹片并重新调校后，叶片会关得严实很多，飘雨情况会明显改善。" },
        { q: "百叶窗维修多少钱？", a: "费用在检查后报价，取决于需要更换的叶片与夹扣数量、是否更换摇杆或剪式铰链，以及框体锈蚀的严重程度。" },
      ],
      metaTitle: "吉隆坡百叶窗与上悬窗维修 | 依报价",
      metaDesc: "吉隆坡与雪兰莪百叶窗、上悬窗维修。更换夹片、玻璃片、卡死摇杆与锈蚀剪式铰链并重新调校，检查后报价。",
    },
  },
  "window-repair/window-waterproofing-and-resealing": {
    ms: {
      name: "Kalis Air & Pengedapan Semula Tingkap",
      tagline: "Buang silikon lama yang gagal, bersihkan sambungan dan kedap semula perimeter tingkap dengan sealant gred luaran untuk menghentikan bocor hujan.",
      description:
        "Kebocoran tingkap semasa hujan lebat biasanya bukan berpunca daripada kaca, tetapi daripada sambungan perimeter antara bingkai dan dinding, lubang saliran yang tersumbat, atau silikon lama yang sudah mengeras, mengecut dan tertanggal. KL Servis Rumah menjalankan pemeriksaan bermula dari luar — memeriksa perimeter bingkai, retakan pada plaster di atas bukaan, keadaan sill dan cerun tolakan air — dan boleh menjalankan ujian air terkawal untuk mengesahkan laluan masuk sebenar. Kerja pembaikan merangkumi pembuangan penuh silikon lama, pembersihan sambungan sehingga permukaan bersih dan kering, pemasangan backer rod untuk sambungan yang lebar, dan penggunaan sealant gred luaran yang sesuai untuk aluminium serta konkrit. Lubang saliran dibersihkan supaya air dalam trek dapat mengalir keluar. Selepas pengedapan sembuh, ujian air ulangan dijalankan untuk pengesahan.",
      highlights: [
        "Pemeriksaan luaran perimeter, sill, plaster atas dan cerun tolakan air",
        "Ujian air terkawal untuk mengesahkan laluan masuk sebenar",
        "Silikon lama dibuang sepenuhnya, bukan sekadar ditindih lapisan baharu",
        "Backer rod dipasang pada sambungan lebar sebelum sealant disapu",
        "Lubang saliran trek dibersihkan supaya air mengalir keluar",
      ],
      process: [
        { step: "01", title: "Pemeriksaan Bocor", desc: "Kami memeriksa perimeter bingkai, sill, retakan plaster dan lubang saliran untuk mengesan punca kemasukan air." },
        { step: "02", title: "Ujian Air", desc: "Ujian air terkawal dijalankan bahagian demi bahagian untuk mengesahkan laluan sebenar sebelum kerja bermula." },
        { step: "03", title: "Pembuangan & Pembersihan", desc: "Silikon lama dipotong dan dibuang sepenuhnya, sambungan dibersihkan dan dibiarkan kering." },
        { step: "04", title: "Pengedapan Semula", desc: "Backer rod dipasang jika perlu, kemudian sealant gred luaran disapu dan ditekan supaya melekat sepenuhnya." },
        { step: "05", title: "Saliran & Pengesahan", desc: "Lubang saliran dibersihkan dan selepas sealant sembuh, ujian air ulangan dijalankan untuk pengesahan." },
      ],
      faqs: [
        { q: "Kenapa tingkap saya bocor walaupun kaca tidak retak?", a: "Air biasanya masuk melalui sambungan perimeter yang silikonnya sudah gagal, melalui retakan plaster di atas bukaan, atau melalui trek yang lubang salirannya tersumbat sehingga air bertakung dan melimpah ke dalam." },
        { q: "Bolehkah silikon baharu disapu atas silikon lama?", a: "Kami tidak mengesyorkannya. Sealant baharu tidak melekat dengan baik pada silikon lama yang sudah teroksida, dan sambungan itu akan gagal semula dalam masa singkat. Pembuangan penuh dan pembersihan memberikan lekatan yang jauh lebih tahan lama." },
        { q: "Berapa lama sealant baharu perlu sembuh?", a: "Kebanyakan sealant gred luaran membentuk kulit dalam beberapa jam dan sembuh sepenuhnya dalam beberapa hari bergantung pada kelembapan. Kami menasihatkan supaya kawasan itu tidak dibasuh dengan kuat sehingga tempoh sembuh selesai." },
        { q: "Berapakah kos kerja pengedapan semula tingkap?", a: "Kos disebut harga selepas pemeriksaan kerana ia bergantung pada jumlah panjang sambungan, bilangan tingkap, tingkat unit, keperluan akses luaran dan sama ada tampalan retakan turut diperlukan." },
      ],
      metaTitle: "Pengedapan Semula & Kalis Air Tingkap KL | Sebut Harga",
      metaDesc: "Hentikan bocor tingkap di KL & Selangor. Buang silikon lama, kedap semula dengan sealant gred luaran, bersihkan lubang saliran dan uji air.",
    },
    zh: {
      name: "窗户防水与重新打胶",
      tagline: "清除失效旧胶、清洁缝口，用户外级密封胶重做窗框周边密封，止住雨天渗漏。",
      description:
        "大雨天窗户渗水，问题通常不在玻璃，而在窗框与墙体之间的周边缝、被堵住的排水孔，或是已经硬化、收缩、脱开的旧硅胶。KL Servis Rumah 会从外侧开始检查——窗框周边缝、洞口上方批荡裂缝、窗台状况与泄水坡度——必要时做控制性淋水测试，确认水真正的进入路径。施工内容包括彻底铲除旧胶、把缝口清理干净并晾干、较宽缝隙先塞入泡沫背衬棒，再选用适合铝材与混凝土基面的户外级密封胶施打。同时疏通排水孔，让轨道内积水能排出。密封胶固化后再做一次淋水复测确认效果。",
      highlights: [
        "外侧检查周边缝、窗台、上方批荡裂缝与泄水坡度",
        "做控制性淋水测试，确认真实渗水路径",
        "彻底铲除旧胶，而不是直接在旧胶上覆盖新胶",
        "较宽缝隙先填泡沫背衬棒再打胶",
        "疏通轨道排水孔，确保积水能顺利排出",
      ],
      process: [
        { step: "01", title: "渗漏检查", desc: "检查窗框周边、窗台、批荡裂缝与排水孔，判断进水位置。" },
        { step: "02", title: "淋水测试", desc: "分区做控制性淋水，在施工前确认真实的渗水路径。" },
        { step: "03", title: "铲除清洁", desc: "切除并彻底铲净旧胶，清理缝口并让基面干透。" },
        { step: "04", title: "重新打胶", desc: "需要时先塞背衬棒，再施打户外级密封胶并压实，确保满粘。" },
        { step: "05", title: "排水复测", desc: "疏通排水孔，待胶体固化后再做一次淋水测试确认。" },
      ],
      faqs: [
        { q: "玻璃没裂，窗户为什么还是漏水？", a: "水通常是从密封失效的周边缝进来的，也可能来自洞口上方的批荡裂缝，或者排水孔堵塞导致轨道积水后倒灌入室内。" },
        { q: "可以直接在旧胶上补打新胶吗？", a: "不建议。新胶很难牢固粘接在已经氧化的旧胶表面，这样处理过不了多久又会开裂脱开。彻底铲除并清洁基面，粘接效果和耐久性都好得多。" },
        { q: "新打的密封胶要多久才固化？", a: "多数户外级密封胶几小时表干，视湿度需要数天完全固化。固化期间建议不要用水强力冲洗该区域。" },
        { q: "窗户重新打胶要多少钱？", a: "费用在检查后报价，取决于缝口总长度、窗户数量、楼层高度、外侧作业方式，以及是否需要同时修补裂缝。" },
      ],
      metaTitle: "吉隆坡窗户防水与重新打胶 | 依报价",
      metaDesc: "吉隆坡与雪兰莪窗户渗水处理。铲除旧胶、户外级密封胶重打、疏通排水孔并做淋水测试，检查后报价。",
    },
  },
  ...
  "glass-aluminium/glass-partition": {
    ms: {
      name: "Partition Kaca",
      tagline: "Partition kaca tempered untuk rumah dan pejabat — pembahagi ruang, dinding kaca dapur dan bilik kerja, dengan pilihan bingkai atau frameless.",
      description:
        "Partition kaca membahagikan ruang tanpa menghalang cahaya, dan ia menjadi pilihan popular untuk memisahkan dapur basah dan kering, membina bilik kerja di rumah, atau menutup ruang tangga di rumah teres. KL Servis Rumah membekal dan memasang partition kaca tempered 10mm dan 12mm dalam konfigurasi frameless, bingkai aluminium nipis, atau bingkai hitam bergaya industrial. Pilihan kaca merangkumi kaca jernih, kaca frosted untuk privasi, dan kaca tinted. Pemasangan bermula dengan ukuran laser bagi memastikan garis lantai dan siling diambil kira, kerana rumah lama jarang benar-benar aras. Kaca tempered dipesan mengikut ukuran akhir, dengan semua lubang engsel dan pemegang dibuat sebelum proses tempering. Pemasangan menggunakan channel U atau spigot yang disauh pada struktur, dengan pengedapan silikon struktur di sambungan.",
      highlights: [
        "Kaca tempered 10mm atau 12mm mengikut ketinggian dan konfigurasi panel",
        "Pilihan frameless, bingkai aluminium nipis atau bingkai hitam industrial",
        "Kaca jernih, frosted untuk privasi atau tinted mengikut keperluan ruang",
        "Ukuran laser mengambil kira lantai dan siling yang tidak sepenuhnya aras",
        "Channel U atau spigot disauh pada struktur dengan pengedapan silikon",
      ],
      process: [
        { step: "01", title: "Lawatan & Ukuran", desc: "Kami mengukur ruang dengan laser, menyemak aras lantai dan siling serta lokasi struktur untuk pengikat." },
        { step: "02", title: "Reka Bentuk Panel", desc: "Susunan panel, kedudukan pintu, jenis kaca dan kemasan bingkai disahkan dalam lukisan ringkas." },
        { step: "03", title: "Tempahan Kaca", desc: "Kaca dipotong, lubang engsel dan pemegang dibuat, kemudian panel di-temper sebelum dihantar ke tapak." },
        { step: "04", title: "Pemasangan", desc: "Channel atau spigot disauh pada struktur, panel dinaikkan dengan alat sedutan dan dilaras aras serta plumb." },
        { step: "05", title: "Kedap & Pembersihan", desc: "Sambungan dikedap dengan silikon struktur, perkakasan dilaras dan kaca dibersihkan sebelum serahan." },
      ],
      faqs: [
        { q: "Kaca tempered 10mm atau 12mm yang perlu saya pilih?", a: "Kaca 10mm memadai untuk kebanyakan partition dalaman setinggi bilik biasa. Kaca 12mm digunakan untuk panel yang lebih tinggi, panel lebar tanpa sokongan tengah, atau apabila pintu kaca frameless disertakan. Kami mencadangkan ketebalan selepas mengukur ruang anda." },
        { q: "Bolehkah partition kaca menghalang bunyi dapur?", a: "Partition kaca tempered dengan pengedapan yang baik mengurangkan bunyi dan bau masakan dengan ketara berbanding ruang terbuka, tetapi ia bukan pengedapan bunyi mutlak. Untuk pengurangan bunyi yang lebih tinggi, kaca laminated berlapis adalah pilihan yang lebih baik." },
        { q: "Berapa lama masa dari ukuran ke pemasangan?", a: "Kaca tempered tidak boleh dipotong selepas proses tempering, jadi ia difabrikasi mengikut ukuran akhir. Tempoh fabrikasi bergantung pada saiz tempahan dan jenis kaca, dan tarikh pemasangan disahkan semasa sebut harga." },
        { q: "Berapakah harga partition kaca?", a: "Partition disebut harga selepas ukuran kerana harga bergantung pada keluasan kaca, ketebalan, jenis kaca, bilangan pintu, perkakasan pilihan, kemasan bingkai dan akses ke lokasi pemasangan." },
      ],
      metaTitle: "Partition Kaca Rumah & Pejabat KL | Atas Sebut Harga",
      metaDesc: "Partition kaca tempered 10mm & 12mm di KL & Selangor. Frameless atau bingkai aluminium, kaca jernih, frosted atau tinted. Jaminan kedap 12 bulan.",
    },
    zh: {
      name: "玻璃隔断",
      tagline: "适用于住宅与办公室的钢化玻璃隔断——空间分隔、厨房与书房玻璃墙，可选带框或无框。",
      description:
        "玻璃隔断能分隔空间又不挡光线，因此常用于分开湿厨与干厨、在家中隔出书房，或封闭排屋的楼梯间。KL Servis Rumah 供应并安装 10mm 与 12mm 钢化玻璃隔断，可做无框、细边铝框，或工业风黑框造型。玻璃可选透明、磨砂（保护隐私）或茶色。施工先用激光测距仪量尺，把地面与天花的实际高差算进去——老房子很少是完全水平的。钢化玻璃按最终尺寸下单，铰链孔与拉手孔都在钢化前加工完成。安装采用锚固在结构上的 U 型槽或驳接爪，接缝处用结构硅胶密封。",
      highlights: [
        "按高度与分格选用 10mm 或 12mm 钢化玻璃",
        "可做无框、细边铝框或工业风黑框",
        "玻璃可选透明、磨砂隐私款或茶色",
        "激光量尺，兼顾地面与天花的实际高差",
        "U 型槽或驳接爪锚固结构，接缝硅胶密封",
      ...
      process: [
        { step: "01", title: "上门量尺", desc: "使用激光量尺，检查地面与天花水平度，确认可供固定的结构位置。" },
        { step: "02", title: "分格设计", desc: "以简图确认分格排布、门扇位置、玻璃类型与边框饰面。" },
        { step: "03", title: "玻璃下单", desc: "按尺寸切割、开铰链与拉手孔，再进行钢化处理后送到现场。" },
        { step: "04", title: "现场安装", desc: "槽件或驳接爪锚固到结构上，用吸盘吊装玻璃并校正水平垂直。" },
        { step: "05", title: "密封清洁", desc: "接缝打结构硅胶，调校五金，清洁玻璃后交付。" },
      ],
      faqs: [
        { q: "10mm 和 12mm 钢化玻璃该选哪种？", a: "常规层高的室内隔断，10mm 一般就够用。若隔断更高、单块玻璃跨度大且中间无支撑，或需要配无框玻璃门，则建议用 12mm。我们会在量尺后给出具体建议。" },
        { q: "玻璃隔断能挡住厨房油烟味和噪音吗？", a: "相比完全开放的空间，密封良好的钢化玻璃隔断在阻隔油烟味和噪音方面改善明显，但不是完全隔绝。如果对隔音要求更高，夹层玻璃是更合适的选择。" },
        { q: "从量尺到安装需要多久？", a: "钢化玻璃钢化后无法再切割，必须按最终尺寸加工。加工周期取决于订单面积与玻璃类型，具体安装日期会在报价时确认。" },
        { q: "玻璃隔断多少钱？", a: "隔断在量尺后报价，取决于玻璃面积、厚度、玻璃类型、门扇数量、五金配置、边框饰面以及安装现场的搬运条件。" },
      ],
      metaTitle: "吉隆坡住宅与办公玻璃隔断 | 依报价",
      metaDesc: "吉隆坡与雪兰莪 10mm/12mm 钢化玻璃隔断。无框或铝框，透明、磨砂与茶色可选，12 个月密封保修。",
    },
  },
  "glass-aluminium/sliding-glass-door": {
    ms: {
      name: "Pintu Kaca Gelangsar",
      tagline: "Pintu kaca gelangsar aluminium untuk balkoni, patio dan ruang tamu, dengan roller kalis haus dan kaca tempered pilihan anda.",
      description:
        "Pintu kaca gelangsar membuka ruang tamu ke balkoni atau halaman tanpa memerlukan ruang ayunan, dan ia menjadi ciri standard di kebanyakan kondominium serta rumah teres moden. KL Servis Rumah membekal dan memasang sistem pintu gelangsar aluminium dua, tiga dan empat panel dengan kaca tempered 8mm hingga 12mm. Trek bawah bergred berat dipilih supaya roller tidak cepat haus, dan roller bearing dua roda digunakan untuk panel yang lebih berat. Bingkai dipasang aras dengan cerun tolakan air yang betul dan lubang saliran yang lancar supaya hujan tempias mengalir keluar dan bukan bertakung di dalam trek. Kunci mortise atau kunci hook dipasang mengikut sistem, dan pengedapan bulu serta gasket dipasang di sepanjang tepi panel untuk mengurangkan tempias, habuk dan bunyi.",
      highlights: [
        "Sistem dua, tiga atau empat panel dengan kaca tempered 8mm–12mm",
        "Trek bergred berat dan roller bearing dua roda untuk panel berat",
        "Cerun tolakan air dan lubang saliran diperiksa supaya trek tidak bertakung",
        "Kunci mortise atau hook dipasang dan diuji mengikut sistem",
        "Pengedap bulu dan gasket sepanjang tepi untuk tempias, habuk dan bunyi",
      ],
      process: [
        { step: "01", title: "Ukuran Bukaan", desc: "Kami mengukur lebar, tinggi dan kedalaman bukaan serta menyemak aras lantai dan kedudukan saliran balkoni." },
        { step: "02", title: "Pilihan Sistem", desc: "Bilangan panel, profil bingkai, ketebalan kaca, warna kemasan dan jenis kunci disahkan." },
        { step: "03", title: "Fabrikasi", desc: "Bingkai dan panel difabrikasi mengikut ukuran tapak dan kaca di-temper sebelum penghantaran." },
        { step: "04", title: "Pemasangan", desc: "Bingkai disauh aras dengan cerun tolakan air, panel dipasang pada roller dan penghenti dipasang." },
        { step: "05", title: "Kedap & Ujian", desc: "Perimeter dikedap, saliran diuji dengan air, dan panel diuji gelangsar serta kunci berulang kali." },
      ],
      faqs: [
        { q: "Kenapa pintu gelangsar lama saya berat dan bising?", a: "Punca paling biasa ialah roller yang sudah haus atau pecah, trek yang penuh pasir dan kotoran, atau trek yang kemek. Kami boleh menggantikan roller dan membersihkan trek pada sistem sedia ada, atau memasang set baharu jika bingkai sudah terlalu haus." },
        { q: "Adakah pintu gelangsar bocor semasa hujan lebat?", a: "Sistem yang dipasang dengan betul mengalirkan air keluar melalui lubang saliran trek. Kebocoran biasanya berlaku apabila saliran tersumbat, cerun lantai menghala ke dalam, atau pengedapan perimeter gagal — semua ini diperiksa semasa pemasangan kami." },
        { q: "Ketebalan kaca apa yang sesuai untuk balkoni?", a: "Kaca tempered 10mm atau 12mm lazimnya digunakan untuk panel balkoni yang besar dan terdedah kepada angin, manakala 8mm memadai untuk bukaan yang lebih kecil dan terlindung. Kami mencadangkan ketebalan selepas mengukur bukaan dan menilai pendedahan." },
        { q: "Berapakah kos pintu kaca gelangsar?", a: "Kos disebut harga selepas ukuran kerana ia bergantung pada saiz bukaan, bilangan panel, ketebalan kaca, sistem bingkai, jenis kunci, tingkat unit dan kesukaran mengangkat panel ke lokasi." },
      ],
      metaTitle: "Pintu Kaca Gelangsar KL & Selangor | Atas Sebut Harga",
      metaDesc: "Pintu kaca gelangsar aluminium di KL & Selangor. Kaca tempered 8–12mm, trek bergred berat, roller bearing dan pengedapan. Jaminan kedap 12 bulan.",
    },
    zh: {
      name: "推拉玻璃门",
      tagline: "适用于阳台、露台与客厅的铝合金推拉玻璃门，配耐磨滑轮与可选钢化玻璃厚度。",
      description:
        "推拉玻璃门不需要旋开空间，就能把客厅与阳台、庭院连通起来，是如今公寓与现代排屋的标准配置。KL Servis Rumah 供应并安装两扇、三扇与四扇铝合金推拉门系统，玻璃采用 8mm 至 12mm 钢化玻璃。下轨选用重型轨道以减缓滑轮磨损，较重的门扇则配双轮轴承滑轮。门框按水平安装并保证正确的泄水坡度与畅通排水孔，让飘雨顺利排出而不是积在轨道里。按系统配装勾锁或插锁，并在门扇边缘装配毛条与胶条密封，减少飘雨、灰尘与噪音。",
      highlights: [
        "两扇、三扇或四扇系统，配 8mm–12mm 钢化玻璃",
        "重型下轨与双轮轴承滑轮，承托较重门扇",
        "检查泄水坡度与排水孔，避免轨道积水",
        "按系统配装勾锁或插锁并逐一测试",
        "边缘毛条与胶条密封，减少飘雨、灰尘和噪音",
      ],
      process: [
        { step: "01", title: "洞口测量", desc: "测量洞口宽高与框深，检查地面水平与阳台排水口位置。" },
        { step: "02", title: "系统选型", desc: "确认扇数、型材、玻璃厚度、饰面颜色与锁具类型。" },
        { step: "03", title: "工厂加工", desc: "按现场尺寸加工框料与门扇，玻璃钢化处理后送达。" },
        { step: "04", title: "现场安装", desc: "门框按水平与泄水坡度锚固，门扇装上滑轮并安装限位块。" },
        { step: "05", title: "密封测试", desc: "周边密封、灌水试排水，并反复测试推拉与上锁。" },
      ],
      faqs: [
        { q: "旧推拉门为什么越来越重、声音很大？", a: "最常见的原因是滑轮磨损或破裂、轨道里积满沙尘，或轨道被压变形。现有系统可以更换滑轮并清理轨道；如果框体磨损太严重，则建议整套更换。" },
        { q: "大雨天推拉门会漏水吗？", a: "安装规范的系统会通过轨道排水孔把水排出去。漏水通常发生在排水孔堵塞、地面坡度朝内，或周边密封失效时——这几项我们在安装时都会逐一检查。" },
        { q: "阳台该用多厚的玻璃？", a: "面积大、受风明显的阳台门扇通常用 10mm 或 12mm 钢化玻璃；较小且有遮挡的洞口用 8mm 也足够。我们会在量尺并评估外露程度后给出建议。" },
        { q: "推拉玻璃门要多少钱？", a: "费用在量尺后报价，取决于洞口尺寸、扇数、玻璃厚度、型材系统、锁具类型、楼层高度以及玻璃搬运难度。" },
      ],
      metaTitle: "吉隆坡推拉玻璃门安装 | 依报价",
      metaDesc: "吉隆坡与雪兰莪铝合金推拉玻璃门。8–12mm 钢化玻璃、重型轨道、轴承滑轮与边缘密封，12 个月密封保修。",
    },
  },
  "glass-aluminium/aluminium-casement-window": {
    ms: {
      name: "Tingkap Casement Aluminium",
      tagline: "Tingkap casement aluminium yang membuka penuh ke luar untuk pengudaraan maksimum, dengan engsel gred marin dan pengedapan gasket berterusan.",
      description:
        "Tingkap casement membuka sepenuhnya ke luar, jadi ia memberikan aliran udara yang jauh lebih baik berbanding tingkap gelangsar, dan lebih mudah dibersihkan dari dalam. KL Servis Rumah membekal dan memasang tingkap casement aluminium dengan kaca tempered atau kaca float mengikut lokasi dan saiz panel. Engsel gunting gred marin dipilih untuk menahan kelembapan tinggi dan hujan asid di kawasan bandar, dan gasket EPDM berterusan dipasang di sepanjang perimeter daun supaya tingkap menutup rapat tanpa bunyi berdetak semasa angin kencang. Handle multi-point boleh dipasang untuk panel yang lebih besar supaya daun terkunci di beberapa titik dan tidak membengkok. Bingkai dipasang aras dengan lubang saliran yang berfungsi, dan setiap tingkap diuji buka-tutup, kunci dan ujian air sebelum serahan.",
      highlights: [
        "Bukaan penuh ke luar untuk aliran udara maksimum dan pembersihan mudah",
        "Engsel gunting gred marin untuk kelembapan dan hujan kawasan bandar",
        "Gasket EPDM berterusan di sepanjang perimeter daun tingkap",
        "Pilihan handle multi-point untuk panel besar supaya terkunci rapat",
        "Lubang saliran berfungsi dan ujian air dijalankan sebelum serahan",
      ],
      process: [
        { step: "01", title: "Ukuran & Penilaian", desc: "Kami mengukur bukaan, menilai pendedahan angin serta hujan dan mencadangkan saiz panel yang sesuai." },
        { step: "02", title: "Spesifikasi", desc: "Profil bingkai, jenis dan ketebalan kaca, warna kemasan serta jenis handle disahkan dalam sebut harga." },
        { step: "03", title: "Fabrikasi", desc: "Bingkai dan daun difabrikasi mengikut ukuran tapak, kaca disediakan dan perkakasan dipasang di bengkel." },
        { step: "04", title: "Pemasangan", desc: "Bingkai disauh aras dan plumb pada struktur, daun digantung dan gasket dipasang sepanjang perimeter." },
        { step: "05", title: "Ujian & Serahan", desc: "Operasi daun, kunci dan saliran diuji, ujian air dijalankan dan kawasan kerja dibersihkan." },
      ],
      faqs: [
        { q: "Casement atau tingkap gelangsar — mana lebih baik?", a: "Casement memberi pengudaraan penuh kerana keseluruhan bukaan boleh dibuka, dan pengedapannya lebih rapat. Tingkap gelangsar pula tidak menonjol keluar, jadi ia lebih sesuai untuk laluan sempit atau koridor. Pilihan bergantung pada ruang luar dan keperluan aliran udara anda." },
        { q: "Adakah tingkap casement selamat semasa angin kencang?", a: "Ya, apabila saiz panel, ketebalan kaca dan engsel dipadankan dengan pendedahan lokasi. Untuk panel besar atau unit tinggi, kami menggunakan engsel gred berat, handle multi-point dan penahan supaya daun tidak terhempas oleh angin." },
        { q: "Bolehkah tingkap casement dipasang bersama grill?", a: "Boleh, tetapi grill perlu dipasang di dalam dengan ruang bebas yang mencukupi supaya daun casement dapat terbuka penuh. Kami mengambil kira ruang ini semasa ukuran supaya kedua-duanya berfungsi bersama." },
        { q: "Berapakah kos tingkap casement aluminium?", a: "Kos disebut harga selepas ukuran kerana ia bergantung pada saiz dan bilangan panel, jenis kaca, profil bingkai, perkakasan pilihan, tingkat unit dan keperluan tampalan dinding." },
      ],
      metaTitle: "Tingkap Casement Aluminium KL | Atas Sebut Harga",
      metaDesc: "Tingkap casement aluminium di KL & Selangor. Engsel gred marin, gasket EPDM, handle multi-point dan ujian air. Jaminan kedap 12 bulan.",
    },
    zh: {
      name: "铝合金平开窗",
      tagline: "向外全开的铝合金平开窗，通风量最大，配船级铰链与整圈胶条密封。",
      description:
        "平开窗可以向外完全打开，通风量远好于推拉窗，而且从室内擦洗玻璃也更方便。KL Servis Rumah 供应并安装铝合金平开窗，按位置与扇型选用钢化玻璃或浮法玻璃。剪式铰链选用船级材质，能耐受城市高湿与酸雨环境；窗扇整圈装配 EPDM 胶条，关闭严实，大风天也不会来回拍打作响。较大的窗扇可配多点锁执手，多点锁紧、窗扇不易变形。窗框按水平安装并保证排水孔畅通，每扇窗在交付前都会做开启、上锁与淋水测试。",
      highlights: [
        "向外全开，通风量最大且便于室内清洁",
        "船级剪式铰链，适应城市高湿与酸雨环境",
        "窗扇整圈 EPDM 胶条密封，关闭严实",
      ...
      process: [
        { step: "01", title: "量尺评估", desc: "测量洞口，评估受风与雨水条件，建议合适的分扇尺寸。" },
        { step: "02", title: "确定规格", desc: "在报价中确认型材、玻璃类型与厚度、饰面颜色与执手形式。" },
        { step: "03", title: "工厂加工", desc: "按现场尺寸加工框扇，配好玻璃并在厂内装配五金。" },
        { step: "04", title: "现场安装", desc: "窗框校平校直后锚固到结构，挂装窗扇并安装整圈胶条。" },
        { step: "05", title: "测试交付", desc: "测试开启、上锁与排水，做淋水检查并清理施工区域。" },
      ],
      faqs: [
        { q: "平开窗和推拉窗哪个更好？", a: "平开窗整个洞口都能打开，通风更充分，密封也更严实。推拉窗不会向外凸出，更适合走道狭窄或有过人通道的位置。具体要看外部空间和通风需求。" },
        { q: "刮大风时平开窗安全吗？", a: "只要分扇尺寸、玻璃厚度与铰链规格匹配现场受风条件就是安全的。大扇或高楼层我们会采用重型铰链、多点锁执手并加装风撑，防止窗扇被风甩坏。" },
        { q: "平开窗可以同时装防盗格栅吗？", a: "可以，但格栅要装在室内，并预留足够净空让窗扇完全开启。我们在量尺时就会把这段活动空间算进去，确保两者互不干涉。" },
        { q: "铝合金平开窗多少钱？", a: "费用在量尺后报价，取决于扇型尺寸与数量、玻璃类型、型材系列、五金配置、楼层高度以及墙面修补需求。" },
      ],
      metaTitle: "吉隆坡铝合金平开窗安装 | 依报价",
      metaDesc: "吉隆坡与雪兰莪铝合金平开窗。船级剪式铰链、EPDM 整圈密封、多点锁执手与淋水测试，12 个月密封保修。",
    },
  },
  "glass-aluminium/glass-railing-and-balustrade": {
    ms: {
      name: "Railing & Balustrade Kaca",
      tagline: "Balustrade kaca tempered untuk tangga, balkoni dan mezzanine dengan spigot stainless steel atau channel base yang disauh pada struktur.",
      description:
        "Railing kaca memberi pandangan terbuka pada tangga dan balkoni sambil kekal berfungsi sebagai penghadang keselamatan. KL Servis Rumah membekal dan memasang balustrade kaca tempered 12mm, atau kaca laminated tempered untuk lokasi yang memerlukan lapisan keselamatan tambahan seperti balkoni tingkat atas dan mezzanine. Sistem sokongan yang biasa digunakan ialah spigot stainless steel SS304 yang disauh dengan angkur kimia ke dalam konkrit, atau channel base aluminium yang menyembunyikan pengikat sepenuhnya. Kekuatan tapak adalah kritikal — kami memeriksa ketebalan dan keadaan konkrit di kawasan pemasangan sebelum mengesahkan sistem yang digunakan. Panel kaca dipesan mengikut ukuran akhir dengan lubang spigot dan tepi dicanai licin sebelum tempering, kemudian dipasang, ditegakkan dan dikunci sebelum sambungan dikedap.",
      highlights: [
        "Kaca tempered 12mm atau laminated tempered untuk lokasi tinggi",
        "Spigot SS304 dengan angkur kimia atau channel base aluminium tersembunyi",
        "Keadaan dan ketebalan konkrit diperiksa sebelum sistem disahkan",
        "Tepi kaca dicanai licin dan lubang dibuat sebelum proses tempering",
        "Panel ditegakkan, dikunci dan sambungan dikedap sebelum serahan",
      ],
      process: [
        { step: "01", title: "Lawatan Tapak", desc: "Kami memeriksa struktur tangga atau balkoni, ketebalan konkrit dan mengukur panjang serta ketinggian railing." },
        { step: "02", title: "Pilihan Sistem", desc: "Spigot atau channel base, jenis kaca dan pilihan handrail atas disahkan mengikut lokasi dan gaya rumah." },
        { step: "03", title: "Fabrikasi Kaca", desc: "Panel dipotong ikut ukuran, lubang dibuat, tepi dicanai dan kaca di-temper sebelum dihantar." },
        { step: "04", title: "Pemasangan Sokongan", desc: "Spigot atau channel disauh dengan angkur kimia mengikut jarak reka bentuk dan dilaras aras." },
        { step: "05", title: "Pemasangan Panel", desc: "Panel dinaikkan, ditegakkan, dikunci pada sokongan, sambungan dikedap dan kaca dibersihkan." },
      ],
      faqs: [
        { q: "Adakah railing kaca selamat untuk rumah berkanak-kanak?", a: "Railing kaca tempered yang dipasang dengan sistem sokongan yang betul berfungsi sebagai penghadang penuh tanpa celah untuk dipanjat, jadi ia sering dipilih untuk rumah berkanak-kanak. Untuk balkoni tingkat atas, kami mengesyorkan kaca laminated tempered sebagai lapisan keselamatan tambahan." },
        { q: "Apa berlaku jika kaca tempered pecah?", a: "Kaca tempered pecah menjadi kepingan tumpul dan bukan serpihan tajam. Kaca laminated tempered pula kekal melekat pada lapisan interlayer walaupun pecah, jadi panel tidak runtuh — sebab itu ia disyorkan untuk lokasi tinggi." },
        { q: "Perlukah handrail di bahagian atas kaca?", a: "Handrail atas tidak semestinya diperlukan pada semua pemasangan, tetapi ia melindungi tepi kaca dan memberi pegangan yang lebih selesa di tangga. Kami membincangkan pilihan ini bersama anda semasa lawatan tapak." },
        { q: "Berapakah kos balustrade kaca?", a: "Kos disebut harga selepas lawatan kerana ia bergantung pada panjang railing, ketinggian panel, jenis dan ketebalan kaca, sistem sokongan, keperluan handrail dan keadaan struktur di tapak." },
      ],
      metaTitle: "Railing & Balustrade Kaca KL & Selangor | Sebut Harga",
      metaDesc: "Balustrade kaca tempered 12mm untuk tangga dan balkoni di KL & Selangor. Spigot SS304, angkur kimia dan channel base tersembunyi.",
    },
    zh: {
      name: "玻璃栏杆与护栏",
      tagline: "适用于楼梯、阳台与夹层的钢化玻璃护栏，配 SS304 驳接爪或槽式底座，锚固于结构层。",
      description:
        "玻璃栏杆让楼梯和阳台保持通透视野，同时仍然是可靠的安全护栏。KL Servis Rumah 供应并安装 12mm 钢化玻璃护栏；对于高层阳台与夹层等需要额外安全冗余的位置，可选用夹层钢化玻璃。常用支撑方式有两种：用化学锚栓固定在混凝土中的 SS304 不锈钢驳接爪，或完全隐藏固定件的铝合金槽式底座。基层强度是关键——我们会先检查安装部位混凝土的厚度与状况，再确认采用哪种系统。玻璃按最终尺寸下单，钢化前完成开孔与磨边，到场后吊装、扶正、锁固，最后打胶密封接缝。",
      highlights: [
        "12mm 钢化玻璃，高处位置可选夹层钢化玻璃",
        "SS304 驳接爪配化学锚栓，或隐藏式铝合金槽底座",
        "确认系统前先检查混凝土基层厚度与状况",
        "钢化前完成开孔与磨边处理",
        "玻璃扶正锁固后打胶密封再交付",
      ],
      process: [
        { step: "01", title: "现场勘查", desc: "检查楼梯或阳台结构与混凝土厚度，测量护栏长度与高度。" },
        { step: "02", title: "系统选型", desc: "按位置与家居风格确定驳接爪或槽底座、玻璃类型与是否加顶部扶手。" },
        { step: "03", title: "玻璃加工", desc: "按尺寸切割、开孔、磨边，钢化处理后送达现场。" },
        { step: "04", title: "安装支撑", desc: "按设计间距用化学锚栓固定驳接爪或底槽，并校准水平。" },
        { step: "05", title: "安装玻璃", desc: "吊装玻璃、扶正锁固，接缝打胶密封并清洁玻璃面。" },
      ],
      faqs: [
        { q: "家里有小孩，玻璃栏杆安全吗？", a: "使用规范支撑系统的钢化玻璃护栏是完整无缝隙的挡板，孩子无处攀爬，因此很多有小孩的家庭都会选它。高层阳台我们建议使用夹层钢化玻璃，多一层安全保障。" },
        { q: "钢化玻璃破了会怎样？", a: "钢化玻璃破碎后会变成边缘钝化的小颗粒，而不是尖锐碎片。夹层钢化玻璃即使破裂，碎片仍会粘在中间胶层上不会整片脱落，所以高处位置更推荐使用。" },
        { q: "玻璃顶部一定要加扶手吗？", a: "并非所有做法都必须加顶部扶手，但它能保护玻璃边缘，在楼梯上握持手感也更好。我们会在现场勘查时与您讨论这个选项。" },
        { q: "玻璃护栏多少钱？", a: "费用在现场勘查后报价，取决于护栏长度、玻璃高度、玻璃类型与厚度、支撑系统、是否加扶手以及现场结构状况。" },
      ],
      metaTitle: "吉隆坡玻璃栏杆与护栏安装 | 依报价",
      metaDesc: "吉隆坡与雪兰莪楼梯阳台 12mm 钢化玻璃护栏。SS304 驳接爪、化学锚栓与隐藏槽式底座，现场勘查后报价。",
    },
  },
  "glass-aluminium/aluminium-composite-panel-cladding": {
    ms: {
      name: "Cladding Panel Komposit Aluminium",
      tagline: "Kerja cladding ACP untuk fasad kedai, papan tanda dan dinding ciri, dengan rangka aluminium dan sambungan yang dikedap kemas.",
      description:
        "Panel komposit aluminium (ACP) memberi kemasan fasad yang bersih, rata dan tahan cuaca, dan ia digunakan secara meluas untuk muka kedai, papan tanda, dinding ciri di kawasan letak kereta serta menutup dinding luar yang tidak sekata. KL Servis Rumah membina rangka sokongan aluminium yang disauh pada struktur, memotong dan melipat panel ACP di bengkel mengikut ukuran tapak, kemudian memasang panel dengan jarak sambungan yang konsisten. Sambungan boleh dikemas secara terbuka (open joint) atau dikedap dengan sealant gred luaran mengikut reka bentuk dan keperluan kalis air. Kami menggunakan panel dengan kemasan PVDF untuk pendedahan luar kerana ia lebih tahan pudar berbanding kemasan polyester. Sudut, tepi dan bukaan dikemas dengan flashing supaya air tidak masuk ke belakang panel.",
      highlights: [
        "Rangka sokongan aluminium disauh terus pada struktur bangunan",
        "Panel dipotong dan dilipat di bengkel mengikut ukuran tapak",
        "Jarak sambungan konsisten dengan pilihan open joint atau bersealant",
        "Kemasan PVDF untuk pendedahan luar kerana lebih tahan pudar",
        "Sudut, tepi dan bukaan dikemas dengan flashing kalis air",
      ],
      process: [
        { step: "01", title: "Ukuran & Reka Bentuk", desc: "Permukaan diukur dan susunan panel, arah sambungan serta pilihan warna dirancang terlebih dahulu." },
        { step: "02", title: "Penyediaan Substrat", desc: "Dinding sedia ada diperiksa kekuatannya dan kedudukan angkur rangka ditanda mengikut susunan panel." },
        { step: "03", title: "Pemasangan Rangka", desc: "Rangka aluminium dipasang aras dan plumb supaya permukaan akhir panel benar-benar rata." },
        { step: "04", title: "Fabrikasi & Pemasangan Panel", desc: "Panel dipotong, dilipat dan dipasang pada rangka dengan jarak sambungan yang sekata." },
        { step: "05", title: "Pengedapan & Kemasan", desc: "Sambungan dikedap jika perlu, flashing dipasang di tepi dan filem pelindung ditanggalkan sebelum serahan." },
      ],
      faqs: [
        { q: "Berapa lama panel ACP bertahan di luar?", a: "Ketahanan bergantung pada kemasan permukaan dan pendedahan. Panel dengan kemasan PVDF mengekalkan warna jauh lebih lama berbanding kemasan polyester di bawah matahari Malaysia, dan sistem rangka yang dipasang dengan betul menghalang panel daripada bergelombang." },
        { q: "Bolehkah ACP dipasang atas dinding sedia ada?", a: "Boleh, selagi dinding cukup kukuh untuk menerima angkur rangka. Rangka aluminium mencipta permukaan rata di hadapan dinding, jadi ACP juga berguna untuk menutup dinding luar yang tidak sekata atau bertampal." },
        { q: "Adakah cladding ACP kalis air?", a: "Sistem ACP direka sebagai skrin hujan — sambungan yang dikedap dan flashing mengalihkan air keluar. Ia bukan pengganti kerja kalis air pada dinding yang sudah bocor; masalah kebocoran sedia ada perlu dibaiki sebelum panel dipasang." },
        { q: "Berapakah kos kerja cladding ACP?", a: "Kos disebut harga selepas ukuran kerana ia bergantung pada keluasan, jenis dan kemasan panel, kerumitan rangka, ketinggian kerja serta keperluan perancah atau akses khas." },
      ],
      metaTitle: "Cladding Panel Komposit Aluminium ACP KL | Sebut Harga",
      metaDesc: "Kerja cladding ACP untuk fasad kedai dan dinding ciri di KL & Selangor. Rangka aluminium, panel PVDF dan sambungan dikedap kemas.",
    },
    zh: {
      name: "铝塑复合板幕墙",
      tagline: "店面门头、招牌与特色墙的铝塑板包覆施工，配铝合金龙骨与规整密封的板缝。",
      description:
        "铝塑复合板（ACP）能做出干净平整、耐候的饰面效果，广泛用于店面门头、广告招牌、停车场特色墙，以及遮盖不平整的外墙面。KL Servis Rumah 先安装锚固在结构上的铝合金龙骨，再按现场尺寸在工厂完成板材开槽折边，然后以统一的缝宽安装面板。板缝可做开放缝（open joint），也可按设计与防水要求使用户外级密封胶填缝。室外部位我们采用 PVDF 氟碳饰面板材，比聚酯漆面更耐紫外线褪色。转角、收边与洞口处均加装泛水收口，防止水从板后渗入。",
      highlights: [
        "铝合金龙骨直接锚固在建筑结构上",
        "板材按现场尺寸在工厂开槽折边加工",
        "缝宽统一，可做开放缝或打胶密封缝",
        "室外部位采用更耐褪色的 PVDF 氟碳饰面",
        "转角、收边与洞口加装泛水收口防渗",
      ],
      process: [
        { step: "01", title: "量尺排版", desc: "测量饰面区域，先规划分板排布、缝路走向与颜色方案。" },
        { step: "02", title: "基层准备", desc: "检查现有墙体承载能力，按排板方案标定龙骨锚固点位。" },
        { step: "03", title: "安装龙骨", desc: "龙骨按水平垂直安装，确保最终饰面平整无波浪。" },
        { step: "04", title: "加工安装板材", desc: "板材开槽折边后上墙固定，保持缝宽均匀一致。" },
        { step: "05", title: "打胶收口", desc: "按需打胶填缝、安装收边泛水，撕除保护膜后交付。" },
      ],
      faqs: [
        { q: "铝塑板在室外能用多久？", a: "耐久性取决于表面涂层与外露程度。在马来西亚的日照条件下，PVDF 氟碳涂层板保色性远好于聚酯漆面板；配合规范安装的龙骨系统，板面也不容易起鼓变形。" },
        { q: "可以直接包在现有墙面上吗？", a: "可以，只要墙体强度足以承受龙骨锚固。铝合金龙骨会在墙前形成一个平整面，因此铝塑板也很适合用来遮盖凹凸不平或修补痕迹明显的外墙。" },
        { q: "铝塑板幕墙防水吗？", a: "铝塑板系统属于雨幕式构造，靠密封缝与泛水把水导出。它不能替代墙体本身的防水处理；如果墙面已有渗漏，必须先修好再包板。" },
        { q: "铝塑板工程多少钱？", a: "费用在量尺后报价，取决于面积、板材类型与涂层、龙骨复杂程度、作业高度，以及是否需要搭设脚手架或特殊登高措施。" },
      ],
      metaTitle: "吉隆坡铝塑板 ACP 幕墙包覆施工 | 依报价",
      metaDesc: "吉隆坡与雪兰莪店面门头与特色墙铝塑板包覆。铝合金龙骨、PVDF 板材与规整密封板缝，量尺后报价。",
    },
  },
  "glass-aluminium/glass-repair-and-reglazing": {
    ms: {
      name: "Pembaikan Kaca & Reglazing",
      tagline: "Penggantian kaca pecah atau retak pada tingkap, pintu, meja dan almari, dengan pembuangan serpihan yang selamat dan pengedapan semula.",
      description:
        "Kaca yang pecah atau retak perlu diuruskan dengan segera kerana ia berisiko mencederakan penghuni dan membiarkan hujan serta habuk masuk. KL Servis Rumah menjalankan kerja reglazing untuk tingkap aluminium dan kayu, pintu kaca, panel almari, cermin serta meja kaca. Kerja bermula dengan pembuangan kaca lama dan serpihan secara selamat, termasuk mengeluarkan sisa gasket, beading dan silikon lama daripada alur bingkai. Kaca gantian dipadankan dengan ketebalan, jenis dan kemasan asal — kaca float jernih, kaca tinted, kaca frosted atau kaca tempered untuk lokasi yang memerlukan kaca keselamatan seperti pintu dan panel rendah. Setelah kaca baharu dipasang, beading atau gasket dipasang semula dan pengedapan dilakukan supaya panel kedap semula. Bagi kes kecemasan, bukaan boleh ditutup sementara sementara menunggu kaca gantian.",
      highlights: [
        "Kaca pecah dan serpihan dibuang serta dilupuskan dengan selamat",
        "Sisa gasket, beading dan silikon lama dibersihkan daripada alur bingkai",
        "Kaca gantian dipadankan mengikut ketebalan, jenis dan kemasan asal",
        "Kaca tempered digunakan untuk pintu dan panel rendah yang berisiko",
        "Beading atau gasket dipasang semula dan panel dikedap semula",
      ],
      process: [
        { step: "01", title: "Pemeriksaan & Ukuran", desc: "Kami memeriksa bingkai, mengukur bukaan kaca dan mengesahkan ketebalan serta jenis kaca yang diperlukan." },
        { step: "02", title: "Penutupan Sementara", desc: "Untuk kes kecemasan, bukaan ditutup sementara supaya kawasan selamat sementara menunggu kaca." },
        { step: "03", title: "Pembuangan Selamat", desc: "Kaca lama dan serpihan dikeluarkan, dibungkus dan dilupuskan, dan alur bingkai dibersihkan sepenuhnya." },
        { step: "04", title: "Pemasangan Kaca", desc: "Kaca baharu dipasang dengan setting block yang betul dan beading atau gasket dipasang semula." },
        { step: "05", title: "Kedap & Pembersihan", desc: "Sambungan dikedap, kaca dibersihkan dan kawasan kerja disapu untuk memastikan tiada serpihan tertinggal." },
      ],
      faqs: [
        { q: "Bolehkah kaca diganti tanpa menukar bingkai?", a: "Ya, dalam kebanyakan kes bingkai dikekalkan dan hanya panel kaca diganti. Bingkai perlu ditukar hanya jika ia bengkok, berkarat teruk atau alurnya sudah rosak sehingga tidak dapat memegang kaca dengan selamat." },
        { q: "Perlukah saya guna kaca tempered?", a: "Kaca tempered disyorkan untuk pintu kaca, panel bersebelahan pintu, panel rendah yang mudah dilanggar, dan kawasan yang kerap digunakan kanak-kanak, kerana ia pecah menjadi kepingan tumpul dan bukan serpihan tajam." },
        { q: "Berapa cepat kaca boleh diganti?", a: "Kaca float jernih dalam ketebalan biasa sering tersedia dengan cepat, manakala kaca tempered, tinted atau bersaiz besar memerlukan masa fabrikasi. Kami boleh menutup bukaan sementara supaya rumah selamat sementara menunggu." },
        { q: "Berapakah kos menggantikan kaca pecah?", a: "Kos disebut harga selepas ukuran kerana ia bergantung pada saiz panel, ketebalan dan jenis kaca, lokasi serta ketinggian pemasangan, dan sama ada penutupan sementara diperlukan." },
      ],
      metaTitle: "Pembaikan Kaca Pecah & Reglazing KL | Atas Sebut Harga",
      metaDesc: "Ganti kaca pecah pada tingkap, pintu dan almari di KL & Selangor. Pembuangan serpihan selamat, kaca tempered dan pengedapan semula.",
    },
    zh: {
      name: "玻璃维修与换装",
      tagline: "更换窗户、门扇、桌面与柜体上的破损或开裂玻璃，安全清运碎片并重新密封。",
      description:
        "玻璃一旦破裂或开裂就要尽快处理，否则既容易割伤家人，也会让雨水和灰尘进入室内。KL Servis Rumah 承接铝窗与木窗、玻璃门、柜体面板、镜子及玻璃台面的换装作业。施工从安全清除旧玻璃与碎片开始，包括清理框槽内残留的胶条、压条与旧硅胶。更换玻璃会按原有厚度、类型与饰面匹配——透明浮法玻璃、茶色玻璃、磨砂玻璃，或门扇与低位板块等需要安全玻璃的位置采用钢化玻璃。新玻璃装好后复装压条或胶条，并重新打胶密封。紧急情况下，可先做临时封挡，等待玻璃加工到货。",
      highlights: [
        "破损玻璃与碎片安全清除并妥善清运",
        "彻底清理框槽内残留胶条、压条与旧硅胶",
        "按原厚度、类型与饰面匹配更换玻璃",
      ...
      process: [
        { step: "01", title: "检查量尺", desc: "检查框体状况，测量玻璃洞口，确认所需厚度与玻璃类型。" },
        { step: "02", title: "临时封挡", desc: "紧急情况下先做临时封挡，等待玻璃到货期间保证现场安全。" },
        { step: "03", title: "安全清除", desc: "取出旧玻璃与碎片并包裹清运，彻底清理框槽。" },
        { step: "04", title: "安装玻璃", desc: "垫好定位块后装入新玻璃，复装压条或胶条。" },
        { step: "05", title: "密封清理", desc: "接缝打胶密封，擦净玻璃并清扫现场，确认无碎片残留。" },
      ],
      faqs: [
        { q: "换玻璃需要连框一起换吗？", a: "多数情况不需要，可以保留原框只换玻璃面板。只有当框体变形、严重锈蚀，或槽口已损坏无法安全夹持玻璃时，才需要更换框体。" },
        { q: "一定要用钢化玻璃吗？", a: "玻璃门、门旁固定扇、容易碰撞的低位板块，以及儿童活动频繁的区域，我们建议使用钢化玻璃，因为它破碎后是钝边颗粒，不会形成锋利碎片。" },
        { q: "换玻璃要等多久？", a: "常规厚度的透明浮法玻璃通常很快就能配到，钢化玻璃、茶色玻璃或超大尺寸则需要加工时间。等待期间我们可以先做临时封挡，保证住宅安全。" },
        { q: "换一块碎玻璃多少钱？", a: "费用在量尺后报价，取决于板块尺寸、玻璃厚度与类型、安装位置与高度，以及是否需要临时封挡。" },
      ],
      metaTitle: "吉隆坡碎玻璃维修与换装 | 依报价",
      metaDesc: "吉隆坡与雪兰莪窗户、门扇与柜体碎玻璃更换。安全清运碎片、钢化玻璃可选与重新密封，量尺后报价。",
    },
  },
  ...
  "door/door-replacement": {
    ms: {
      ...
      tagline: "Tukar daun pintu lama pada bingkai yang masih kukuh — pintu baharu dibekalkan, engsel diperbaharui, set kunci dipasang semula dan jurang dilaras semula.",
      description:
        "Apabila bingkai pintu masih segi empat dan kukuh, menggantikan daun pintu sahaja ialah pilihan paling jimat dan paling cepat. KL Servis Rumah mengukur bukaan sedia ada — tinggi, lebar, kedalaman bingkai, arah ayunan dan kedudukan engsel — kemudian membekalkan pintu baharu mengikut ukuran tersebut. Pilihan merangkumi pintu laminate kulit HDF, pintu kayu pepejal meranti atau chengal, dan pintu bilik air kalis lembapan. Kerja termasuk penanggalan pintu lama, pemasangan engsel baharu (atau menggunakan semula engsel sedia ada jika masih baik), mortise dan pemasangan set kunci, serta pelarasan jurang 3–4mm di atas dan sisi dengan 5–8mm di bawah. Setiap pintu diuji hayun, tutup dan latch sebelum serahan. Harga bergantung pada jenis pintu, saiz dan perkakasan pilihan, jadi kerja ini disebut harga selepas ukuran tapak.",
      highlights: [
        "Kekalkan bingkai sedia ada dan jimatkan kos penggantian bingkai penuh",
        "Pilihan pintu laminate, kayu pepejal atau pintu kalis lembapan untuk bilik air",
        "Engsel baharu atau engsel sedia ada disemak, diketatkan dan dijajarkan semula",
        "Set kunci di-mortise dan dipasang semula dengan strike plate yang tepat",
        "Jurang sekata 3–4mm atas/sisi dan 5–8mm bawah, diuji hayun dan latch",
      ],
      process: [
        { step: "01", title: "Semakan Bingkai", desc: "Kami menyemak sama ada bingkai sedia ada masih segi empat, kukuh dan bebas reput sebelum mengesahkan penggantian daun pintu sahaja." },
        { step: "02", title: "Ukuran & Pilihan Pintu", desc: "Tinggi, lebar, kedalaman dan arah ayunan diukur, kemudian jenis pintu serta kemasan dipilih mengikut bilik dan bajet anda." },
        { step: "03", title: "Tempahan & Penghantaran", desc: "Pintu laminate lazimnya tersedia dalam beberapa hari manakala pintu kayu pepejal ditempah ikut ukuran; tarikh disahkan semasa sebut harga." },
        { step: "04", title: "Tanggal & Pasang", desc: "Pintu lama ditanggalkan, engsel disemak atau diganti, pintu baharu digantung dan set kunci di-mortise serta dipasang." },
        { step: "05", title: "Pelarasan & Ujian", desc: "Jurang dilaras sekata, latch dan strike plate ditepatkan, dan pintu diuji buka-tutup berulang kali sebelum kawasan dibersihkan." },
      ],
      faqs: [
        { q: "Bila saya boleh tukar daun pintu sahaja tanpa bingkai?", a: "Jika bingkai masih segi empat, kukuh, tidak reput dan saiznya standard, daun pintu sahaja boleh diganti. Kami menekan bingkai, memeriksa sambungan sudut dan mencari tanda reput atau anai-anai semasa lawatan sebelum mengesahkan pendekatan ini." },
        { q: "Berapa harga penggantian pintu?", a: "Kerja ini disebut harga selepas ukuran kerana harga bergantung pada jenis pintu (laminate, kayu pepejal atau kalis lembapan), saiz bukaan, perkakasan pilihan dan sama ada engsel serta set kunci perlu diganti. Sebut harga terperinci diberikan sebelum kerja bermula." },
        { q: "Bolehkah saya guna semula set kunci lama?", a: "Boleh jika set kunci masih berfungsi lancar dan saiz mortise pintu baharu sepadan. Kami memindahkan dan melaraskannya. Jika kunci sudah longgar atau berkarat, kami cadangkan set kunci baharu supaya latch dan strike plate sejajar dengan betul." },
        { q: "Berapa lama kerja penggantian mengambil masa?", a: "Pemasangan di tapak biasanya siap dalam beberapa jam untuk satu pintu apabila stok sudah tiba. Masa keseluruhan bergantung pada tempoh tempahan pintu — laminate lebih cepat, kayu pepejal kustom mengambil masa lebih lama." },
      ],
      metaTitle: "Penggantian Pintu KL & Selangor | Atas Sebut Harga",
      metaDesc: "Tukar daun pintu pada bingkai sedia ada di KL & Selangor. Pintu laminate, kayu pepejal atau kalis lembapan, engsel dan set kunci dilaras. Jaminan 12 bulan.",
    },
    zh: {
      name: "门扇更换",
      tagline: "门框仍稳固时只换门扇——供应新门、更换铰链、重装锁具并重新调匀缝隙。",
      description:
        "当门框仍然方正稳固时，只更换门扇是最省钱也最快的做法。KL Servis Rumah 会测量现有门洞的高度、宽度、框深、开门方向与铰链位置，再按尺寸供应新门。可选防火板 HDF 贴面门、meranti 或 chengal 实木门，以及适合浴室的防潮门。施工内容包括拆除旧门、安装新铰链（若原铰链状况良好也可沿用）、锁具开槽安装，以及调校顶部与两侧 3–4mm、底部 5–8mm 的均匀缝隙。每扇门在交付前都会做开关与锁舌测试。价格取决于门型、尺寸与五金配置，因此在现场量尺后再出报价。",
      highlights: [
        "保留现有门框，省下整体换框的费用",
        "可选防火板门、实木门或浴室防潮门",
        "更换新铰链或检查、紧固并重新校正原有铰链",
        "锁具重新开槽安装，锁扣板位置精确对位",
        "顶/侧缝 3–4mm、底缝 5–8mm，开关与锁舌逐项测试",
      ],
      process: [
        { step: "01", title: "检查门框", desc: "先确认现有门框是否方正、牢固、无腐朽，再决定是否可只换门扇。" },
        { step: "02", title: "量尺选门", desc: "测量高度、宽度、框深与开门方向，按房间用途和预算选定门型与饰面。" },
        { step: "03", title: "下单送货", desc: "防火板门通常数日可得，实木门按尺寸定制；确切交期在报价时确认。" },
        { step: "04", title: "拆旧装新", desc: "拆除旧门，检查或更换铰链，挂装新门，并完成锁具开槽与安装。" },
        { step: "05", title: "调校测试", desc: "调匀缝隙，校准锁舌与锁扣板，反复测试开关后清理现场。" },
      ],
      faqs: [
        { q: "什么情况下可以只换门扇不换门框？", a: "只要门框方正、牢固、没有腐朽且尺寸标准，就可以只换门扇。上门时我们会按压门框、检查角部接合并查看是否有受潮腐朽或虫蛀，再确认这个方案是否可行。" },
        { q: "更换门扇要多少钱？", a: "这项服务在量尺后报价，因为价格取决于门型（防火板、实木或防潮门）、洞口尺寸、五金配置，以及铰链和锁具是否需要更换。开工前会提供逐项报价。" },
        { q: "原来的锁具可以继续用吗？", a: "如果锁具开关顺畅且新门的开槽尺寸匹配，可以移装沿用，我们会重新调校。若锁体已松动或锈蚀，建议更换新锁，这样锁舌与锁扣板才能准确对位。" },
        { q: "更换一扇门要多久？", a: "货到之后，单扇门的现场安装通常几个小时即可完成。整体时间主要取决于门的备货周期——防火板门较快，定制实木门需要更长时间。" },
      ],
      metaTitle: "吉隆坡与雪兰莪门扇更换 | 依报价",
      metaDesc: "吉隆坡与雪兰莪在原门框上更换门扇。可选防火板门、实木门或防潮门，含铰链与锁具调校，12 个月保修。",
    },
  },
  "door/door-frame-repair-and-replacement": {
    ms: {
      name: "Pembaikan & Penggantian Bingkai Pintu",
      tagline: "Baiki bingkai reput, retak atau tidak segi empat, atau pasang bingkai meranti atau PVC baharu lengkap dengan architrave dan pelarasan pintu.",
      description:
        "Bingkai pintu yang reput di bahagian bawah, retak di sekitar engsel atau sudah tidak segi empat akan menyebabkan pintu menggesel, tidak mengunci atau bergoyang setiap kali ditutup. KL Servis Rumah menilai keadaan bingkai sedia ada dan mencadangkan pembaikan setempat atau penggantian penuh. Pembaikan biasa termasuk memotong dan menampal bahagian kaki bingkai yang reput, mengukuhkan kedudukan engsel dengan skru lebih panjang atau sisipan kayu, meluruskan bingkai yang mendap dan memasang semula strike plate. Untuk kerosakan teruk atau kesan lembapan berterusan di bilik air dan dapur, kami menanggalkan bingkai lama sepenuhnya dan memasang bingkai meranti atau PVC baharu, dijajarkan dengan aras dan plumb, kemudian architrave dipasang dengan sudut mitre. Setiap kerja diakhiri dengan pemasangan semula pintu dan ujian buka-tutup.",
      highlights: [
        "Tampalan kaki bingkai reput tanpa perlu menukar keseluruhan bingkai",
        "Kedudukan engsel diperkukuh dengan skru panjang atau sisipan kayu",
        "Pilihan bingkai meranti atau PVC kalis lembapan untuk kawasan basah",
        "Bingkai dipasang aras dan plumb supaya pintu tidak menggesel atau bergoyang",
        "Architrave dipasang dengan sudut mitre, dikedap dan sedia untuk dicat",
      ],
      process: [
        { step: "01", title: "Penilaian Bingkai", desc: "Kami memeriksa reput, retak, kedudukan engsel, kelurusan dan punca lembapan sebelum mencadangkan pembaikan atau penggantian." },
        { step: "02", title: "Cadangan & Sebut Harga", desc: "Skop kerja, bahan bingkai dan keperluan architrave dijelaskan dalam sebut harga terperinci untuk kelulusan anda." },
        { step: "03", title: "Kerja Pembaikan", desc: "Bahagian reput dipotong dan ditampal, atau bingkai lama ditanggalkan dengan kerosakan dinding paling minimum." },
        { step: "04", title: "Pemasangan Bingkai", desc: "Bingkai baharu atau yang dibaiki disauh dengan aras dan plumb, dan jurang sekeliling ditutup dengan kemas." },
        { step: "05", title: "Pintu & Kemasan", desc: "Pintu digantung semula, engsel dan latch dilaras, architrave dipasang dan permukaan disediakan untuk cat." },
      ],
      faqs: [
        { q: "Kenapa bingkai pintu bilik air saya reput?", a: "Bahagian kaki bingkai di bilik air dan dapur menyerap air yang tergenang di lantai dan percikan harian. Kayu yang sentiasa lembap akhirnya reput dan menjadi lembut. Untuk kawasan basah kami lazimnya mengesyorkan bingkai PVC atau aluminium supaya masalah tidak berulang." },
        { q: "Boleh bingkai dibaiki tanpa ditukar sepenuhnya?", a: "Boleh, jika kerosakan setempat — contohnya hanya kaki bingkai yang reput atau kawasan engsel yang longgar. Kami memotong bahagian rosak, menampal dengan kayu padu dan mengukuhkan pengikat. Jika lebih separuh bingkai terjejas, penggantian penuh lebih berbaloi." },
        { q: "Adakah dinding perlu diketuk semasa menukar bingkai?", a: "Dalam kebanyakan kes tidak. Bingkai boleh ditanggalkan dengan memotong pengikat dan mengeluarkan bingkai lama; hanya sedikit plaster di sekeliling mungkin terjejas dan akan ditampal semula sebelum architrave dipasang." },
        { q: "Berapakah kos pembaikan bingkai pintu?", a: "Kos disebut harga selepas pemeriksaan kerana ia bergantung pada tahap reput, jenis bingkai yang dipilih, sama ada architrave baharu diperlukan dan kerja tampalan dinding. Kami memberi sebut harga terperinci sebelum memulakan kerja." },
      ],
      metaTitle: "Pembaikan Bingkai Pintu KL & Selangor | Atas Sebut Harga",
      metaDesc: "Baiki atau ganti bingkai pintu reput dan senget di KL & Selangor. Bingkai meranti atau PVC, architrave mitre, pintu dilaras semula. Jaminan kerja 12 bulan.",
    },
    zh: {
      name: "门框维修与更换",
      tagline: "修复腐朽、开裂或不方正的门框，或安装全新 meranti / PVC 门框，含门套与门扇复位调校。",
      description:
        "门框底部受潮腐朽、铰链处开裂或整体走形，都会让门刮框、关不严、锁不上或每次关门都晃动。KL Servis Rumah 会先评估现有门框，再判断做局部修复还是整体更换。常见修复包括切除并镶补腐朽的框脚、用加长螺丝或木塞加固铰链位、校直沉降变形的门框，以及重新安装锁扣板。若损坏严重，或厨卫长期受潮反复出问题，我们会整体拆除旧框，改装 meranti 实木或 PVC 门框，按水平与垂直校正后固定，再斜角拼装门套。完工后重新挂门并做开关测试。",
      highlights: [
        "局部镶补腐朽框脚，无需整体换框",
        "用加长螺丝或木塞加固铰链固定位",
        "潮湿区域可选 meranti 实木或防潮 PVC 门框",
        "按水平垂直校正安装，门不再刮框或晃动",
        "门套斜角拼接、封边收口，可直接上漆",
      ],
      process: [
        { step: "01", title: "门框评估", desc: "检查腐朽、开裂、铰链固定、垂直度以及受潮来源，再建议维修或更换。" },
        { step: "02", title: "方案与报价", desc: "在逐项报价中说明施工范围、门框材质与门套需求，供您确认。" },
        { step: "03", title: "拆除修复", desc: "切除腐朽部位并镶补，或以最小的墙面损伤整体拆下旧门框。" },
        { step: "04", title: "安装门框", desc: "新框或修复后的门框按水平垂直固定，四周缝隙妥善填补收口。" },
        { step: "05", title: "复位收尾", desc: "重新挂门、调校铰链与锁舌，安装门套并处理待上漆的表面。" },
      ],
      faqs: [
        { q: "浴室门框为什么会腐朽？", a: "厨卫门框的框脚会长期吸收地面积水和日常溅水，木材持续受潮后就会变软腐朽。对于这类潮湿区域，我们通常建议改用 PVC 或铝合金门框，从根源上避免问题反复出现。" },
        { q: "门框可以只修不换吗？", a: "如果损坏是局部的，比如只有框脚腐朽或铰链位松动，可以切除坏的部分、用实木镶补并加固固定件。但若超过一半框体受影响，整体更换更划算也更耐用。" },
        { q: "换门框需要凿墙吗？", a: "多数情况不需要。可以先切断固定件再取出旧框，通常只有周边少量批荡会受影响，安装完成后会先修补再装门套。" },
        { q: "门框维修多少钱？", a: "费用在现场检查后报价，取决于腐朽程度、所选门框材质、是否需要新门套以及墙面修补量。开工前我们会提供逐项报价。" },
      ],
      metaTitle: "吉隆坡门框维修与更换 | 依报价",
      metaDesc: "吉隆坡与雪兰莪门框腐朽、开裂与走形维修更换。meranti 或 PVC 门框、斜拼门套、门扇复位调校，12 个月保修。",
    },
  },
  "door/bathroom-and-kitchen-pvc-door-replacement": {
    ms: {
      name: "Penggantian Pintu PVC Bilik Mandi & Dapur",
      tagline: "Set pintu dan bingkai PVC atau aluminium kalis lembapan untuk bilik air dan dapur, dibuat mengikut bukaan sedia ada dan dikedap dengan kemas.",
      description:
        "Pintu kayu di bilik air dan dapur basah adalah antara pintu paling cepat rosak di rumah Malaysia — bahagian bawah menyerap air, mengembang, mengelupas dan akhirnya reput. KL Servis Rumah menggantikan pintu tersebut dengan set pintu PVC atau aluminium kalis lembapan yang dibuat mengikut ukuran bukaan sedia ada. Pintu PVC ringan, tidak reput dan mudah dibersihkan; pintu aluminium dengan panel komposit pula lebih kukuh untuk bukaan yang lebih besar atau kegunaan berat. Kerja termasuk menanggalkan pintu dan bingkai lama yang telah rosak, membaiki kaki dinding jika perlu, memasang bingkai baharu dengan aras dan plumb, memasang engsel serta set kunci tandas, dan mengedap sambungan bingkai ke dinding dengan silikon sanitari. Ventilasi louvre atau grille bawah boleh ditambah untuk pengaliran udara bilik air.",
      highlights: [
        "Pintu PVC atau aluminium yang tidak reput walaupun terdedah kepada percikan",
        "Dibuat mengikut ukuran bukaan sedia ada, termasuk bukaan bukan standard",
        "Pintu dan bingkai lama yang reput ditanggalkan dan dilupuskan",
        "Sambungan bingkai ke dinding dikedap dengan silikon sanitari",
        "Pilihan ventilasi louvre atau grille bawah untuk pengudaraan bilik air",
      ],
      process: [
        { step: "01", title: "Ukuran Bukaan", desc: "Kami mengukur tinggi, lebar dan kedalaman bukaan, serta menyemak keadaan dinding dan lantai di sekelilingnya." },
        { step: "02", title: "Pilihan Set Pintu", desc: "Anda memilih antara pintu PVC atau aluminium, warna, corak panel dan sama ada ventilasi louvre diperlukan." },
        { step: "03", title: "Tanggal Pintu Lama", desc: "Pintu dan bingkai lama yang reput ditanggalkan, dan kaki dinding dibersihkan atau ditampal jika rosak." },
        { step: "04", title: "Pasang Set Baharu", desc: "Bingkai baharu disauh aras dan plumb, pintu digantung, dan set kunci tandas dipasang serta diuji." },
        { step: "05", title: "Kedap & Kemas", desc: "Sambungan bingkai ke dinding dikedap dengan silikon sanitari dan kawasan kerja dibersihkan sebelum serahan." },
      ],
      faqs: [
        { q: "Adakah pintu PVC cukup kukuh untuk bilik air?", a: "Ya, untuk kegunaan bilik air dan tandas biasa. Pintu PVC direka khusus untuk kawasan basah — ia tidak menyerap air, tidak reput dan mudah dibersihkan. Untuk bukaan lebih besar atau penggunaan yang lebih berat, kami cadangkan pintu aluminium dengan panel komposit." },
        { q: "Bolehkah bingkai kayu lama dikekalkan?", a: "Kami tidak menggalakkannya di kawasan basah kerana bingkai kayu yang sama akan reput semula walaupun pintu baharu dipasang. Menukar set pintu dan bingkai serentak memberi hasil yang lebih tahan lama dan pengedapan yang lebih baik." },
        { q: "Bolehkah pintu ditempah untuk bukaan bukan standard?", a: "Boleh. Set pintu PVC dan aluminium dipotong mengikut ukuran bukaan sebenar, termasuk bukaan lama yang lebih rendah atau lebih sempit daripada saiz standard hari ini. Ukuran diambil di tapak sebelum tempahan." },
        { q: "Berapakah kos menukar pintu bilik air?", a: "Kerja ini disebut harga selepas ukuran kerana ia bergantung pada saiz bukaan, jenis pintu, keperluan ventilasi, keadaan bingkai lama dan sama ada kerja tampalan dinding diperlukan. Sebut harga terperinci diberi sebelum kerja." },
      ],
      metaTitle: "Pintu PVC Bilik Mandi & Dapur KL | Atas Sebut Harga",
      metaDesc: "Ganti pintu bilik air reput dengan set pintu PVC atau aluminium kalis lembapan di KL & Selangor. Ukuran tersuai, engsel, kunci tandas dan pengedapan silikon.",
    },
    zh: {
      name: "厨卫 PVC 门更换",
      tagline: "适用于浴室与厨房的防潮 PVC 或铝合金门与门框成套，按现有洞口定制并做好密封收口。",
      description:
        "在马来西亚住宅里，浴室与湿厨房的木门往往最先损坏——底部吸水、膨胀、起皮，最后彻底腐朽。KL Servis Rumah 会按现有洞口尺寸，用防潮 PVC 或铝合金门与门框成套替换。PVC 门轻便、不腐朽、易清洁；铝合金门配复合面板则更结实，适合较大洞口或使用频繁的位置。施工包括拆除已损坏的旧门与旧框、必要时修补墙脚、按水平垂直安装新门框、装配铰链与卫浴插锁，并用卫浴级硅胶密封门框与墙体交接。也可加装百叶或下部通风格栅，改善浴室通风。",
      highlights: [
        "PVC 或铝合金门材，长期溅水也不会腐朽",
        "按现有洞口定制，非标准尺寸同样适用",
        "拆除并清运已腐朽的旧门与旧门框",
        "门框与墙体交接使用卫浴级硅胶密封",
        "可选百叶或下部通风格栅，改善浴室换气",
      ...
      process: [
        { step: "01", title: "测量洞口", desc: "测量洞口高度、宽度与框深，并检查周边墙面与地面的状况。" },
        { step: "02", title: "选择门型", desc: "确认 PVC 或铝合金门材、颜色、面板样式，以及是否需要百叶通风。" },
        { step: "03", title: "拆除旧门", desc: "拆下腐朽的旧门与门框，清理并按需修补受损的墙脚部位。" },
        { step: "04", title: "安装新门", desc: "新门框按水平垂直固定，挂装门扇，安装并测试卫浴插锁。" },
        { step: "05", title: "密封收尾", desc: "用卫浴级硅胶密封门框与墙体交接，清理施工区域后交付。" },
      ],
      faqs: [
        { q: "PVC 门用在浴室够牢固吗？", a: "对于一般家庭浴室和卫生间是足够的。PVC 门本身就是为潮湿区域设计的，不吸水、不腐朽、擦洗方便。如果洞口较大或使用强度较高，我们会建议改用配复合面板的铝合金门。" },
        { q: "可以保留原来的木门框吗？", a: "在潮湿区域不建议保留。即使换了新门，同一个木门框还是会继续受潮腐朽。门与框成套更换，密封效果更好，使用寿命也更长。" },
        { q: "非标准尺寸的洞口能定制吗？", a: "可以。PVC 与铝合金门套都按实际洞口尺寸裁切制作，包括比现行标准更矮或更窄的老式洞口。下单前会先到现场量尺。" },
        { q: "换一扇浴室门要多少钱？", a: "这项服务在量尺后报价，费用取决于洞口尺寸、门材类型、是否需要通风百叶、旧门框状况以及墙面修补量。开工前会提供逐项报价。" },
      ],
      metaTitle: "吉隆坡厨卫 PVC 门更换 | 依报价",
      metaDesc: "吉隆坡与雪兰莪浴室厨房防潮门更换。PVC 或铝合金门框成套、按洞口定制、卫浴插锁与硅胶密封，量尺后报价。",
    },
  },
  "door/sliding-and-bi-fold-door-installation": {
    ms: {
      name: "Pemasangan Pintu Gelangsar & Bi-Fold",
      tagline: "Set pintu gelangsar top-hung, pocket dan bi-fold dengan trek, pemandu lantai dan perkakasan tutup lembut untuk ruang yang terhad.",
      description:
        "Pintu gelangsar dan bi-fold menjimatkan ruang kerana daun pintu tidak perlu berayun ke dalam bilik — sesuai untuk bilik tidur kecil, bilik belajar, ruang stor, laluan wardrobe dan pembahagi ruang di kondominium. KL Servis Rumah membekal dan memasang set pintu gelangsar top-hung dengan trek aluminium tersembunyi atau terdedah, pintu pocket yang menyorok ke dalam dinding partition, serta pintu bi-fold dua atau empat daun. Setiap pemasangan bermula dengan semakan struktur di atas bukaan kerana trek top-hung memikul keseluruhan berat daun pintu. Kami memasang rasuk sokongan atau papan pengukuh apabila perlu, memasang trek dengan aras yang tepat, memasang roller kalis haus, pemandu lantai dan penghenti, serta melaraskan supaya daun pintu bergerak lancar tanpa bergoyang atau menggesel.",
      highlights: [
        "Menjimatkan ruang kerana pintu tidak berayun ke dalam bilik",
        "Trek top-hung tersembunyi atau terdedah dengan roller kalis haus",
        "Semakan struktur di atas bukaan sebelum trek dipasang",
        "Pemandu lantai dan penghenti dipasang supaya daun tidak bergoyang",
        "Pilihan perkakasan tutup lembut untuk penutupan senyap",
      ],
      process: [
        { step: "01", title: "Semakan Bukaan", desc: "Kami mengukur bukaan dan menyemak struktur di atasnya kerana trek top-hung memikul berat keseluruhan daun pintu." },
        { step: "02", title: "Pilihan Sistem", desc: "Gelangsar, pocket atau bi-fold dipilih mengikut ruang dinding, laluan pengguna dan jenis daun pintu yang dikehendaki." },
        { step: "03", title: "Persediaan Struktur", desc: "Rasuk sokongan atau papan pengukuh dipasang jika perlu supaya trek boleh disauh dengan selamat." },
        { step: "04", title: "Pemasangan Trek & Daun", desc: "Trek dipasang aras, roller dan daun pintu digantung, pemandu lantai serta penghenti dipasang." },
        { step: "05", title: "Pelarasan & Ujian", desc: "Ketinggian roller dilaras, pergerakan diuji berulang kali dan perkakasan diketatkan sebelum serahan." },
      ],
      faqs: [
        { q: "Pintu gelangsar atau bi-fold — mana lebih sesuai?", a: "Pintu gelangsar sesuai apabila terdapat dinding kosong bersebelahan bukaan untuk daun pintu menyorok. Bi-fold sesuai apabila tiada ruang dinding kerana daun terlipat ke tepi bukaan. Kami mencadangkan pilihan selepas melihat susun atur bilik anda." },
        { q: "Adakah trek perlu dipasang pada struktur khas?", a: "Trek top-hung memikul keseluruhan berat pintu, jadi ia mesti disauh pada struktur kukuh — rasuk konkrit, batu bata atau papan pengukuh yang dipasang khas. Kami menyemak keadaan di atas bukaan semasa lawatan dan memasang sokongan tambahan jika perlu." },
        { q: "Bolehkah pintu gelangsar dipasang di kondominium?", a: "Boleh. Kami kerap memasang pintu gelangsar dan bi-fold di kondominium, mengikut waktu kerja yang dibenarkan pengurusan, menggunakan perlindungan lif dan menguruskan pelupusan serpihan mengikut peraturan bangunan." },
        { q: "Berapakah kos pemasangan pintu gelangsar?", a: "Kos disebut harga selepas ukuran kerana ia bergantung pada saiz bukaan, bilangan daun, jenis daun pintu, sistem trek, keperluan kerja struktur dan sama ada perkakasan tutup lembut dipilih." },
      ],
      metaTitle: "Pemasangan Pintu Gelangsar & Bi-Fold KL | Atas Sebut Harga",
      metaDesc: "Pintu gelangsar, pocket dan bi-fold di KL & Selangor. Trek top-hung, roller kalis haus, pemandu lantai dan pilihan tutup lembut. Sebut harga selepas ukuran.",
    },
    zh: {
      name: "推拉门与折叠门安装",
      tagline: "吊轨推拉门、隐藏式推拉门与折叠门成套，含轨道、地导与缓冲五金，适合空间紧凑的房间。",
      description:
        "推拉门与折叠门不需要门扇向房内旋开，能省下宝贵的活动空间——很适合小卧室、书房、储藏室、衣帽间过道以及公寓里的空间分隔。KL Servis Rumah 供应并安装吊轨推拉门（明装或隐藏轨道）、推入墙体的隐藏式推拉门，以及双扇或四扇折叠门。因为吊轨承担门扇的全部重量，每次安装都会先检查洞口上方的结构条件，必要时加装支撑梁或加固木衬板，再水平精确安装轨道，配装耐磨滑轮、地导与限位挡块，最后调校至门扇推拉顺畅、不晃动、不刮碰。",
      highlights: [
        "门扇不向内旋开，有效节省房间使用面积",
        "明装或隐藏式吊轨，配耐磨静音滑轮",
        "安装轨道前先检查洞口上方结构承载条件",
      ...
      process: [
        { step: "01", title: "检查洞口", desc: "测量洞口并检查上方结构，因为吊轨要承担门扇的全部重量。" },
        { step: "02", title: "选择系统", desc: "根据墙面余量、通行动线与门扇类型，确定推拉、隐藏式或折叠方案。" },
        { step: "03", title: "结构准备", desc: "如有需要，先加装支撑梁或加固衬板，确保轨道能牢固固定。" },
        { step: "04", title: "安装轨道门扇", desc: "水平安装轨道，挂装滑轮与门扇，再装配地导与限位挡块。" },
        { step: "05", title: "调校测试", desc: "调整滑轮高度，反复测试推拉手感，紧固五金后交付。" },
      ],
      faqs: [
        { q: "推拉门和折叠门该怎么选？", a: "如果洞口旁边有可供门扇滑入的空白墙面，推拉门更合适；如果没有多余墙面，折叠门更实用，因为门扇会折叠收在洞口两侧。我们会先看房间布局再给建议。" },
        { q: "轨道对结构有要求吗？", a: "吊轨承担门扇全部重量，必须固定在牢固的结构上——混凝土梁、砖墙或专门加装的加固衬板。上门时我们会检查洞口上方情况，需要时先增设支撑。" },
        { q: "公寓可以安装推拉门吗？", a: "可以。我们经常在公寓安装推拉门和折叠门，会遵守管理处规定的施工时间，做好电梯保护，并按大楼规定清运废料。" },
        { q: "安装推拉门要多少钱？", a: "费用在量尺后报价，取决于洞口尺寸、门扇数量、门扇类型、轨道系统、是否需要结构加固，以及是否选配缓冲五金。" },
      ],
      metaTitle: "吉隆坡推拉门与折叠门安装 | 依报价",
      metaDesc: "吉隆坡与雪兰莪推拉门、隐藏门与折叠门安装。吊轨系统、耐磨滑轮、地导与缓冲五金，量尺后提供报价。",
    },
  },
  "door/main-entrance-door-installation": {
    ms: {
      name: "Pemasangan Pintu Utama",
      tagline: "Set pintu utama yang lebih berat dengan engsel diperkukuh, persediaan set kunci keselamatan dan kemasan ambang kalis cuaca.",
      description:
        "Pintu utama menanggung beban paling berat di rumah — ia lebih tebal, lebih kerap digunakan dan terdedah kepada hujan, cahaya matahari serta risiko pecah masuk. KL Servis Rumah memasang set pintu utama untuk rumah teres, semi-D, banglo dan unit kondominium: pintu kayu pepejal seperti meranti dan chengal, pintu engineered dengan kulit tahan cuaca, serta pintu logam untuk pintu belakang dan pintu keselamatan. Pemasangan menggunakan tiga hingga empat engsel bebola SS304 dengan skru panjang yang mencengkam bingkai dan struktur di belakangnya, strike plate diperkukuh, serta persediaan mortise untuk set kunci keselamatan atau kunci digital pilihan anda. Bahagian ambang dikemas supaya air hujan tidak melimpah masuk, dan jurang sekeliling dikedap. Setiap set diuji hayun, tutup dan kunci sebelum serahan.",
      highlights: [
        "Engsel bebola SS304 dengan skru panjang untuk daun pintu yang berat",
        "Strike plate diperkukuh untuk rintangan pecah masuk yang lebih baik",
        "Persediaan mortise untuk set kunci keselamatan atau kunci digital",
        "Kemasan ambang dan pengedapan sekeliling untuk hujan tempias",
        "Diuji hayun, tutup dan kunci berulang kali sebelum serahan",
      ],
      process: [
        { step: "01", title: "Ukuran & Semakan Struktur", desc: "Kami mengukur bukaan, menyemak keadaan bingkai serta dinding sekeliling dan mencatat arah tempias hujan." },
        { step: "02", title: "Pilihan Pintu & Kunci", desc: "Jenis pintu, kemasan dan set kunci (mekanikal atau digital) dipilih mengikut keperluan keselamatan dan gaya rumah." },
        { step: "03", title: "Tempahan & Penyediaan", desc: "Pintu dan bingkai ditempah ikut ukuran; bukaan disediakan dan pintu lama ditanggalkan pada hari pemasangan." },
        { step: "04", title: "Pemasangan Set Pintu", desc: "Bingkai disauh aras dan plumb, pintu digantung pada engsel SS304, dan mortise kunci serta strike plate dipasang." },
        { step: "05", title: "Kedap & Ujian", desc: "Ambang dan jurang sekeliling dikedap, kunci diuji berulang kali dan anak kunci atau akses digital diserahkan." },
      ],
      faqs: [
        { q: "Pintu jenis apa paling sesuai untuk pintu utama?", a: "Kayu pepejal seperti meranti atau chengal memberi rasa kukuh dan kedap bunyi, sesuai untuk pintu utama yang terlindung. Untuk pintu yang terdedah terus kepada hujan dan matahari, pintu engineered berkulit tahan cuaca atau pintu logam lebih stabil. Kami mencadangkan pilihan selepas melihat kedudukan pintu anda." },
        { q: "Bolehkah kunci digital dipasang pada pintu utama baharu?", a: "Boleh. Kami menyediakan mortise dan lubang yang betul untuk kunci digital semasa pemasangan supaya tiada kerja potong tambahan kemudian. Pemasangan dan pendaftaran pengguna kunci pintar juga boleh disusun bersama pasukan locksmith kami." },
        { q: "Bagaimana menghalang air hujan masuk di bawah pintu?", a: "Kami mengekalkan jurang bawah yang betul, mengemas bahagian ambang dan boleh memasang pengedap bawah pintu atau ambang drop-down. Untuk pintu yang sangat terdedah, kanopi atau awning tambahan memberi perlindungan yang jauh lebih baik." },
        { q: "Berapa harga pemasangan pintu utama?", a: "Harga disebut selepas ukuran kerana ia bergantung pada jenis dan saiz pintu, bahan bingkai, set kunci pilihan, keperluan menukar bingkai dan kerja kemasan sekeliling. Sebut harga terperinci diberikan sebelum tempahan." },
      ],
      metaTitle: "Pemasangan Pintu Utama KL & Selangor | Atas Sebut Harga",
      metaDesc: "Pasang pintu utama di KL & Selangor. Engsel SS304 skru panjang, strike plate diperkukuh, persediaan kunci digital dan pengedapan ambang. Jaminan 12 bulan.",
    },
    zh: {
      name: "入户大门安装",
      tagline: "较重的入户门成套安装，配加固铰链、安全锁具开孔准备与防风雨门槛收口。",
      description:
        "入户大门是全屋负荷最重的门——门扇更厚、开关最频繁，还要直面日晒雨淋与防盗需求。KL Servis Rumah 为排屋、半独立式、独立洋房与公寓单位安装入户门：meranti、chengal 等实木门，带耐候贴面的工程木门，以及用于后门与安全门的金属门。安装采用 3 至 4 个 SS304 不锈钢滚珠铰链，配长螺丝穿透门框固定到后方结构，并加装加固型锁扣板，同时按您选择的机械安全锁或数字锁预留开槽与孔位。门槛部位做好收口，避免雨水倒灌，周边缝隙一并密封。每套门在交付前都会反复测试开关与锁闭。",
      highlights: [
        "SS304 滚珠铰链配长螺丝，稳稳承托厚重门扇",
        "加固型锁扣板，提升抗撬防破门能力",
        "按机械安全锁或数字锁预留开槽与孔位",
        "门槛收口与周边密封，减少雨水倒灌",
        "交付前反复测试开关与锁闭动作",
      ...
      process: [
        { step: "01", title: "量尺与结构检查", desc: "测量洞口，检查门框与周边墙体状况，并记录雨水飘打方向。" },
        { step: "02", title: "选门与选锁", desc: "根据安全需求与住宅风格确定门型、饰面与锁具（机械锁或数字锁）。" },
        { step: "03", title: "下单与准备", desc: "门与门框按尺寸定制；安装当天完成洞口准备并拆除旧门。" },
        { step: "04", title: "安装门套", desc: "门框按水平垂直固定，门扇挂装在 SS304 铰链上，完成锁具开槽与锁扣板安装。" },
        { step: "05", title: "密封与测试", desc: "门槛与周边缝隙密封，反复测试锁闭，交付钥匙或数字开锁权限。" },
      ],
      faqs: [
        { q: "入户大门选什么门型比较好？", a: "meranti、chengal 等实木门手感厚重、隔音好，适合有遮挡的入户位置。如果门直接受日晒雨淋，带耐候贴面的工程木门或金属门尺寸更稳定。我们会先看门的实际朝向和遮挡情况再建议。" },
        { q: "新装大门可以装数字锁吗？", a: "可以。安装时我们会按数字锁规格提前开槽打孔，避免日后再返工切割。智能锁的安装与用户录入也可以安排我们的锁具团队一并完成。" },
        { q: "怎样防止雨水从门下渗入？", a: "我们会控制合理的门底缝隙、做好门槛收口，也可加装门底密封条或自动升降门底封。对于特别外露的门，加装雨棚或遮阳篷的防护效果会明显更好。" },
        { q: "安装入户大门要多少钱？", a: "价格在量尺后报价，取决于门型与尺寸、门框材质、所选锁具、是否需要换框以及周边收口工程量。下单前会提供逐项报价。" },
      ],
      metaTitle: "吉隆坡入户大门安装 | 依报价",
      metaDesc: "吉隆坡与雪兰莪入户大门安装。SS304 加固铰链、加强锁扣板、数字锁开孔预留与门槛密封，12 个月保修。",
    },
  },
  "door/door-closer-and-hardware-installation": {
    ms: {
      name: "Pemasangan Door Closer & Perkakasan",
      tagline: "Bekalan dan pemasangan door closer, floor spring, penahan pintu, pengedap dan ambang drop-down pada pintu sedia ada atau pintu baharu.",
      description:
        "Perkakasan pintu yang betul menentukan sama ada sebuah pintu ditutup dengan lembut atau menghempas, sama ada ia menahan angin dan bunyi, dan sama ada ia kekal lurus selepas bertahun digunakan. KL Servis Rumah membekal dan memasang pelbagai perkakasan pintu: door closer atas untuk pintu pejabat, kedai dan pintu tahan api; floor spring untuk pintu kaca dan pintu berat; penahan pintu lantai atau dinding untuk melindungi dinding dan tombol; pengedap pinggir dan pengedap bawah pintu untuk mengurangkan bunyi, habuk dan tempias; serta ambang drop-down tersembunyi. Kami juga menukar engsel yang haus, memasang strike plate baharu, dan melaraskan kelajuan tutup serta daya latch door closer supaya pintu menutup rapat tanpa menghempas. Semua kerja disesuaikan dengan jenis pintu dan bingkai sedia ada.",
      highlights: [
        "Door closer atas dan floor spring dipasang serta dilaras dengan betul",
        "Kelajuan tutup dan daya latch ditala supaya pintu tidak menghempas",
        "Penahan pintu lantai atau dinding untuk melindungi dinding dan tombol",
        "Pengedap pinggir, pengedap bawah dan ambang drop-down untuk bunyi serta habuk",
        "Engsel haus dan strike plate boleh ditukar dalam lawatan yang sama",
      ],
      process: [
        { step: "01", title: "Semakan Pintu", desc: "Kami menilai berat pintu, jenis bingkai, arah ayunan dan masalah semasa seperti menghempas, bocor angin atau bunyi." },
        { step: "02", title: "Cadangan Perkakasan", desc: "Model door closer, floor spring atau pengedap yang bersesuaian dengan berat dan penggunaan pintu dicadangkan dalam sebut harga." },
        { step: "03", title: "Penyediaan", desc: "Kedudukan pemasangan ditanda, lubang skru disediakan dan pengikat sesuai dipilih mengikut bahan pintu serta bingkai." },
        { step: "04", title: "Pemasangan", desc: "Perkakasan dipasang dengan kemas, engsel atau strike plate ditukar jika perlu dan pintu diperiksa kelurusannya." },
        { step: "05", title: "Penalaan & Ujian", desc: "Kelajuan tutup, daya latch dan penghenti dilaras, kemudian pintu diuji berulang kali sehingga menutup rapat tanpa menghempas." },
      ],
      faqs: [
        { q: "Door closer atas atau floor spring — mana lebih sesuai?", a: "Door closer atas sesuai untuk kebanyakan pintu kayu dan logam di pejabat, kedai serta pintu tahan api, dan lebih mudah dipasang pada pintu sedia ada. Floor spring biasanya digunakan untuk pintu kaca atau pintu berat yang memerlukan kemasan lebih bersih, tetapi memerlukan persediaan lantai." },
        { q: "Kenapa pintu saya menghempas kuat?", a: "Biasanya kerana tiada door closer, kelajuan tutup door closer sedia ada tidak ditala, atau tekanan angin dari tingkap dan aircond terbuka. Kami melaras injap kelajuan dan daya latch, dan boleh memasang penahan pintu supaya dinding serta tombol tidak rosak." },
        { q: "Bolehkah pengedap dipasang pada pintu sedia ada?", a: "Boleh. Pengedap pinggir, berus bawah pintu dan ambang drop-down direka untuk dipasang pada pintu sedia ada dan sangat membantu mengurangkan bunyi, habuk serta tempias di bawah pintu utama dan pintu bilik." },
        { q: "Berapakah kos memasang door closer?", a: "Kos disebut harga selepas semakan kerana ia bergantung pada jenis dan jenama perkakasan, berat pintu, bilangan pintu dan sama ada engsel atau strike plate turut perlu ditukar." },
      ],
      metaTitle: "Pemasangan Door Closer & Perkakasan Pintu KL | Sebut Harga",
      metaDesc: "Pasang door closer, floor spring, penahan pintu, pengedap dan ambang drop-down di KL & Selangor. Kelajuan tutup ditala. Jaminan perkakasan 12 bulan.",
    },
    zh: {
      name: "闭门器与五金安装",
      tagline: "为现有门或新装门供应并安装闭门器、地弹簧、门吸、密封条与自动升降门底封。",
      description:
        "门五金配得对不对，决定了门是轻柔回位还是砰砰甩门，能不能挡风隔音，以及用了几年后是否还能保持端正。KL Servis Rumah 供应并安装各类门五金：适用于办公室、店铺与防火门的上置闭门器；适用于玻璃门与重型门扇的地弹簧；保护墙面与门把手的地装或墙装门吸；降低噪音、灰尘与飘雨的门边密封条与门底密封；以及隐藏式自动升降门底封。我们同时可更换磨损铰链、加装新锁扣板，并调校闭门器的关门速度与终段闭合力，让门轻柔而严实地关到位。所有做法都会配合现有门扇与门框的实际条件。",
      highlights: [
        "上置闭门器与地弹簧规范安装并逐项调校",
        "调整关门速度与终段闭合力，避免甩门",
        "地装或墙装门吸，保护墙面与门把手",
        "门边密封、门底密封与自动升降门底封，降噪防尘",
        "同一次上门可一并更换磨损铰链与锁扣板",
      ],
      process: [
        { step: "01", title: "检查门扇", desc: "评估门扇重量、门框类型、开门方向以及甩门、漏风、异响等现有问题。" },
        { step: "02", title: "五金选型", desc: "按门重与使用频率推荐合适的闭门器、地弹簧或密封配件，并列入报价。" },
        { step: "03", title: "安装准备", desc: "标出安装位置、预打螺丝孔，并按门与门框材质选择合适固定件。" },
        { step: "04", title: "现场安装", desc: "规范安装五金，必要时更换铰链或锁扣板，并复核门扇是否端正。" },
        { step: "05", title: "调校测试", desc: "调整关门速度、闭合力与限位，反复测试至门能轻柔严实关到位。" },
      ],
      faqs: [
        { q: "上置闭门器和地弹簧怎么选？", a: "办公室、店铺与防火门的大多数木门和金属门用上置闭门器就足够，且更容易加装在现有门上。地弹簧多用于玻璃门或重型门，外观更简洁，但需要提前处理地面预埋。" },
        { q: "我家的门为什么总是砰地甩上？", a: "常见原因是没有闭门器、现有闭门器速度未调，或是窗户与空调造成的室内风压。我们会调整速度阀与终段闭合力，也可加装门吸，避免撞坏墙面和把手。" },
        { q: "现有的门可以加装密封条吗？", a: "可以。门边密封条、门底毛刷条与自动升降门底封都可以加装在现有门上，对减少噪音、灰尘以及大门和房门下方的飘雨很有效。" },
        { q: "安装闭门器要多少钱？", a: "费用在检查后报价，取决于五金类型与品牌、门扇重量、安装数量，以及是否需要同时更换铰链或锁扣板。" },
      ],
      metaTitle: "吉隆坡闭门器与门五金安装 | 依报价",
      metaDesc: "吉隆坡与雪兰莪闭门器、地弹簧、门吸、密封条与门底封安装调校。关门速度可调，五金享 12 个月保修。",
    },
  },
  ...
  "welding/iron-works": {
    ms: {
      name: "Kerja Besi",
      tagline: "Kerja besi tersuai untuk rumah dan kedai — rangka, penyangga, bracket, penutup dan struktur kecil yang difabrikasi mengikut ukuran tapak.",
      description:
        "Bukan semua keperluan logam di rumah termasuk dalam kategori pagar atau grill. KL Servis Rumah menerima kerja besi tersuai: rangka penyangga tangki air, bracket penyandar unit luar penghawa dingin, rangka sokongan singki dan meja kerja, penutup meter dan pam, penghadang kecil, tangga servis, serta rangka untuk papan tanda kedai. Kerja bermula dengan ukuran tapak dan lakaran ringkas supaya dimensi, ketebalan profil dan kaedah pemasangan disahkan sebelum fabrikasi. Kami menggunakan besi hollow, angle bar, flat bar atau channel mengikut beban yang dijangka. Semua kimpalan dicanai, permukaan dibersihkan daripada kerak, kemudian primer kalis karat dan cat akhir disapu. Pemasangan menggunakan angkur yang sesuai dengan bahan pemasangan sama ada konkrit, bata atau struktur besi sedia ada.",
      highlights: [
        "Fabrikasi tersuai mengikut ukuran tapak, bukan saiz standard",
        "Profil besi hollow, angle, flat atau channel dipilih mengikut beban",
        "Lakaran ringkas disahkan sebelum fabrikasi bermula",
        "Kimpalan dicanai licin, primer kalis karat dan cat akhir disapu",
        "Angkur dipadankan dengan konkrit, bata atau struktur besi sedia ada",
      ],
      process: [
        { step: "01", title: "Bincang Keperluan", desc: "Kami memahami fungsi, beban yang dijangka dan lokasi pemasangan untuk kerja besi yang diperlukan." },
        { step: "02", title: "Ukuran & Lakaran", desc: "Dimensi tapak diukur dan lakaran ringkas disediakan untuk pengesahan sebelum bahan dipesan." },
        { step: "03", title: "Fabrikasi Bengkel", desc: "Profil dipotong, dikimpal dan dicanai di bengkel, kemudian permukaan disediakan untuk primer." },
        { step: "04", title: "Pemasangan Tapak", desc: "Struktur dipasang aras, disauh dengan angkur sesuai dan diperiksa kestabilannya." },
        { step: "05", title: "Kemasan Akhir", desc: "Titik kimpalan tapak disentuh semula dengan primer dan cat, dan kawasan kerja dibersihkan." },
      ],
      faqs: [
        { q: "Bolehkah kerja besi difabrikasi mengikut ukuran saya sendiri?", a: "Ya, itulah asas kerja besi tersuai. Kami mengukur di tapak, mengesahkan lakaran dengan anda, dan memfabrikasi mengikut dimensi sebenar supaya ia muat pada ruang yang ada tanpa pengubahsuaian tergesa-gesa semasa pemasangan." },
        { q: "Ketebalan besi apa yang digunakan?", a: "Ketebalan dipilih mengikut beban dan bentang. Bracket ringan menggunakan profil nipis, manakala rangka tangki air atau platform yang memikul berat memerlukan profil lebih tebal. Kami menyatakan saiz profil yang dicadangkan dalam sebut harga." },
        { q: "Adakah kerja besi luaran akan cepat berkarat?", a: "Karat berlaku apabila permukaan tidak disediakan dengan betul. Kami membersihkan kerak kimpalan, menyapu primer kalis karat dan cat akhir. Untuk pendedahan yang sangat teruk, hot-dip galvanized atau kemasan tambahan boleh dibincangkan semasa sebut harga." },
        { q: "Berapakah kos kerja besi tersuai?", a: "Kos disebut harga selepas ukuran kerana ia bergantung pada berat bahan, kerumitan fabrikasi, kemasan cat, ketinggian pemasangan dan akses ke lokasi kerja." },
      ],
      metaTitle: "Kerja Besi Tersuai KL & Selangor | Atas Sebut Harga",
      metaDesc: "Kerja besi tersuai di KL & Selangor — rangka, bracket, penutup dan struktur kecil. Kimpalan dicanai, primer kalis karat. Jaminan kimpalan 12 bulan.",
    },
    zh: {
      name: "铁工制作",
      tagline: "住宅与店铺定制铁件——支架、托架、防护罩与小型钢结构，按现场尺寸加工制作。",
      description:
        "家里需要的金属件并不都属于大门或格栅。KL Servis Rumah 承接各类定制铁工：水箱支撑架、空调外机托架、水槽与工作台支撑架、水表与水泵防护罩、小型隔挡、检修爬梯，以及店铺招牌骨架等。施工从现场量尺与简图确认开始，先定好尺寸、型材壁厚与固定方式，再进入加工。我们按预计荷载选用方通、角钢、扁铁或槽钢。所有焊缝打磨平整，表面除渣清理后涂刷防锈底漆与面漆。安装时按基材是混凝土、砖墙还是既有钢结构，选用相应的锚固方式。",
      highlights: [
        "按现场实测尺寸定制，不受标准规格限制",
        "按荷载选用方通、角钢、扁铁或槽钢型材",
        "加工前先确认简图与尺寸方案",
      ...
      process: [
        { step: "01", title: "沟通需求", desc: "了解铁件的用途、预计承重与安装位置等具体要求。" },
        { step: "02", title: "量尺出图", desc: "现场测量尺寸并出简图确认，之后再采购材料。" },
        { step: "03", title: "工厂加工", desc: "型材下料、焊接、打磨，并做好上底漆前的表面处理。" },
        { step: "04", title: "现场安装", desc: "构件校平后用合适锚固件固定，并检查整体稳固性。" },
        { step: "05", title: "涂装收尾", desc: "现场焊点补涂底漆与面漆，并清理施工区域。" },
      ],
      faqs: [
        { q: "可以按我自己的尺寸定制吗？", a: "可以，这正是定制铁工的核心。我们会现场量尺、与您确认图样，再按实际尺寸加工，避免安装时临时切割拼凑。" },
        { q: "会用多厚的铁料？", a: "壁厚按荷载和跨度确定。轻型托架用较薄型材即可，而水箱支架或承重平台则需要更厚的型材。建议的型材规格会在报价中写明。" },
        { q: "室外铁件会不会很快生锈？", a: "生锈多半源于表面处理不到位。我们会清除焊渣、涂刷防锈底漆与面漆。若外露环境特别恶劣，也可以在报价阶段讨论热浸镀锌等加强处理方案。" },
        { q: "定制铁工多少钱？", a: "费用在量尺后报价，取决于用料重量、加工复杂度、涂装方式、安装高度以及现场作业条件。" },
      ],
      metaTitle: "吉隆坡定制铁工制作安装 | 依报价",
      metaDesc: "吉隆坡与雪兰莪定制铁工——支架、托架、防护罩与小型钢构。焊缝打磨、防锈涂装，12 个月焊接保修。",
    },
  },
  "welding/metal-grille-installation": {
    ms: {
      name: "Pemasangan Grill Logam",
      tagline: "Grill keselamatan untuk tingkap, pintu, laluan udara dan bukaan servis, difabrikasi mengikut ukuran dan disauh pada struktur.",
      description:
        "Grill logam ialah penghadang keselamatan pertama pada kebanyakan rumah teres, rumah pangsa dan kedai di Lembah Klang. KL Servis Rumah memfabrikasi dan memasang grill untuk tingkap, pintu gelangsar, laluan udara dapur, bukaan tangga dan lubang servis. Ukuran diambil di tapak kerana bukaan rumah lama jarang sepadan dengan saiz standard. Kami menggunakan besi hollow atau bar pepejal dengan jarak bar yang direka supaya tidak boleh dimasuki, dan menyauh grill dengan angkur yang mencengkam bata atau konkrit di sebalik plaster — kekuatan pemasangan sama pentingnya dengan kekuatan grill itu sendiri. Panel boleh buka dengan mangga dalaman boleh disertakan untuk bilik tidur sebagai laluan keluar kecemasan. Kemasan merangkumi primer kalis karat dan cat akhir dalam warna pilihan anda.",
      highlights: [
        "Difabrikasi mengikut ukuran bukaan sebenar di tapak",
        "Besi hollow atau bar pepejal dengan jarak bar yang selamat",
        "Angkur mencengkam bata atau konkrit, bukan hanya lapisan plaster",
        "Panel boleh buka dengan mangga dalaman untuk laluan keluar bilik tidur",
        "Primer kalis karat dan cat akhir dalam warna pilihan anda",
      ],
      process: [
        { step: "01", title: "Ukuran Bukaan", desc: "Setiap bukaan diukur dan keadaan dinding di sekelilingnya disemak untuk kedudukan angkur." },
        { step: "02", title: "Reka Bentuk Grill", desc: "Corak, saiz profil, jarak bar dan bilangan panel boleh buka disahkan bersama anda." },
        { step: "03", title: "Fabrikasi", desc: "Grill dipotong, dikimpal dan dicanai di bengkel, kemudian disapu primer kalis karat." },
        { step: "04", title: "Pemasangan", desc: "Grill dipasang aras dan disauh pada struktur dengan angkur yang sesuai untuk bahan dinding." },
        { step: "05", title: "Ujian & Kemasan", desc: "Panel boleh buka diuji, tepi tajam diperiksa, cat disentuh semula dan kawasan dibersihkan." },
      ],
      faqs: [
        { q: "Jarak bar berapa yang selamat?", a: "Jarak bar dirancang supaya bukaan terlalu kecil untuk dimasuki, dan lebih rapat lagi di rumah berkanak-kanak untuk mengelakkan kepala atau anggota badan tersepit. Kami mencadangkan jarak yang bersesuaian semasa lawatan ukuran." },
        { q: "Adakah grill boleh dipasang pada dinding gipsum?", a: "Tidak selamat. Grill mesti disauh pada bata, konkrit atau struktur logam yang kukuh. Jika dinding di sekeliling bukaan adalah partition ringan, kami mencari struktur di belakangnya atau memasang rangka sokongan tambahan." },
        { q: "Bagaimana grill boleh dibuka semasa kebakaran?", a: "Kami memasang panel boleh buka dengan mangga di bahagian dalam untuk bilik tidur dan laluan keluar utama. Kunci tersebut kekal di dalam supaya penghuni boleh keluar dengan cepat semasa kecemasan." },
        { q: "Berapakah kos grill logam?", a: "Kos disebut harga selepas ukuran kerana ia bergantung pada keluasan bukaan, jenis dan ketebalan profil, kerumitan corak, bilangan panel boleh buka serta kemasan cat." },
      ],
      metaTitle: "Pemasangan Grill Logam Keselamatan KL | Sebut Harga",
      metaDesc: "Grill logam ikut ukuran untuk tingkap dan pintu di KL & Selangor. Angkur ke bata atau konkrit, panel keluar kecemasan, cat kalis karat.",
    },
    zh: {
      name: "金属防盗格栅安装",
      tagline: "窗户、门扇、通风口与检修口的安全格栅，按尺寸定制并锚固到结构层。",
      description:
        "在巴生谷，金属格栅是排屋、组屋与店铺最基础的第一道安全屏障。KL Servis Rumah 为窗户、推拉门、厨房通风口、楼梯洞口与检修口定制并安装格栅。尺寸一律现场实测，因为老房子的洞口很少能对上标准规格。我们采用方通或实心圆钢，栏杆间距按防钻入原则设计，并使用能穿透批荡层咬合砖墙或混凝土的锚固件——安装的牢固程度和格栅本身的强度同样重要。卧室可加装带内侧挂锁的可开启扇，作为紧急逃生出口。表面处理包含防锈底漆与您指定颜色的面漆。",
      highlights: [
        "按现场实测洞口尺寸定制加工",
        "方通或实心圆钢，栏杆间距按防钻入设计",
        "锚固件咬合砖墙或混凝土，而非只固定在批荡层",
        "卧室可加装带内锁的可开启逃生扇",
        "防锈底漆加指定颜色面漆",
      ],
      process: [
        { step: "01", title: "洞口测量", desc: "逐个测量洞口，并检查周边墙体状况以确定锚固点位。" },
        { step: "02", title: "格栅设计", desc: "与您确认花式、型材规格、栏杆间距与可开启扇数量。" },
        { step: "03", title: "工厂加工", desc: "下料、焊接、打磨，出厂前完成防锈底漆处理。" },
        { step: "04", title: "现场安装", desc: "格栅校平后按墙体材质选用锚固件固定到结构层。" },
        { step: "05", title: "测试收尾", desc: "测试可开启扇、检查尖锐边角、补涂漆面并清理现场。" },
      ],
      faqs: [
        { q: "栏杆间距多少才安全？", a: "间距按无法钻入的原则设计；有小孩的家庭还会再收紧一些，避免头部或肢体卡住。具体尺寸我们会在量尺时给出建议。" },
        { q: "石膏板墙上能装格栅吗？", a: "不安全。格栅必须锚固在砖墙、混凝土或牢固的金属结构上。如果洞口周边是轻质隔墙，我们会寻找后方结构，或额外加设支撑骨架。" },
        { q: "发生火灾时格栅能打开吗？", a: "卧室与主要疏散通道我们会设置带内侧挂锁的可开启扇，锁具留在室内一侧，紧急情况下住户可以迅速开启撤离。" },
        { q: "金属格栅多少钱？", a: "费用在量尺后报价，取决于洞口面积、型材类型与壁厚、花式复杂度、可开启扇数量以及涂装方式。" },
      ],
      metaTitle: "吉隆坡金属防盗格栅安装 | 依报价",
      metaDesc: "吉隆坡与雪兰莪定制窗门金属格栅。锚入砖墙混凝土、逃生开启扇与防锈涂装，量尺后报价。",
    },
  },
  "welding/metal-gate-repair": {
    ms: {
      name: "Pembaikan Pagar Logam",
      tagline: "Baiki pagar yang senget, engsel longgar, kimpalan retak, roda haus dan bahagian berkarat tanpa menggantikan keseluruhan pagar.",
      description:
        "Pagar rumah yang menggesel lantai, tidak boleh dikunci atau bergoyang setiap kali ditolak biasanya boleh dibaiki tanpa perlu difabrikasi semula. KL Servis Rumah menjalankan pembaikan kimpalan di tapak untuk pagar gelangsar dan pagar berayun: engsel yang longgar atau haus diganti, sambungan kimpalan yang retak dikimpal semula dan diperkukuh, roda pagar gelangsar yang haus ditukar, trek lantai yang bengkok diluruskan atau digantikan bahagiannya, dan bar bawah yang berkarat dipotong lalu diganti dengan profil baharu. Untuk pagar yang telah mendap, tiang pagar diperiksa kerana masalah selalunya berpunca daripada tapak tiang yang bergerak. Selepas pembaikan struktur, kawasan yang dikerjakan dibersihkan daripada karat, disapu primer dan dicat semula supaya sepadan dengan kemasan sedia ada.",
      highlights: [
        "Pembaikan kimpalan dijalankan terus di tapak tanpa membawa pagar keluar",
        "Engsel haus, roda dan trek pagar gelangsar diganti atau diluruskan",
        "Sambungan kimpalan retak dikimpal semula dan diperkukuh",
        "Tiang pagar diperiksa apabila pagar mendap atau senget",
        "Kawasan dibaiki dibersihkan daripada karat, diprimer dan dicat semula",
      ],
      process: [
        { step: "01", title: "Pemeriksaan Pagar", desc: "Kami mengendalikan pagar, memeriksa engsel, roda, trek, kimpalan dan tiang untuk mengenal pasti punca." },
        { step: "02", title: "Sebut Harga Pembaikan", desc: "Komponen yang perlu diganti dan skop kimpalan dijelaskan sebelum kerja bermula." },
        { step: "03", title: "Kerja Kimpalan", desc: "Sambungan retak dikimpal semula, pengukuh ditambah dan bahagian berkarat dipotong serta diganti." },
        { step: "04", title: "Penggantian Perkakasan", desc: "Engsel, roda, penahan dan bahagian trek yang haus diganti, kemudian pagar dijajarkan semula." },
        { step: "05", title: "Kemasan & Ujian", desc: "Karat dibersihkan, primer dan cat disapu, dan pagar diuji buka-tutup serta kunci berulang kali." },
      ],
      faqs: [
        { q: "Kenapa pagar gelangsar saya semakin berat ditolak?", a: "Punca biasa ialah roda yang haus atau bearingnya rosak, trek lantai yang penuh pasir atau bengkok, atau pagar yang sudah tidak aras kerana tiang mendap. Kami memeriksa ketiga-tiganya sebelum mencadangkan pembaikan." },
        { q: "Boleh pagar dibaiki tanpa dibuat semula?", a: "Dalam kebanyakan kes ya. Selagi rangka utama masih kukuh dan tidak reput karat sepenuhnya, pembaikan kimpalan, penggantian perkakasan dan kerja cat sudah memulihkan fungsi pagar dengan kos yang jauh lebih rendah." },
        { q: "Adakah kerja kimpalan boleh dibuat di rumah saya?", a: "Ya. Pembaikan pagar lazimnya dijalankan di tapak menggunakan set kimpalan mudah alih, dengan perlindungan pada lantai dan kawasan sekeliling untuk mengelakkan percikan mengenai permukaan lain." },
        { q: "Berapakah kos pembaikan pagar?", a: "Kos disebut harga selepas pemeriksaan kerana ia bergantung pada bilangan sambungan yang perlu dikimpal, perkakasan yang perlu diganti, tahap karat dan sama ada kerja cat semula diperlukan." },
      ],
      metaTitle: "Pembaikan Pagar Logam & Kimpalan KL | Atas Sebut Harga",
      metaDesc: "Baiki pagar senget, engsel longgar dan roda haus di KL & Selangor. Kimpalan di tapak, penggantian trek, rawatan karat dan cat semula.",
    },
    zh: {
      name: "金属大门维修",
      tagline: "维修下沉歪斜、铰链松动、焊缝开裂、滑轮磨损与锈蚀的大门，无需整体更换。",
      description:
        "大门刮地、锁不上，或一推就晃，多数情况下不必重新制作整扇门。KL Servis Rumah 提供上门焊接维修，适用于推拉门与平开门：更换松动或磨损的铰链、重新焊接并加固开裂焊缝、更换磨损的推拉门滑轮、校直或局部更换变形的地轨，以及切除锈穿的下横档并换上新型材。若大门已经明显下沉，我们还会检查门柱，因为问题往往出在柱基位移。结构修复完成后，施工部位会做除锈、涂底漆并补面漆，尽量与原有涂装保持一致。",
      highlights: [
        "现场上门焊接维修，无需把大门拆走送厂",
        "更换磨损铰链、滑轮，并校直或更换地轨",
        "开裂焊缝重新焊接并加设补强",
      ...
      process: [
        { step: "01", title: "检查大门", desc: "实际操作大门，检查铰链、滑轮、地轨、焊缝与门柱，找出根本原因。" },
        { step: "02", title: "维修报价", desc: "开工前说明需要更换的部件与焊接工作范围。" },
        { step: "03", title: "焊接施工", desc: "重新焊接开裂节点、增设补强，并切除更换锈蚀部位。" },
        { step: "04", title: "更换五金", desc: "更换磨损的铰链、滑轮、限位与地轨部件，并重新校正门扇。" },
        { step: "05", title: "涂装测试", desc: "除锈、上底漆补面漆，并反复测试开关与上锁动作。" },
      ],
      faqs: [
        { q: "推拉大门为什么越来越难推？", a: "常见原因是滑轮磨损或轴承损坏、地轨积沙或变形，以及门柱下沉导致门扇不再水平。我们会把这三项都检查一遍再给出维修方案。" },
        { q: "大门可以只修不重做吗？", a: "多数情况可以。只要主框架还结实、没有整体锈穿，通过焊接修复、更换五金和重新涂装就能恢复使用，费用比重做低得多。" },
        { q: "焊接可以在家里现场做吗？", a: "可以。大门维修通常使用便携式焊机现场作业，施工时会对地面与周边做好遮护，防止焊接火花损伤其他表面。" },
        { q: "大门维修多少钱？", a: "费用在检查后报价，取决于需要焊接的节点数量、更换的五金件、锈蚀程度，以及是否需要整体重新涂装。" },
      ],
      metaTitle: "吉隆坡金属大门维修与焊接 | 依报价",
      metaDesc: "吉隆坡与雪兰莪大门下沉、铰链松动与滑轮磨损维修。上门焊接、更换地轨、除锈补漆，检查后报价。",
    },
  },
  "welding/stainless-steel-railing-fabrication": {
    ms: {
      name: "Fabrikasi Railing Stainless Steel",
      tagline: "Railing stainless steel SS304 untuk tangga, balkoni dan laluan, dicanai kemas dan disauh dengan plat tapak pada struktur.",
      description:
        "Railing stainless steel memberi kemasan bersih yang kekal berkilat tanpa perlu dicat semula setiap tahun, dan ia menjadi pilihan biasa untuk tangga dalaman, balkoni, ramp dan laluan koridor. KL Servis Rumah memfabrikasi railing menggunakan tiub SS304 untuk kegunaan dalaman dan luaran biasa, dengan pilihan kemasan hairline atau mirror. Reka bentuk boleh menggabungkan bar mendatar, bar menegak, panel kaca tempered atau tali kabel. Setiap sambungan dikimpal TIG supaya kemasan lebih bersih, kemudian dicanai dan digilap sehingga garis kimpalan hampir tidak kelihatan. Tiang disauh menggunakan plat tapak dengan angkur ke dalam konkrit, dan jarak tiang dirancang supaya railing tidak bergoyang. Ketinggian railing dan jarak bar dirancang mengambil kira keselamatan kanak-kanak.",
      highlights: [
        "Tiub SS304 dengan pilihan kemasan hairline atau mirror",
        "Kimpalan TIG dicanai dan digilap sehingga sambungan hampir tidak kelihatan",
        "Pilihan bar mendatar, menegak, panel kaca tempered atau tali kabel",
        "Plat tapak disauh ke dalam konkrit dengan jarak tiang yang dirancang",
        "Ketinggian dan jarak bar mengambil kira keselamatan kanak-kanak",
      ],
      process: [
        { step: "01", title: "Ukuran & Reka Bentuk", desc: "Panjang, ketinggian dan sudut tangga diukur, dan gaya railing dipilih bersama anda." },
        { step: "02", title: "Pengesahan Lakaran", desc: "Jarak tiang, saiz tiub, jenis pengisi dan kemasan permukaan disahkan sebelum fabrikasi." },
        { step: "03", title: "Fabrikasi", desc: "Tiub dipotong dan dilentur mengikut sudut, dikimpal TIG, kemudian dicanai dan digilap." },
        { step: "04", title: "Pemasangan", desc: "Plat tapak disauh pada konkrit, tiang ditegakkan aras dan bahagian atas railing disambung." },
        { step: "05", title: "Gilap & Semakan", desc: "Titik kimpalan tapak digilap semula, kestabilan railing diuji dan permukaan dibersihkan." },
      ],
      faqs: [
        { q: "Adakah stainless steel akan berkarat?", a: "SS304 sangat tahan karat untuk kegunaan dalaman dan kebanyakan lokasi luaran, tetapi ia boleh menunjukkan bintik permukaan jika terdedah kepada air masin atau bahan kimia. Membersihkan permukaan secara berkala mengekalkan kemasannya." },
        { q: "Boleh railing digabungkan dengan panel kaca?", a: "Boleh. Kombinasi tiang stainless steel dengan panel kaca tempered sangat popular untuk tangga dan balkoni kerana ia mengekalkan pandangan terbuka. Ketebalan kaca dan kaedah pemegangan disahkan semasa reka bentuk." },
        { q: "Berapa ketinggian railing yang sesuai?", a: "Ketinggian dipilih supaya selesa dipegang dan selamat untuk kanak-kanak, dan bahagian balkoni lazimnya lebih tinggi berbanding pemegang tangga. Kami mencadangkan ketinggian yang sesuai mengikut lokasi semasa lawatan." },
        { q: "Berapakah kos railing stainless steel?", a: "Kos disebut harga selepas ukuran kerana ia bergantung pada panjang railing, saiz tiub, jenis pengisi, kemasan permukaan, kerumitan sudut tangga dan keadaan struktur pemasangan." },
      ],
      metaTitle: "Fabrikasi Railing Stainless Steel KL | Atas Sebut Harga",
      metaDesc: "Railing stainless steel SS304 untuk tangga dan balkoni di KL & Selangor. Kimpalan TIG digilap, plat tapak berangkur. Jaminan kimpalan 12 bulan.",
    },
    zh: {
      name: "不锈钢栏杆制作",
      tagline: "楼梯、阳台与走道的 SS304 不锈钢栏杆，焊点打磨抛光，底板锚固于结构层。",
      description:
        "不锈钢栏杆外观干净、常年保持光泽，不必每年重新补漆，因此常用于室内楼梯、阳台、坡道与走廊。KL Servis Rumah 采用 SS304 不锈钢管制作，适用于室内与一般室外环境，表面可选拉丝或镜面。样式上可搭配横杆、竖杆、钢化玻璃板或钢索。所有节点采用 TIG 氩弧焊，焊后打磨抛光，焊缝几乎看不出来。立柱通过底板加锚栓固定在混凝土上，立柱间距按防晃动原则设计。栏杆高度与栏杆间距也会兼顾儿童安全考虑。",
      highlights: [
        "SS304 不锈钢管，可选拉丝或镜面表面处理",
        "TIG 氩弧焊接，焊后打磨抛光几乎无痕",
        "可搭配横杆、竖杆、钢化玻璃或钢索样式",
        "底板锚栓固定混凝土，立柱间距经过设计",
        "高度与栏杆间距兼顾儿童安全",
      ...
      process: [
        { step: "01", title: "量尺设计", desc: "测量长度、高度与楼梯坡度角，并与您确定栏杆样式。" },
        { step: "02", title: "图样确认", desc: "加工前确认立柱间距、管径规格、填充形式与表面处理。" },
        { step: "03", title: "工厂加工", desc: "按角度切割弯管，TIG 焊接成型后打磨抛光。" },
        { step: "04", title: "现场安装", desc: "底板锚固于混凝土，立柱校正扶正后连接上部扶手。" },
        { step: "05", title: "抛光验收", desc: "现场焊点重新抛光，测试栏杆稳固性并清洁表面。" },
      ],
      faqs: [
        { q: "不锈钢会生锈吗？", a: "SS304 在室内和大多数室外环境下抗锈性能很好，但若长期接触盐分或化学品，表面可能出现锈点。定期擦拭清洁就能保持光泽。" },
        { q: "栏杆可以搭配玻璃吗？", a: "可以。不锈钢立柱配钢化玻璃是楼梯与阳台的热门做法，视野更通透。玻璃厚度与夹持方式会在设计阶段一并确认。" },
        { q: "栏杆做多高比较合适？", a: "高度以握持舒适、对儿童安全为准，阳台部位通常比楼梯扶手更高一些。我们会在现场勘查时按位置给出建议高度。" },
        { q: "不锈钢栏杆多少钱？", a: "费用在量尺后报价，取决于栏杆长度、管径规格、填充形式、表面处理、楼梯转角复杂度以及安装基层状况。" },
      ],
      metaTitle: "吉隆坡不锈钢栏杆制作安装 | 依报价",
      metaDesc: "吉隆坡与雪兰莪楼梯阳台 SS304 不锈钢栏杆。TIG 焊接抛光、底板锚固安装，12 个月焊接保修。",
    },
  },
  "welding/steel-structure-and-awning-fabrication": {
    ms: {
      name: "Fabrikasi Struktur Besi & Awning",
      tagline: "Rangka besi untuk awning, car porch, penutup laluan dan bumbung tambahan, dengan pilihan penutup polycarbonate atau metal deck.",
      description:
        "Awning dan penutup laluan melindungi kereta, pintu masuk dan ruang jemuran daripada hujan serta panas terik. KL Servis Rumah memfabrikasi rangka besi untuk car porch, awning tingkap, penutup laluan sisi, penutup ruang jemuran dan bumbung tambahan halaman belakang. Reka bentuk bermula dengan bentang, ketinggian dan cara sokongan — sama ada dipasang pada dinding rumah, disokong dengan tiang, atau gabungan kedua-duanya. Profil besi hollow atau I-beam dipilih mengikut bentang dan beban, dan kecerunan bumbung dirancang supaya air hujan mengalir ke arah yang betul dan tidak melimpah ke pintu masuk. Penutup boleh dipilih antara lembaran polycarbonate untuk cahaya semula jadi atau metal deck untuk pengurangan haba. Semua kimpalan dicanai, disapu primer kalis karat dan dicat, serta sambungan ke dinding dikedap.",
      highlights: [
        "Rangka besi hollow atau I-beam dipilih mengikut bentang dan beban",
        "Sokongan pada dinding, tiang atau gabungan mengikut susun atur tapak",
        "Kecerunan bumbung dirancang supaya air mengalir jauh dari pintu masuk",
        "Pilihan penutup polycarbonate untuk cahaya atau metal deck untuk haba",
        "Kimpalan dicanai, diprimer, dicat dan sambungan ke dinding dikedap",
      ],
      process: [
        { step: "01", title: "Lawatan & Ukuran", desc: "Bentang, ketinggian, kedudukan tiang dan keadaan dinding sokongan diukur serta diperiksa." },
        { step: "02", title: "Reka Bentuk Rangka", desc: "Saiz profil, jarak rasuk, kecerunan dan jenis penutup dicadangkan mengikut beban serta bentang." },
        { step: "03", title: "Fabrikasi", desc: "Rangka dipotong dan dikimpal di bengkel mengikut ukuran tapak, kemudian disapu primer." },
        { step: "04", title: "Pemasangan Struktur", desc: "Tiang ditegakkan dan rangka disauh pada dinding atau tapak konkrit dengan angkur yang sesuai." },
        { step: "05", title: "Penutup & Kemasan", desc: "Lembaran penutup dipasang, sambungan dinding dikedap, cat disentuh semula dan aliran air diuji." },
      ],
      faqs: [
      ...
      metaTitle: "Fabrikasi Awning & Struktur Besi KL | Atas Sebut Harga",
      metaDesc: "Rangka besi awning dan car porch di KL & Selangor. Polycarbonate atau metal deck, kecerunan dirancang, primer kalis karat dan cat.",
    },
    zh: {
      name: "钢结构与雨棚制作",
      tagline: "雨棚、车棚、通道遮盖与加建屋顶的钢结构骨架，可选阳光板或彩钢瓦覆面。",
      description:
        "雨棚与通道遮盖能为车辆、入户口和晾晒区挡雨遮阳。KL Servis Rumah 承接车棚、窗户雨棚、侧巷遮盖、晾衣区顶棚与后院加建屋顶的钢骨架制作。设计先从跨度、净高与支撑方式入手——是固定在住宅墙体上、由立柱支撑，还是两者结合。按跨度与荷载选用方通或工字钢型材，屋面坡度经过规划，确保雨水导向正确方向，不会倒灌到入户口。覆面材料可选阳光板（保留自然采光）或彩钢瓦（隔热更好）。所有焊缝打磨后涂刷防锈底漆与面漆，与墙体的接缝一并做密封处理。",
      highlights: [
        "按跨度与荷载选用方通或工字钢骨架",
        "支撑方式可为墙体固定、立柱支撑或两者结合",
        "屋面坡度经过规划，雨水导离入户口",
        "覆面可选采光阳光板或隔热彩钢瓦",
        "焊缝打磨、防锈涂装，墙体接缝做密封",
      ],
      process: [
        { step: "01", title: "现场勘测", desc: "测量跨度、净高与立柱位置，并检查承力墙体的实际状况。" },
        { step: "02", title: "骨架设计", desc: "按荷载与跨度确定型材规格、梁间距、屋面坡度与覆面材料。" },
        { step: "03", title: "工厂加工", desc: "按现场尺寸下料焊接骨架，并完成防锈底漆处理。" },
        { step: "04", title: "结构安装", desc: "立柱就位，骨架用合适锚栓固定到墙体或混凝土基础上。" },
        { step: "05", title: "覆面收尾", desc: "安装覆面板材、密封墙体接缝、补涂漆面并测试排水效果。" },
      ],
      faqs: [
        { q: "阳光板和彩钢瓦哪个更好？", a: "阳光板能透进自然光，适合侧巷通道和晾晒区。彩钢瓦隔热效果和降低雨噪的表现更好，适合车棚与户外休息区。选哪种主要看您更看重采光还是凉爽。" },
        { q: "装雨棚需要审批吗？", a: "部分地方政府与住宅区管理方对加建构筑物有规定，包括退界距离等。建议您先确认当地要求，我们会按获批的规格施工。" },
        { q: "可以直接固定在现有墙上吗？", a: "如果墙体强度足够是可以的。我们会检查墙体类型与后方结构；若墙体不足以承担全部荷载，会增设支撑立柱分担受力。" },
        { q: "雨棚或车棚要多少钱？", a: "费用在现场勘查后报价，取决于面积、跨度、型材规格、覆面材料、是否需要立柱与混凝土基础，以及现场施工条件。" },
      ],
      metaTitle: "吉隆坡钢结构雨棚与车棚制作 | 依报价",
      metaDesc: "吉隆坡与雪兰莪雨棚、车棚钢骨架制作。阳光板或彩钢瓦覆面、坡度规划与防锈涂装，勘查后报价。",
    },
  },
  "welding/anti-rust-treatment-and-repainting": {
    ms: {
      name: "Rawatan Kalis Karat & Cat Semula",
      tagline: "Buang karat pada pagar, grill dan struktur besi, sapu primer kalis karat dan cat semula untuk memanjangkan hayat logam.",
      description:
        "Cuaca lembap dan hujan kerap di Lembah Klang menyebabkan pagar, grill, tiang dan rangka besi berkarat dalam beberapa tahun jika kemasan catnya gagal. Membiarkan karat berterusan akhirnya menipiskan profil sehingga keseluruhan struktur perlu diganti. KL Servis Rumah menjalankan rawatan karat dan kerja cat semula: karat longgar dan cat yang mengelupas dibuang dengan berus kawat, pengikis atau alat mekanikal, permukaan dibersihkan daripada minyak dan habuk, lubang karat yang teruk ditampal atau bahagian yang sudah nipis dipotong dan diganti, kemudian primer kalis karat disapu diikuti dua lapisan cat akhir. Kami memberi tumpuan kepada kawasan yang paling kerap gagal — kaki tiang yang bersentuhan dengan lantai, sambungan kimpalan, bahagian dalam profil hollow dan bahagian bawah pagar yang terkena air bertakung.",
      highlights: [
        "Karat longgar dan cat mengelupas dibuang secara mekanikal sebelum mengecat",
        "Permukaan dibersihkan daripada minyak dan habuk untuk lekatan cat",
        "Bahagian yang sudah nipis atau berlubang dipotong dan diganti",
        "Primer kalis karat diikuti dua lapisan cat akhir",
        "Tumpuan pada kaki tiang, kimpalan dan bahagian bawah yang bertakung air",
      ],
      process: [
        { step: "01", title: "Penilaian Karat", desc: "Kami memeriksa tahap karat, mengenal pasti bahagian yang masih boleh dirawat dan yang perlu diganti." },
        { step: "02", title: "Penyediaan Permukaan", desc: "Karat longgar dan cat mengelupas dibuang, permukaan dibersihkan dan kawasan sekeliling dilindungi." },
        { step: "03", title: "Pembaikan Setempat", desc: "Lubang karat ditampal dan bahagian profil yang terlalu nipis dipotong lalu diganti dengan besi baharu." },
        { step: "04", title: "Primer", desc: "Primer kalis karat disapu sama rata, memberi tumpuan pada kimpalan, sudut dan kaki tiang." },
        { step: "05", title: "Cat Akhir", desc: "Dua lapisan cat akhir disapu mengikut masa kering yang betul dan kawasan kerja dibersihkan." },
      ],
      faqs: [
        { q: "Bolehkah cat baharu disapu terus atas karat?", a: "Tidak disyorkan. Cat yang disapu atas karat longgar akan mengelupas dalam masa singkat kerana lapisan di bawahnya terus mengembang. Karat perlu dibuang sehingga permukaan stabil dahulu supaya primer dan cat melekat dengan betul." },
        { q: "Berapa lama kerja cat semula bertahan?", a: "Ketahanan bergantung pada penyediaan permukaan, sistem cat yang digunakan dan pendedahan kepada hujan serta matahari. Permukaan yang disediakan dengan baik dan disapu primer kalis karat bertahan jauh lebih lama berbanding cat yang disapu terus." },
        { q: "Bagaimana jika pagar sudah berlubang kerana karat?", a: "Bahagian yang sudah berlubang atau terlalu nipis tidak boleh dipulihkan dengan cat sahaja. Kami memotong bahagian tersebut dan mengimpal profil baharu sebelum kerja cat, supaya struktur kembali kukuh." },
        { q: "Berapakah kos rawatan karat dan cat semula?", a: "Kos disebut harga selepas pemeriksaan kerana ia bergantung pada keluasan permukaan, tahap karat, keperluan penggantian bahagian, jenis cat dan ketinggian kerja." },
      ],
      metaTitle: "Rawatan Karat & Cat Semula Pagar Besi KL | Sebut Harga",
      metaDesc: "Rawatan karat dan cat semula pagar, grill dan struktur besi di KL & Selangor. Buang karat, primer kalis karat dan dua lapisan cat akhir.",
    },
    zh: {
      name: "除锈处理与重新涂装",
      tagline: "清除大门、格栅与钢构上的锈蚀，涂刷防锈底漆并重新上漆，延长金属使用寿命。",
      description:
        "巴生谷潮湿多雨，一旦漆膜失效，大门、格栅、立柱与钢架往往几年内就开始生锈。放任锈蚀发展，型材会越锈越薄，最后只能整体更换。KL Servis Rumah 提供除锈与重新涂装服务：用钢丝刷、刮刀或电动工具清除浮锈与起皮旧漆，清洁表面油污与灰尘，锈坑严重处进行补焊，型材已经锈薄的部位切除更换，然后涂刷防锈底漆并施工两道面漆。我们会重点处理最容易失效的部位——接触地面的柱脚、焊接节点、方管内壁，以及容易积水的门体下沿。",
      highlights: [
        "上漆前先用机械方式清除浮锈与起皮旧漆",
        "清洁表面油污与灰尘，保证漆膜附着力",
        "型材锈薄或穿孔部位切除更换",
      ...
      process: [
        { step: "01", title: "锈蚀评估", desc: "检查锈蚀程度，区分哪些部位可以处理、哪些必须切除更换。" },
        { step: "02", title: "表面处理", desc: "清除浮锈与起皮旧漆，清洁基面并做好周边区域遮护。" },
        { step: "03", title: "局部修复", desc: "锈坑补焊，型材过薄的部位切除后换上新料。" },
        { step: "04", title: "涂刷底漆", desc: "均匀涂刷防锈底漆，重点覆盖焊点、转角与柱脚部位。" },
        { step: "05", title: "面漆施工", desc: "按规定的干燥间隔施工两道面漆，完工后清理现场。" },
      ],
      faqs: [
        { q: "可以直接在锈面上刷新漆吗？", a: "不建议。直接刷在浮锈上的漆很快就会起皮，因为下面的锈还在继续膨胀。必须先把锈清除到基面稳定，底漆和面漆才能真正附着。" },
        { q: "重新涂装能维持多久？", a: "耐久性取决于表面处理质量、所用涂装体系，以及日晒雨淋的程度。基面处理到位并涂了防锈底漆的漆膜，寿命明显长于直接刷面漆的做法。" },
        { q: "大门已经锈穿了怎么办？", a: "已经穿孔或锈得太薄的部位，光靠刷漆无法恢复。我们会切除该段并焊上新型材，再进行涂装，让结构重新达到应有的强度。" },
        { q: "除锈重涂要多少钱？", a: "费用在检查后报价，取决于处理面积、锈蚀程度、需要更换的部件、涂料类型与作业高度。" },
      ],
      metaTitle: "吉隆坡铁门钢构除锈与重新涂装 | 依报价",
      metaDesc: "吉隆坡与雪兰莪大门、格栅与钢构除锈重涂。机械除锈、防锈底漆加两道面漆，检查后报价。",
    },
  },
  ...
  "house-renovation/office-renovation-and-fit-out": {
    ms: {
      ...
      tagline: "Fit-out pejabat lengkap di KL & Selangor: perancangan ruang, partisi, stesen kerja, bilik mesyuarat, elektrik, pencahayaan dan penghawa dingin. Atas sebut harga.",
      description: "Perkhidmatan pengubahsuaian dan fit-out pejabat KL Servis Rumah direka untuk syarikat yang menyewa ruang baharu, berpindah ke unit lebih besar, atau ingin membaik pulih pejabat sedia ada. Skop kami merangkumi perancangan ruang berdasarkan aliran kerja, pemasangan partisi gypsum atau kaca untuk bilik mesyuarat dan bilik pengarah, stesen kerja terbuka atau berkubikel, pembaharuan lantai dan siling, titik elektrik, pencahayaan bersama suis, titik penghawa dingin dan sistem pengudaraan, serta kerja penyudahan cat dan kaca. Pasukan dalaman menyelaras semua perdagangan di bawah satu kontrak, dengan penyerahan kerja kepada pengurusan bangunan, pematuhan garis panduan keselamatan kebakaran dan jadual kerja luar waktu pejabat untuk mengelakkan gangguan operasi.",
      highlights: [
        "Satu kontrak untuk semua perdagangan: partisi, elektrik, pencahayaan, lantai, siling, cat dan HVAC",
        "Perancangan ruang berdasarkan aliran kerja untuk memaksimumkan kapasiti dan kecekapan",
        "Bilik mesyuarat, bilik pengarah dan stesen kerja dengan penyelesaian penebat bunyi",
        "Pematuhan keperluan pengurusan bangunan dan garis panduan keselamatan kebakaran",
        "Kerja dijadualkan luar waktu pejabat untuk mengurangkan gangguan operasi",
      ],
      process: [
        { step: "01", title: "Tinjauan & Ukuran", desc: "Kami melawat premis, mengukur ruang, memahami bilangan staf, aliran kerja dan keperluan mesyuarat, serta keperluan pengurusan bangunan." },
        { step: "02", title: "Pelan & Sebut Harga", desc: "Kami sediakan pelan susun atur dan sebut harga item bagi setiap perdagangan, termasuk garis masa berperingkat untuk setiap fasa." },
        { step: "03", title: "Pembinaan Partisi & M&E", desc: "Partisi gypsum dan kaca, siling, lantai, titik elektrik, pencahayaan dan titik penghawa dingin dipasang mengikut urutan untuk mengelakkan kerja semula." },
        { step: "04", title: "Penyudahan & Serahan", desc: "Cat, kaca, kabinet dan kemasan akhir disiapkan, ujian sistem dijalankan, dan ruang diserahkan bersih dan sedia diguna." },
      ],
      faqs: [
        { q: "Berapa lama masa fit-out pejabat biasanya mengambil masa?", a: "Pejabat kecil sekitar 1,500–3,000 kaki persegi biasanya siap dalam 3 hingga 5 minggu, manakala pejabat lebih besar atau yang melibatkan banyak partisi kaca boleh mengambil 6 hingga 8 minggu. Garis masa bergantung pada kelulusan pengurusan bangunan, tempoh kerja yang dibenarkan dan kerumitan M&E." },
        { q: "Boleh anda bekerja di luar waktu pejabat?", a: "Ya. Kami boleh menjadualkan kerja bising seperti pemotongan dan pemasangan partisi pada waktu malam atau hujung minggu, dan kerja kemasan pada waktu siang, selaras dengan kebenaran pengurusan bangunan. Ini membantu syarikat terus beroperasi sepanjang tempoh pengubahsuaian." },
        { q: "Adakah anda menguruskan kelulusan bangunan dan keselamatan kebakaran?", a: "Kami menyediakan dokumen yang diperlukan oleh pengurusan bangunan, termasuk insurans, tempoh kerja dan keperluan keselamatan kebakaran asas untuk ruang pejabat. Untuk perubahan besar yang memerlukan kelulusan pihak berkuasa, kami akan nasihatkan anda sebelum memulakan kerja." },
        { q: "Boleh saya menggabungkan fit-out dengan sistem elektrik dan HVAC sedia ada?", a: "Boleh. Kami menilai kapasiti sedia ada terlebih dahulu dan mereka kerja elektrik serta penghawa dingin supaya tiada beban lampau, dan menambah titik baharu di lokasi yang paling sesuai untuk stesen kerja anda." },
      ],
      metaTitle: "Pengubahsuaian & Fit-Out Pejabat KL | KL Servis Rumah",
      metaDesc: "Fit-out pejabat lengkap di KL & Selangor: perancangan ruang, partisi, stesen kerja, bilik mesyuarat, elektrik, pencahayaan dan HVAC. Satu kontrak. Sebut harga percuma.",
    },
    zh: {
      name: "办公室装修与整备",
      tagline: "吉隆坡与雪兰莪一站式办公室装修整备：空间规划、隔断、工作站、会议室、电路、照明与空调。依报价。",
      description: "KL Servis Rumah 办公室装修与整备服务面向租用新场地、搬迁或想翻新旧办公室的企业。服务范围包括按工作流程做空间规划、搭建石膏板或玻璃隔断形成会议室与总监室、开放式或格子工作站、地面与天花翻新、电路点位与控制开关、照明、空调与通风点位，以及油漆和玻璃收尾。内部团队以单一合同协调各工种，并配合大楼管理处要求、消防规范指引以及非办公时段施工，尽量减少对日常运营的干扰。",
      highlights: [
        "单一合同覆盖全部工种：隔断、电路、照明、地面、天花、油漆与空调",
        "按工作流程做空间规划，最大化座位容量与协作效率",
        "会议室、总监室与工作站提供隔音处理方案",
        "配合管理处规范与基础消防安全指引",
        "安排在非办公时段施工，降低对运营的干扰",
      ],
      process: [
        { step: "01", title: "现场勘察与量尺", desc: "我们到现场量取尺寸、了解员工人数、工作流程与会议需求，并确认大楼管理处的进场条件。" },
        { step: "02", title: "布局设计与报价", desc: "我们提交空间布局图与分项报价，列出每个工种的细目与分阶段时间表。" },
        { step: "03", title: "隔断与机电施工", desc: "按顺序安装石膏板和玻璃隔断、天花、地面、电路点位、照明与空调点位，避免返工。" },
        { step: "04", title: "收尾与交付", desc: "完成油漆、玻璃与柜体收尾，进行系统测试，并把空间清理干净、可即时启用地交付。" },
      ],
      faqs: [
        { q: "办公室整备通常需要多长时间？", a: "约 1,500–3,000 平方英尺的小型办公室通常需 3 至 5 周；面积较大或涉及大量玻璃隔断的项目需 6 至 8 周。工期取决于管理处审批、允许的作业时段以及机电复杂程度。" },
        { q: "你们能在非办公时间施工吗？", a: "可以。我们会在夜间或周末安排切割与隔断安装等噪音工程，白天进行收尾工程，并遵守管理处的许可条件，让公司在装修期间尽量继续办公。" },
        { q: "你们会协助处理大楼审批与消防安全吗？", a: "我们会准备管理处要求的文件，包括保险、作业时段与办公室空间的基本消防安全要求。涉及需报批的大改动，我们会在开工前先向您说明。" },
        { q: "可以沿用现有的电路与空调系统吗？", a: "可以。我们会先评估现有容量，再设计电路与空调点位，确保不超载并把新点位布置在最适合您工作站的位置。" },
      ],
      metaTitle: "吉隆坡办公室装修与整备 | KL Servis Rumah",
      metaDesc: "吉隆坡与雪兰莪办公室装修整备：空间规划、隔断、工作站、会议室、电路、照明与空调。单一合同，免费报价，非办公时段施工。",
    },
  },
  "house-renovation/retail-shop-renovation": {
    ms: {
      name: "Pengubahsuaian Kedai Runcit",
      tagline: "Pengubahsuaian butik, kedai dan ruang pameran di KL & Selangor: storefront, rak paparan, pencahayaan, jubin, elektrik dan kesediaan papan tanda. Atas sebut harga.",
      description: "Perkhidmatan pengubahsuaian kedai runcit KL Servis Rumah direka untuk peruncit yang membuka kedai baharu, menukar jenama, atau ingin mengubah suai kedai sedia ada. Skop termasuk kemasan bahagian hadapan kedai (storefront), rak paparan dan jadual pameran custom, pencahayaan perdagangan dan aksen, lantai tahan lasak seperti jubin porselin atau SPC, kemasan dinding dan cat, titik elektrik tambahan untuk mesin juruwang dan sistem CCTV, serta penyediaan kuasa dan struktur untuk papan tanda. Kami bekerjasama dengan pemilik premis untuk mematuhi keperluan pengurusan kompleks membeli-belah dan garis panduan keselamatan kebakaran, dan menjadualkan kerja supaya kedai boleh dibuka secepat mungkin.",
      highlights: [
        "Kemasan storefront, rak paparan custom dan pantulan jenama",
        "Pencahayaan perdagangan dan aksen untuk mempamerkan produk dengan menarik",
        "Lantai dan dinding tahan lasak untuk lalu lintas pelanggan yang tinggi",
        "Titik elektrik tambahan untuk kasir, CCTV dan peralatan runcit",
        "Penyediaan kuasa dan struktur untuk pemasangan papan tanda",
      ],
      process: [
        { step: "01", title: "Kunjungan & Ukuran", desc: "Kami mengukur ruang, memahami konsep jenama, jenis produk dan aliran pelanggan, serta keperluan pengurusan pusat beli-belah." },
        { step: "02", title: "Reka Bentuk & Sebut Harga", desc: "Kami sediakan reka bentuk kedai, pemilihan bahan dan sebut harga terperinci untuk setiap perdagangan." },
        { step: "03", title: "Kerja Binaan", desc: "Kemasan storefront, rak, lantai, siling, pencahayaan dan elektrik dipasang mengikut urutan." },
        { step: "04", title: "Papan Tanda & Serahan", desc: "Papan tanda dipasang sekiranya dalam skop, pembersihan akhir dijalankan, dan kedai diserahkan sedia dibuka." },
      ],
      faqs: [
        { q: "Berapa lama untuk mengubah suai kedai runcit?", a: "Kedai runcit bersaiz sederhana sekitar 1,000–2,000 kaki persegi biasanya mengambil 2 hingga 4 minggu untuk fit-out penuh. Kedai kecil boleh siap lebih cepat, manakala projek yang melibatkan banyak kerja storefront atau papan tanda perlu mengambil kira masa kelulusan pengurusan." },
        { q: "Adakah anda menyediakan skema rak dan paparan?", a: "Ya. Kami mereka dan memasang rak paparan custom yang sepadan dengan jenama anda, dan boleh menggabungkannya dengan pencahayaan serta kemasan dinding untuk mencipta kesan visual yang menarik." },
        { q: "Bagaimana anda mematuhi keperluan pengurusan pusat beli-belah?", a: "Kami menyediakan dokumen dan insurans yang diperlukan, mematuhi waktu kerja yang ditetapkan, menggunakan laluan barang yang diluluskan, dan memastikan koridor serta kawasan awam kekal bersih sepanjang kerja." },
        { q: "Adakah kerja elektrik sesuai untuk peralatan runcit dan papan tanda?", a: "Ya. Kami menambah titik elektrik yang mencukupi untuk mesin juruwang, CCTV, pencahayaan dan peralatan runcit, dan kami sediakan titik kuasa serta struktur untuk pemasangan papan tanda oleh vendor papan tanda." },
      ],
      metaTitle: "Pengubahsuaian Kedai Runcit KL & Selangor | KL Servis Rumah",
      metaDesc: "Pengubahsuaian butik, kedai dan ruang pameran di KL & Selangor: storefront, rak paparan, pencahayaan runcit, lantai dan elektrik. Pematuhan pengurusan. Sebut harga percuma.",
    },
    zh: {
      name: "零售店面装修",
      tagline: "吉隆坡与雪兰莪精品店、商铺与展示厅装修：门头、展示货架、商用照明、地面与电路升级。依报价。",
      description: "KL Servis Rumah 零售店面装修服务面向开设新店、换品牌或翻新旧店面的零售商。范围包括门头（storefront）饰面、定制展示货架与陈列柜、商用照明与重点照明、耐磨地面（如抛光砖或 SPC）、墙面与油漆饰面、为收银机与监控加装电路点位，以及为招牌预留电源与结构。我们与商场管理处的要求和消防安全指引对接，并把施工安排在最快开业的节奏内。",
      highlights: [
        "门头饰面、定制展示货架与品牌形象呈现",
        "商用照明与重点照明，突出商品陈列",
        "耐磨地面与墙面，应对高客流",
      ...
      process: [
        { step: "01", title: "上门量尺与勘察", desc: "我们量取空间尺寸，了解品牌理念、商品类型与客流动线，并确认商场管理处的进场条件。" },
        { step: "02", title: "设计定稿与报价", desc: "我们提交店面设计、材料选型与分项报价，说明每个工种的细目与工期。" },
        { step: "03", title: "施工阶段", desc: "按顺序安装门头、货架、地面、天花、照明与电路点位。" },
        { step: "04", title: "招牌与交付", desc: "如需，安装招牌；完成后做最终保洁，并将可即时开店的空间交付给您。" },
      ],
      faqs: [
        { q: "装修一家零售店通常需要多久？", a: "约 1,000–2,000 平方英尺的中型店铺通常需 2 至 4 周完成整备。小店更快；若涉及大量门头或招牌工程，还需预留商场审批时间。" },
        { q: "你们能提供货架与陈列方案吗？", a: "可以。我们按您的品牌定制并安装展示货架与陈列柜，并结合照明和墙面饰面打造吸引人的视觉呈现。" },
        { q: "如何配合商场管理处的要求？", a: "我们准备所需文件与保险、遵守规定作业时段、使用核定货梯与通道，并保持公共走廊与区域在施工期间干净整洁。" },
        { q: "电路能支持收银、监控与招牌吗？", a: "可以。我们为收银机、监控、照明与零售设备预留充足点位，并为招牌供应商预留电源与安装结构。" },
      ],
      metaTitle: "吉隆坡零售店面装修 | KL Servis Rumah",
      metaDesc: "吉隆坡与雪兰莪精品店、商铺与展示厅装修：门头、展示货架、商用照明、地面与电路升级，配合商场管理要求，免费报价。",
    },
  },
  "house-renovation/restaurant-and-f-and-b-renovation": {
    ms: {
      name: "Pengubahsuaian Restoran & F&B",
      tagline: "Fit-out restoran, kafe dan premis F&B di KL & Selangor: dapur komersial, hud ekzos, perangkap gris, gas, saliran, dewan makan dan lantai. Atas sebut harga.",
      description: "Perkhidmatan pengubahsuaian restoran dan F&B KL Servis Rumah direka untuk pengusaha yang membuka restoran, kafe atau outlet makanan baharu atau menaik taraf dapur sedia ada. Skop kami merangkumi kawasan dapur komersial dengan hud ekzos dan sistem pengudaraan, perangkap gris dan saliran yang mematuhi garis panduan pihak berkuasa, pemasangan gas dan penyambungan yang mesti dikendalikan oleh juruteknik bertauliah, dewan makan dengan tiling dan flooring tahan lasak, pencahayaan ambien dan aksen, serta kemasan dinding yang mudah dibersihkan. Kami menyelaras dengan pengurusan bangunan dan memastikan skop mematuhi keperluan kesihatan, perparitan dan keselamatan kebakaran tempatan. Penyerahan kerja disusun mengikut urutan supaya restoran boleh membuka segera selepas pemeriksaan pihak berkuasa.",
      highlights: [
        "Dapur komersial dengan hud ekzos dan sistem pengudaraan yang sesuai",
        "Perangkap gris dan saliran yang mematuhi garis panduan kesihatan dan perparitan",
        "Kawasan penyediaan makanan dengan permukaan mudah dibersihkan",
        "Dewan makan dan lantai tahan lasak untuk trafik pelanggan tinggi",
        "Koordinasi dengan juruteknik bertauliah untuk kerja gas dan elektrik",
      ],
      process: [
        { step: "01", title: "Tinjauan & Keperluan Pihak Berkuasa", desc: "Kami menilai saiz dapur, lokasi perangkap gris dan saliran, serta keperluan lesen dan kesihatan yang berkaitan dengan premis anda." },
        { step: "02", title: "Reka Bentuk & Sebut Harga", desc: "Kami sediakan pelan susun atur dapur dan dewan makan serta sebut harga terperinci, termasuk garis masa untuk kerja gas, ekzos dan saliran." },
        { step: "03", title: "Kerja Dapur & M&E", desc: "Hud ekzos, pengudaraan, saliran, perangkap gris, titik gas oleh juruteknik bertauliah dan elektrik dipasang mengikut urutan." },
        { step: "04", title: "Kemasan Dewan & Serahan", desc: "Lantai, tiling, pencahayaan dan kemasan dewan makan disiapkan, pembersihan akhir dijalankan, dan premis diserahkan untuk pemeriksaan pihak berkuasa." },
      ],
      faqs: [
        { q: "Adakah anda menguruskan pemasangan hud ekzos dan perangkap gris?", a: "Ya. Kami mereka dan memasang hud ekzos dapur serta sistem pengudaraan mengikut keperluan premis, dan perangkap gris serta saliran yang mematuhi garis panduan kesihatan dan perparitan tempatan. Untuk kerja gas dan elektrik, kami menyelaras dengan juruteknik bertauliah yang berdaftar." },
        { q: "Berapa lama untuk mengubah suai restoran?", a: "Kafe atau restoran kecil biasanya mengambil 4 hingga 6 minggu, manakala restoran bersaiz besar dengan dapur komersial penuh boleh mengambil 8 hingga 12 minggu. Kerja ekzos, gas dan perparitan selalunya memerlukan kelulusan pihak berkuasa yang menetapkan garis masa." },
        { q: "Boleh anda bekerja dengan kami semasa kami masih beroperasi?", a: "Untuk projek naik taraf, ya—kami boleh mengasingkan kawasan kerja dan menjadualkan kerja bising di luar waktu buka. Untuk pembinaan dapur besar, kami biasanya menyarankan pengasingan sepenuhnya bagi memastikan keselamatan makanan dan pematuhan piawaian kesihatan." },
        { q: "Sejauh mana anda membantu dengan lesen dan pemeriksaan?", a: "Kami menyediakan premis supaya mematuhi keperluan bangunan dan kesihatan yang berkaitan dengan skop kerja kami (dapur, ekzos, saliran), dan kami boleh menyelaras dengan pihak berkuasa serta menjadi tuan rumah pemeriksaan pemasangan yang kami lakukan." },
      ],
      metaTitle: "Pengubahsuaian Restoran & F&B KL | KL Servis Rumah",
      metaDesc: "Fit-out restoran, kafe dan premis F&B di KL & Selangor: dapur komersial, hud ekzos, perangkap gris, saliran, gas, dewan makan dan lantai. Pematuhan pihak berkuasa. Sebut harga percuma.",
    },
    zh: {
      name: "餐厅与餐饮门店装修",
      tagline: "吉隆坡与雪兰莪餐厅、咖啡厅与餐饮门店装修：商用厨房、排油烟罩、隔油池、燃气、排水、用餐区与地面。依报价。",
      description: "KL Servis Rumah 餐厅与餐饮门店装修服务面向新开餐厅、咖啡厅或新品牌的门店，以及翻新现有厨房的经营者。范围包括带排油烟罩与通风系统的商用厨房、符合卫生与排水指引的隔油池与排给水、必须由持证技师完成的燃气连接、可高频客流的耐磨地面与贴砖、环境与重点照明，以及易于清洁的墙面饰面。我们与物业及当地卫生、排水、消防规范对接，并按顺序安排施工，让门店在政府复检通过后尽快开业。",
      highlights: [
        "商用厨房配排油烟罩与合适的通风系统",
        "符合卫生与排水指引的隔油池与排给水",
        "易于清洁的食品加工区域表面",
      ...
      process: [
        { step: "01", title: "勘察与合规确认", desc: "我们评估厨房尺寸、隔油池与排水位置，以及门店相关的卫生与营业证照要求。" },
        { step: "02", title: "设计定稿与报价", desc: "我们提交厨房与用餐区布局图以及分项报价，含燃气、排风与排水各阶段时间表。" },
        { step: "03", title: "厨房与机电施工", desc: "按顺序安装排油烟罩、通风、排水、隔油池、燃气点位（由持证技师）与电路。" },
        { step: "04", title: "用餐区收尾与交付", desc: "完成用餐区地面、贴砖、照明与饰面，做最终保洁，并交付用于政府复检。" },
      ],
      faqs: [
        { q: "你们负责排油烟罩与隔油池吗？", a: "是。我们按门店需求设计并安装厨房排油烟罩与通风系统，以及符合当地卫生与排水指引的隔油池和排给水。燃气与电气部分我们协调注册持证技师完成。" },
        { q: "装修一家餐厅通常需要多久？", a: "小型咖啡厅或餐厅通常需 4 至 6 周；带完整商用厨房的大型餐厅需 8 至 12 周。排风、燃气与排水往往需主管部门审批，审批时间会影响总工期。" },
        { q: "营业期间可以施工吗？", a: "翻新升级项目可以——我们会隔离施工区并把噪音工程安排在非营业时段。大型厨房新建我们通常建议完全停业施工，以确保食品安全与卫生标准。" },
        { q: "你们在证照与复检方面帮多少忙？", a: "我们把门店准备到符合我们施工范围内（厨房、排风、排水）的建筑与卫生要求，并可协助与主管部门对接、主持我们施工部分的复检。" },
      ],
      metaTitle: "吉隆坡餐厅与餐饮门店装修 | KL Servis Rumah",
      metaDesc: "吉隆坡与雪兰莪餐厅、咖啡厅与餐饮门店装修：商用厨房、排油烟罩、隔油池、排水、燃气、用餐区与地面，配合主管部门要求，免费报价。",
    },
  },
  "house-renovation/office-partition-and-workspace-build": {
    ms: {
      name: "Partisi Pejabat & Pembinaan Ruang Kerja",
      tagline: "Pembinaan partisi gypsum dan kaca, bilik mesyuarat, kluster stesen kerja dan ruang kerja berpenebat bunyi untuk pejabat dan ruang komersial. Atas sebut harga.",
      description: "Perkhidmatan partisi pejabat dan pembinaan ruang kerja KL Servis Rumah memberi tumpuan kepada pembahagian ruang di pejabat, pusat sewa dan ruang komersial lain. Skop termasuk partisi gypsum separuh atau penuh, partisi kaca berbingkai aluminium untuk bilik mesyuarat dan ruang pengurusan, rak dan pintu kabinet, penebat bunyi di dinding dalaman, kluster stesen kerja terbuka atau berkubikel, serta penyelarasan titik elektrik dan lampu untuk setiap ruang. Kami mereka partisi mengikut garis panduan keselamatan kebakaran dan keperluan pengurusan bangunan, dan membina di luar waktu pejabat apabila perlu supaya operasi dapat diteruskan. Kerja boleh dilakukan sebagai sebahagian daripada fit-out pejabat yang lebih besar atau sebagai projek pembahagian semula ruang yang berdiri sendiri.",
      highlights: [
        "Partisi gypsum dan kaca berbingkai aluminium untuk bilik mesyuarat dan pengurusan",
        "Penebat bunyi pada dinding dalaman dan bilik mesyuarat",
        "Kluster stesen kerja terbuka dan berkubikel yang boleh disesuaikan",
        "Koordinasi titik elektrik dan lampu untuk setiap ruang",
        "Pematuhan keselamatan kebakaran dan keperluan pengurusan bangunan",
      ],
      process: [
        { step: "01", title: "Ukuran & Perancangan", desc: "Kami mengukur ruang sedia ada dan merancang susun atur partisi serta kluster stesen kerja." },
        { step: "02", title: "Sebut Harga & Kelulusan", desc: "Kami sediakan sebut harga untuk struktur partisi, kaca, pintu dan perdagangan berkaitan, dan membantu dengan kelulusan pengurusan bangunan." },
        { step: "03", title: "Pembinaan Struktur", desc: "Trek dan stud partisi dipasang, plumb dan aras disemak, dan elektrik serta lampu dimasukkan sebelum penutupan dinding." },
        { step: "04", title: "Kaca, Pintu & Kemasan", desc: "Kaca, pintu dan kemasan akhir (skim, cat) dipasang, bunyi diperiksa dan ruang diserahkan bersih." },
      ],
      faqs: [
        { q: "Apakah perbezaan antara partisi gypsum dan kaca?", a: "Partisi gypsum memberikan privasi penuh dan penebat bunyi yang baik serta boleh dicat, manakala partisi kaca mengekalkan cahaya dan keterbukaan antara ruang. Untuk bilik mesyuarat yang memerlukan privasi kami biasanya menggabungkan kaca separa dengan panel gypsum berpenebat bunyi." },
        { q: "Berapa cepat partisi pejabat boleh dipasang?", a: "Partisi linear sederhana biasanya dipasang dalam beberapa hari hingga 1 minggu untuk jumlah kecil, manakala projek yang melibatkan banyak bilik mesyuarat dan kaca boleh mengambil 1 hingga 2 minggu selepas kelulusan." },
        { q: "Boleh partisi dipasang tanpa mengganggu operasi?", a: "Ya. Kami memasang di luar waktu pejabat atau secara berperingkat supaya setiap bahagian ruang boleh dipisahkan dan diperbaharui satu demi satu; ini membolehkan pasukan anda terus bekerja." },
        { q: "Adakah anda memasukkan titik elektrik dan lampu?", a: "Ya. Kami menyelaras titik elektrik, suis dan lampu untuk setiap ruang baharu sebagai sebahagian daripada kerja partisi, atau anda boleh menggunakan juruelektrik sendiri jika anda mahu." },
      ],
      metaTitle: "Partisi Pejabat & Pembinaan Ruang Kerja KL | KL Servis Rumah",
      metaDesc: "Pembinaan partisi gypsum dan kaca, bilik mesyuarat, kluster stesen kerja dan penebat bunyi untuk pejabat di KL & Selangor. Pematuhan bomba. Sebut harga percuma.",
    },
    zh: {
      name: "办公室隔断与工位搭建",
      tagline: "吉隆坡与雪兰莪办公室与商业空间的石膏板与玻璃隔断、会议室舱位、工位组团与隔音隔墙搭建。依报价。",
      description: "KL Servis Rumah 办公室隔断与工位搭建服务专注于办公室、共享办公及商业空间的空间划分。范围包括半高或通顶石膏板隔断、带铝合金边框的玻璃隔断（用于会议室与管理区）、柜体与门扇、内墙隔音、开放式或格子式工位组团，以及为每个空间协调电路与照明点位。我们依据消防指引与大楼管理要求设计隔断，并在必要时于非办公时段施工，让运营可以继续。本服务可作为大型办公室整备的一部分，也可作为一个独立的重新分区项目执行。",
      highlights: [
        "石膏板隔断与铝合金边框玻璃隔断，用于会议室与管理区",
        "内墙与会议室隔音处理",
        "可灵活配置的开放式与格子式工位组团",
        "为每个空间协调电路与照明点位",
        "符合消防与管理处规范要求",
      ...
      process: [
        { step: "01", title: "量尺与规划", desc: "我们量取现有空间尺寸，规划隔断布局与工位组团。" },
        { step: "02", title: "报价与审批", desc: "我们为隔断结构、玻璃、门及相关工种提交报价，并协助办理大楼审批。" },
        { step: "03", title: "结构施工", desc: "安装隔断的轻钢龙骨与轨道，校直与找平，并在封板前预埋电路与灯具。" },
        { step: "04", title: "玻璃、门与收尾", desc: "安装玻璃、门与最终饰面（批灰、油漆），检查隔音并做无尘交付。" },
      ],
      faqs: [
        { q: "石膏板隔断和玻璃隔断有什么不同？", a: "石膏板隔断提供完全隐私与良好隔音，可喷漆；玻璃隔断则保留光线与空间通透感。需要隐私的会议室，我们通常用局部玻璃加隔音石膏板面板的组合。" },
        { q: "办公室隔断安装需要多久？", a: "简单线性隔断通常几天到 1 周内可完成；涉及多间会议室与大量玻璃的项目，在审批通过后需 1 至 2 周。" },
        { q: "施工会影响办公吗？", a: "可以做到影响很小。我们安排在非办公时段或分区分段施工，让您在用的区域先隔离、其余区域逐一翻新，团队可继续工作。" },
        { q: "你们包含电路与灯具点位吗？", a: "包含。我们作为隔断工程的一部分，为每个新空间协调电路、开关与灯具点位；如果您愿意，也可由您的电工独立完成。" },
      ],
      metaTitle: "吉隆坡办公室隔断与工位搭建 | KL Servis Rumah",
      metaDesc: "吉隆坡与雪兰莪办公室石膏板与玻璃隔断、会议室舱位、工位组团与隔音隔墙搭建。符合消防与管理处要求，免费报价。",
    },
  },
  ...
  "post-renovation-cleaning/construction-rough-cleaning-and-site-clearance": {
    ms: {
      name: "Pembersihan Kasar Pembinaan & Pembersihan Tapak",
      tagline: "Pembersihan fasa awal sisa pembinaan berat, pembungkusan bahan buangan, penyingkiran serpihan kayu dan pembersihan tapak sebelum kerja kemasan. Atas sebut harga.",
      description:
        "Perkhidmatan pembersihan kasar pembinaan dan tapak binaan KL Servis Rumah direka khusus untuk fasa peralihan antara kerja perobohan/pertukangan berat dan kemasan halus. Selepas kerja perobohan dinding, pemasangan siling plaster, atau pembinaan sambungan rumah, tapak dipenuhi sisa mortar kering, serpihan konkrit, potongan kayu, pembungkusan jubin, dan paku berkarat yang menghalang kerja seterusnya. Pasukan kami menjalankan pengasingan serpihan, membungkus bahan terpakai ke dalam guni tugas berat, membersihkan lantai dengan penyapu industri, dan mengeluarkan serpihan ke kawasan pelupusan atau menyelaras tong skip berlesen. Tapak kerja yang bersih mencegah calar pada lantai baharu, memastikan laluan selamat untuk pekerja sub-kontraktor, dan membolehkan kerja jubin, pendawaian serta pengecatan dijalankan dengan lebih lancar tanpa halangan sisa kasar.",
      highlights: [
        "Pengasingan dan pembungkusan serpihan berat — konkrit, mortar, kayu dan sisa pembungkusan",
        "Pembersihan lantai tapak kerja untuk persediaan fasa pemasangan kemasan dan pertukangan",
        "Mengelakkan calaran pada jubin atau lantai baharu akibat sisa batu dan paku berkarat",
        "Penyelarasan tong roro atau lori pelupusan berlesen mengikut peraturan pihak berkuasa",
        "Jaminan kerja kemas, selamat dan mematuhi standard keselamatan tapak binaan",
      ],
      process: [
        { step: "01", title: "Tinjauan Tapak", desc: "Kami memeriksa kuantiti sisa pembinaan, akses laluan keluar dan keperluan tong pelupusan di tapak." },
        { step: "02", title: "Pengasingan Sisa", desc: "Sisa pembinaan diasingkan antara bahan tajam, kayu, kepingan plaster dan konkrit ke dalam guni khas." },
        { step: "03", title: "Pembersihan Kasar", desc: "Lantai disapu bersih menggunakan penyapu industri lasak dan alat pengikis untuk membuang gumpalan simen longgar." },
        { step: "04", title: "Pemindahan Serpihan", desc: "Guni dan sisa dipindahkan secara selamat ke tong roro atau lori pelupusan sisa berlesen tanpa mengotorkan koridor." },
        { step: "05", title: "Pemeriksaan Laluan", desc: "Laluan keluar, tangga dan kawasan kerja dibersihkan untuk memastikan keselamatan pekerja fasa seterusnya." },
      ],
      faqs: [
        { q: "Apakah beza antara pembersihan kasar dan pembersihan selepas ubah suai penuh?", a: "Pembersihan kasar dijalankan semasa atau di antara fasa kerja pengubahsuaian untuk membuang sisa berat seperti batu bata, kayu dan habuk kasar. Pembersihan selepas ubah suai penuh pula ialah pembersihan terperinci sebelum serahan kunci apabila semua kerja telah selesai." },
        { q: "Adakah caj sewa tong roro termasuk dalam sebut harga?", a: "Untuk jumlah sisa kecil yang boleh dilupuskan dengan lori biasa, kos pelupusan disertakan. Untuk projek besar yang memerlukan tong roro (skip bin), kami menyediakan sebut harga berasingan yang telus mengikut saiz tong dan tempoh sewaan." },
        { q: "Bolehkah pembersihan kasar ini dilakukan di kondominium atau apartmen bertingkat?", a: "Boleh. Pasukan kami berpengalaman mematuhi SOP pihak pengurusan bangunan (JMB/MC), termasuk menggunakan laluan lif kargo berlapik, waktu kerja yang dibenarkan dan memastikan koridor serta lobi kekal bersih sepanjang pemindahan." },
        { q: "Berapa lama masa diperlukan untuk membersihkan satu tapak rumah teres?", a: "Biasanya pembersihan kasar untuk rumah teres dua tingkat mengambil masa setengah hari hingga satu hari penuh, bergantung kepada kepadatan sisa binaan dan kemudahan akses lori." },
      ],
      metaTitle: "Pembersihan Kasar Tapak Pembinaan KL | KL Servis Rumah",
      metaDesc: "Perkhidmatan pembersihan kasar pembinaan dan pembersihan tapak di KL & Selangor. Buang sisa konkrit, kayu dan habuk kasar sebelum kerja kemasan. Sebut harga percuma.",
    },
    zh: {
      name: "施工现场粗保洁与清场服务",
      tagline: "装修阶段初期重度建材废料清运、木料与水泥块装袋、杂物清场与施工通道疏通。依报价。",
      description:
        "KL Servis Rumah 施工现场粗保洁与清场服务专为敲墙拆旧、泥水瓦作、木工吊顶等中间施工阶段设计。在全屋大改或局部敲墙后，地面堆积大量碎砖瓦砾、水泥碎渣、木料边角料、瓷砖包装盒与生锈螺丝钉，严重影响后续油漆与地板施工并存在安全隐患。我们的专业清场团队进行物料快速分类装袋，使用重工业扫把与平铲清除地面松动砂浆，将施工垃圾平稳搬运至室外清运车或协调环保斗清运。干净平整的施工地面不仅能避免新装瓷砖与地板受碎石划伤，更能确保各工种作业人员的人身安全与施工作业效率。",
      highlights: [
        "快速分拣装袋重度施工废料——红砖碎石、石膏板屑、木料与包装废弃物",
        "平整清理作业面，为后续批灰刷漆、铺砖贴地板创造洁净施工环境",
        "有效防止细小砂石与生锈铁钉划伤新装管道、防水层或铝合金地轨",
        "熟知物业公约，严格遵守电梯防护、防尘包裹与规定清运时间作业",
        "透明报价，支持零散清理或按阶段定点包场清运服务",
      ],
      process: [
        { step: "01", title: "现场勘测", desc: "实地勘察施工废料总体方量、清运路线宽度及楼梯或货梯装运条件。" },
        { step: "02", title: "分拣装袋", desc: "将重石渣、长木条、尖锐金属及纸箱塑料分类打包装入加厚编织袋内。" },
        { step: "03", title: "粗扫平整", desc: "使用重型工业扫把全面清扫地面，配合平铲铲除粘附地面的松散水泥浮浆。" },
        { step: "04", title: "外运清场", desc: "将垃圾袋密闭搬运至指定垃圾斗或货车内，确保沿途走廊过道不撒漏扬尘。" },
        { step: "05", title: "通道清洁", desc: "对搬运经过的公用走廊、货梯轿厢地面进行快速除尘扫除，完成交接。" },
      ],
      faqs: [
        { q: "施工粗保洁与开荒精保洁有什么区别？", a: "粗保洁是在施工各工种交叉作业期间进行的场地清理，主要清除砖石大垃圾与木料废渣，为后续工序打通作业面；开荒精保洁则是所有装修完工后的全屋无尘细部清洁，面向直接入住标准。" },
        { q: "大件装修垃圾包含清运外运费用吗？", a: "散装少量废料一般直接包含人工装袋与货车清运；如果属于全屋拆旧等大型工程，我们会根据需要的罗里（货车）车次或外置环保斗（Skip Bin）规格提供透明的独立清运报价。" },
        { q: "高层公寓的施工垃圾清运能处理吗？", a: "完全可以。我们严格配合公寓物业管理处（JMB/MC）的管理规定，做好专用货梯防护、地垫铺设，并在物业规定的合法噪音与垃圾运输时段内高效完成搬运。" },
        { q: "一套标准排屋的粗保洁需要多长时间？", a: "一间标准双层排屋的粗保洁与垃圾装运通常耗时半天至一天，具体取决于施工废料的堆放体积与现场装车通道的便利程度。" },
      ],
      metaTitle: "吉隆坡施工现场粗保洁与清场服务 | KL Servis Rumah",
      metaDesc: "吉隆坡与雪兰莪施工现场粗保洁与装修垃圾清运服务。清除建筑残渣、木料碎屑与水泥块，平整作业面。正规合规清运，透明报价。",
    },
  },
  "post-renovation-cleaning/fine-dust-extraction-and-air-purifying": {
    ms: {
      name: "Penyedutan Habuk Halus & Pembersihan Udara",
      tagline: "Sedutan vakum HEPA gred industri, lap elektrostatik dan penapisan zarah mikro simen, gypsum dan cat dari siling, tingkap dan corong hawa dingin. Atas sebut harga.",
      description:
        "Selepas kerja pengisaran siling plaster, pemasangan papan gypsum, dan pengamplasan skim coat, habuk halus (PM2.5 dan zarah kapur) akan berterbangan dan mendap di setiap sudut tersembunyi rumah anda. Habuk halus ini mustahil dibersihkan dengan penyapu biasa kerana ia hanya akan berterbangan semula ke udara dan memasuki sistem pernafasan. Perkhidmatan penyedutan habuk halus dan pembersihan udara KL Servis Rumah menggunakan penapis HEPA berprestasi tinggi dan kain lap elektrostatik untuk menarik habuk tanpa menyebarkannya. Kami menyedut palung siling tersembunyi (L-box), corong penyaman udara, bahagian atas kabinet dapur, bingkai pintu, dan rel tingkap. Seterusnya, sapuan basah dengan bahan mikrofiber antimikrob memastikan udara dalaman kediaman anda kembali segar, selamat untuk kanak-kanak dan penghidap alergi, serta bebas sisa kapur berterbangan.",
      highlights: [
        "Vakum industri dilengkapi penapis HEPA berbilang peringkat untuk menahan zarah habuk mikro",
        "Pembersihan mendalam untuk palung siling L-box, rel tingkap dan bahagian atas pintu",
        "Lap elektrostatik kering diikuti sapuan lembap mikrofiber bagi menghalang habuk terbang",
        "Sesuai untuk keluarga yang mempunyai anak kecil, warga emas atau penghidap asma dan alahan",
        "Memastikan kualiti udara dalaman kediaman selamat dan bebas bau kimia pembinaan",
      ],
      process: [
        { step: "01", title: "Penilaian Habuk", desc: "Kami memeriksa ketebalan mendapan habuk kapur di siling, dinding, kabinet dan unit penyaman udara." },
        { step: "02", title: "Sedutan Paras Atas", desc: "Penyedutan vakum bermula dari siling L-box, corong hawa dingin, dan cucur atap dalaman menggunakan nozel lembut." },
        { step: "03", title: "Sedutan Paras Sederhana", desc: "Vakum HEPA diteruskan ke bahagian atas pintu, bingkai tingkap, permukaan dinding dan suis elektrik." },
        { step: "04", title: "Lap Elektrostatik", desc: "Semua permukaan menegak dan mendatar dilap menggunakan kain elektrostatik untuk menangkap sisa mikro." },
        { step: "05", title: "Sapuan Mikrofiber", desc: "Lap lembap akhir dengan mikrofiber antimikrob untuk meneutralkan cas habuk dan menyegarkan udara ruang." },
      ],
      faqs: [
        { q: "Mengapa habuk pengubahsuaian terus berterbangan walaupun sudah disapu berulang kali?", a: "Habuk plaster dan simen mempunyai zarah yang sangat halus dan ringan. Apabila disapu dengan penyapu biasa, habuk naik ke udara dan mendap semula beberapa jam kemudian. Hanya vakum penapis HEPA tertutup yang mampu menangkap zarah halus ini tanpa menghembusnya semula ke udara." },
        { q: "Adakah corong atau unit penyaman udara perlu dibersihkan sekali semasa pembersihan habuk?", a: "Ya, penapis penyaman udara sering menyedut habuk kapur semasa kerja mengamplas dinding. Kami menyedut dan mencuci jaring penapis hawa dingin supaya habuk tidak disembur keluar apabila pendingin udara mula dihidupkan." },
        { q: "Adakah kaedah pembersihan ini selamat untuk dinding yang baru dicat?", a: "Sangat selamat. Kami menggunakan kepala berus berbulu lembut dan kain mikrofiber khas yang direka untuk menyerap habuk tanpa mencakar atau mencacatkan lapisan cat baharu yang masih segar." },
        { q: "Berapakah masa yang diambil untuk proses penyingkiran habuk halus ini?", a: "Untuk sebuah kondominium biasa berkeluasan 1,000 kaki persegi, proses penyedutan habuk terperinci biasanya mengambil masa antara 3 hingga 5 jam oleh dua orang pakar pembersih." },
      ],
      metaTitle: "Penyedutan Habuk Halus Selepas Renovasi KL | KL Servis Rumah",
      metaDesc: "Perkhidmatan penyedutan habuk halus plaster, simen & siling guna vakum HEPA industri di KL & Selangor. Kualiti udara bersih & selamat untuk keluarga. Sebut harga pantas.",
    },
    zh: {
      name: "细粉尘深层清除与空气净化",
      tagline: "工业级多重 HEPA 过滤吸尘、静电微纤维抹拭，彻底清除天花板暗槽、门窗框与空调风口超细石膏粉尘。依报价。",
      description:
        "在墙面打磨、石膏吊顶做批灰以及木工开料后，微米级的水泥粉尘与滑石粉尘会弥漫全屋并沉积在各类隐蔽缝隙中。普通扫把或家用吸尘器因过滤网密度不足，不仅无法彻底清理，反而会造成二次扬尘，导致装修完工后数月依然粉尘不断。KL Servis Rumah 细粉尘深层清除服务采用专业工业级 HEPA 过滤系统，能牢牢锁住 0.3 微米的悬浮微尘。我们自上而下对 L 盒吊顶灯槽、中央及分体空调回风网、门框上沿、高处柜顶及踢脚线进行系统性吸尘，并辅以静电吸尘布与微纤维湿抹，让全屋空气洁净如新，贴心呵护老人、孕妇与过敏体质家庭的呼吸健康。",
      highlights: [
        "专业工业级 HEPA 密闭微孔过滤系统，杜绝排气口二次喷尘污染",
        "自上而下立体吸尘——深层覆盖天花板灯带槽、空调出风口与门框顶面",
        "静电微纤维抹布干湿双向除尘，彻底吸附悬浮细粉，阻断静电吸灰",
        "同步清理室内空调滤网与表面积尘，避免开机时喷出陈年装修白灰",
        "专为家中有鼻炎敏感者、婴幼儿或注重室内空气健康的业主量身定制",
      ],
      process: [
        { step: "01", title: "粉尘评估", desc: "检测全屋各区域石膏粉尘沉降密度，重点定位灯槽、排气孔与高处缝隙。" },
        { step: "02", title: "高位吸尘", desc: "使用加长工业吸尘软管与软毛刷头，由上而下清理吊顶灯槽与空调风口积灰。" },
        { step: "03", title: "中位细吸", desc: "逐一清理门套线顶端、窗框凹槽、电源开关盒周边以及高位橱柜层板。" },
        { step: "04", title: "静电擦拭", desc: "采用专业静电除尘抹布对墙体表面及立面饰面进行静电吸附，带走浮尘。" },
        { step: "05", title: "微纤保洁", desc: "使用微纤维抗静电湿布进行二次收光，中和表面静电，杜绝粉尘再度附着。" },
      ],
      faqs: [
        { q: "为什么普通扫把清扫后，家里几天后还是有一层白灰？", a: "石膏打磨后的超细粉尘粒径极小且重量极轻。普通打扫会使其在空中漂浮数小时后再重新沉降在家具地面上。必须使用带密闭 HEPA 过滤滤芯的专业吸尘设备配合静电湿擦，才能彻底截留并带走这些微细颗粒物。" },
        { q: "新刷好的乳胶漆墙面吸尘会弄花或磨损吗？", a: "绝不会。我们的工业吸尘设备配备特制天然软毛吸头，吸附过程不产生机械划痕；擦拭时选用超柔长纤维微尘抹布，温和呵护未完全硬化的新鲜漆膜。" },
        { q: "服务中包含空调内部滤网的清理吗？", a: "是的，我们会帮您拆卸并彻底吸洗室内空调的回风滤尘网，清理出风口周边的施工积粉，确保您在新家首次开机使用时吹出清新健康的洁净冷风。" },
        { q: "一套标准公寓做一次细粉尘彻底清除需要多久？", a: "一套约 1,000 平方英尺的公寓，通常由 2 位经验丰富的除尘技师耗时约 3 至 4 小时完成全套精细吸尘与抹净工序。" },
      ],
      metaTitle: "吉隆坡装修后细粉尘深层清除与空气净化 | KL Servis Rumah",
      metaDesc: "吉隆坡与雪兰莪专业装修后细粉尘清除服务。工业 HEPA 吸尘净化，彻底清除石膏天花板、空调口与门窗细粉。呵护呼吸健康，免费报价。",
    },
  },
  "post-renovation-cleaning/paint-splatter-and-silicone-smear-removal": {
    ms: {
      name: "Penyingkiran Percikan Cat & Sisa Silikon",
      tagline: "Pelarutan kimia mesra permukaan, pengikisan bilah plastik dan pembersihan sisa cat emulsi, cat minyak, calitan silikon dan pita pelekat tanpa mencalar kemasan. Atas sebut harga.",
      description:
        "Semasa kerja mengecat dan memasang kabinet atau tingkap, percikan cat, calitan silikon asid/neutral, dan sisa gam pelekat pita masking kerap tertinggal pada permukaan jubin seramik, lantai SPC, suis elektrik, cermin dan bingkai aluminium. Jika dikikis dengan pisau tajam biasa atau diluntur dengan thiner kuat, ia boleh menghakis kilauan jubin, melunturkan warna bingkai aluminium dan mencalarkan cermin. Pasukan penyingkiran percikan cat dan sisa silikon KL Servis Rumah menggunakan kombinasi pelarut khusus berasaskan sitrus serta pengikis bilah polimer selamat yang tidak merosakkan substrat. Kami melarutkan lapisan silikon yang berlebihan, membersihkan titisan cat kering pada jubin lantai, dan menghilangkan kesan gam pelekat tanpa meninggalkan tanda kusam atau calar.",
      highlights: [
        "Pelarut kimia khusus yang bertindak pantas melembutkan silikon degil dan cat minyak kering",
        "Pengikis bilah polimer mesra permukaan — dijamin bebas calar pada cermin, kaca dan jubin",
        "Menanggalkan sisa gam pita masking dan pelekat kilang yang melekat kuat akibat haba",
        "Selamat digunakan pada aluminium powder-coated, keluli tahan karat dan lantai vinil SPC",
        "Hasil permukaan yang licin, bersih dan kembali kepada tekstur asal tanpa sebarang kesan kusam",
      ],
      process: [
        { step: "01", title: "Pemeriksaan Permukaan", desc: "Mengenal pasti jenis bahan asas (jubin porselin, kaca, aluminium atau SPC) dan jenis sisa cat atau silikon." },
        { step: "02", title: "Aplikasi Pelarut", desc: "Menyapu cecair pelarut khusus pada sisa silikon atau cat kering untuk melembutkan ikatan kimia bahan." },
        { step: "03", title: "Pengikisan Lembut", desc: "Mengikis sisa yang telah lembut menggunakan bilah plastik polimer fleksibel dengan sudut selamat bebas calar." },
        { step: "04", title: "Pembersihan Gam", desc: "Menyental sisa pelekat pita pelekat dengan kain mikrofiber yang dilembapkan larutan penanggal berasaskan sitrus." },
        { step: "05", title: "Bilas & Gilap", desc: "Membilas permukaan dengan air bersih suam dan mengelap kering dengan kain mikrofiber sehingga licin berkilat." },
      ],
      faqs: [
        { q: "Bolehkah thinner biasa digunakan untuk membersihkan percikan cat pada tingkap aluminium?", a: "Tidak digalakkan sama sekali. Thinner yang agresif boleh melarutkan lapisan salutan serbuk (powder coating) pada bingkai aluminium dan meninggalkan tompok putih yang kekal. Kami menggunakan pelarut pH-neutral khusus yang hanya menyerang cat tanpa merosakkan salutan asas." },
        { q: "Adakah pisau pengikis anda akan meninggalkan calar pada jubin berkilat saya?", a: "Tidak. Kami menggunakan pengikis berbilah plastik atau tembaga lembut bersudut tepat yang direka khas untuk pembersihan lantai kaca dan jubin kilat, memastikan kotoran terangkat tanpa meninggalkan sebarang calar mikro." },
        { q: "Bagaimana anda menanggalkan calitan silikon yang comot di sekeliling sinki atau tab mandi?", a: "Kami menggunakan gel pelarut silikon khas yang mengurai silikon dalam masa beberapa minit, membolehkan sisa comot ditanggalkan dengan mudah dan kemas tanpa perlu merosakkan garisan silikon kedap air yang utama." },
        { q: "Adakah perkhidmatan ini boleh menanggalkan kesan cat semburan (overspray) pada suis dan soket?", a: "Ya. Kami membersihkan penutup suis dan soket elektrik secara manual dengan pelarut selamat elektrikal tanpa perlu membuka wayar pendawaian atau menjejaskan sistem keselamatan litar." },
      ],
      metaTitle: "Penyingkiran Percikan Cat & Silikon KL | KL Servis Rumah",
      metaDesc: "Perkhidmatan buang percikan cat, calitan silikon & gam pelekat selepas renovasi di KL & Selangor. Kaedah kimia selamat tanpa calar pada jubin & kaca. Sebut harga percuma.",
    },
    zh: {
      name: "油漆飞溅与硅胶残留清除",
      tagline: "环保安全溶剂软化、专业高分子柔性刮刀除渍，无划痕清除瓷砖、玻璃、铝材与开关插座上的油漆点、硅胶与残胶。依报价。",
      description:
        "在油漆粉刷、门窗打胶与橱柜收口施工后，干涸的乳胶漆滴、聚氨酯发泡胶残块、耐候硅胶指印及高温老化的美纹胶纸常常顽固地附着在地面瓷砖、铝合金窗框、卫生间五金件与玻璃移门上。如果盲目使用工业香蕉水或锋利金属刀片猛刮，极易导致铝材氧化掉漆、地砖釉面发乌刮花。KL Servis Rumah 采用针对性环保有机溶剂配合专业高分子刮刀，能够迅速渗透并瓦解顽固胶层分子链，温和剥离各种油性乳胶漆飞溅点与硅胶胶丝，使新装五金与瓷砖恢复原本的光洁透亮，实现毫无刮擦瑕疵的高品质开荒标准。",
      highlights: [
        "专用环保解胶剂快速软化顽固硅胶与干透乳胶漆，避免强酸碱腐蚀基材",
        "高分子聚合物防刮平刮刀，杜绝在抛光地砖、大理石与玻璃表面留下划痕",
        "专业清除因暴晒或施工受压导致的高粘度美纹纸与保护膜陈年背胶",
        "温和配方适用于静电喷涂铝合金、不锈钢花洒龙头及 SPC 石塑锁扣地板",
        "纯手工精细化定点局部除渍，确保每一处墙角与接缝均恢复干爽平滑",
      ],
      process: [
        { step: "01", title: "污渍辨识", desc: "排查现场油漆飞溅种类（水性漆/油性磁漆）、硅胶性质及附着材质底板特性。" },
        { step: "02", title: "溶剂渗透", desc: "将专业中性溶剂均匀涂覆在干固漆滴或硅胶表面，静置数分钟使化学分子链充分软化。" },
        { step: "03", title: "安全刮除", desc: "调整防刮刮刀至安全夹角，以柔和力度将已软化的胶状物轻巧从基材表面完整起除。" },
        { step: "04", title: "残胶溶解", desc: "使用天然柑橘基除胶剂配合微纤维干布，彻底乳化擦除撕膜后残留的黏腻胶痕。" },
        { step: "05", title: "净面复原", desc: "使用温水洁净布彻底中和清洗残留溶剂，擦干并检验表面光泽度无异常斑痕。" },
      ],
      faqs: [
        { q: "为什么不能直接用天那水（香蕉水）擦拭铝合金窗框上的漆点？", a: "天那水含有强腐蚀性有机溶剂，会直接溶解铝合金窗框表面的氟碳漆或静电粉末涂层，造成永久性的白斑、发黄或哑光脱色。我们采用温和的中性专业清洁剂，只剥离污渍而不伤害原装涂层。" },
        { q: "刚铺的大理石或抛光瓷砖除漆点会被刮花吗？", a: "绝对不会。我们严禁在石材与镜面瓷砖上使用普通美工刀片，全线采用特制高韧性工程塑料铲刀与无痕除胶棉，经软化后一推即除，杜绝微小刮伤风险。" },
        { q: "卫生间瓷砖边缝上打得乱七八糟的溢出硅胶能清理干净吗？", a: "可以。我们使用专用硅胶软化凝胶对多余溢胶进行定点降解，然后沿瓷砖边线进行精修裁边擦除，既保全了原本有效的防水密封槽，又清除了多余难看的脏乱毛边。" },
        { q: "开关面板和插座上的油漆飞溅也能清除吗？", a: "完全可以。我们使用无水微湿的电气安全溶剂进行局部点对点手工细擦，在确保电路完全干燥安全的前提下，彻底清除塑料面板与按键上的涂料斑点。" },
      ],
      metaTitle: "吉隆坡油漆飞溅与硅胶残留清除服务 | KL Servis Rumah",
      metaDesc: "吉隆坡与雪兰莪专业油漆飞溅、硅胶残留与胶带残胶清除服务。温和安全溶剂无划痕刮除，呵护地砖釉面与铝材。免费上门评估报价。",
    },
  },
  "post-renovation-cleaning/window-glass-and-aluminium-track-detailing": {
    ms: {
      name: "Pembersihan Terperinci Kaca Tingkap & Rel Aluminium",
      tagline: "Koyak filem pelindung kilang, kikis tompok simen pada kaca, dan sedut pasir kotoran dari rel gelongsor tingkap aluminium sehingga lancar. Atas sebut harga.",
      description:
        "Tingkap kaca dan pintu gelangsar aluminium adalah elemen rumah yang paling terdedah kepada percikan simen, habuk plaster dan habuk gergaji semasa pengubahsuaian dijalankan. Lebih parah, filem pelindung plastik kilang yang dibiarkan terdedah kepada cahaya matahari Malaysia akan mereput dan melekat kuat pada kaca, manakala rel gelongsor bawah dipenuhi batu pasir yang menyekat roda roller tingkap. Perkhidmatan pembersihan terperinci kaca tingkap dan rel aluminium KL Servis Rumah menyelesaikan masalah ini dari akar umbi. Kami menanggalkan filem plastik yang reput dengan pelarut stim atau stim lembut, mengikis percikan simen menggunakan pencuci berasid ringan selamat kaca, dan menggunakan nozel vakum bertekanan untuk menyedut setiap butiran pasir dari celah rel aluminium sebelum melincirkan rodanya.",
      highlights: [
        "Menanggalkan filem pelindung kilang dan pelekat tingkap yang terbakar matahari tanpa meninggalkan kesan",
        "Penyedutan habuk pasir dan serpihan simen dari alur rel tingkap gelongsor hingga ke sudut tersembunyi",
        "Mengikis titisan simen dan cat dari cermin menggunakan bilah getah/plastik tanpa mencalarkan kaca",
        "Pembersihan kimia mesra bingkai aluminium powder-coat yang menghapuskan kesan kusam",
        "Menjadikan tingkap gelongsor bergerak lancar semula tanpa bunyi geseran kasar batu pasir",
      ],
      process: [
        { step: "01", title: "Kopek Pelekat", desc: "Membuka pita pelekat, plastik pelindung UV dan pelekat kilang pada kaca serta bingkai menggunakan stim." },
        { step: "02", title: "Sedut Alur Rel", desc: "Menyedut pasir, batu kerikil dan sisa plaster dari celah alur rel aluminium menggunakan vakum bertekanan." },
        { step: "03", title: "Kikis Simen Kaca", desc: "Menanggalkan tompokan simen dan mortar pada kaca menggunakan larutan pelarut lembut dan pengikis kaca profesional." },
        { step: "04", title: "Cuci & Bilas", desc: "Membasuh kaca dengan detergen nyah minyak bebas corengan dan menarik air dengan bilah getah squeegee getah." },
        { step: "05", title: "Lap Bingkai & Uji", desc: "Mengelap bingkai aluminium dengan kain mikrofiber kering dan menguji kelancaran pergerakan roda gelongsor." },
      ],
      faqs: [
        { q: "Bolehkah filem pelindung tingkap yang mereput dan terbakar matahari ditanggalkan?", a: "Boleh. Filem pelindung yang terbiar lama di bawah panas matahari akan rapuh dan meninggalkan gam yang sangat melekit. Kami menggunakan kombinasi stim haba terkawal dan pelarut gam berasaskan sitrus untuk menanggalkan filem tersebut tanpa mencalarkan kaca." },
        { q: "Mengapa tingkap gelongsor saya terasa berat dan berbunyi kasar selepas renovasi?", a: "Ini disebabkan habuk simen dan butiran pasir halus telah masuk ke dalam alur rel dan menyaluti galas roda gelongsor. Kami menyedut keluar semua kotoran ini dan membersihkan alur dengan teliti supaya roda berputar lancar semula." },
        { q: "Adakah cecair pembersih anda akan melunturkan warna bingkai aluminium hitam atau kelabu saya?", a: "Sama sekali tidak. Kami menggunakan detergen pH seimbang yang diuji selamat untuk aluminium bersalut serbuk (powder coating) dan anodized, menghalang risiko perubahan warna atau timbulnya kesan tompokan putih." },
        { q: "Adakah pembersihan ini meliputi tingkap aras tinggi kondominium?", a: "Ya. Pasukan kami terlatih mengendalikan pembersihan tingkap dari bahagian dalam menggunakan peralatan teleskopik magnetik dan alat keselamatan standard yang mematuhi garis panduan keselamatan bangunan tinggi." },
      ],
      metaTitle: "Pembersihan Kaca Tingkap & Rel Aluminium KL | KL Servis Rumah",
      metaDesc: "Perkhidmatan bersihkan kaca tingkap berdebu, koyak plastik pelindung & sedut pasir rel tingkap aluminium di KL & Selangor. Pintu gelongsor kembali lancar. Sebut harga percuma.",
    },
    zh: {
      name: "窗户玻璃与铝合金滑轨深度精洁",
      tagline: "撕除老化出厂膜、清除玻璃水泥点、深层吸除铝合金滑槽砂石，恢复移门轻顺滑动。依报价。",
      description:
        "装修施工期间，门窗玻璃与推拉铝合金滑槽极易受到高空水泥飞溅、腻子粉尘侵蚀以及电焊火花的污染。特别是在马来西亚炽热阳光照射下，门窗原厂自带的塑料保护膜极易脆化硬化，死死黏附在玻璃与铝框表面难以撕掉，下轨凹槽更会堆积厚厚的沙石粉尘导致滑轮卡死甚至损坏。KL Servis Rumah 窗户玻璃与滑轨深度精洁服务采用专用物理剥离与化学清洗技术，利用温和蒸汽软化撕除老化胶膜，使用专业玻璃刮刀平稳起除干固水泥结块，并通过高负压扁嘴吸尘器彻底抽吸滑轨深处的砂石与木屑，最后进行玻璃无痕双面刮洗与轨道润滑，让视野通透无瑕，推拉丝滑无声。",
      highlights: [
        "专业软化剥离经高温暴晒老化的门窗保护膜与顽固出厂质保标签",
        "扁嘴高负压吸尘深层清理推拉门窗下轨死角砂石，保护滑轮轴承免受磨损",
        "专业安全角度玻璃刮刀，平稳剔除玻璃表面固化的水泥点与石膏硬块",
        "中性除油环保清洁剂配合橡胶刮水条，实现双面玻璃无水纹无毛絮透亮",
        "适用于铝合金平开窗、重型推拉移门、百叶窗及落地阳光房玻璃外立面",
      ],
      process: [
        { step: "01", title: "撕膜除胶", desc: "利用可控温热蒸汽与专用脱胶剂，软化并完整撕除老化的防划塑料保护膜与背胶。" },
        { step: "02", title: "深吸槽内", desc: "使用工业吸尘器配备细扁缝隙吸头，强力吸出推拉窗下部滑道深处的沙砾与石膏残渣。" },
        { step: "03", title: "铲除水泥", desc: "对玻璃与窗框表面的硬化水泥斑点进行浸泡润湿，使用专业无痕刮刀平整铲起。" },
        { step: "04", title: "双面刮拭", desc: "涂抹无氨玻璃清洗剂均匀乳化油垢，配合高弹性进口橡胶水刮一刮到底，不留水渍。" },
        { step: "05", title: "轨道调理", desc: "细致擦净铝框表面灰尘，清理排水孔积垢，并在导轨滑槽表面均匀点润滑剂测试顺畅度。" },
      ],
      faqs: [
        { q: "晒化了粘在玻璃上的门窗保护膜有办法除掉吗？", a: "完全可以。出厂膜暴晒后会发生胶水氧化降解，硬刮会损伤玻璃。我们使用控温热风或专业安全脱膜剂进行分子解聚软化，再由经验丰富的技师配合专业除胶工具整片脱落剥离，彻底除胶无残留。" },
        { q: "为什么装修后窗户推拉起来感觉很重还有沙沙的刺耳响声？", a: "这是因为泥瓦与油漆阶段有大量细微的水泥砂浆颗粒掉入了滑轮凹槽内部，与润滑油混合形成研磨膏阻碍了轴承滚动。我们彻底吸洗滑轨并清除滑轮轴心积砂后，推拉便能恢复出厂时的轻巧静音。" },
        { q: "清洗剂会对黑色哑光粉末喷涂的铝合金表面造成腐蚀变色吗？", a: "绝对不会。我们所选用的清洗剂均经过严格的金属耐受性测试，呈完全中性温和配方，不含任何可腐蚀粉末涂层的强酸、强碱或工业重溶剂，确保铝框表面色泽均匀无光斑。" },
        { q: "高层公寓外侧不能探身出去的玻璃怎么处理？", a: "我们严格遵守高空作业安全规范，使用专业高空磁吸双面擦窗器、多级伸缩延长杆配合内窗安全锁止装置，在绝对保障人身安全的前提下完成外侧玻璃的除尘与收光。" },
      ],
      metaTitle: "吉隆坡窗户玻璃与铝合金滑轨深度精洁 | KL Servis Rumah",
      metaDesc: "吉隆坡与雪兰莪窗户玻璃除水泥、撕老化保护膜及铝合金滑轨深层吸尘清沙服务。恢复推拉顺畅，通透无痕。免费咨询报价。",
    },
  },
  "post-renovation-cleaning/floor-machine-scrubbing-and-buffing": {
    ms: {
      name: "Penyentalan & Penggilapan Mesin Lantai",
      tagline: "Penyentalan lantai menggunakan mesin rotary cakera tunggal, detergen neutral dan sedutan hampagas basah untuk jubin, SPC dan epoxy. Atas sebut harga.",
      description:
        "Selepas kerja renovasi, lantai rumah sering kelihatan kusam, berkabus dan berkerak akibat mendapan air simen, kesan tapak kasut keselamatan pekerja dan lilin pelindung jubin yang kotor. Mengemop lantai secara manual dengan baldi biasa hanya memindahkan air kotor dari satu sudut ke sudut lain dan tidak mampu menembusi liang mikro jubin atau alur timbul lantai SPC. Perkhidmatan penyentalan dan penggilapan mesin lantai KL Servis Rumah menggunakan mesin penyental berputar cakera tunggal (rotary floor scrubber) industri berkelajuan rendah yang dipadankan dengan pad pembersih berbeza kekerasan. Dikombinasikan dengan detergen pelbagai guna ber-pH seimbang dan vakum penyedut air berkuasa tinggi, kami mencuci daki pembinaan secara menyeluruh dari jubin porselin, jubin homogen, lantai SPC, dan lantai epoxy sebelum menggilap permukaannya sehingga menyerlahkan semula seri lantai baharu anda.",
      highlights: [
        "Mesin penyental lantai industri berkuasa tinggi yang membersihkan liang jubin secara mendalam",
        "Pad mesin khas pelbagai tahap kelembutan — selamat untuk jubin porselin, SPC, vinil dan epoxy",
        "Penggunaan detergen pH-neutral yang menghapuskan kesan berkabus simen tanpa menghakis kilauan",
        "Sistem vakum sedutan basah berkapasiti besar yang mengeringkan air kotor serta-merta",
        "Mengembalikan kilauan asal lantai kilat dan kesegaran rona semula jadi lantai bertekstur matte",
      ],
      process: [
        { step: "01", title: "Ujian Bahan", desc: "Memeriksa jenis material lantai (porselin kilat, jubin kusam, SPC atau epoxy) untuk memilih pad dan sabun yang tepat." },
        { step: "02", title: "Sapuan Sabun", desc: "Menyebarkan larutan pembersih neutral secara rata ke atas permukaan lantai untuk melembutkan kotoran daki degil." },
        { step: "03", title: "Sental Mesin", desc: "Mengoperasikan mesin cakera berputar di atas lantai secara perlahan dan sekata untuk mencuci liang dan alur permukaan." },
        { step: "04", title: "Sedut Cecair", desc: "Menyedut air kotor dan sisa mendapan kotoran serta-merta menggunakan mesin vakum basah berkuasa industri." },
        { step: "05", title: "Bilas & Gilap", desc: "Membilas lantai dengan air bersih dan memasang pad penggilap kering untuk mengeringkan dan mengilapkan permukaan lantai." },
      ],
      faqs: [
        { q: "Adakah mesin penyental lantai ini selamat digunakan pada lantai SPC atau vinil?", a: "Sangat selamat. Kami menggunakan pad span putih atau merah yang sangat lembut bersama kawalan kelajuan rendah khas untuk lantai SPC/vinil. Kaedah ini menanggalkan kotoran daki pengubahsuaian tanpa mengoyakkan atau mengelupas lapisan perlindungan UV lantai." },
        { q: "Mengapa jubin porselin baru saya kelihatan pudar dan melekit selepas renovasi?", a: "Kebanyakan pengeluar jubin meletakkan lapisan lilin pelindung (protective transit wax) untuk melindungi jubin semasa penghantaran. Lilin ini memerangkap habuk simen menjadikannya kelabu kusam. Mesin penyental kami menyingkirkan lapisan lilin kotor ini dengan sempurna." },
        { q: "Bolehkah mesin ini membuang kotoran hitam pada garisan celah jubin (grout line)?", a: "Ya. Berus berputar mesin bersama detergen aktif mampu menembusi alur grout dan mengangkat kotoran simen serta lumpur yang terperangkap dalam liang grout, menjadikannya bersih semula sekata." },
        { q: "Berapa lama masa diperlukan untuk mencuci seluruh tingkat bawah rumah teres?", a: "Untuk ruang tamu, ruang makan dan dapur seluas kira-kira 800 hingga 1,200 kaki persegi, proses penyentalan mesin dan penyedutan basah biasanya siap dalam tempoh 2 hingga 3 jam." },
      ],
      metaTitle: "Penyentalan & Penggilapan Mesin Lantai KL | KL Servis Rumah",
      metaDesc: "Perkhidmatan cuci lantai guna mesin rotary scrubber & gilap jubin porselin, SPC, epoxy selepas renovasi di KL & Selangor. Hilangkan kabus simen. Sebut harga percuma.",
    },
    zh: {
      name: "地板机械深度洗地与抛光护理",
      tagline: "重型单盘旋转地刷机配合中性专业清洁剂与吸水机，深层去除瓷砖、SPC石塑与环氧地坪灰雾残蜡。依报价。",
      description:
        "在全屋敲墙、贴砖与木工完工后，地面瓷砖与地板上往往覆盖着顽固的水泥灰水层、施工脚印印记以及原厂出厂防护蜡。普通拖把手工反复拖洗，只是把混浊的水泥水涂抹开来，不仅干透后浮灰复现、表面粘腻发黑，更无法触及瓷砖防滑纹理或石塑地板浮雕木纹深处的污垢。KL Servis Rumah 采用专业重型单盘旋转擦地机（Single-Disc Scrubber），针对瓷砖釉面、仿古砖、SPC石塑防水地板及环氧地坪，精选匹配不同软硬度的专业清洁磨盘。配合专用中性低泡清洁剂进行深度旋刷去污，并利用大功率工业吸水机瞬间抽干泥水污水，彻底瓦解水泥灰翳，还原地板晶莹平滑的出厂质感。",
      highlights: [
        "专业单盘高速旋转重型洗地机，强力瓦解瓷砖细微毛孔与防滑纹理积垢",
        "配备白盘、红盘等多样化专用百洁垫，绝不磨损微晶石、抛光砖及 SPC 涂层",
        "精准中性配方深度清洗，彻底清除出厂运输防护蜡（Transit Wax）与水泥雾",
        "工业级高负压吸污机同步瞬时抽干泥浆积水，杜绝污水回渗与砖缝二次发黑",
        "适用于抛光地砖、大理石原石、水磨石地坪、环氧自流平及 SPC 锁扣地板",
      ],
      process: [
        { step: "01", title: "材质判定", desc: "根据地面铺装材质（亮光瓷砖/柔光哑面砖/SPC木地板/环氧），配置合适清洁液浓度与磨盘软硬度。" },
        { step: "02", title: "药水布洒", desc: "将专业中性除垢水溶液均匀喷洒浸润地面，使其深层渗透软化水泥浆垢与表面油脂。" },
        { step: "03", title: "机械旋刷", desc: "操作单盘擦地机按十字交叉路径进行全方位机械旋刷，彻底起除缝隙污垢与出厂浮蜡。" },
        { step: "04", title: "瞬时抽污", desc: "紧随洗地机后方，使用大功率双马达工业吸水机将泥水脏污彻底抽干，保持基面干爽。" },
        { step: "05", title: "清水收光", desc: "换装清水与纯棉抛光盘做最终平衡中和拖拭，自然风干后地面呈现清澈纯净的原厂色泽。" },
      ],
      faqs: [
        { q: "用机械洗地机会不会刮伤或打磨坏我家新铺的 SPC 石塑防水地板？", a: "绝对不会。对于 SPC 和乙烯基塑胶地板，我们严格禁用黑绿硬质打磨盘，统一采用特制超柔白垫或超细纤维刷盘，配合低速轻柔运转，只去除表面污垢与胶印，丝毫不会损伤其耐磨层和紫外线防护膜。" },
        { q: "为什么新地砖拖了十几次地，干了之后看起来还是灰蒙蒙发白？", a: "这通常是由两种原因造成的：一是许多品牌瓷砖在出厂时涂抹了一层用于防刮擦的运输石蜡（Transit Wax），二是漂浮的极细水泥浆水干涸结晶。普通清水无法溶解这些蜡层和微结晶，必须依靠专业擦地机与除蜡剂才能彻底脱除净透。" },
        { q: "地砖缝隙（填缝剂）里面的黑色施工脏污能刷干净吗？", a: "可以。机器的旋转刷毛配合专用活性清洗剂，能深层探入凹陷的填缝线槽内，将施工期间踩入缝隙的泥砂与粉尘翻卷吸出，使填缝剂恢复原本均匀清爽的线条色彩。" },
        { q: "清洗一套约 1,000 平方英尺的住宅公共区域地面需要多久？", a: "客厅、餐厅、走廊及厨房区域约 800 至 1,000 平方英尺，由专业技师操作洗地机与吸污机进行全面深度清洗通常需耗时 2 至 3 小时。" },
      ],
      metaTitle: "吉隆坡地板机械深度洗地与抛光护理 | KL Servis Rumah",
      metaDesc: "吉隆坡与雪兰莪专业地面机械洗地机深度除垢除蜡与抛光服务。彻底清除瓷砖水泥雾、出厂蜡与SPC脚印。恢复地砖出厂光泽。免费报价。",
    },
  },
  "post-renovation-cleaning/move-in-and-handover-final-cleaning": {
    ms: {
      name: "Pembersihan Akhir Penyerahan & Masuk Rumah",
      tagline: "Pembersihan sanitasi terperinci tahap sarung tangan putih untuk kabinet, almari pakaian, kaunter dapur dan sanitari sebelum masuk rumah. Atas sebut harga.",
      description:
        "Pembersihan akhir penyerahan dan masuk rumah (move-in & handover final cleaning) KL Servis Rumah adalah fasa pembersihan paling teliti sebelum anda membawa masuk perabot lembut dan memulakan kehidupan baharu di rumah anda. Pada tahap ini, semua kerja pertukangan, pengecatan dan pemasangan telah 100% selesai. Pasukan pembersihan khusus kami memberikan tumpuan penuh kepada pembersihan dalaman kabinet dapur dan almari pakaian terbina dalam (setiap laci dan engsel dilap bebas habuk), sanitasi lekapan bilik mandi (mangkuk tandas, tab mandi, paip air berkilau dan cermin tanpa kesan cap jari), pengelapan suis elektrik dan pemegang pintu dengan cecair pembasmi kuman mesra keluarga, serta sapuan lantai akhir. Standard kerja kami memenuhi kriteria pemeriksaan serahan kunci oleh pereka hiasan dalaman (ID) dan memastikan rumah anda benar-benar bersih serta selamat untuk dihuni serta-merta.",
      highlights: [
        "Standard sarung tangan putih — memastikan bahagian dalam laci dan kabinet bebas habuk halus",
        "Sanitasi penuh mangkuk tandas, besen, tab mandi dan paip dengan pembasmi kuman antibakteria",
        "Pengelapan terperinci suis lampu, tombol pintu dan pemegang laci untuk sentuhan selamat",
        "Sesuai untuk pemeriksaan rasmi bersama pereka dalaman (ID) atau pemilik sebelum masuk rumah",
        "Hasil ruang kediaman yang wangi, segar, bersih dan siap untuk dihuni tanpa perlu kerja tambahan",
      ],
      process: [
        { step: "01", title: "Penilaian Akhir", desc: "Menjalankan semakan teliti bersama senarai semak serahan untuk memastikan semua kerja ubah suai telah selesai." },
        { step: "02", title: "Lap Dalam Kabinet", desc: "Membuka semua pintu almari, laci dapur dan rak kasut untuk menyedut habuk sudut dan mengelap hingga bersih." },
        { step: "03", title: "Sanitasi Sanitari", desc: "Membasuh, menyahkuman dan menggilap mangkuk tandas, sinki seramik, skrin mandi kaca dan paip chrome berkilat." },
        { step: "04", title: "Disinfeksi Sentuhan", desc: "Mengelap semua suis lampu, soket dinding, pemegang pintu, pagar tangga dan loceng pintu dengan cecair sanitasi." },
        { step: "05", title: "Serahan Kunci", desc: "Melakukan semakan bersama (walkthrough) pemilik rumah bagi memastikan setiap bilik mematuhi piawaian sedia didiami." },
      ],
      faqs: [
        { q: "Bilakah waktu terbaik untuk menempah pembersihan akhir masuk rumah ini?", a: "Waktu paling ideal ialah 2 hingga 4 hari sebelum tarikh anda berpindah masuk atau tarikh perabot baharu (seperti tilam dan sofa) dihantar, dan selepas semua kontraktor atau juruteknik pemasangan keluar sepenuhnya dari premis." },
        { q: "Adakah bahagian dalam kabinet dapur dan almari pakaian akan dibuka dan dilap?", a: "Pasti. Ini adalah teras kepada perkhidmatan serahan kami. Kami membuka setiap pintu kabinet, mengeluarkan laci jika boleh, dan menyedut serta mengelap setiap para, rel dan engsel supaya pakaian dan pinggan mangkuk boleh disimpan terus." },
        { q: "Adakah bahan pembersih dan pembasmi kuman anda selamat untuk bayi dan haiwan peliharaan?", a: "Ya. Kami menggunakan formulasi pembasmi kuman gred hospital yang tidak bertoksik, bebas klorin peluntur keras dan mesra keluarga, meninggalkan aroma segar yang selamat untuk persekitaran kanak-kanak serta haiwan peliharaan." },
        { q: "Bagaimana jika saya menemui tompok kotoran yang terlepas pandang selepas pembersihan?", a: "KL Servis Rumah menyediakan jaminan semakan dan cuci semula percuma selama 7 hari. Sekiranya ada sudut yang tidak menepati standard yang dipersetujui, pasukan kami akan hadir semula untuk membetulkannya tanpa sebarang caj tambahan." },
      ],
      metaTitle: "Pembersihan Akhir Masuk Rumah KL | KL Servis Rumah",
      metaDesc: "Perkhidmatan pembersihan akhir penyerahan kunci & sedia masuk rumah di KL & Selangor. Cuci dalam kabinet, sanitasi bilik mandi & serahan ID. Sebut harga percuma.",
    },
    zh: {
      name: "交付入住前最终全面精细保洁",
      tagline: "白手套级别精细保洁，对全屋定制橱柜内膛、衣柜抽屉、卫浴洁具及五金把手深度消毒与无尘擦拭。依报价。",
      description:
        "KL Servis Rumah 交付入住前最终全面精细保洁服务是您搬入家具软装、正式开启新家生活前的终极收官工序。在这一阶段，泥瓦、油漆、木工及家电安装已全部完工离场。我们派遣经验丰富的精保洁小组，以严苛的白手套交付标准深入每一个日常触碰的细节：自上而下对厨房整体橱柜、内嵌衣柜的每一层隔板、抽屉滑轨及阻尼铰链进行双向无尘擦拭；对全套卫浴洁具（智能马桶、淋浴五金、亚克力浴缸及玻璃隔断）进行抗菌消毒除垢与镀铬镜面抛光；对手指频繁接触的门窗把手、电源开关及楼梯扶手做抑菌抹拭，并完成终极除味收尾，让您的新居达到设计师交房级标准，真正实现即刻安全拎包入住。",
      highlights: [
        "白手套严苛标准——全屋定制橱柜隔板、抽屉滑槽与衣柜内膛做到无死角抹拭",
        "全套卫浴洁具使用医用级环保抑菌液深度消毒，去除异味并抛亮五金水龙头",
        "对所有门把手、电灯开关面板及柜门暗拉手进行高频接触面重点除菌防护",
        "符合室内设计师（ID）苛刻验收标准，专为业主入伙或新屋交付打造",
        "享 7 天质量检查与免费返工保障，承诺未达标准绝不向客户敷衍交工",
      ],
      process: [
        { step: "01", title: "全面巡检", desc: "对照交付验收清单，逐间检查全屋施工是否彻底收尾，标记重点精洁区域与脆弱高定材质。" },
        { step: "02", title: "柜内除尘", desc: "逐一打开全屋定制橱柜与衣帽间抽屉，深层吸除角落木屑，使用微纤维净布双向抹净隔板。" },
        { step: "03", title: "洁具消毒", desc: "使用中性抑菌除垢剂洗净卫浴瓷盆、马桶及花洒，毛巾收水并对镀铬五金进行镜面增亮抛光。" },
        { step: "04", title: "高频擦拭", desc: "对所有进户门锁具、室内门把手、插座外壳、智能面板及楼梯扶手进行细致擦拭消毒除菌。" },
        { step: "05", title: "联合验收", desc: "陪同业主或室内设计师进行全屋逐室灯光验收比对，确保每一处角落达到无瑕入住高标准。" },
      ],
      faqs: [
        { q: "什么时候预约这个入住前最终精保洁最为合适？", a: "最理想的时间是在所有施工队与安装师傅（如窗帘、家具、空调安装）完全离场后，且在您的大宗软装床垫、沙发进场前 2 至 4 天进行，这样能确保保洁成果不受任何施工人员再次踩踏破坏。" },
        { q: "厨房橱柜内部和定制衣柜里面都会打开来彻底擦干净吗？", a: "必须会。这是我们入住精保洁的核心内容。保洁师会逐个拉开所有抽屉与柜门，对滑轨角落、铰链五金以及层板内壁做细致吸尘与去污擦拭，确保您的衣物和餐具可以直接收纳摆放。" },
        { q: "你们使用的清洁和消毒药剂对家里的婴儿或宠物安全吗？", a: "非常安全。我们严禁在居住空间使用刺鼻有毒的强氯漂白水，统一采用符合环保认证的母婴级植物基抑菌除垢剂，气味清新柔和且挥发无毒，全方位呵护儿童与宠物的健康安全。" },
        { q: "如果在验收或者入住后发现有遗漏的死角怎么办？", a: "KL Servis Rumah 为所有保洁服务提供 7 天质量抽检与免费返工保证。如果您在验收后发现有任何细节未达到约定标准，我们会在接到反馈后迅速安排师傅免费上门修补，绝不推诿。" },
      ],
      metaTitle: "吉隆坡交付入住前最终全面精细保洁 | KL Servis Rumah",
      metaDesc: "吉隆坡与雪兰莪专业新家交付入住前白手套精保洁服务。橱柜内膛擦拭、卫浴深度消毒及设计师级交房标准。7天返工保证，免费报价。",
    },
  },
  /* ── AIRCON ──────────────────────────────────────────────────────────── */
