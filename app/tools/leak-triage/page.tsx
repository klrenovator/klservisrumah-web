...
const content = toolsContent["leak-triage"];
 ...
 */
const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/leak-triage"), {
  loading: () => (
    ...
    <>
      ...
      <Breadcrumbs
        items={[
          ...
          { label: content.name, href: "/tools/leak-triage" }
        ]}
      />
