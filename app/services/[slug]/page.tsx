          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-7 flex flex-col gap-10">
              ...
              <div className="flex flex-col gap-5">
                <h2 className="text-xl font-extrabold text-[#075985] tracking-tight border-b border-slate-100 pb-3">
              ...
              <div className="flex flex-col gap-5 bg-slate-50 rounded-3xl p-6 sm:p-8 border border-slate-100">
                <div className="flex flex-col gap-1">
                  <h2 className="text-lg font-extrabold text-[#075985] tracking-tight">
                ...
                <div className="flex flex-col gap-3 mt-2">
                  {service.subServices.map((sub, idx) => (
                    ...
                    >
                      <div className="flex flex-col gap-1">
                        <span className="text-sm font-bold text-[#075985]">{sub.name}</span>
                ...
                <div className="flex flex-col gap-4">
                  {service.process.map((step, idx) => (
                    <div key={idx} className="flex gap-4 items-start">
                      <span className="text-lg font-extrabold text-[#0EA5E9] bg-[#E0F2FE]/30 px-3.5 py-1.5 rounded-xl">
                        {step.step}
                      </span>
                      <div className="flex flex-col gap-1">
                        <h3 className="text-sm font-bold text-[#075985]">{step.title}</h3>
            ...
            <div className="lg:col-span-5 w-full sticky top-28">
              <div className="bg-slate-50 rounded-3xl p-6 sm:p-8 border border-slate-100 flex flex-col gap-6">
                <div className="flex flex-col gap-1">
                  ...
                  <h2 className="text-xl sm:text-2xl font-extrabold text-[#075985] tracking-tight">Need {service.title}?</h2>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <a
                    ...
                    className="w-full bg-white hover:bg-slate-100/50 border border-[#075985]/15 text-[#075985] text-center font-extrabold text-sm py-4 rounded-xl transition-all duration-200 flex items-center justify-center gap-2"
                  >
                ...
                <div className="text-[10px] text-[#475569] font-bold text-center leading-normal border-t border-slate-200/50 pt-5">
                  Established local company with insured operations, itemized pricing, and background-verified tradesmen.
                </div>
              </div>
            </div>
