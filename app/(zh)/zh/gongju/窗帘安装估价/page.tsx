...
const content = localizedToolContent("curtain-installation-calculator", "zh");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/zh/curtain-installation-calculator"), {
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="首页" ariaLabel="面包屑导航" items={[{ label: "免费工具", href: "/zh/gongju" }, { label: content.name, href: "/zh/gongju/窗帘安装估价" }]} />
