...
const content = localizedToolContent("roof-repair-estimator", "zh");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/zh/roof-repair-estimator"), {
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="首页" ariaLabel="面包屑导航" items={[{ label: "免费工具", href: "/zh/gongju" }, { label: content.name, href: "/zh/gongju/屋顶维修估价" }]} />
