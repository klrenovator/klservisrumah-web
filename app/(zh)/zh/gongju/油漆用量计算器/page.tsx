...
const content = localizedToolContent("paint-quantity-estimator", "zh");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/zh/paint-quantity-estimator"), {
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="首页" ariaLabel="面包屑导航" items={[{ label: "免费工具", href: "/zh/gongju" }, { label: content.name, href: "/zh/gongju/油漆用量计算器" }]} />
