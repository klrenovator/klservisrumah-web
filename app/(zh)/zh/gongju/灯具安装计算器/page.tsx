...
const content = localizedToolContent("lighting-installation-calculator", "zh");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/zh/lighting-installation-calculator"), {
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="首页" ariaLabel="面包屑导航" items={[{ label: "免费工具", href: "/zh/gongju" }, { label: content.name, href: "/zh/gongju/灯具安装计算器" }]} />
