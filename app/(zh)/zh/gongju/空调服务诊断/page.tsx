...
const content = localizedToolContent("aircon-service-picker", "zh");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/zh/aircon-service-picker"), {
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="首页" ariaLabel="面包屑导航" items={[{ label: "免费工具", href: "/zh/gongju" }, { label: content.name, href: "/zh/gongju/空调服务诊断" }]} />
