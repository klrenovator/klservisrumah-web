...
export default function ChineseBlogHub() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center gap-4 max-w-3xl mx-auto">
            ...
            <div className="flex items-center gap-4 mt-2">
              <a href={getWhatsAppLink({ lang: "zh" })} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#128C7E] text-white font-extrabold text-sm px-6 py-3 rounded-xl transition-all duration-200 shadow-sm">
      ...
      <nav aria-label="面包屑导航" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 text-sm">
