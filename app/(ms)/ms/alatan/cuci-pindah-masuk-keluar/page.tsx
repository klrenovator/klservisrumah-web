...
const content = localizedToolContent("move-in-out-cleaning-calculator", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/move-in-out-cleaning-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/ms/alatan/cuci-pindah-masuk-keluar",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/cuci-pindah-masuk-keluar" }]} />
