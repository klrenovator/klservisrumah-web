...
const content = localizedToolContent("socket-quantity-calculator", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/socket-quantity-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/ms/alatan/kalkulator-kuantiti-soket",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/kalkulator-kuantiti-soket" }]} />
