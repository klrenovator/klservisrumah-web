...
const content = localizedToolContent("bathroom-waterproofing-estimator", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/bathroom-waterproofing-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/ms/alatan/kalis-air-bilik-mandi",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/kalis-air-bilik-mandi" }]} />
