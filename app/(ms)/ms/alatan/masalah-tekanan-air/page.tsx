...
const content = localizedToolContent("water-pressure-troubleshooter", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/water-pressure-troubleshooter"), {
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/masalah-tekanan-air" }]} />
