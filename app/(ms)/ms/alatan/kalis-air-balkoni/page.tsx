...
const content = localizedToolContent("balcony-waterproofing-estimator", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/balcony-waterproofing-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/ms/alatan/kalis-air-balkoni",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/kalis-air-balkoni" }]} />
