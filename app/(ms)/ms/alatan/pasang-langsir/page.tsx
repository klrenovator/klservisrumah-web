...
const content = localizedToolContent("curtain-installation-calculator", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/curtain-installation-calculator"), {
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/pasang-langsir" }]} />
