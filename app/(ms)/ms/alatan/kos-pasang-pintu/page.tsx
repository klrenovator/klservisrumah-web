...
const content = localizedToolContent("door-installation-cost", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/door-installation-cost"), {
...
export const metadata = buildMetadata({
  ...
  path: "/ms/alatan/kos-pasang-pintu",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/kos-pasang-pintu" }]} />
