...
const content = localizedToolContent("roof-area-calculator", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/roof-area-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/ms/alatan/kalkulator-keluasan-bumbung",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/kalkulator-keluasan-bumbung" }]} />
