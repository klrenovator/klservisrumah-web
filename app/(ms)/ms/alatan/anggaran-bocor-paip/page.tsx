...
const content = localizedToolContent("pipe-leak-estimator", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/pipe-leak-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/ms/alatan/anggaran-bocor-paip",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/anggaran-bocor-paip" }]} />
