...
const content = localizedToolContent("aircon-service-picker", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/aircon-service-picker"), {
...
export const metadata = buildMetadata({
  ...
  path: "/ms/alatan/diagnostik-servis-aircond",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/diagnostik-servis-aircond" }]} />
