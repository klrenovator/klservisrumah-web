...
const content = localizedToolContent("paint-quantity-estimator", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/paint-quantity-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/ms/alatan/kalkulator-kuantiti-cat",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/kalkulator-kuantiti-cat" }]} />
