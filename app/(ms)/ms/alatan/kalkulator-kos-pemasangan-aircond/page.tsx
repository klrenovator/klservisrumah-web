...
const content = localizedToolContent("aircon-installation-cost", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/aircon-installation-cost"), {
...
export const metadata = buildMetadata({
  ...
  path: "/ms/alatan/kalkulator-kos-pemasangan-aircond",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/kalkulator-kos-pemasangan-aircond" }]} />
