...
const content = localizedToolContent("aircon-gas-topup-cost", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/aircon-gas-topup-cost"), {
...
export const metadata = buildMetadata({
  ...
  path: "/ms/alatan/kalkulator-kos-topup-gas-aircond",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/kalkulator-kos-topup-gas-aircond" }]} />
