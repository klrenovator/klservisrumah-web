...
const content = localizedToolContent("vinyl-flooring-cost-estimator", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/vinyl-flooring-cost-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/ms/alatan/kos-lantai-vinyl",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/kos-lantai-vinyl" }]} />
