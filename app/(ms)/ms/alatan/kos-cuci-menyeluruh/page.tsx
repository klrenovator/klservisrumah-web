...
const content = localizedToolContent("deep-cleaning-cost-estimator", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/deep-cleaning-cost-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/ms/alatan/kos-cuci-menyeluruh",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/kos-cuci-menyeluruh" }]} />
