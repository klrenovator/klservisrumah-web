...
const content = localizedToolContent("ceiling-replacement-cost", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/ceiling-replacement-cost"), {
...
export const metadata = buildMetadata({
  ...
  path: "/ms/alatan/kos-ganti-siling",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/kos-ganti-siling" }]} />
