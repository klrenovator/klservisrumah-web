...
const content = localizedToolContent("bathroom-renovation-estimator", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/bathroom-renovation-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/ms/alatan/renovasi-bilik-air",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/renovasi-bilik-air" }]} />
