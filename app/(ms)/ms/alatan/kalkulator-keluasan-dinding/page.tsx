...
const content = localizedToolContent("wall-area-calculator", "ms");

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ms/wall-area-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/ms/alatan/kalkulator-keluasan-dinding",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs homeLabel="Utama" ariaLabel="Laluan navigasi" items={[{ label: "Alat Percuma", href: "/ms/alatan" }, { label: content.name, href: "/ms/alatan/kalkulator-keluasan-dinding" }]} />
