...
const content = toolsContent["roof-area-calculator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/roof-area-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/roof-area-calculator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/roof-area-calculator" }]} />
