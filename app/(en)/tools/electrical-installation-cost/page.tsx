...
const content = toolsContent["electrical-installation-cost"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/electrical-installation-cost"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/electrical-installation-cost",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/electrical-installation-cost" }]} />
