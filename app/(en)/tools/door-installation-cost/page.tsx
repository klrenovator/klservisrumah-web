...
const content = toolsContent["door-installation-cost"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/door-installation-cost"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/door-installation-cost",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/door-installation-cost" }]} />
