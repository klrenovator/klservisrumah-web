...
const content = toolsContent["socket-quantity-calculator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/socket-quantity-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/socket-quantity-calculator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/socket-quantity-calculator" }]} />
