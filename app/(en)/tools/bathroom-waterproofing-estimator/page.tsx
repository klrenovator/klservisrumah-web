...
const content = toolsContent["bathroom-waterproofing-estimator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/bathroom-waterproofing-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/bathroom-waterproofing-estimator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/bathroom-waterproofing-estimator" }]} />
