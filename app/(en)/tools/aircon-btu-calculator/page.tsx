...
const content = toolsContent["aircon-btu-calculator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/aircon-btu-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/aircon-btu-calculator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/aircon-btu-calculator" }]} />
