...
const content = toolsContent["aircon-service-picker"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/aircon-service-picker"), {
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/aircon-service-picker" }]} />
