...
const content = toolsContent["paint-quantity-estimator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/paint-quantity-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/paint-quantity-estimator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/paint-quantity-estimator" }]} />
