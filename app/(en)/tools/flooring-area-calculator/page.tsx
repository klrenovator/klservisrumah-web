...
const content = toolsContent["flooring-area-calculator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/flooring-area-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/flooring-area-calculator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/flooring-area-calculator" }]} />
