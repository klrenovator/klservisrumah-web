...
const content = toolsContent["room-renovation-estimator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/room-renovation-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/room-renovation-estimator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/room-renovation-estimator" }]} />
