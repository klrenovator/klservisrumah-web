...
const content = toolsContent["deep-cleaning-cost-estimator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/deep-cleaning-cost-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/deep-cleaning-cost-estimator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/deep-cleaning-cost-estimator" }]} />
