...
const content = toolsContent["ceiling-area-calculator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ceiling-area-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/ceiling-area-calculator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/ceiling-area-calculator" }]} />
