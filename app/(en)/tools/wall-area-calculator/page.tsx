...
const content = toolsContent["wall-area-calculator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/wall-area-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/wall-area-calculator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/wall-area-calculator" }]} />
