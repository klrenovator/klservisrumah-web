...
const content = toolsContent["handyman-cost-estimator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/handyman-cost-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/handyman-cost-estimator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/handyman-cost-estimator" }]} />
