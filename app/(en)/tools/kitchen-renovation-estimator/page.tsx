...
const content = toolsContent["kitchen-renovation-estimator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/kitchen-renovation-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/kitchen-renovation-estimator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/kitchen-renovation-estimator" }]} />
