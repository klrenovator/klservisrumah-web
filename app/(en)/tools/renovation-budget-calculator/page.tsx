...
const content = toolsContent["renovation-budget-calculator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/renovation-budget-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/renovation-budget-calculator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/renovation-budget-calculator" }]} />
