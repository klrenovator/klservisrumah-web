...
const content = toolsContent["balcony-waterproofing-estimator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/balcony-waterproofing-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/balcony-waterproofing-estimator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/balcony-waterproofing-estimator" }]} />
