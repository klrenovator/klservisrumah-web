...
const content = toolsContent["waterproofing-cost-calculator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/waterproofing-cost-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/waterproofing-cost-calculator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/waterproofing-cost-calculator" }]} />
