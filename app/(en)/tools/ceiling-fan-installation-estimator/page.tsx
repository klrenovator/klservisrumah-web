...
const content = toolsContent["ceiling-fan-installation-estimator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ceiling-fan-installation-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/ceiling-fan-installation-estimator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/ceiling-fan-installation-estimator" }]} />
