...
const content = toolsContent["ceiling-replacement-cost"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/ceiling-replacement-cost"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/ceiling-replacement-cost",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/ceiling-replacement-cost" }]} />
