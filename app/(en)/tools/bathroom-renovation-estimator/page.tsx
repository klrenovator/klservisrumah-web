...
const content = toolsContent["bathroom-renovation-estimator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/bathroom-renovation-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/bathroom-renovation-estimator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/bathroom-renovation-estimator" }]} />
