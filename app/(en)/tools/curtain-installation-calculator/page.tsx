...
const content = toolsContent["curtain-installation-calculator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/curtain-installation-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/curtain-installation-calculator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/curtain-installation-calculator" }]} />
