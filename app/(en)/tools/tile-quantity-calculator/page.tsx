...
const content = toolsContent["tile-quantity-calculator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/tile-quantity-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/tile-quantity-calculator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/tile-quantity-calculator" }]} />
