...
const content = toolsContent["glass-replacement-calculator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/glass-replacement-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/glass-replacement-calculator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/glass-replacement-calculator" }]} />
