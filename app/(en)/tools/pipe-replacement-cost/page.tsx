...
const content = toolsContent["pipe-replacement-cost"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/pipe-replacement-cost"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/pipe-replacement-cost",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/pipe-replacement-cost" }]} />
