...
const content = toolsContent["window-replacement-estimator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/window-replacement-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/window-replacement-estimator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/window-replacement-estimator" }]} />
