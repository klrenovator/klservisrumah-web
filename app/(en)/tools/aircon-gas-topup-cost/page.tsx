...
const content = toolsContent["aircon-gas-topup-cost"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/aircon-gas-topup-cost"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/aircon-gas-topup-cost",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/aircon-gas-topup-cost" }]} />
