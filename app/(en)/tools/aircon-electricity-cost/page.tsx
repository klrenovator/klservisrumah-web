...
const content = toolsContent["aircon-electricity-cost"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/aircon-electricity-cost"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/aircon-electricity-cost",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/aircon-electricity-cost" }]} />
