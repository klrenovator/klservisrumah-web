...
const content = toolsContent["water-pressure-troubleshooter"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/water-pressure-troubleshooter"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/water-pressure-troubleshooter",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/water-pressure-troubleshooter" }]} />
