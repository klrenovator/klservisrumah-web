...
const content = toolsContent["roof-replacement-cost"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/roof-replacement-cost"), {
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/roof-replacement-cost" }]} />
