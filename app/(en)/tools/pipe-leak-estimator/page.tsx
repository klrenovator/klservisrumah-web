...
const content = toolsContent["pipe-leak-estimator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/pipe-leak-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/pipe-leak-estimator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/pipe-leak-estimator" }]} />
