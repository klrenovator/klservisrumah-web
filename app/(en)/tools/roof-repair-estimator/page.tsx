...
const content = toolsContent["roof-repair-estimator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/roof-repair-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/roof-repair-estimator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/roof-repair-estimator" }]} />
