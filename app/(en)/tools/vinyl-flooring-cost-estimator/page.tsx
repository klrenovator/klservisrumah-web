...
const content = toolsContent["vinyl-flooring-cost-estimator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/vinyl-flooring-cost-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/vinyl-flooring-cost-estimator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/vinyl-flooring-cost-estimator" }]} />
