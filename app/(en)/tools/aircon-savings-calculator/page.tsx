...
const content = toolsContent["aircon-savings-calculator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/aircon-savings-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/aircon-savings-calculator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/aircon-savings-calculator" }]} />
