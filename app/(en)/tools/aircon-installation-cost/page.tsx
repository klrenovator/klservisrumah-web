...
const content = toolsContent["aircon-installation-cost"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/aircon-installation-cost"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/aircon-installation-cost",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/aircon-installation-cost" }]} />
