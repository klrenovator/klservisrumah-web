...
const content = toolsContent["furniture-assembly-estimator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/furniture-assembly-estimator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/furniture-assembly-estimator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/furniture-assembly-estimator" }]} />
