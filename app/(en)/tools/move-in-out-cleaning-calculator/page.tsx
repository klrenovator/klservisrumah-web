...
const content = toolsContent["move-in-out-cleaning-calculator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/move-in-out-cleaning-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/move-in-out-cleaning-calculator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/move-in-out-cleaning-calculator" }]} />
