...
const content = toolsContent["aircon-size-calculator"];

const Wizard = dynamic(() => import("@/components/tools/estimator/wizards/aircon-size-calculator"), {
...
export const metadata = buildMetadata({
  ...
  path: "/tools/aircon-size-calculator",
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumbs items={[{ label: "Free Tools", href: "/tools" }, { label: content.name, href: "/tools/aircon-size-calculator" }]} />
