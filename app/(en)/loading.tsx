 ...
 *
 * Note: this is a server component (no `"use client"`) so it ships zero JS.
 * The "Loading..." label is therefore intentionally English-only; it is
 * also marked `aria-live="polite"` so screen readers announce progress
 * without forcing a translation lookup on every navigation.
 */
export default function Loading() {
  return (
    <div
      ...
      className="min-h-[60vh] flex flex-col items-center justify-center gap-6 px-4 py-16"
    >
