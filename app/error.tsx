  ...
  return (
    <section className="bg-gradient-to-b from-slate-50 to-white py-24">
      <div className="mx-auto flex max-w-3xl flex-col items-center gap-6 px-4 text-center">
        ...
        <h1 className="text-4xl font-extrabold text-[#1E40AF]">This page hit a temporary issue</h1>
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          <button onClick={reset} className="rounded-xl bg-[#2563EB] px-5 py-3 text-sm font-extrabold text-white">Try again</button>
          <Link href="/services" className="rounded-xl border border-slate-200 px-5 py-3 text-sm font-extrabold text-[#1E40AF]">Services</Link>
