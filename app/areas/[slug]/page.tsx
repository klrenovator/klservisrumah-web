          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-7 flex flex-col gap-10">
              ...
              <div className="flex flex-col gap-4">
                <span className="text-xs font-bold text-[#0781B2] uppercase tracking-widest bg-[#0781B2]/10 px-4 py-1.5 rounded-full w-fit flex items-center gap-1.5">
              ...
              <div className="bg-slate-50 rounded-3xl p-6 border border-slate-100/80 flex flex-col gap-5">
                <h2 className="text-lg font-extrabold text-[#021F44] tracking-tight flex items-center gap-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {area.landmarks.map((landmark, idx) => (
                    <div key={idx} className="flex gap-2 items-center text-xs sm:text-sm font-semibold text-[#4A607C]">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#0781B2]" />
                      <span>{landmark}</span>
                    </div>
                  ))}
                </div>
            ...
            <div className="lg:col-span-5 w-full lg:sticky lg:top-28">
              <div className="bg-[#021F44] text-white rounded-3xl p-6 sm:p-8 flex flex-col gap-6 shadow-[0_20px_50px_rgba(2,31,68,0.12)]">
                <div className="flex flex-col gap-1">
                  <span className="text-xs font-bold text-[#0781B2] uppercase tracking-widest">Immediate Dispatch</span>
                ...
                <div className="bg-white/5 p-5 rounded-2xl border border-white/10 flex flex-col gap-3 text-xs sm:text-sm font-semibold">
                  <div className="flex items-center gap-2 text-[#0781B2]">
                  ...
                  <ul className="flex flex-col gap-2 text-slate-200">
                    <li>✓ Operated by SSM registered parent company</li>
